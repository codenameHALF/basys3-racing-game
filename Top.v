...
`endif // RANDOMIZE_REG_INIT
  ...
  wire [9:0] _viewBoxXReg_T_1 = viewBoxXReg + 10'h8; // @[src/main/scala/ScreenManager.scala 156:36]
  wire [9:0] _GEN_4 = io_newFrame ? _viewBoxXReg_T_1 : viewBoxXReg; // @[src/main/scala/ScreenManager.scala 155:25 156:21 97:28]
  wire [2:0] _GEN_5 = io_newFrame ? 3'h3 : screenManagerStateReg; // @[src/main/scala/ScreenManager.scala 155:25 157:31 103:38]
  wire [2:0] _GEN_6 = viewBoxXReg >= 10'h280 ? 3'h6 : 3'h2; // @[src/main/scala/ScreenManager.scala 163:34 164:31 167:31]
  wire  _GEN_7 = viewBoxXReg >= 10'h280 | currentScreenReg; // @[src/main/scala/ScreenManager.scala 163:34 165:26 104:33]
  wire [2:0] _GEN_8 = screenLoader_io_done ? 3'h5 : screenManagerStateReg; // @[src/main/scala/ScreenManager.scala 175:34 177:31 103:38]
  wire [2:0] _GEN_9 = ~currentScreenReg ? 3'h2 : screenManagerStateReg; // @[src/main/scala/ScreenManager.scala 204:48 205:33 103:38]
  wire [2:0] _GEN_10 = currentScreenReg ? 3'h4 : _GEN_9; // @[src/main/scala/ScreenManager.scala 207:54 208:33]
  wire [9:0] _GEN_11 = currentScreenReg ? 10'h0 : viewBoxXReg; // @[src/main/scala/ScreenManager.scala 207:54 209:23 97:28]
  wire [2:0] _GEN_13 = io_btnC ? _GEN_10 : screenManagerStateReg; // @[src/main/scala/ScreenManager.scala 203:21 103:38]
  wire [9:0] _GEN_14 = io_btnC ? _GEN_11 : viewBoxXReg; // @[src/main/scala/ScreenManager.scala 203:21 97:28]
  wire [2:0] _GEN_16 = io_newFrame ? 3'h7 : _GEN_13; // @[src/main/scala/ScreenManager.scala 214:25 215:31]
  wire [2:0] _GEN_18 = 3'h7 == screenManagerStateReg ? 3'h6 : screenManagerStateReg; // @[src/main/scala/ScreenManager.scala 136:33 221:29 103:38]
  wire [2:0] _GEN_19 = 3'h6 == screenManagerStateReg ? _GEN_16 : _GEN_18; // @[src/main/scala/ScreenManager.scala 136:33]
  wire [9:0] _GEN_20 = 3'h6 == screenManagerStateReg ? _GEN_14 : viewBoxXReg; // @[src/main/scala/ScreenManager.scala 136:33 97:28]
  wire [9:0] _GEN_111 = 3'h5 == screenManagerStateReg ? 10'h0 : viewBoxXReg; // @[src/main/scala/ScreenManager.scala 136:33 190:19 99:15]
  wire [5:0] _GEN_113 = 3'h5 == screenManagerStateReg ? 6'h0 : screenLoader_io_backBufferWriteData; // @[src/main/scala/ScreenManager.scala 130:26 136:33 193:30]
  wire [10:0] _GEN_114 = 3'h5 == screenManagerStateReg ? 11'h0 : screenLoader_io_backBufferWriteAddress; // @[src/main/scala/ScreenManager.scala 131:29 136:33 194:33]
  wire  _GEN_115 = 3'h5 == screenManagerStateReg ? 1'h0 : screenLoader_io_backBufferWriteEnable; // @[src/main/scala/ScreenManager.scala 132:28 136:33 195:32]
  wire [2:0] _GEN_118 = 3'h5 == screenManagerStateReg ? screenManagerStateReg : _GEN_19; // @[src/main/scala/ScreenManager.scala 136:33 103:38]
  wire [9:0] _GEN_119 = 3'h5 == screenManagerStateReg ? viewBoxXReg : _GEN_20; // @[src/main/scala/ScreenManager.scala 136:33 97:28]
  wire [3:0] _GEN_122 = 3'h4 == screenManagerStateReg ? 4'h1 : 4'h0; // @[src/main/scala/ScreenManager.scala 110:28 136:33 173:32]
  wire [2:0] _GEN_124 = 3'h4 == screenManagerStateReg ? _GEN_8 : _GEN_118; // @[src/main/scala/ScreenManager.scala 136:33]
  wire [9:0] _GEN_213 = 3'h4 == screenManagerStateReg ? viewBoxXReg : _GEN_111; // @[src/main/scala/ScreenManager.scala 136:33 99:15]
  wire [5:0] _GEN_215 = 3'h4 == screenManagerStateReg ? screenLoader_io_backBufferWriteData : _GEN_113; // @[src/main/scala/ScreenManager.scala 130:26 136:33]
  wire [10:0] _GEN_216 = 3'h4 == screenManagerStateReg ? screenLoader_io_backBufferWriteAddress : _GEN_114; // @[src/main/scala/ScreenManager.scala 131:29 136:33]
  wire  _GEN_217 = 3'h4 == screenManagerStateReg ? screenLoader_io_backBufferWriteEnable : _GEN_115; // @[src/main/scala/ScreenManager.scala 132:28 136:33]
  wire [9:0] _GEN_219 = 3'h4 == screenManagerStateReg ? viewBoxXReg : _GEN_119; // @[src/main/scala/ScreenManager.scala 136:33 97:28]
  wire [2:0] _GEN_222 = 3'h3 == screenManagerStateReg ? _GEN_6 : _GEN_124; // @[src/main/scala/ScreenManager.scala 136:33]
  wire  _GEN_223 = 3'h3 == screenManagerStateReg ? _GEN_7 : currentScreenReg; // @[src/main/scala/ScreenManager.scala 104:33 136:33]
  wire  _GEN_224 = 3'h3 == screenManagerStateReg ? 1'h0 : 3'h4 == screenManagerStateReg; // @[src/main/scala/ScreenManager.scala 112:24 136:33]
  wire [3:0] _GEN_225 = 3'h3 == screenManagerStateReg ? 4'h0 : _GEN_122; // @[src/main/scala/ScreenManager.scala 110:28 136:33]
  wire [9:0] _GEN_314 = 3'h3 == screenManagerStateReg ? viewBoxXReg : _GEN_213; // @[src/main/scala/ScreenManager.scala 136:33 99:15]
  wire [5:0] _GEN_316 = 3'h3 == screenManagerStateReg ? screenLoader_io_backBufferWriteData : _GEN_215; // @[src/main/scala/ScreenManager.scala 130:26 136:33]
  wire [10:0] _GEN_317 = 3'h3 == screenManagerStateReg ? screenLoader_io_backBufferWriteAddress : _GEN_216; // @[src/main/scala/ScreenManager.scala 131:29 136:33]
  wire  _GEN_318 = 3'h3 == screenManagerStateReg ? screenLoader_io_backBufferWriteEnable : _GEN_217; // @[src/main/scala/ScreenManager.scala 132:28 136:33]
  wire [9:0] _GEN_320 = 3'h3 == screenManagerStateReg ? viewBoxXReg : _GEN_219; // @[src/main/scala/ScreenManager.scala 136:33 97:28]
  wire  _GEN_326 = 3'h2 == screenManagerStateReg ? 1'h0 : _GEN_224; // @[src/main/scala/ScreenManager.scala 112:24 136:33]
  wire [3:0] _GEN_327 = 3'h2 == screenManagerStateReg ? 4'h0 : _GEN_225; // @[src/main/scala/ScreenManager.scala 110:28 136:33]
  wire [9:0] _GEN_416 = 3'h2 == screenManagerStateReg ? viewBoxXReg : _GEN_314; // @[src/main/scala/ScreenManager.scala 136:33 99:15]
  wire [5:0] _GEN_418 = 3'h2 == screenManagerStateReg ? screenLoader_io_backBufferWriteData : _GEN_316; // @[src/main/scala/ScreenManager.scala 130:26 136:33]
  wire [10:0] _GEN_419 = 3'h2 == screenManagerStateReg ? screenLoader_io_backBufferWriteAddress : _GEN_317; // @[src/main/scala/ScreenManager.scala 131:29 136:33]
  wire  _GEN_420 = 3'h2 == screenManagerStateReg ? screenLoader_io_backBufferWriteEnable : _GEN_318; // @[src/main/scala/ScreenManager.scala 132:28 136:33]
  wire  _GEN_423 = 3'h1 == screenManagerStateReg | _GEN_326; // @[src/main/scala/ScreenManager.scala 136:33 144:28]
  wire [3:0] _GEN_424 = 3'h1 == screenManagerStateReg ? 4'h0 : _GEN_327; // @[src/main/scala/ScreenManager.scala 136:33 145:32]
  wire [9:0] _GEN_517 = 3'h1 == screenManagerStateReg ? viewBoxXReg : _GEN_416; // @[src/main/scala/ScreenManager.scala 136:33 99:15]
  wire [5:0] _GEN_519 = 3'h1 == screenManagerStateReg ? screenLoader_io_backBufferWriteData : _GEN_418; // @[src/main/scala/ScreenManager.scala 130:26 136:33]
  wire [10:0] _GEN_520 = 3'h1 == screenManagerStateReg ? screenLoader_io_backBufferWriteAddress : _GEN_419; // @[src/main/scala/ScreenManager.scala 131:29 136:33]
  wire  _GEN_521 = 3'h1 == screenManagerStateReg ? screenLoader_io_backBufferWriteEnable : _GEN_420; // @[src/main/scala/ScreenManager.scala 132:28 136:33]
  reg  io_frameUpdateDone_REG; // @[src/main/scala/ScreenManager.scala 227:40]
  reg  io_frameUpdateDone_REG_1; // @[src/main/scala/ScreenManager.scala 227:32]
  ...
  assign io_viewBoxX = 3'h0 == screenManagerStateReg ? viewBoxXReg : _GEN_517; // @[src/main/scala/ScreenManager.scala 136:33 99:15]
  assign io_backBufferWriteData = 3'h0 == screenManagerStateReg ? screenLoader_io_backBufferWriteData : _GEN_519; // @[src/main/scala/ScreenManager.scala 130:26 136:33]
  assign io_backBufferWriteAddress = 3'h0 == screenManagerStateReg ? screenLoader_io_backBufferWriteAddress : _GEN_520; // @[src/main/scala/ScreenManager.scala 131:29 136:33]
  assign io_backBufferWriteEnable = 3'h0 == screenManagerStateReg ? screenLoader_io_backBufferWriteEnable : _GEN_521; // @[src/main/scala/ScreenManager.scala 132:28 136:33]
  assign io_frameUpdateDone = io_frameUpdateDone_REG_1; // @[src/main/scala/ScreenManager.scala 227:22]
  assign tilemapRom_io_tilemapIdx = 3'h0 == screenManagerStateReg ? 4'h0 : _GEN_424; // @[src/main/scala/ScreenManager.scala 110:28 136:33]
  assign tilemapRom_io_tileAddress = screenLoader_io_tileAddress; // @[src/main/scala/ScreenManager.scala 111:29]
  assign screenLoader_clock = clock;
  assign screenLoader_reset = reset;
  assign screenLoader_io_load = 3'h0 == screenManagerStateReg ? 1'h0 : _GEN_423; // @[src/main/scala/ScreenManager.scala 112:24 136:33]
  ...
  always @(posedge clock) begin
    ...
    end else if (!(3'h0 == screenManagerStateReg)) begin // @[src/main/scala/ScreenManager.scala 136:33]
      if (!(3'h1 == screenManagerStateReg)) begin // @[src/main/scala/ScreenManager.scala 136:33]
        if (3'h2 == screenManagerStateReg) begin // @[src/main/scala/ScreenManager.scala 136:33]
          viewBoxXReg <= _GEN_4;
        end else begin
          viewBoxXReg <= _GEN_320;
        end
      end
    end
    if (reset) begin // @[src/main/scala/ScreenManager.scala 103:38]
      ...
      if (io_newFrame) begin // @[src/main/scala/ScreenManager.scala 138:25]
        screenManagerStateReg <= 3'h1; // @[src/main/scala/ScreenManager.scala 139:31]
      end
    end else if (3'h1 == screenManagerStateReg) begin // @[src/main/scala/ScreenManager.scala 136:33]
      if (screenLoader_io_done) begin // @[src/main/scala/ScreenManager.scala 147:34]
        screenManagerStateReg <= 3'h6; // @[src/main/scala/ScreenManager.scala 149:31]
      end
    end else if (3'h2 == screenManagerStateReg) begin // @[src/main/scala/ScreenManager.scala 136:33]
      screenManagerStateReg <= _GEN_5;
    end else begin
      screenManagerStateReg <= _GEN_222;
    end
    if (reset) begin // @[src/main/scala/ScreenManager.scala 104:33]
      ...
      if (3'h1 == screenManagerStateReg) begin // @[src/main/scala/ScreenManager.scala 136:33]
        if (screenLoader_io_done) begin // @[src/main/scala/ScreenManager.scala 147:34]
          currentScreenReg <= 1'h0; // @[src/main/scala/ScreenManager.scala 150:26]
        end
      end else if (!(3'h2 == screenManagerStateReg)) begin // @[src/main/scala/ScreenManager.scala 136:33]
        currentScreenReg <= _GEN_223;
      end
    end
    io_frameUpdateDone_REG <= io_newFrame; // @[src/main/scala/ScreenManager.scala 227:40]
    io_frameUpdateDone_REG_1 <= io_frameUpdateDone_REG; // @[src/main/scala/ScreenManager.scala 227:32]
  end
// Register and memory initialization
`ifdef RANDOMIZE_GARBAGE_ASSIGN
`define RANDOMIZE

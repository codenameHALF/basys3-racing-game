...
`endif // RANDOMIZE_REG_INIT
  ...
  wire [31:0] _GEN_23 = io_enable ? $signed(playerXPositionReg) : $signed(32'sh2400000); // @[src/main/scala/PlayerController.scala 134:22 139:28 69:35]
  wire [31:0] _GEN_24 = io_enable ? $signed(playerYPositionReg) : $signed(32'sha00000); // @[src/main/scala/PlayerController.scala 134:22 140:28 70:35]
  wire [31:0] _T_4 = 32'sh0 - 32'sh7a120; // @[src/main/scala/PlayerController.scala 151:32]
  wire [31:0] _sprite0SpeedReg_T_2 = $signed(sprite0SpeedReg) - 32'sh5dc; // @[src/main/scala/PlayerController.scala 152:46]
  wire [31:0] _GEN_29 = $signed(sprite0SpeedReg) > $signed(_T_4) ? $signed(_sprite0SpeedReg_T_2) : $signed(
    sprite0SpeedReg); // @[src/main/scala/PlayerController.scala 151:42 152:27 71:32]
  wire [31:0] _sprite0SpeedReg_T_5 = $signed(sprite0SpeedReg) + 32'sh3e8; // @[src/main/scala/PlayerController.scala 156:46]
  wire [31:0] _GEN_30 = $signed(sprite0SpeedReg) < 32'sh7a120 ? $signed(_sprite0SpeedReg_T_5) : $signed(sprite0SpeedReg)
    ; // @[src/main/scala/PlayerController.scala 155:41 156:27 71:32]
  wire [31:0] _sprite0SpeedReg_T_8 = $signed(sprite0SpeedReg) - 32'sh190; // @[src/main/scala/PlayerController.scala 160:46]
  wire [31:0] _T_10 = 32'sh0 - 32'sh190; // @[src/main/scala/PlayerController.scala 161:38]
  wire [31:0] _sprite0SpeedReg_T_11 = $signed(sprite0SpeedReg) + 32'sh190; // @[src/main/scala/PlayerController.scala 162:46]
  wire [31:0] _GEN_31 = $signed(sprite0SpeedReg) < $signed(_T_10) ? $signed(_sprite0SpeedReg_T_11) : $signed(32'sh0); // @[src/main/scala/PlayerController.scala 161:49 162:27 164:27]
  wire [31:0] _GEN_32 = $signed(sprite0SpeedReg) > 32'sh190 ? $signed(_sprite0SpeedReg_T_8) : $signed(_GEN_31); // @[src/main/scala/PlayerController.scala 159:42 160:27]
  wire [31:0] _GEN_33 = io_btnU ? $signed(_GEN_30) : $signed(_GEN_32); // @[src/main/scala/PlayerController.scala 154:27]
  wire [7:0] _sprite0AngleReg_T_1 = sprite0AngleReg + 8'h1; // @[src/main/scala/PlayerController.scala 169:44]
  wire [7:0] _sprite0AngleReg_T_3 = sprite0AngleReg - 8'h1; // @[src/main/scala/PlayerController.scala 171:44]
  wire [7:0] _GEN_35 = io_btnL ? _sprite0AngleReg_T_3 : sprite0AngleReg; // @[src/main/scala/PlayerController.scala 170:26 171:25 72:32]
  wire  _GEN_37 = sprite0AngleReg >= 8'h51 & sprite0AngleReg <= 8'h70 ? 1'h0 : sprite0Visible; // @[src/main/scala/PlayerController.scala 237:69 238:26 97:31]
  wire  _GEN_38 = sprite0AngleReg >= 8'h51 & sprite0AngleReg <= 8'h70 | sprite1Visible; // @[src/main/scala/PlayerController.scala 237:69 239:26 98:31]
  wire  _GEN_39 = sprite0AngleReg >= 8'h51 & sprite0AngleReg <= 8'h70 ? 1'h0 : sprite2Visible; // @[src/main/scala/PlayerController.scala 237:69 240:26 99:31]
  wire  _GEN_40 = sprite0AngleReg >= 8'h51 & sprite0AngleReg <= 8'h70 ? 1'h0 : sprite1FlipHorizontalReg; // @[src/main/scala/PlayerController.scala 237:69 242:36 92:41]
  wire  _GEN_41 = sprite0AngleReg >= 8'h51 & sprite0AngleReg <= 8'h70 | sprite1FlipVerticalReg; // @[src/main/scala/PlayerController.scala 237:69 243:34 93:39]
  wire  _GEN_42 = sprite0AngleReg >= 8'h31 & sprite0AngleReg <= 8'h50 ? 1'h0 : _GEN_37; // @[src/main/scala/PlayerController.scala 229:68 230:26]
  wire  _GEN_43 = sprite0AngleReg >= 8'h31 & sprite0AngleReg <= 8'h50 ? 1'h0 : _GEN_38; // @[src/main/scala/PlayerController.scala 229:68 231:26]
  wire  _GEN_44 = sprite0AngleReg >= 8'h31 & sprite0AngleReg <= 8'h50 | _GEN_39; // @[src/main/scala/PlayerController.scala 229:68 232:26]
  wire  _GEN_45 = sprite0AngleReg >= 8'h31 & sprite0AngleReg <= 8'h50 | sprite2FlipVerticalReg; // @[src/main/scala/PlayerController.scala 229:68 234:34 95:39]
  wire  _GEN_46 = sprite0AngleReg >= 8'h31 & sprite0AngleReg <= 8'h50 ? sprite1FlipHorizontalReg : _GEN_40; // @[src/main/scala/PlayerController.scala 229:68 92:41]
  wire  _GEN_47 = sprite0AngleReg >= 8'h31 & sprite0AngleReg <= 8'h50 ? sprite1FlipVerticalReg : _GEN_41; // @[src/main/scala/PlayerController.scala 229:68 93:39]
  wire  _GEN_48 = sprite0AngleReg >= 8'h11 & sprite0AngleReg <= 8'h30 ? 1'h0 : _GEN_42; // @[src/main/scala/PlayerController.scala 220:68 221:26]
  wire  _GEN_49 = sprite0AngleReg >= 8'h11 & sprite0AngleReg <= 8'h30 | _GEN_43; // @[src/main/scala/PlayerController.scala 220:68 222:26]
  wire  _GEN_50 = sprite0AngleReg >= 8'h11 & sprite0AngleReg <= 8'h30 ? 1'h0 : _GEN_44; // @[src/main/scala/PlayerController.scala 220:68 223:26]
  wire  _GEN_51 = sprite0AngleReg >= 8'h11 & sprite0AngleReg <= 8'h30 | _GEN_46; // @[src/main/scala/PlayerController.scala 220:68 225:36]
  wire  _GEN_52 = sprite0AngleReg >= 8'h11 & sprite0AngleReg <= 8'h30 | _GEN_47; // @[src/main/scala/PlayerController.scala 220:68 226:34]
  wire  _GEN_53 = sprite0AngleReg >= 8'h11 & sprite0AngleReg <= 8'h30 ? sprite2FlipVerticalReg : _GEN_45; // @[src/main/scala/PlayerController.scala 220:68 95:39]
  wire  _GEN_54 = sprite0AngleReg >= 8'hf1 | sprite0AngleReg <= 8'h10 | _GEN_48; // @[src/main/scala/PlayerController.scala 211:127 212:26]
  wire  _GEN_55 = sprite0AngleReg >= 8'hf1 | sprite0AngleReg <= 8'h10 ? 1'h0 : _GEN_49; // @[src/main/scala/PlayerController.scala 211:127 213:26]
  wire  _GEN_56 = sprite0AngleReg >= 8'hf1 | sprite0AngleReg <= 8'h10 ? 1'h0 : _GEN_50; // @[src/main/scala/PlayerController.scala 211:127 214:26]
  wire  _GEN_57 = sprite0AngleReg >= 8'hf1 | sprite0AngleReg <= 8'h10 | sprite0FlipHorizontalReg; // @[src/main/scala/PlayerController.scala 211:127 216:36 89:41]
  wire  _GEN_59 = sprite0AngleReg >= 8'hf1 | sprite0AngleReg <= 8'h10 ? sprite1FlipHorizontalReg : _GEN_51; // @[src/main/scala/PlayerController.scala 211:127 92:41]
  wire  _GEN_60 = sprite0AngleReg >= 8'hf1 | sprite0AngleReg <= 8'h10 ? sprite1FlipVerticalReg : _GEN_52; // @[src/main/scala/PlayerController.scala 211:127 93:39]
  wire  _GEN_61 = sprite0AngleReg >= 8'hf1 | sprite0AngleReg <= 8'h10 ? sprite2FlipVerticalReg : _GEN_53; // @[src/main/scala/PlayerController.scala 211:127 95:39]
  wire  _GEN_62 = sprite0AngleReg >= 8'hd1 & sprite0AngleReg <= 8'hf0 ? 1'h0 : _GEN_54; // @[src/main/scala/PlayerController.scala 202:70 203:26]
  wire  _GEN_63 = sprite0AngleReg >= 8'hd1 & sprite0AngleReg <= 8'hf0 | _GEN_55; // @[src/main/scala/PlayerController.scala 202:70 204:26]
  wire  _GEN_64 = sprite0AngleReg >= 8'hd1 & sprite0AngleReg <= 8'hf0 ? 1'h0 : _GEN_56; // @[src/main/scala/PlayerController.scala 202:70 205:26]
  wire  _GEN_65 = sprite0AngleReg >= 8'hd1 & sprite0AngleReg <= 8'hf0 | _GEN_59; // @[src/main/scala/PlayerController.scala 202:70 207:36]
  wire  _GEN_66 = sprite0AngleReg >= 8'hd1 & sprite0AngleReg <= 8'hf0 ? 1'h0 : _GEN_60; // @[src/main/scala/PlayerController.scala 202:70 208:34]
  wire  _GEN_67 = sprite0AngleReg >= 8'hd1 & sprite0AngleReg <= 8'hf0 ? sprite0FlipHorizontalReg : _GEN_57; // @[src/main/scala/PlayerController.scala 202:70 89:41]
  wire  _GEN_69 = sprite0AngleReg >= 8'hd1 & sprite0AngleReg <= 8'hf0 ? sprite2FlipVerticalReg : _GEN_61; // @[src/main/scala/PlayerController.scala 202:70 95:39]
  wire  _GEN_70 = sprite0AngleReg >= 8'hb1 & sprite0AngleReg <= 8'hd0 ? 1'h0 : _GEN_62; // @[src/main/scala/PlayerController.scala 194:70 195:26]
  wire  _GEN_71 = sprite0AngleReg >= 8'hb1 & sprite0AngleReg <= 8'hd0 ? 1'h0 : _GEN_63; // @[src/main/scala/PlayerController.scala 194:70 196:26]
  wire  _GEN_72 = sprite0AngleReg >= 8'hb1 & sprite0AngleReg <= 8'hd0 | _GEN_64; // @[src/main/scala/PlayerController.scala 194:70 197:26]
  wire  _GEN_73 = sprite0AngleReg >= 8'hb1 & sprite0AngleReg <= 8'hd0 ? 1'h0 : _GEN_69; // @[src/main/scala/PlayerController.scala 194:70 199:34]
  wire  _GEN_74 = sprite0AngleReg >= 8'hb1 & sprite0AngleReg <= 8'hd0 ? sprite1FlipHorizontalReg : _GEN_65; // @[src/main/scala/PlayerController.scala 194:70 92:41]
  wire  _GEN_75 = sprite0AngleReg >= 8'hb1 & sprite0AngleReg <= 8'hd0 ? sprite1FlipVerticalReg : _GEN_66; // @[src/main/scala/PlayerController.scala 194:70 93:39]
  wire  _GEN_76 = sprite0AngleReg >= 8'hb1 & sprite0AngleReg <= 8'hd0 ? sprite0FlipHorizontalReg : _GEN_67; // @[src/main/scala/PlayerController.scala 194:70 89:41]
  wire  _GEN_78 = sprite0AngleReg >= 8'h91 & sprite0AngleReg <= 8'hb0 ? 1'h0 : _GEN_70; // @[src/main/scala/PlayerController.scala 185:70 186:26]
  wire  _GEN_79 = sprite0AngleReg >= 8'h91 & sprite0AngleReg <= 8'hb0 | _GEN_71; // @[src/main/scala/PlayerController.scala 185:70 187:26]
  wire  _GEN_80 = sprite0AngleReg >= 8'h91 & sprite0AngleReg <= 8'hb0 ? 1'h0 : _GEN_72; // @[src/main/scala/PlayerController.scala 185:70 188:26]
  wire  _GEN_81 = sprite0AngleReg >= 8'h91 & sprite0AngleReg <= 8'hb0 ? 1'h0 : _GEN_74; // @[src/main/scala/PlayerController.scala 185:70 190:36]
  wire  _GEN_82 = sprite0AngleReg >= 8'h91 & sprite0AngleReg <= 8'hb0 ? 1'h0 : _GEN_75; // @[src/main/scala/PlayerController.scala 185:70 191:34]
  wire  _GEN_83 = sprite0AngleReg >= 8'h91 & sprite0AngleReg <= 8'hb0 ? sprite2FlipVerticalReg : _GEN_73; // @[src/main/scala/PlayerController.scala 185:70 95:39]
  wire  _GEN_84 = sprite0AngleReg >= 8'h91 & sprite0AngleReg <= 8'hb0 ? sprite0FlipHorizontalReg : _GEN_76; // @[src/main/scala/PlayerController.scala 185:70 89:41]
  wire  _GEN_86 = sprite0AngleReg >= 8'h71 & sprite0AngleReg <= 8'h90 | _GEN_78; // @[src/main/scala/PlayerController.scala 176:66 177:26]
  wire [15:0] _GEN_95 = 8'h1 == sprite0AngleReg ? $signed(16'shff) : $signed(16'sh100); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_96 = 8'h2 == sprite0AngleReg ? $signed(16'shff) : $signed(_GEN_95); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_97 = 8'h3 == sprite0AngleReg ? $signed(16'shff) : $signed(_GEN_96); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_98 = 8'h4 == sprite0AngleReg ? $signed(16'shfe) : $signed(_GEN_97); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_99 = 8'h5 == sprite0AngleReg ? $signed(16'shfe) : $signed(_GEN_98); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_100 = 8'h6 == sprite0AngleReg ? $signed(16'shfd) : $signed(_GEN_99); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_101 = 8'h7 == sprite0AngleReg ? $signed(16'shfc) : $signed(_GEN_100); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_102 = 8'h8 == sprite0AngleReg ? $signed(16'shfb) : $signed(_GEN_101); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_103 = 8'h9 == sprite0AngleReg ? $signed(16'shf9) : $signed(_GEN_102); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_104 = 8'ha == sprite0AngleReg ? $signed(16'shf8) : $signed(_GEN_103); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_105 = 8'hb == sprite0AngleReg ? $signed(16'shf6) : $signed(_GEN_104); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_106 = 8'hc == sprite0AngleReg ? $signed(16'shf4) : $signed(_GEN_105); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_107 = 8'hd == sprite0AngleReg ? $signed(16'shf3) : $signed(_GEN_106); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_108 = 8'he == sprite0AngleReg ? $signed(16'shf1) : $signed(_GEN_107); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_109 = 8'hf == sprite0AngleReg ? $signed(16'shee) : $signed(_GEN_108); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_110 = 8'h10 == sprite0AngleReg ? $signed(16'shec) : $signed(_GEN_109); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_111 = 8'h11 == sprite0AngleReg ? $signed(16'shea) : $signed(_GEN_110); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_112 = 8'h12 == sprite0AngleReg ? $signed(16'she7) : $signed(_GEN_111); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_113 = 8'h13 == sprite0AngleReg ? $signed(16'she4) : $signed(_GEN_112); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_114 = 8'h14 == sprite0AngleReg ? $signed(16'she1) : $signed(_GEN_113); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_115 = 8'h15 == sprite0AngleReg ? $signed(16'shde) : $signed(_GEN_114); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_116 = 8'h16 == sprite0AngleReg ? $signed(16'shdb) : $signed(_GEN_115); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_117 = 8'h17 == sprite0AngleReg ? $signed(16'shd8) : $signed(_GEN_116); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_118 = 8'h18 == sprite0AngleReg ? $signed(16'shd4) : $signed(_GEN_117); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_119 = 8'h19 == sprite0AngleReg ? $signed(16'shd1) : $signed(_GEN_118); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_120 = 8'h1a == sprite0AngleReg ? $signed(16'shcd) : $signed(_GEN_119); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_121 = 8'h1b == sprite0AngleReg ? $signed(16'shc9) : $signed(_GEN_120); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_122 = 8'h1c == sprite0AngleReg ? $signed(16'shc5) : $signed(_GEN_121); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_123 = 8'h1d == sprite0AngleReg ? $signed(16'shc1) : $signed(_GEN_122); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_124 = 8'h1e == sprite0AngleReg ? $signed(16'shbd) : $signed(_GEN_123); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_125 = 8'h1f == sprite0AngleReg ? $signed(16'shb9) : $signed(_GEN_124); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_126 = 8'h20 == sprite0AngleReg ? $signed(16'shb5) : $signed(_GEN_125); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_127 = 8'h21 == sprite0AngleReg ? $signed(16'shb0) : $signed(_GEN_126); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_128 = 8'h22 == sprite0AngleReg ? $signed(16'shab) : $signed(_GEN_127); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_129 = 8'h23 == sprite0AngleReg ? $signed(16'sha7) : $signed(_GEN_128); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_130 = 8'h24 == sprite0AngleReg ? $signed(16'sha2) : $signed(_GEN_129); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_131 = 8'h25 == sprite0AngleReg ? $signed(16'sh9d) : $signed(_GEN_130); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_132 = 8'h26 == sprite0AngleReg ? $signed(16'sh98) : $signed(_GEN_131); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_133 = 8'h27 == sprite0AngleReg ? $signed(16'sh93) : $signed(_GEN_132); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_134 = 8'h28 == sprite0AngleReg ? $signed(16'sh8e) : $signed(_GEN_133); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_135 = 8'h29 == sprite0AngleReg ? $signed(16'sh88) : $signed(_GEN_134); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_136 = 8'h2a == sprite0AngleReg ? $signed(16'sh83) : $signed(_GEN_135); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_137 = 8'h2b == sprite0AngleReg ? $signed(16'sh7e) : $signed(_GEN_136); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_138 = 8'h2c == sprite0AngleReg ? $signed(16'sh78) : $signed(_GEN_137); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_139 = 8'h2d == sprite0AngleReg ? $signed(16'sh73) : $signed(_GEN_138); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_140 = 8'h2e == sprite0AngleReg ? $signed(16'sh6d) : $signed(_GEN_139); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_141 = 8'h2f == sprite0AngleReg ? $signed(16'sh67) : $signed(_GEN_140); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_142 = 8'h30 == sprite0AngleReg ? $signed(16'sh61) : $signed(_GEN_141); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_143 = 8'h31 == sprite0AngleReg ? $signed(16'sh5c) : $signed(_GEN_142); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_144 = 8'h32 == sprite0AngleReg ? $signed(16'sh56) : $signed(_GEN_143); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_145 = 8'h33 == sprite0AngleReg ? $signed(16'sh50) : $signed(_GEN_144); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_146 = 8'h34 == sprite0AngleReg ? $signed(16'sh4a) : $signed(_GEN_145); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_147 = 8'h35 == sprite0AngleReg ? $signed(16'sh44) : $signed(_GEN_146); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_148 = 8'h36 == sprite0AngleReg ? $signed(16'sh3e) : $signed(_GEN_147); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_149 = 8'h37 == sprite0AngleReg ? $signed(16'sh38) : $signed(_GEN_148); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_150 = 8'h38 == sprite0AngleReg ? $signed(16'sh31) : $signed(_GEN_149); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_151 = 8'h39 == sprite0AngleReg ? $signed(16'sh2b) : $signed(_GEN_150); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_152 = 8'h3a == sprite0AngleReg ? $signed(16'sh25) : $signed(_GEN_151); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_153 = 8'h3b == sprite0AngleReg ? $signed(16'sh1f) : $signed(_GEN_152); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_154 = 8'h3c == sprite0AngleReg ? $signed(16'sh19) : $signed(_GEN_153); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_155 = 8'h3d == sprite0AngleReg ? $signed(16'sh12) : $signed(_GEN_154); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_156 = 8'h3e == sprite0AngleReg ? $signed(16'shc) : $signed(_GEN_155); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_157 = 8'h3f == sprite0AngleReg ? $signed(16'sh6) : $signed(_GEN_156); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_158 = 8'h40 == sprite0AngleReg ? $signed(16'sh0) : $signed(_GEN_157); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_159 = 8'h41 == sprite0AngleReg ? $signed(-16'sh6) : $signed(_GEN_158); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_160 = 8'h42 == sprite0AngleReg ? $signed(-16'shc) : $signed(_GEN_159); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_161 = 8'h43 == sprite0AngleReg ? $signed(-16'sh12) : $signed(_GEN_160); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_162 = 8'h44 == sprite0AngleReg ? $signed(-16'sh19) : $signed(_GEN_161); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_163 = 8'h45 == sprite0AngleReg ? $signed(-16'sh1f) : $signed(_GEN_162); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_164 = 8'h46 == sprite0AngleReg ? $signed(-16'sh25) : $signed(_GEN_163); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_165 = 8'h47 == sprite0AngleReg ? $signed(-16'sh2b) : $signed(_GEN_164); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_166 = 8'h48 == sprite0AngleReg ? $signed(-16'sh31) : $signed(_GEN_165); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_167 = 8'h49 == sprite0AngleReg ? $signed(-16'sh38) : $signed(_GEN_166); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_168 = 8'h4a == sprite0AngleReg ? $signed(-16'sh3e) : $signed(_GEN_167); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_169 = 8'h4b == sprite0AngleReg ? $signed(-16'sh44) : $signed(_GEN_168); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_170 = 8'h4c == sprite0AngleReg ? $signed(-16'sh4a) : $signed(_GEN_169); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_171 = 8'h4d == sprite0AngleReg ? $signed(-16'sh50) : $signed(_GEN_170); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_172 = 8'h4e == sprite0AngleReg ? $signed(-16'sh56) : $signed(_GEN_171); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_173 = 8'h4f == sprite0AngleReg ? $signed(-16'sh5c) : $signed(_GEN_172); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_174 = 8'h50 == sprite0AngleReg ? $signed(-16'sh61) : $signed(_GEN_173); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_175 = 8'h51 == sprite0AngleReg ? $signed(-16'sh67) : $signed(_GEN_174); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_176 = 8'h52 == sprite0AngleReg ? $signed(-16'sh6d) : $signed(_GEN_175); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_177 = 8'h53 == sprite0AngleReg ? $signed(-16'sh73) : $signed(_GEN_176); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_178 = 8'h54 == sprite0AngleReg ? $signed(-16'sh78) : $signed(_GEN_177); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_179 = 8'h55 == sprite0AngleReg ? $signed(-16'sh7e) : $signed(_GEN_178); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_180 = 8'h56 == sprite0AngleReg ? $signed(-16'sh83) : $signed(_GEN_179); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_181 = 8'h57 == sprite0AngleReg ? $signed(-16'sh88) : $signed(_GEN_180); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_182 = 8'h58 == sprite0AngleReg ? $signed(-16'sh8e) : $signed(_GEN_181); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_183 = 8'h59 == sprite0AngleReg ? $signed(-16'sh93) : $signed(_GEN_182); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_184 = 8'h5a == sprite0AngleReg ? $signed(-16'sh98) : $signed(_GEN_183); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_185 = 8'h5b == sprite0AngleReg ? $signed(-16'sh9d) : $signed(_GEN_184); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_186 = 8'h5c == sprite0AngleReg ? $signed(-16'sha2) : $signed(_GEN_185); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_187 = 8'h5d == sprite0AngleReg ? $signed(-16'sha7) : $signed(_GEN_186); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_188 = 8'h5e == sprite0AngleReg ? $signed(-16'shab) : $signed(_GEN_187); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_189 = 8'h5f == sprite0AngleReg ? $signed(-16'shb0) : $signed(_GEN_188); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_190 = 8'h60 == sprite0AngleReg ? $signed(-16'shb5) : $signed(_GEN_189); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_191 = 8'h61 == sprite0AngleReg ? $signed(-16'shb9) : $signed(_GEN_190); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_192 = 8'h62 == sprite0AngleReg ? $signed(-16'shbd) : $signed(_GEN_191); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_193 = 8'h63 == sprite0AngleReg ? $signed(-16'shc1) : $signed(_GEN_192); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_194 = 8'h64 == sprite0AngleReg ? $signed(-16'shc5) : $signed(_GEN_193); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_195 = 8'h65 == sprite0AngleReg ? $signed(-16'shc9) : $signed(_GEN_194); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_196 = 8'h66 == sprite0AngleReg ? $signed(-16'shcd) : $signed(_GEN_195); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_197 = 8'h67 == sprite0AngleReg ? $signed(-16'shd1) : $signed(_GEN_196); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_198 = 8'h68 == sprite0AngleReg ? $signed(-16'shd4) : $signed(_GEN_197); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_199 = 8'h69 == sprite0AngleReg ? $signed(-16'shd8) : $signed(_GEN_198); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_200 = 8'h6a == sprite0AngleReg ? $signed(-16'shdb) : $signed(_GEN_199); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_201 = 8'h6b == sprite0AngleReg ? $signed(-16'shde) : $signed(_GEN_200); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_202 = 8'h6c == sprite0AngleReg ? $signed(-16'she1) : $signed(_GEN_201); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_203 = 8'h6d == sprite0AngleReg ? $signed(-16'she4) : $signed(_GEN_202); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_204 = 8'h6e == sprite0AngleReg ? $signed(-16'she7) : $signed(_GEN_203); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_205 = 8'h6f == sprite0AngleReg ? $signed(-16'shea) : $signed(_GEN_204); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_206 = 8'h70 == sprite0AngleReg ? $signed(-16'shec) : $signed(_GEN_205); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_207 = 8'h71 == sprite0AngleReg ? $signed(-16'shee) : $signed(_GEN_206); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_208 = 8'h72 == sprite0AngleReg ? $signed(-16'shf1) : $signed(_GEN_207); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_209 = 8'h73 == sprite0AngleReg ? $signed(-16'shf3) : $signed(_GEN_208); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_210 = 8'h74 == sprite0AngleReg ? $signed(-16'shf4) : $signed(_GEN_209); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_211 = 8'h75 == sprite0AngleReg ? $signed(-16'shf6) : $signed(_GEN_210); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_212 = 8'h76 == sprite0AngleReg ? $signed(-16'shf8) : $signed(_GEN_211); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_213 = 8'h77 == sprite0AngleReg ? $signed(-16'shf9) : $signed(_GEN_212); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_214 = 8'h78 == sprite0AngleReg ? $signed(-16'shfb) : $signed(_GEN_213); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_215 = 8'h79 == sprite0AngleReg ? $signed(-16'shfc) : $signed(_GEN_214); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_216 = 8'h7a == sprite0AngleReg ? $signed(-16'shfd) : $signed(_GEN_215); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_217 = 8'h7b == sprite0AngleReg ? $signed(-16'shfe) : $signed(_GEN_216); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_218 = 8'h7c == sprite0AngleReg ? $signed(-16'shfe) : $signed(_GEN_217); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_219 = 8'h7d == sprite0AngleReg ? $signed(-16'shff) : $signed(_GEN_218); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_220 = 8'h7e == sprite0AngleReg ? $signed(-16'shff) : $signed(_GEN_219); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_221 = 8'h7f == sprite0AngleReg ? $signed(-16'shff) : $signed(_GEN_220); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_222 = 8'h80 == sprite0AngleReg ? $signed(-16'sh100) : $signed(_GEN_221); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_223 = 8'h81 == sprite0AngleReg ? $signed(-16'shff) : $signed(_GEN_222); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_224 = 8'h82 == sprite0AngleReg ? $signed(-16'shff) : $signed(_GEN_223); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_225 = 8'h83 == sprite0AngleReg ? $signed(-16'shff) : $signed(_GEN_224); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_226 = 8'h84 == sprite0AngleReg ? $signed(-16'shfe) : $signed(_GEN_225); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_227 = 8'h85 == sprite0AngleReg ? $signed(-16'shfe) : $signed(_GEN_226); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_228 = 8'h86 == sprite0AngleReg ? $signed(-16'shfd) : $signed(_GEN_227); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_229 = 8'h87 == sprite0AngleReg ? $signed(-16'shfc) : $signed(_GEN_228); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_230 = 8'h88 == sprite0AngleReg ? $signed(-16'shfb) : $signed(_GEN_229); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_231 = 8'h89 == sprite0AngleReg ? $signed(-16'shf9) : $signed(_GEN_230); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_232 = 8'h8a == sprite0AngleReg ? $signed(-16'shf8) : $signed(_GEN_231); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_233 = 8'h8b == sprite0AngleReg ? $signed(-16'shf6) : $signed(_GEN_232); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_234 = 8'h8c == sprite0AngleReg ? $signed(-16'shf4) : $signed(_GEN_233); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_235 = 8'h8d == sprite0AngleReg ? $signed(-16'shf3) : $signed(_GEN_234); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_236 = 8'h8e == sprite0AngleReg ? $signed(-16'shf1) : $signed(_GEN_235); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_237 = 8'h8f == sprite0AngleReg ? $signed(-16'shee) : $signed(_GEN_236); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_238 = 8'h90 == sprite0AngleReg ? $signed(-16'shec) : $signed(_GEN_237); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_239 = 8'h91 == sprite0AngleReg ? $signed(-16'shea) : $signed(_GEN_238); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_240 = 8'h92 == sprite0AngleReg ? $signed(-16'she7) : $signed(_GEN_239); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_241 = 8'h93 == sprite0AngleReg ? $signed(-16'she4) : $signed(_GEN_240); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_242 = 8'h94 == sprite0AngleReg ? $signed(-16'she1) : $signed(_GEN_241); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_243 = 8'h95 == sprite0AngleReg ? $signed(-16'shde) : $signed(_GEN_242); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_244 = 8'h96 == sprite0AngleReg ? $signed(-16'shdb) : $signed(_GEN_243); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_245 = 8'h97 == sprite0AngleReg ? $signed(-16'shd8) : $signed(_GEN_244); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_246 = 8'h98 == sprite0AngleReg ? $signed(-16'shd4) : $signed(_GEN_245); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_247 = 8'h99 == sprite0AngleReg ? $signed(-16'shd1) : $signed(_GEN_246); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_248 = 8'h9a == sprite0AngleReg ? $signed(-16'shcd) : $signed(_GEN_247); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_249 = 8'h9b == sprite0AngleReg ? $signed(-16'shc9) : $signed(_GEN_248); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_250 = 8'h9c == sprite0AngleReg ? $signed(-16'shc5) : $signed(_GEN_249); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_251 = 8'h9d == sprite0AngleReg ? $signed(-16'shc1) : $signed(_GEN_250); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_252 = 8'h9e == sprite0AngleReg ? $signed(-16'shbd) : $signed(_GEN_251); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_253 = 8'h9f == sprite0AngleReg ? $signed(-16'shb9) : $signed(_GEN_252); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_254 = 8'ha0 == sprite0AngleReg ? $signed(-16'shb5) : $signed(_GEN_253); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_255 = 8'ha1 == sprite0AngleReg ? $signed(-16'shb0) : $signed(_GEN_254); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_256 = 8'ha2 == sprite0AngleReg ? $signed(-16'shab) : $signed(_GEN_255); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_257 = 8'ha3 == sprite0AngleReg ? $signed(-16'sha7) : $signed(_GEN_256); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_258 = 8'ha4 == sprite0AngleReg ? $signed(-16'sha2) : $signed(_GEN_257); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_259 = 8'ha5 == sprite0AngleReg ? $signed(-16'sh9d) : $signed(_GEN_258); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_260 = 8'ha6 == sprite0AngleReg ? $signed(-16'sh98) : $signed(_GEN_259); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_261 = 8'ha7 == sprite0AngleReg ? $signed(-16'sh93) : $signed(_GEN_260); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_262 = 8'ha8 == sprite0AngleReg ? $signed(-16'sh8e) : $signed(_GEN_261); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_263 = 8'ha9 == sprite0AngleReg ? $signed(-16'sh88) : $signed(_GEN_262); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_264 = 8'haa == sprite0AngleReg ? $signed(-16'sh83) : $signed(_GEN_263); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_265 = 8'hab == sprite0AngleReg ? $signed(-16'sh7e) : $signed(_GEN_264); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_266 = 8'hac == sprite0AngleReg ? $signed(-16'sh78) : $signed(_GEN_265); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_267 = 8'had == sprite0AngleReg ? $signed(-16'sh73) : $signed(_GEN_266); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_268 = 8'hae == sprite0AngleReg ? $signed(-16'sh6d) : $signed(_GEN_267); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_269 = 8'haf == sprite0AngleReg ? $signed(-16'sh67) : $signed(_GEN_268); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_270 = 8'hb0 == sprite0AngleReg ? $signed(-16'sh61) : $signed(_GEN_269); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_271 = 8'hb1 == sprite0AngleReg ? $signed(-16'sh5c) : $signed(_GEN_270); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_272 = 8'hb2 == sprite0AngleReg ? $signed(-16'sh56) : $signed(_GEN_271); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_273 = 8'hb3 == sprite0AngleReg ? $signed(-16'sh50) : $signed(_GEN_272); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_274 = 8'hb4 == sprite0AngleReg ? $signed(-16'sh4a) : $signed(_GEN_273); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_275 = 8'hb5 == sprite0AngleReg ? $signed(-16'sh44) : $signed(_GEN_274); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_276 = 8'hb6 == sprite0AngleReg ? $signed(-16'sh3e) : $signed(_GEN_275); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_277 = 8'hb7 == sprite0AngleReg ? $signed(-16'sh38) : $signed(_GEN_276); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_278 = 8'hb8 == sprite0AngleReg ? $signed(-16'sh31) : $signed(_GEN_277); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_279 = 8'hb9 == sprite0AngleReg ? $signed(-16'sh2b) : $signed(_GEN_278); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_280 = 8'hba == sprite0AngleReg ? $signed(-16'sh25) : $signed(_GEN_279); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_281 = 8'hbb == sprite0AngleReg ? $signed(-16'sh1f) : $signed(_GEN_280); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_282 = 8'hbc == sprite0AngleReg ? $signed(-16'sh19) : $signed(_GEN_281); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_283 = 8'hbd == sprite0AngleReg ? $signed(-16'sh12) : $signed(_GEN_282); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_284 = 8'hbe == sprite0AngleReg ? $signed(-16'shc) : $signed(_GEN_283); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_285 = 8'hbf == sprite0AngleReg ? $signed(-16'sh6) : $signed(_GEN_284); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_286 = 8'hc0 == sprite0AngleReg ? $signed(16'sh0) : $signed(_GEN_285); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_287 = 8'hc1 == sprite0AngleReg ? $signed(16'sh6) : $signed(_GEN_286); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_288 = 8'hc2 == sprite0AngleReg ? $signed(16'shc) : $signed(_GEN_287); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_289 = 8'hc3 == sprite0AngleReg ? $signed(16'sh12) : $signed(_GEN_288); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_290 = 8'hc4 == sprite0AngleReg ? $signed(16'sh19) : $signed(_GEN_289); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_291 = 8'hc5 == sprite0AngleReg ? $signed(16'sh1f) : $signed(_GEN_290); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_292 = 8'hc6 == sprite0AngleReg ? $signed(16'sh25) : $signed(_GEN_291); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_293 = 8'hc7 == sprite0AngleReg ? $signed(16'sh2b) : $signed(_GEN_292); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_294 = 8'hc8 == sprite0AngleReg ? $signed(16'sh31) : $signed(_GEN_293); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_295 = 8'hc9 == sprite0AngleReg ? $signed(16'sh38) : $signed(_GEN_294); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_296 = 8'hca == sprite0AngleReg ? $signed(16'sh3e) : $signed(_GEN_295); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_297 = 8'hcb == sprite0AngleReg ? $signed(16'sh44) : $signed(_GEN_296); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_298 = 8'hcc == sprite0AngleReg ? $signed(16'sh4a) : $signed(_GEN_297); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_299 = 8'hcd == sprite0AngleReg ? $signed(16'sh50) : $signed(_GEN_298); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_300 = 8'hce == sprite0AngleReg ? $signed(16'sh56) : $signed(_GEN_299); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_301 = 8'hcf == sprite0AngleReg ? $signed(16'sh5c) : $signed(_GEN_300); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_302 = 8'hd0 == sprite0AngleReg ? $signed(16'sh61) : $signed(_GEN_301); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_303 = 8'hd1 == sprite0AngleReg ? $signed(16'sh67) : $signed(_GEN_302); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_304 = 8'hd2 == sprite0AngleReg ? $signed(16'sh6d) : $signed(_GEN_303); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_305 = 8'hd3 == sprite0AngleReg ? $signed(16'sh73) : $signed(_GEN_304); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_306 = 8'hd4 == sprite0AngleReg ? $signed(16'sh78) : $signed(_GEN_305); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_307 = 8'hd5 == sprite0AngleReg ? $signed(16'sh7e) : $signed(_GEN_306); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_308 = 8'hd6 == sprite0AngleReg ? $signed(16'sh83) : $signed(_GEN_307); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_309 = 8'hd7 == sprite0AngleReg ? $signed(16'sh88) : $signed(_GEN_308); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_310 = 8'hd8 == sprite0AngleReg ? $signed(16'sh8e) : $signed(_GEN_309); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_311 = 8'hd9 == sprite0AngleReg ? $signed(16'sh93) : $signed(_GEN_310); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_312 = 8'hda == sprite0AngleReg ? $signed(16'sh98) : $signed(_GEN_311); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_313 = 8'hdb == sprite0AngleReg ? $signed(16'sh9d) : $signed(_GEN_312); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_314 = 8'hdc == sprite0AngleReg ? $signed(16'sha2) : $signed(_GEN_313); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_315 = 8'hdd == sprite0AngleReg ? $signed(16'sha7) : $signed(_GEN_314); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_316 = 8'hde == sprite0AngleReg ? $signed(16'shab) : $signed(_GEN_315); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_317 = 8'hdf == sprite0AngleReg ? $signed(16'shb0) : $signed(_GEN_316); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_318 = 8'he0 == sprite0AngleReg ? $signed(16'shb5) : $signed(_GEN_317); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_319 = 8'he1 == sprite0AngleReg ? $signed(16'shb9) : $signed(_GEN_318); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_320 = 8'he2 == sprite0AngleReg ? $signed(16'shbd) : $signed(_GEN_319); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_321 = 8'he3 == sprite0AngleReg ? $signed(16'shc1) : $signed(_GEN_320); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_322 = 8'he4 == sprite0AngleReg ? $signed(16'shc5) : $signed(_GEN_321); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_323 = 8'he5 == sprite0AngleReg ? $signed(16'shc9) : $signed(_GEN_322); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_324 = 8'he6 == sprite0AngleReg ? $signed(16'shcd) : $signed(_GEN_323); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_325 = 8'he7 == sprite0AngleReg ? $signed(16'shd1) : $signed(_GEN_324); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_326 = 8'he8 == sprite0AngleReg ? $signed(16'shd4) : $signed(_GEN_325); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_327 = 8'he9 == sprite0AngleReg ? $signed(16'shd8) : $signed(_GEN_326); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_328 = 8'hea == sprite0AngleReg ? $signed(16'shdb) : $signed(_GEN_327); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_329 = 8'heb == sprite0AngleReg ? $signed(16'shde) : $signed(_GEN_328); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_330 = 8'hec == sprite0AngleReg ? $signed(16'she1) : $signed(_GEN_329); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_331 = 8'hed == sprite0AngleReg ? $signed(16'she4) : $signed(_GEN_330); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_332 = 8'hee == sprite0AngleReg ? $signed(16'she7) : $signed(_GEN_331); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_333 = 8'hef == sprite0AngleReg ? $signed(16'shea) : $signed(_GEN_332); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_334 = 8'hf0 == sprite0AngleReg ? $signed(16'shec) : $signed(_GEN_333); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_335 = 8'hf1 == sprite0AngleReg ? $signed(16'shee) : $signed(_GEN_334); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_336 = 8'hf2 == sprite0AngleReg ? $signed(16'shf1) : $signed(_GEN_335); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_337 = 8'hf3 == sprite0AngleReg ? $signed(16'shf3) : $signed(_GEN_336); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_338 = 8'hf4 == sprite0AngleReg ? $signed(16'shf4) : $signed(_GEN_337); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_339 = 8'hf5 == sprite0AngleReg ? $signed(16'shf6) : $signed(_GEN_338); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_340 = 8'hf6 == sprite0AngleReg ? $signed(16'shf8) : $signed(_GEN_339); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_341 = 8'hf7 == sprite0AngleReg ? $signed(16'shf9) : $signed(_GEN_340); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_342 = 8'hf8 == sprite0AngleReg ? $signed(16'shfb) : $signed(_GEN_341); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_343 = 8'hf9 == sprite0AngleReg ? $signed(16'shfc) : $signed(_GEN_342); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_344 = 8'hfa == sprite0AngleReg ? $signed(16'shfd) : $signed(_GEN_343); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_345 = 8'hfb == sprite0AngleReg ? $signed(16'shfe) : $signed(_GEN_344); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_346 = 8'hfc == sprite0AngleReg ? $signed(16'shfe) : $signed(_GEN_345); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_347 = 8'hfd == sprite0AngleReg ? $signed(16'shff) : $signed(_GEN_346); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_348 = 8'hfe == sprite0AngleReg ? $signed(16'shff) : $signed(_GEN_347); // @[src/main/scala/PlayerController.scala 246:{14,14}]
  wire [15:0] _GEN_351 = 8'h1 == sprite0AngleReg ? $signed(16'sh6) : $signed(16'sh0); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_352 = 8'h2 == sprite0AngleReg ? $signed(16'shc) : $signed(_GEN_351); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_353 = 8'h3 == sprite0AngleReg ? $signed(16'sh12) : $signed(_GEN_352); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_354 = 8'h4 == sprite0AngleReg ? $signed(16'sh19) : $signed(_GEN_353); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_355 = 8'h5 == sprite0AngleReg ? $signed(16'sh1f) : $signed(_GEN_354); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_356 = 8'h6 == sprite0AngleReg ? $signed(16'sh25) : $signed(_GEN_355); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_357 = 8'h7 == sprite0AngleReg ? $signed(16'sh2b) : $signed(_GEN_356); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_358 = 8'h8 == sprite0AngleReg ? $signed(16'sh31) : $signed(_GEN_357); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_359 = 8'h9 == sprite0AngleReg ? $signed(16'sh38) : $signed(_GEN_358); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_360 = 8'ha == sprite0AngleReg ? $signed(16'sh3e) : $signed(_GEN_359); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_361 = 8'hb == sprite0AngleReg ? $signed(16'sh44) : $signed(_GEN_360); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_362 = 8'hc == sprite0AngleReg ? $signed(16'sh4a) : $signed(_GEN_361); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_363 = 8'hd == sprite0AngleReg ? $signed(16'sh50) : $signed(_GEN_362); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_364 = 8'he == sprite0AngleReg ? $signed(16'sh56) : $signed(_GEN_363); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_365 = 8'hf == sprite0AngleReg ? $signed(16'sh5c) : $signed(_GEN_364); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_366 = 8'h10 == sprite0AngleReg ? $signed(16'sh61) : $signed(_GEN_365); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_367 = 8'h11 == sprite0AngleReg ? $signed(16'sh67) : $signed(_GEN_366); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_368 = 8'h12 == sprite0AngleReg ? $signed(16'sh6d) : $signed(_GEN_367); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_369 = 8'h13 == sprite0AngleReg ? $signed(16'sh73) : $signed(_GEN_368); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_370 = 8'h14 == sprite0AngleReg ? $signed(16'sh78) : $signed(_GEN_369); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_371 = 8'h15 == sprite0AngleReg ? $signed(16'sh7e) : $signed(_GEN_370); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_372 = 8'h16 == sprite0AngleReg ? $signed(16'sh83) : $signed(_GEN_371); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_373 = 8'h17 == sprite0AngleReg ? $signed(16'sh88) : $signed(_GEN_372); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_374 = 8'h18 == sprite0AngleReg ? $signed(16'sh8e) : $signed(_GEN_373); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_375 = 8'h19 == sprite0AngleReg ? $signed(16'sh93) : $signed(_GEN_374); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_376 = 8'h1a == sprite0AngleReg ? $signed(16'sh98) : $signed(_GEN_375); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_377 = 8'h1b == sprite0AngleReg ? $signed(16'sh9d) : $signed(_GEN_376); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_378 = 8'h1c == sprite0AngleReg ? $signed(16'sha2) : $signed(_GEN_377); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_379 = 8'h1d == sprite0AngleReg ? $signed(16'sha7) : $signed(_GEN_378); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_380 = 8'h1e == sprite0AngleReg ? $signed(16'shab) : $signed(_GEN_379); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_381 = 8'h1f == sprite0AngleReg ? $signed(16'shb0) : $signed(_GEN_380); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_382 = 8'h20 == sprite0AngleReg ? $signed(16'shb5) : $signed(_GEN_381); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_383 = 8'h21 == sprite0AngleReg ? $signed(16'shb9) : $signed(_GEN_382); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_384 = 8'h22 == sprite0AngleReg ? $signed(16'shbd) : $signed(_GEN_383); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_385 = 8'h23 == sprite0AngleReg ? $signed(16'shc1) : $signed(_GEN_384); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_386 = 8'h24 == sprite0AngleReg ? $signed(16'shc5) : $signed(_GEN_385); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_387 = 8'h25 == sprite0AngleReg ? $signed(16'shc9) : $signed(_GEN_386); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_388 = 8'h26 == sprite0AngleReg ? $signed(16'shcd) : $signed(_GEN_387); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_389 = 8'h27 == sprite0AngleReg ? $signed(16'shd1) : $signed(_GEN_388); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_390 = 8'h28 == sprite0AngleReg ? $signed(16'shd4) : $signed(_GEN_389); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_391 = 8'h29 == sprite0AngleReg ? $signed(16'shd8) : $signed(_GEN_390); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_392 = 8'h2a == sprite0AngleReg ? $signed(16'shdb) : $signed(_GEN_391); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_393 = 8'h2b == sprite0AngleReg ? $signed(16'shde) : $signed(_GEN_392); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_394 = 8'h2c == sprite0AngleReg ? $signed(16'she1) : $signed(_GEN_393); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_395 = 8'h2d == sprite0AngleReg ? $signed(16'she4) : $signed(_GEN_394); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_396 = 8'h2e == sprite0AngleReg ? $signed(16'she7) : $signed(_GEN_395); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_397 = 8'h2f == sprite0AngleReg ? $signed(16'shea) : $signed(_GEN_396); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_398 = 8'h30 == sprite0AngleReg ? $signed(16'shec) : $signed(_GEN_397); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_399 = 8'h31 == sprite0AngleReg ? $signed(16'shee) : $signed(_GEN_398); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_400 = 8'h32 == sprite0AngleReg ? $signed(16'shf1) : $signed(_GEN_399); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_401 = 8'h33 == sprite0AngleReg ? $signed(16'shf3) : $signed(_GEN_400); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_402 = 8'h34 == sprite0AngleReg ? $signed(16'shf4) : $signed(_GEN_401); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_403 = 8'h35 == sprite0AngleReg ? $signed(16'shf6) : $signed(_GEN_402); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_404 = 8'h36 == sprite0AngleReg ? $signed(16'shf8) : $signed(_GEN_403); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_405 = 8'h37 == sprite0AngleReg ? $signed(16'shf9) : $signed(_GEN_404); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_406 = 8'h38 == sprite0AngleReg ? $signed(16'shfb) : $signed(_GEN_405); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_407 = 8'h39 == sprite0AngleReg ? $signed(16'shfc) : $signed(_GEN_406); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_408 = 8'h3a == sprite0AngleReg ? $signed(16'shfd) : $signed(_GEN_407); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_409 = 8'h3b == sprite0AngleReg ? $signed(16'shfe) : $signed(_GEN_408); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_410 = 8'h3c == sprite0AngleReg ? $signed(16'shfe) : $signed(_GEN_409); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_411 = 8'h3d == sprite0AngleReg ? $signed(16'shff) : $signed(_GEN_410); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_412 = 8'h3e == sprite0AngleReg ? $signed(16'shff) : $signed(_GEN_411); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_413 = 8'h3f == sprite0AngleReg ? $signed(16'shff) : $signed(_GEN_412); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_414 = 8'h40 == sprite0AngleReg ? $signed(16'sh100) : $signed(_GEN_413); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_415 = 8'h41 == sprite0AngleReg ? $signed(16'shff) : $signed(_GEN_414); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_416 = 8'h42 == sprite0AngleReg ? $signed(16'shff) : $signed(_GEN_415); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_417 = 8'h43 == sprite0AngleReg ? $signed(16'shff) : $signed(_GEN_416); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_418 = 8'h44 == sprite0AngleReg ? $signed(16'shfe) : $signed(_GEN_417); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_419 = 8'h45 == sprite0AngleReg ? $signed(16'shfe) : $signed(_GEN_418); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_420 = 8'h46 == sprite0AngleReg ? $signed(16'shfd) : $signed(_GEN_419); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_421 = 8'h47 == sprite0AngleReg ? $signed(16'shfc) : $signed(_GEN_420); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_422 = 8'h48 == sprite0AngleReg ? $signed(16'shfb) : $signed(_GEN_421); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_423 = 8'h49 == sprite0AngleReg ? $signed(16'shf9) : $signed(_GEN_422); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_424 = 8'h4a == sprite0AngleReg ? $signed(16'shf8) : $signed(_GEN_423); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_425 = 8'h4b == sprite0AngleReg ? $signed(16'shf6) : $signed(_GEN_424); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_426 = 8'h4c == sprite0AngleReg ? $signed(16'shf4) : $signed(_GEN_425); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_427 = 8'h4d == sprite0AngleReg ? $signed(16'shf3) : $signed(_GEN_426); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_428 = 8'h4e == sprite0AngleReg ? $signed(16'shf1) : $signed(_GEN_427); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_429 = 8'h4f == sprite0AngleReg ? $signed(16'shee) : $signed(_GEN_428); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_430 = 8'h50 == sprite0AngleReg ? $signed(16'shec) : $signed(_GEN_429); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_431 = 8'h51 == sprite0AngleReg ? $signed(16'shea) : $signed(_GEN_430); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_432 = 8'h52 == sprite0AngleReg ? $signed(16'she7) : $signed(_GEN_431); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_433 = 8'h53 == sprite0AngleReg ? $signed(16'she4) : $signed(_GEN_432); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_434 = 8'h54 == sprite0AngleReg ? $signed(16'she1) : $signed(_GEN_433); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_435 = 8'h55 == sprite0AngleReg ? $signed(16'shde) : $signed(_GEN_434); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_436 = 8'h56 == sprite0AngleReg ? $signed(16'shdb) : $signed(_GEN_435); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_437 = 8'h57 == sprite0AngleReg ? $signed(16'shd8) : $signed(_GEN_436); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_438 = 8'h58 == sprite0AngleReg ? $signed(16'shd4) : $signed(_GEN_437); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_439 = 8'h59 == sprite0AngleReg ? $signed(16'shd1) : $signed(_GEN_438); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_440 = 8'h5a == sprite0AngleReg ? $signed(16'shcd) : $signed(_GEN_439); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_441 = 8'h5b == sprite0AngleReg ? $signed(16'shc9) : $signed(_GEN_440); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_442 = 8'h5c == sprite0AngleReg ? $signed(16'shc5) : $signed(_GEN_441); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_443 = 8'h5d == sprite0AngleReg ? $signed(16'shc1) : $signed(_GEN_442); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_444 = 8'h5e == sprite0AngleReg ? $signed(16'shbd) : $signed(_GEN_443); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_445 = 8'h5f == sprite0AngleReg ? $signed(16'shb9) : $signed(_GEN_444); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_446 = 8'h60 == sprite0AngleReg ? $signed(16'shb5) : $signed(_GEN_445); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_447 = 8'h61 == sprite0AngleReg ? $signed(16'shb0) : $signed(_GEN_446); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_448 = 8'h62 == sprite0AngleReg ? $signed(16'shab) : $signed(_GEN_447); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_449 = 8'h63 == sprite0AngleReg ? $signed(16'sha7) : $signed(_GEN_448); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_450 = 8'h64 == sprite0AngleReg ? $signed(16'sha2) : $signed(_GEN_449); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_451 = 8'h65 == sprite0AngleReg ? $signed(16'sh9d) : $signed(_GEN_450); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_452 = 8'h66 == sprite0AngleReg ? $signed(16'sh98) : $signed(_GEN_451); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_453 = 8'h67 == sprite0AngleReg ? $signed(16'sh93) : $signed(_GEN_452); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_454 = 8'h68 == sprite0AngleReg ? $signed(16'sh8e) : $signed(_GEN_453); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_455 = 8'h69 == sprite0AngleReg ? $signed(16'sh88) : $signed(_GEN_454); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_456 = 8'h6a == sprite0AngleReg ? $signed(16'sh83) : $signed(_GEN_455); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_457 = 8'h6b == sprite0AngleReg ? $signed(16'sh7e) : $signed(_GEN_456); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_458 = 8'h6c == sprite0AngleReg ? $signed(16'sh78) : $signed(_GEN_457); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_459 = 8'h6d == sprite0AngleReg ? $signed(16'sh73) : $signed(_GEN_458); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_460 = 8'h6e == sprite0AngleReg ? $signed(16'sh6d) : $signed(_GEN_459); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_461 = 8'h6f == sprite0AngleReg ? $signed(16'sh67) : $signed(_GEN_460); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_462 = 8'h70 == sprite0AngleReg ? $signed(16'sh61) : $signed(_GEN_461); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_463 = 8'h71 == sprite0AngleReg ? $signed(16'sh5c) : $signed(_GEN_462); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_464 = 8'h72 == sprite0AngleReg ? $signed(16'sh56) : $signed(_GEN_463); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_465 = 8'h73 == sprite0AngleReg ? $signed(16'sh50) : $signed(_GEN_464); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_466 = 8'h74 == sprite0AngleReg ? $signed(16'sh4a) : $signed(_GEN_465); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_467 = 8'h75 == sprite0AngleReg ? $signed(16'sh44) : $signed(_GEN_466); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_468 = 8'h76 == sprite0AngleReg ? $signed(16'sh3e) : $signed(_GEN_467); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_469 = 8'h77 == sprite0AngleReg ? $signed(16'sh38) : $signed(_GEN_468); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_470 = 8'h78 == sprite0AngleReg ? $signed(16'sh31) : $signed(_GEN_469); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_471 = 8'h79 == sprite0AngleReg ? $signed(16'sh2b) : $signed(_GEN_470); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_472 = 8'h7a == sprite0AngleReg ? $signed(16'sh25) : $signed(_GEN_471); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_473 = 8'h7b == sprite0AngleReg ? $signed(16'sh1f) : $signed(_GEN_472); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_474 = 8'h7c == sprite0AngleReg ? $signed(16'sh19) : $signed(_GEN_473); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_475 = 8'h7d == sprite0AngleReg ? $signed(16'sh12) : $signed(_GEN_474); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_476 = 8'h7e == sprite0AngleReg ? $signed(16'shc) : $signed(_GEN_475); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_477 = 8'h7f == sprite0AngleReg ? $signed(16'sh6) : $signed(_GEN_476); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_478 = 8'h80 == sprite0AngleReg ? $signed(16'sh0) : $signed(_GEN_477); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_479 = 8'h81 == sprite0AngleReg ? $signed(-16'sh6) : $signed(_GEN_478); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_480 = 8'h82 == sprite0AngleReg ? $signed(-16'shc) : $signed(_GEN_479); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_481 = 8'h83 == sprite0AngleReg ? $signed(-16'sh12) : $signed(_GEN_480); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_482 = 8'h84 == sprite0AngleReg ? $signed(-16'sh19) : $signed(_GEN_481); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_483 = 8'h85 == sprite0AngleReg ? $signed(-16'sh1f) : $signed(_GEN_482); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_484 = 8'h86 == sprite0AngleReg ? $signed(-16'sh25) : $signed(_GEN_483); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_485 = 8'h87 == sprite0AngleReg ? $signed(-16'sh2b) : $signed(_GEN_484); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_486 = 8'h88 == sprite0AngleReg ? $signed(-16'sh31) : $signed(_GEN_485); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_487 = 8'h89 == sprite0AngleReg ? $signed(-16'sh38) : $signed(_GEN_486); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_488 = 8'h8a == sprite0AngleReg ? $signed(-16'sh3e) : $signed(_GEN_487); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_489 = 8'h8b == sprite0AngleReg ? $signed(-16'sh44) : $signed(_GEN_488); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_490 = 8'h8c == sprite0AngleReg ? $signed(-16'sh4a) : $signed(_GEN_489); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_491 = 8'h8d == sprite0AngleReg ? $signed(-16'sh50) : $signed(_GEN_490); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_492 = 8'h8e == sprite0AngleReg ? $signed(-16'sh56) : $signed(_GEN_491); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_493 = 8'h8f == sprite0AngleReg ? $signed(-16'sh5c) : $signed(_GEN_492); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_494 = 8'h90 == sprite0AngleReg ? $signed(-16'sh61) : $signed(_GEN_493); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_495 = 8'h91 == sprite0AngleReg ? $signed(-16'sh67) : $signed(_GEN_494); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_496 = 8'h92 == sprite0AngleReg ? $signed(-16'sh6d) : $signed(_GEN_495); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_497 = 8'h93 == sprite0AngleReg ? $signed(-16'sh73) : $signed(_GEN_496); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_498 = 8'h94 == sprite0AngleReg ? $signed(-16'sh78) : $signed(_GEN_497); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_499 = 8'h95 == sprite0AngleReg ? $signed(-16'sh7e) : $signed(_GEN_498); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_500 = 8'h96 == sprite0AngleReg ? $signed(-16'sh83) : $signed(_GEN_499); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_501 = 8'h97 == sprite0AngleReg ? $signed(-16'sh88) : $signed(_GEN_500); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_502 = 8'h98 == sprite0AngleReg ? $signed(-16'sh8e) : $signed(_GEN_501); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_503 = 8'h99 == sprite0AngleReg ? $signed(-16'sh93) : $signed(_GEN_502); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_504 = 8'h9a == sprite0AngleReg ? $signed(-16'sh98) : $signed(_GEN_503); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_505 = 8'h9b == sprite0AngleReg ? $signed(-16'sh9d) : $signed(_GEN_504); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_506 = 8'h9c == sprite0AngleReg ? $signed(-16'sha2) : $signed(_GEN_505); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_507 = 8'h9d == sprite0AngleReg ? $signed(-16'sha7) : $signed(_GEN_506); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_508 = 8'h9e == sprite0AngleReg ? $signed(-16'shab) : $signed(_GEN_507); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_509 = 8'h9f == sprite0AngleReg ? $signed(-16'shb0) : $signed(_GEN_508); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_510 = 8'ha0 == sprite0AngleReg ? $signed(-16'shb5) : $signed(_GEN_509); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_511 = 8'ha1 == sprite0AngleReg ? $signed(-16'shb9) : $signed(_GEN_510); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_512 = 8'ha2 == sprite0AngleReg ? $signed(-16'shbd) : $signed(_GEN_511); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_513 = 8'ha3 == sprite0AngleReg ? $signed(-16'shc1) : $signed(_GEN_512); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_514 = 8'ha4 == sprite0AngleReg ? $signed(-16'shc5) : $signed(_GEN_513); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_515 = 8'ha5 == sprite0AngleReg ? $signed(-16'shc9) : $signed(_GEN_514); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_516 = 8'ha6 == sprite0AngleReg ? $signed(-16'shcd) : $signed(_GEN_515); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_517 = 8'ha7 == sprite0AngleReg ? $signed(-16'shd1) : $signed(_GEN_516); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_518 = 8'ha8 == sprite0AngleReg ? $signed(-16'shd4) : $signed(_GEN_517); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_519 = 8'ha9 == sprite0AngleReg ? $signed(-16'shd8) : $signed(_GEN_518); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_520 = 8'haa == sprite0AngleReg ? $signed(-16'shdb) : $signed(_GEN_519); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_521 = 8'hab == sprite0AngleReg ? $signed(-16'shde) : $signed(_GEN_520); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_522 = 8'hac == sprite0AngleReg ? $signed(-16'she1) : $signed(_GEN_521); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_523 = 8'had == sprite0AngleReg ? $signed(-16'she4) : $signed(_GEN_522); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_524 = 8'hae == sprite0AngleReg ? $signed(-16'she7) : $signed(_GEN_523); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_525 = 8'haf == sprite0AngleReg ? $signed(-16'shea) : $signed(_GEN_524); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_526 = 8'hb0 == sprite0AngleReg ? $signed(-16'shec) : $signed(_GEN_525); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_527 = 8'hb1 == sprite0AngleReg ? $signed(-16'shee) : $signed(_GEN_526); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_528 = 8'hb2 == sprite0AngleReg ? $signed(-16'shf1) : $signed(_GEN_527); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_529 = 8'hb3 == sprite0AngleReg ? $signed(-16'shf3) : $signed(_GEN_528); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_530 = 8'hb4 == sprite0AngleReg ? $signed(-16'shf4) : $signed(_GEN_529); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_531 = 8'hb5 == sprite0AngleReg ? $signed(-16'shf6) : $signed(_GEN_530); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_532 = 8'hb6 == sprite0AngleReg ? $signed(-16'shf8) : $signed(_GEN_531); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_533 = 8'hb7 == sprite0AngleReg ? $signed(-16'shf9) : $signed(_GEN_532); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_534 = 8'hb8 == sprite0AngleReg ? $signed(-16'shfb) : $signed(_GEN_533); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_535 = 8'hb9 == sprite0AngleReg ? $signed(-16'shfc) : $signed(_GEN_534); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_536 = 8'hba == sprite0AngleReg ? $signed(-16'shfd) : $signed(_GEN_535); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_537 = 8'hbb == sprite0AngleReg ? $signed(-16'shfe) : $signed(_GEN_536); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_538 = 8'hbc == sprite0AngleReg ? $signed(-16'shfe) : $signed(_GEN_537); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_539 = 8'hbd == sprite0AngleReg ? $signed(-16'shff) : $signed(_GEN_538); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_540 = 8'hbe == sprite0AngleReg ? $signed(-16'shff) : $signed(_GEN_539); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_541 = 8'hbf == sprite0AngleReg ? $signed(-16'shff) : $signed(_GEN_540); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_542 = 8'hc0 == sprite0AngleReg ? $signed(-16'sh100) : $signed(_GEN_541); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_543 = 8'hc1 == sprite0AngleReg ? $signed(-16'shff) : $signed(_GEN_542); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_544 = 8'hc2 == sprite0AngleReg ? $signed(-16'shff) : $signed(_GEN_543); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_545 = 8'hc3 == sprite0AngleReg ? $signed(-16'shff) : $signed(_GEN_544); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_546 = 8'hc4 == sprite0AngleReg ? $signed(-16'shfe) : $signed(_GEN_545); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_547 = 8'hc5 == sprite0AngleReg ? $signed(-16'shfe) : $signed(_GEN_546); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_548 = 8'hc6 == sprite0AngleReg ? $signed(-16'shfd) : $signed(_GEN_547); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_549 = 8'hc7 == sprite0AngleReg ? $signed(-16'shfc) : $signed(_GEN_548); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_550 = 8'hc8 == sprite0AngleReg ? $signed(-16'shfb) : $signed(_GEN_549); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_551 = 8'hc9 == sprite0AngleReg ? $signed(-16'shf9) : $signed(_GEN_550); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_552 = 8'hca == sprite0AngleReg ? $signed(-16'shf8) : $signed(_GEN_551); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_553 = 8'hcb == sprite0AngleReg ? $signed(-16'shf6) : $signed(_GEN_552); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_554 = 8'hcc == sprite0AngleReg ? $signed(-16'shf4) : $signed(_GEN_553); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_555 = 8'hcd == sprite0AngleReg ? $signed(-16'shf3) : $signed(_GEN_554); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_556 = 8'hce == sprite0AngleReg ? $signed(-16'shf1) : $signed(_GEN_555); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_557 = 8'hcf == sprite0AngleReg ? $signed(-16'shee) : $signed(_GEN_556); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_558 = 8'hd0 == sprite0AngleReg ? $signed(-16'shec) : $signed(_GEN_557); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_559 = 8'hd1 == sprite0AngleReg ? $signed(-16'shea) : $signed(_GEN_558); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_560 = 8'hd2 == sprite0AngleReg ? $signed(-16'she7) : $signed(_GEN_559); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_561 = 8'hd3 == sprite0AngleReg ? $signed(-16'she4) : $signed(_GEN_560); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_562 = 8'hd4 == sprite0AngleReg ? $signed(-16'she1) : $signed(_GEN_561); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_563 = 8'hd5 == sprite0AngleReg ? $signed(-16'shde) : $signed(_GEN_562); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_564 = 8'hd6 == sprite0AngleReg ? $signed(-16'shdb) : $signed(_GEN_563); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_565 = 8'hd7 == sprite0AngleReg ? $signed(-16'shd8) : $signed(_GEN_564); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_566 = 8'hd8 == sprite0AngleReg ? $signed(-16'shd4) : $signed(_GEN_565); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_567 = 8'hd9 == sprite0AngleReg ? $signed(-16'shd1) : $signed(_GEN_566); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_568 = 8'hda == sprite0AngleReg ? $signed(-16'shcd) : $signed(_GEN_567); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_569 = 8'hdb == sprite0AngleReg ? $signed(-16'shc9) : $signed(_GEN_568); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_570 = 8'hdc == sprite0AngleReg ? $signed(-16'shc5) : $signed(_GEN_569); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_571 = 8'hdd == sprite0AngleReg ? $signed(-16'shc1) : $signed(_GEN_570); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_572 = 8'hde == sprite0AngleReg ? $signed(-16'shbd) : $signed(_GEN_571); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_573 = 8'hdf == sprite0AngleReg ? $signed(-16'shb9) : $signed(_GEN_572); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_574 = 8'he0 == sprite0AngleReg ? $signed(-16'shb5) : $signed(_GEN_573); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_575 = 8'he1 == sprite0AngleReg ? $signed(-16'shb0) : $signed(_GEN_574); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_576 = 8'he2 == sprite0AngleReg ? $signed(-16'shab) : $signed(_GEN_575); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_577 = 8'he3 == sprite0AngleReg ? $signed(-16'sha7) : $signed(_GEN_576); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_578 = 8'he4 == sprite0AngleReg ? $signed(-16'sha2) : $signed(_GEN_577); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_579 = 8'he5 == sprite0AngleReg ? $signed(-16'sh9d) : $signed(_GEN_578); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_580 = 8'he6 == sprite0AngleReg ? $signed(-16'sh98) : $signed(_GEN_579); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_581 = 8'he7 == sprite0AngleReg ? $signed(-16'sh93) : $signed(_GEN_580); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_582 = 8'he8 == sprite0AngleReg ? $signed(-16'sh8e) : $signed(_GEN_581); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_583 = 8'he9 == sprite0AngleReg ? $signed(-16'sh88) : $signed(_GEN_582); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_584 = 8'hea == sprite0AngleReg ? $signed(-16'sh83) : $signed(_GEN_583); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_585 = 8'heb == sprite0AngleReg ? $signed(-16'sh7e) : $signed(_GEN_584); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_586 = 8'hec == sprite0AngleReg ? $signed(-16'sh78) : $signed(_GEN_585); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_587 = 8'hed == sprite0AngleReg ? $signed(-16'sh73) : $signed(_GEN_586); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_588 = 8'hee == sprite0AngleReg ? $signed(-16'sh6d) : $signed(_GEN_587); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_589 = 8'hef == sprite0AngleReg ? $signed(-16'sh67) : $signed(_GEN_588); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_590 = 8'hf0 == sprite0AngleReg ? $signed(-16'sh61) : $signed(_GEN_589); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_591 = 8'hf1 == sprite0AngleReg ? $signed(-16'sh5c) : $signed(_GEN_590); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_592 = 8'hf2 == sprite0AngleReg ? $signed(-16'sh56) : $signed(_GEN_591); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_593 = 8'hf3 == sprite0AngleReg ? $signed(-16'sh50) : $signed(_GEN_592); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_594 = 8'hf4 == sprite0AngleReg ? $signed(-16'sh4a) : $signed(_GEN_593); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_595 = 8'hf5 == sprite0AngleReg ? $signed(-16'sh44) : $signed(_GEN_594); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_596 = 8'hf6 == sprite0AngleReg ? $signed(-16'sh3e) : $signed(_GEN_595); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_597 = 8'hf7 == sprite0AngleReg ? $signed(-16'sh38) : $signed(_GEN_596); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_598 = 8'hf8 == sprite0AngleReg ? $signed(-16'sh31) : $signed(_GEN_597); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_599 = 8'hf9 == sprite0AngleReg ? $signed(-16'sh2b) : $signed(_GEN_598); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_600 = 8'hfa == sprite0AngleReg ? $signed(-16'sh25) : $signed(_GEN_599); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_601 = 8'hfb == sprite0AngleReg ? $signed(-16'sh1f) : $signed(_GEN_600); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_602 = 8'hfc == sprite0AngleReg ? $signed(-16'sh19) : $signed(_GEN_601); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_603 = 8'hfd == sprite0AngleReg ? $signed(-16'sh12) : $signed(_GEN_602); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [15:0] _GEN_604 = 8'hfe == sprite0AngleReg ? $signed(-16'shc) : $signed(_GEN_603); // @[src/main/scala/PlayerController.scala 247:{14,14}]
  wire [47:0] _playerXPositionReg_T = $signed(sprite0SpeedReg) * $signed(cosReg); // @[src/main/scala/PlayerController.scala 254:68]
  wire [39:0] _playerXPositionReg_T_1 = _playerXPositionReg_T[47:8]; // @[src/main/scala/PlayerController.scala 254:78]
  wire [39:0] _GEN_713 = {{8{playerXPositionReg[31]}},playerXPositionReg}; // @[src/main/scala/PlayerController.scala 254:48]
  wire [39:0] _playerXPositionReg_T_4 = $signed(_GEN_713) + $signed(_playerXPositionReg_T_1); // @[src/main/scala/PlayerController.scala 254:48]
  wire [47:0] _playerYPositionReg_T = $signed(sprite0SpeedReg) * $signed(sinReg); // @[src/main/scala/PlayerController.scala 255:68]
  wire [39:0] _playerYPositionReg_T_1 = _playerYPositionReg_T[47:8]; // @[src/main/scala/PlayerController.scala 255:78]
  wire [39:0] _GEN_720 = {{8{playerYPositionReg[31]}},playerYPositionReg}; // @[src/main/scala/PlayerController.scala 255:48]
  wire [39:0] _playerYPositionReg_T_4 = $signed(_GEN_720) + $signed(_playerYPositionReg_T_1); // @[src/main/scala/PlayerController.scala 255:48]
  wire [5:0] tile1Idx = checkPointCntReg * 2'h2; // @[src/main/scala/PlayerController.scala 264:39]
  wire [5:0] tile2Idx = tile1Idx + 6'h1; // @[src/main/scala/PlayerController.scala 265:47]
  wire  _GEN_728 = 3'h0 == _currentTrack_T_1[2:0]; // @[src/main/scala/PlayerController.scala 268:{34,34}]
  wire [15:0] _GEN_607 = 3'h0 == _currentTrack_T_1[2:0] & 3'h1 == tile1Idx[2:0] ? 16'h285 : 16'h284; // @[src/main/scala/PlayerController.scala 268:{34,34}]
  wire [15:0] _GEN_608 = 3'h0 == _currentTrack_T_1[2:0] & 3'h2 == tile1Idx[2:0] ? 16'h3d1 : _GEN_607; // @[src/main/scala/PlayerController.scala 268:{34,34}]
  wire [15:0] _GEN_609 = 3'h0 == _currentTrack_T_1[2:0] & 3'h3 == tile1Idx[2:0] ? 16'h3f9 : _GEN_608; // @[src/main/scala/PlayerController.scala 268:{34,34}]
  wire [15:0] _GEN_610 = 3'h0 == _currentTrack_T_1[2:0] & 3'h4 == tile1Idx[2:0] ? 16'h2a2 : _GEN_609; // @[src/main/scala/PlayerController.scala 268:{34,34}]
  wire [15:0] _GEN_611 = 3'h0 == _currentTrack_T_1[2:0] & 3'h5 == tile1Idx[2:0] ? 16'h2a3 : _GEN_610; // @[src/main/scala/PlayerController.scala 268:{34,34}]
  wire  _GEN_782 = 3'h1 == _currentTrack_T_1[2:0]; // @[src/main/scala/PlayerController.scala 268:{34,34}]
  wire [15:0] _GEN_612 = 3'h1 == _currentTrack_T_1[2:0] & 3'h0 == tile1Idx[2:0] ? 16'h3ca : _GEN_611; // @[src/main/scala/PlayerController.scala 268:{34,34}]
  wire [15:0] _GEN_613 = 3'h1 == _currentTrack_T_1[2:0] & 3'h1 == tile1Idx[2:0] ? 16'h3f2 : _GEN_612; // @[src/main/scala/PlayerController.scala 268:{34,34}]
  wire [15:0] _GEN_614 = 3'h1 == _currentTrack_T_1[2:0] & 3'h2 == tile1Idx[2:0] ? 16'h3b3 : _GEN_613; // @[src/main/scala/PlayerController.scala 268:{34,34}]
  wire [15:0] _GEN_615 = 3'h1 == _currentTrack_T_1[2:0] & 3'h3 == tile1Idx[2:0] ? 16'h3db : _GEN_614; // @[src/main/scala/PlayerController.scala 268:{34,34}]
  wire [15:0] _GEN_616 = 3'h1 == _currentTrack_T_1[2:0] & 3'h4 == tile1Idx[2:0] ? 16'h1da : _GEN_615; // @[src/main/scala/PlayerController.scala 268:{34,34}]
  wire [15:0] _GEN_617 = 3'h1 == _currentTrack_T_1[2:0] & 3'h5 == tile1Idx[2:0] ? 16'h1db : _GEN_616; // @[src/main/scala/PlayerController.scala 268:{34,34}]
  wire  _GEN_794 = 3'h2 == _currentTrack_T_1[2:0]; // @[src/main/scala/PlayerController.scala 268:{34,34}]
  wire [15:0] _GEN_618 = 3'h2 == _currentTrack_T_1[2:0] & 3'h0 == tile1Idx[2:0] ? 16'h25c : _GEN_617; // @[src/main/scala/PlayerController.scala 268:{34,34}]
  wire [15:0] _GEN_619 = 3'h2 == _currentTrack_T_1[2:0] & 3'h1 == tile1Idx[2:0] ? 16'h25d : _GEN_618; // @[src/main/scala/PlayerController.scala 268:{34,34}]
  wire [15:0] _GEN_620 = 3'h2 == _currentTrack_T_1[2:0] & 3'h2 == tile1Idx[2:0] ? 16'h1f6 : _GEN_619; // @[src/main/scala/PlayerController.scala 268:{34,34}]
  wire [15:0] _GEN_621 = 3'h2 == _currentTrack_T_1[2:0] & 3'h3 == tile1Idx[2:0] ? 16'h21e : _GEN_620; // @[src/main/scala/PlayerController.scala 268:{34,34}]
  wire [15:0] _GEN_622 = 3'h2 == _currentTrack_T_1[2:0] & 3'h4 == tile1Idx[2:0] ? 16'h2ca : _GEN_621; // @[src/main/scala/PlayerController.scala 268:{34,34}]
  wire [15:0] _GEN_623 = 3'h2 == _currentTrack_T_1[2:0] & 3'h5 == tile1Idx[2:0] ? 16'h2cb : _GEN_622; // @[src/main/scala/PlayerController.scala 268:{34,34}]
  wire  _GEN_806 = 3'h3 == _currentTrack_T_1[2:0]; // @[src/main/scala/PlayerController.scala 268:{34,34}]
  wire [15:0] _GEN_624 = 3'h3 == _currentTrack_T_1[2:0] & 3'h0 == tile1Idx[2:0] ? 16'h260 : _GEN_623; // @[src/main/scala/PlayerController.scala 268:{34,34}]
  wire [15:0] _GEN_625 = 3'h3 == _currentTrack_T_1[2:0] & 3'h1 == tile1Idx[2:0] ? 16'h261 : _GEN_624; // @[src/main/scala/PlayerController.scala 268:{34,34}]
  wire [15:0] _GEN_626 = 3'h3 == _currentTrack_T_1[2:0] & 3'h2 == tile1Idx[2:0] ? 16'h427 : _GEN_625; // @[src/main/scala/PlayerController.scala 268:{34,34}]
  wire [15:0] _GEN_627 = 3'h3 == _currentTrack_T_1[2:0] & 3'h3 == tile1Idx[2:0] ? 16'h44f : _GEN_626; // @[src/main/scala/PlayerController.scala 268:{34,34}]
  wire [15:0] _GEN_628 = 3'h3 == _currentTrack_T_1[2:0] & 3'h4 == tile1Idx[2:0] ? 16'h1fc : _GEN_627; // @[src/main/scala/PlayerController.scala 268:{34,34}]
  wire [15:0] _GEN_629 = 3'h3 == _currentTrack_T_1[2:0] & 3'h5 == tile1Idx[2:0] ? 16'h1fd : _GEN_628; // @[src/main/scala/PlayerController.scala 268:{34,34}]
  wire  _GEN_818 = 3'h4 == _currentTrack_T_1[2:0]; // @[src/main/scala/PlayerController.scala 268:{34,34}]
  wire [15:0] _GEN_630 = 3'h4 == _currentTrack_T_1[2:0] & 3'h0 == tile1Idx[2:0] ? 16'h3c7 : _GEN_629; // @[src/main/scala/PlayerController.scala 268:{34,34}]
  wire [15:0] _GEN_631 = 3'h4 == _currentTrack_T_1[2:0] & 3'h1 == tile1Idx[2:0] ? 16'h3ef : _GEN_630; // @[src/main/scala/PlayerController.scala 268:{34,34}]
  wire [15:0] _GEN_632 = 3'h4 == _currentTrack_T_1[2:0] & 3'h2 == tile1Idx[2:0] ? 16'h3d0 : _GEN_631; // @[src/main/scala/PlayerController.scala 268:{34,34}]
  wire [15:0] _GEN_633 = 3'h4 == _currentTrack_T_1[2:0] & 3'h3 == tile1Idx[2:0] ? 16'h3f8 : _GEN_632; // @[src/main/scala/PlayerController.scala 268:{34,34}]
  wire [15:0] _GEN_634 = 3'h4 == _currentTrack_T_1[2:0] & 3'h4 == tile1Idx[2:0] ? 16'h3e0 : _GEN_633; // @[src/main/scala/PlayerController.scala 268:{34,34}]
  wire [15:0] _GEN_635 = 3'h4 == _currentTrack_T_1[2:0] & 3'h5 == tile1Idx[2:0] ? 16'h408 : _GEN_634; // @[src/main/scala/PlayerController.scala 268:{34,34}]
  wire  _GEN_830 = 3'h5 == _currentTrack_T_1[2:0]; // @[src/main/scala/PlayerController.scala 268:{34,34}]
  wire [15:0] _GEN_636 = 3'h5 == _currentTrack_T_1[2:0] & 3'h0 == tile1Idx[2:0] ? 16'h3c9 : _GEN_635; // @[src/main/scala/PlayerController.scala 268:{34,34}]
  wire [15:0] _GEN_637 = 3'h5 == _currentTrack_T_1[2:0] & 3'h1 == tile1Idx[2:0] ? 16'h3f1 : _GEN_636; // @[src/main/scala/PlayerController.scala 268:{34,34}]
  wire [15:0] _GEN_638 = 3'h5 == _currentTrack_T_1[2:0] & 3'h2 == tile1Idx[2:0] ? 16'h158 : _GEN_637; // @[src/main/scala/PlayerController.scala 268:{34,34}]
  wire [15:0] _GEN_639 = 3'h5 == _currentTrack_T_1[2:0] & 3'h3 == tile1Idx[2:0] ? 16'h180 : _GEN_638; // @[src/main/scala/PlayerController.scala 268:{34,34}]
  wire [15:0] _GEN_640 = 3'h5 == _currentTrack_T_1[2:0] & 3'h4 == tile1Idx[2:0] ? 16'h3db : _GEN_639; // @[src/main/scala/PlayerController.scala 268:{34,34}]
  wire [15:0] _GEN_641 = 3'h5 == _currentTrack_T_1[2:0] & 3'h5 == tile1Idx[2:0] ? 16'h403 : _GEN_640; // @[src/main/scala/PlayerController.scala 268:{34,34}]
  wire  _GEN_842 = 3'h6 == _currentTrack_T_1[2:0]; // @[src/main/scala/PlayerController.scala 268:{34,34}]
  wire [15:0] _GEN_642 = 3'h6 == _currentTrack_T_1[2:0] & 3'h0 == tile1Idx[2:0] ? 16'h34c : _GEN_641; // @[src/main/scala/PlayerController.scala 268:{34,34}]
  wire [15:0] _GEN_643 = 3'h6 == _currentTrack_T_1[2:0] & 3'h1 == tile1Idx[2:0] ? 16'h375 : _GEN_642; // @[src/main/scala/PlayerController.scala 268:{34,34}]
  wire [15:0] _GEN_644 = 3'h6 == _currentTrack_T_1[2:0] & 3'h2 == tile1Idx[2:0] ? 16'h154 : _GEN_643; // @[src/main/scala/PlayerController.scala 268:{34,34}]
  wire [15:0] _GEN_645 = 3'h6 == _currentTrack_T_1[2:0] & 3'h3 == tile1Idx[2:0] ? 16'h17c : _GEN_644; // @[src/main/scala/PlayerController.scala 268:{34,34}]
  wire [15:0] _GEN_646 = 3'h6 == _currentTrack_T_1[2:0] & 3'h4 == tile1Idx[2:0] ? 16'h36a : _GEN_645; // @[src/main/scala/PlayerController.scala 268:{34,34}]
  wire [15:0] _GEN_647 = 3'h6 == _currentTrack_T_1[2:0] & 3'h5 == tile1Idx[2:0] ? 16'h36b : _GEN_646; // @[src/main/scala/PlayerController.scala 268:{34,34}]
  wire [15:0] _GEN_854 = {{5'd0}, tilemapRomTileAddrReg}; // @[src/main/scala/PlayerController.scala 268:34]
  wire [15:0] _GEN_649 = _GEN_728 & 3'h1 == tile2Idx[2:0] ? 16'h285 : 16'h284; // @[src/main/scala/PlayerController.scala 269:{34,34}]
  wire [15:0] _GEN_650 = _GEN_728 & 3'h2 == tile2Idx[2:0] ? 16'h3d1 : _GEN_649; // @[src/main/scala/PlayerController.scala 269:{34,34}]
  wire [15:0] _GEN_651 = _GEN_728 & 3'h3 == tile2Idx[2:0] ? 16'h3f9 : _GEN_650; // @[src/main/scala/PlayerController.scala 269:{34,34}]
  wire [15:0] _GEN_652 = _GEN_728 & 3'h4 == tile2Idx[2:0] ? 16'h2a2 : _GEN_651; // @[src/main/scala/PlayerController.scala 269:{34,34}]
  wire [15:0] _GEN_653 = _GEN_728 & 3'h5 == tile2Idx[2:0] ? 16'h2a3 : _GEN_652; // @[src/main/scala/PlayerController.scala 269:{34,34}]
  wire [15:0] _GEN_654 = _GEN_782 & 3'h0 == tile2Idx[2:0] ? 16'h3ca : _GEN_653; // @[src/main/scala/PlayerController.scala 269:{34,34}]
  wire [15:0] _GEN_655 = _GEN_782 & 3'h1 == tile2Idx[2:0] ? 16'h3f2 : _GEN_654; // @[src/main/scala/PlayerController.scala 269:{34,34}]
  wire [15:0] _GEN_656 = _GEN_782 & 3'h2 == tile2Idx[2:0] ? 16'h3b3 : _GEN_655; // @[src/main/scala/PlayerController.scala 269:{34,34}]
  wire [15:0] _GEN_657 = _GEN_782 & 3'h3 == tile2Idx[2:0] ? 16'h3db : _GEN_656; // @[src/main/scala/PlayerController.scala 269:{34,34}]
  wire [15:0] _GEN_658 = _GEN_782 & 3'h4 == tile2Idx[2:0] ? 16'h1da : _GEN_657; // @[src/main/scala/PlayerController.scala 269:{34,34}]
  wire [15:0] _GEN_659 = _GEN_782 & 3'h5 == tile2Idx[2:0] ? 16'h1db : _GEN_658; // @[src/main/scala/PlayerController.scala 269:{34,34}]
  wire [15:0] _GEN_660 = _GEN_794 & 3'h0 == tile2Idx[2:0] ? 16'h25c : _GEN_659; // @[src/main/scala/PlayerController.scala 269:{34,34}]
  wire [15:0] _GEN_661 = _GEN_794 & 3'h1 == tile2Idx[2:0] ? 16'h25d : _GEN_660; // @[src/main/scala/PlayerController.scala 269:{34,34}]
  wire [15:0] _GEN_662 = _GEN_794 & 3'h2 == tile2Idx[2:0] ? 16'h1f6 : _GEN_661; // @[src/main/scala/PlayerController.scala 269:{34,34}]
  wire [15:0] _GEN_663 = _GEN_794 & 3'h3 == tile2Idx[2:0] ? 16'h21e : _GEN_662; // @[src/main/scala/PlayerController.scala 269:{34,34}]
  wire [15:0] _GEN_664 = _GEN_794 & 3'h4 == tile2Idx[2:0] ? 16'h2ca : _GEN_663; // @[src/main/scala/PlayerController.scala 269:{34,34}]
  wire [15:0] _GEN_665 = _GEN_794 & 3'h5 == tile2Idx[2:0] ? 16'h2cb : _GEN_664; // @[src/main/scala/PlayerController.scala 269:{34,34}]
  wire [15:0] _GEN_666 = _GEN_806 & 3'h0 == tile2Idx[2:0] ? 16'h260 : _GEN_665; // @[src/main/scala/PlayerController.scala 269:{34,34}]
  wire [15:0] _GEN_667 = _GEN_806 & 3'h1 == tile2Idx[2:0] ? 16'h261 : _GEN_666; // @[src/main/scala/PlayerController.scala 269:{34,34}]
  wire [15:0] _GEN_668 = _GEN_806 & 3'h2 == tile2Idx[2:0] ? 16'h427 : _GEN_667; // @[src/main/scala/PlayerController.scala 269:{34,34}]
  wire [15:0] _GEN_669 = _GEN_806 & 3'h3 == tile2Idx[2:0] ? 16'h44f : _GEN_668; // @[src/main/scala/PlayerController.scala 269:{34,34}]
  wire [15:0] _GEN_670 = _GEN_806 & 3'h4 == tile2Idx[2:0] ? 16'h1fc : _GEN_669; // @[src/main/scala/PlayerController.scala 269:{34,34}]
  wire [15:0] _GEN_671 = _GEN_806 & 3'h5 == tile2Idx[2:0] ? 16'h1fd : _GEN_670; // @[src/main/scala/PlayerController.scala 269:{34,34}]
  wire [15:0] _GEN_672 = _GEN_818 & 3'h0 == tile2Idx[2:0] ? 16'h3c7 : _GEN_671; // @[src/main/scala/PlayerController.scala 269:{34,34}]
  wire [15:0] _GEN_673 = _GEN_818 & 3'h1 == tile2Idx[2:0] ? 16'h3ef : _GEN_672; // @[src/main/scala/PlayerController.scala 269:{34,34}]
  wire [15:0] _GEN_674 = _GEN_818 & 3'h2 == tile2Idx[2:0] ? 16'h3d0 : _GEN_673; // @[src/main/scala/PlayerController.scala 269:{34,34}]
  wire [15:0] _GEN_675 = _GEN_818 & 3'h3 == tile2Idx[2:0] ? 16'h3f8 : _GEN_674; // @[src/main/scala/PlayerController.scala 269:{34,34}]
  wire [15:0] _GEN_676 = _GEN_818 & 3'h4 == tile2Idx[2:0] ? 16'h3e0 : _GEN_675; // @[src/main/scala/PlayerController.scala 269:{34,34}]
  wire [15:0] _GEN_677 = _GEN_818 & 3'h5 == tile2Idx[2:0] ? 16'h408 : _GEN_676; // @[src/main/scala/PlayerController.scala 269:{34,34}]
  wire [15:0] _GEN_678 = _GEN_830 & 3'h0 == tile2Idx[2:0] ? 16'h3c9 : _GEN_677; // @[src/main/scala/PlayerController.scala 269:{34,34}]
  wire [15:0] _GEN_679 = _GEN_830 & 3'h1 == tile2Idx[2:0] ? 16'h3f1 : _GEN_678; // @[src/main/scala/PlayerController.scala 269:{34,34}]
  wire [15:0] _GEN_680 = _GEN_830 & 3'h2 == tile2Idx[2:0] ? 16'h158 : _GEN_679; // @[src/main/scala/PlayerController.scala 269:{34,34}]
  wire [15:0] _GEN_681 = _GEN_830 & 3'h3 == tile2Idx[2:0] ? 16'h180 : _GEN_680; // @[src/main/scala/PlayerController.scala 269:{34,34}]
  wire [15:0] _GEN_682 = _GEN_830 & 3'h4 == tile2Idx[2:0] ? 16'h3db : _GEN_681; // @[src/main/scala/PlayerController.scala 269:{34,34}]
  wire [15:0] _GEN_683 = _GEN_830 & 3'h5 == tile2Idx[2:0] ? 16'h403 : _GEN_682; // @[src/main/scala/PlayerController.scala 269:{34,34}]
  wire [15:0] _GEN_684 = _GEN_842 & 3'h0 == tile2Idx[2:0] ? 16'h34c : _GEN_683; // @[src/main/scala/PlayerController.scala 269:{34,34}]
  wire [15:0] _GEN_685 = _GEN_842 & 3'h1 == tile2Idx[2:0] ? 16'h375 : _GEN_684; // @[src/main/scala/PlayerController.scala 269:{34,34}]
  wire [15:0] _GEN_686 = _GEN_842 & 3'h2 == tile2Idx[2:0] ? 16'h154 : _GEN_685; // @[src/main/scala/PlayerController.scala 269:{34,34}]
  wire [15:0] _GEN_687 = _GEN_842 & 3'h3 == tile2Idx[2:0] ? 16'h17c : _GEN_686; // @[src/main/scala/PlayerController.scala 269:{34,34}]
  wire [15:0] _GEN_688 = _GEN_842 & 3'h4 == tile2Idx[2:0] ? 16'h36a : _GEN_687; // @[src/main/scala/PlayerController.scala 269:{34,34}]
  wire [15:0] _GEN_689 = _GEN_842 & 3'h5 == tile2Idx[2:0] ? 16'h36b : _GEN_688; // @[src/main/scala/PlayerController.scala 269:{34,34}]
  wire  _T_45 = _GEN_854 == _GEN_689; // @[src/main/scala/PlayerController.scala 269:34]
  wire  _T_46 = _GEN_854 == _GEN_647 | _T_45; // @[src/main/scala/PlayerController.scala 268:61]
  wire [3:0] _checkPointCntReg_T_1 = checkPointCntReg + 4'h1; // @[src/main/scala/PlayerController.scala 271:46]
  wire [3:0] _GEN_690 = _T_46 ? _checkPointCntReg_T_1 : checkPointCntReg; // @[src/main/scala/PlayerController.scala 269:62 271:26 55:33]
  wire  _T_50 = checkPointCntReg == 4'h3; // @[src/main/scala/PlayerController.scala 273:105]
  wire [3:0] _lapCntReg_T_1 = lapCntReg + 4'h1; // @[src/main/scala/PlayerController.scala 274:32]
  wire [3:0] _GEN_691 = (tilemapRomTileAddrReg == 11'hb1 | tilemapRomTileAddrReg == 11'hd9) & checkPointCntReg == 4'h3
     ? _lapCntReg_T_1 : lapCntReg; // @[src/main/scala/PlayerController.scala 273:113 274:19 56:26]
  wire [3:0] _GEN_692 = (tilemapRomTileAddrReg == 11'hb1 | tilemapRomTileAddrReg == 11'hd9) & checkPointCntReg == 4'h3
     ? 4'h0 : _GEN_690; // @[src/main/scala/PlayerController.scala 273:113 275:26]
  wire [31:0] _GEN_693 = checkPointCntReg == 4'h0 ? $signed(32'sh2400000) : $signed(playerXPositionReg); // @[src/main/scala/PlayerController.scala 283:39 284:30 69:35]
  wire [31:0] _GEN_694 = checkPointCntReg == 4'h0 ? $signed(32'sha00000) : $signed(playerYPositionReg); // @[src/main/scala/PlayerController.scala 283:39 285:30 70:35]
  wire [31:0] _GEN_695 = checkPointCntReg == 4'h0 ? $signed(32'sh0) : $signed(sprite0SpeedReg); // @[src/main/scala/PlayerController.scala 283:39 286:27 71:32]
  wire [7:0] _GEN_696 = checkPointCntReg == 4'h0 ? 8'h80 : sprite0AngleReg; // @[src/main/scala/PlayerController.scala 283:39 287:27 72:32]
  wire [15:0] _playerXPositionReg_T_7 = addressToPosition_io_posX - 16'h10; // @[src/main/scala/PlayerController.scala 290:62]
  wire [31:0] _playerXPositionReg_T_9 = {_playerXPositionReg_T_7, 16'h0}; // @[src/main/scala/PlayerController.scala 290:77]
  wire [15:0] _playerYPositionReg_T_7 = addressToPosition_io_posY - 16'h10; // @[src/main/scala/PlayerController.scala 291:62]
  wire [31:0] _playerYPositionReg_T_9 = {_playerYPositionReg_T_7, 16'h0}; // @[src/main/scala/PlayerController.scala 291:77]
  wire [31:0] _GEN_697 = checkPointCntReg == 4'h1 ? $signed(_playerXPositionReg_T_9) : $signed(_GEN_693); // @[src/main/scala/PlayerController.scala 289:39 290:30]
  wire [31:0] _GEN_698 = checkPointCntReg == 4'h1 ? $signed(_playerYPositionReg_T_9) : $signed(_GEN_694); // @[src/main/scala/PlayerController.scala 289:39 291:30]
  wire [31:0] _GEN_699 = checkPointCntReg == 4'h1 ? $signed(32'sh0) : $signed(_GEN_695); // @[src/main/scala/PlayerController.scala 289:39 292:27]
  wire [7:0] _GEN_700 = checkPointCntReg == 4'h1 ? 8'h40 : _GEN_696; // @[src/main/scala/PlayerController.scala 289:39 293:27]
  wire [31:0] _GEN_701 = checkPointCntReg == 4'h2 ? $signed(_playerXPositionReg_T_9) : $signed(_GEN_697); // @[src/main/scala/PlayerController.scala 295:39 296:30]
  wire [31:0] _GEN_702 = checkPointCntReg == 4'h2 ? $signed(_playerYPositionReg_T_9) : $signed(_GEN_698); // @[src/main/scala/PlayerController.scala 295:39 297:30]
  wire [31:0] _GEN_703 = checkPointCntReg == 4'h2 ? $signed(32'sh0) : $signed(_GEN_699); // @[src/main/scala/PlayerController.scala 295:39 298:27]
  wire [7:0] _GEN_704 = checkPointCntReg == 4'h2 ? 8'h0 : _GEN_700; // @[src/main/scala/PlayerController.scala 295:39 299:27]
  wire [31:0] _GEN_705 = _T_50 ? $signed(_playerXPositionReg_T_9) : $signed(_GEN_701); // @[src/main/scala/PlayerController.scala 301:39 302:30]
  wire [31:0] _GEN_706 = _T_50 ? $signed(_playerYPositionReg_T_9) : $signed(_GEN_702); // @[src/main/scala/PlayerController.scala 301:39 303:30]
  wire [31:0] _GEN_707 = _T_50 ? $signed(32'sh0) : $signed(_GEN_703); // @[src/main/scala/PlayerController.scala 301:39 304:27]
  wire [7:0] _GEN_708 = _T_50 ? 8'hc0 : _GEN_704; // @[src/main/scala/PlayerController.scala 301:39 305:27]
  wire [31:0] _GEN_709 = io_tilemapRomCollisionData ? $signed(_GEN_705) : $signed(playerXPositionReg); // @[src/main/scala/PlayerController.scala 282:40 69:35]
  wire [31:0] _GEN_710 = io_tilemapRomCollisionData ? $signed(_GEN_706) : $signed(playerYPositionReg); // @[src/main/scala/PlayerController.scala 282:40 70:35]
  wire [31:0] _GEN_711 = io_tilemapRomCollisionData ? $signed(_GEN_707) : $signed(sprite0SpeedReg); // @[src/main/scala/PlayerController.scala 282:40 71:32]
  wire [7:0] _GEN_712 = io_tilemapRomCollisionData ? _GEN_708 : sprite0AngleReg; // @[src/main/scala/PlayerController.scala 282:40 72:32]
  wire [2:0] _GEN_714 = 3'h5 == stateReg ? 3'h0 : stateReg; // @[src/main/scala/PlayerController.scala 132:20 314:16 66:25]
  wire [31:0] _GEN_715 = 3'h4 == stateReg ? $signed(_GEN_709) : $signed(playerXPositionReg); // @[src/main/scala/PlayerController.scala 132:20 69:35]
  wire [31:0] _GEN_716 = 3'h4 == stateReg ? $signed(_GEN_710) : $signed(playerYPositionReg); // @[src/main/scala/PlayerController.scala 132:20 70:35]
  wire [31:0] _GEN_717 = 3'h4 == stateReg ? $signed(_GEN_711) : $signed(sprite0SpeedReg); // @[src/main/scala/PlayerController.scala 132:20 71:32]
  wire [7:0] _GEN_718 = 3'h4 == stateReg ? _GEN_712 : sprite0AngleReg; // @[src/main/scala/PlayerController.scala 132:20 72:32]
  wire [2:0] _GEN_719 = 3'h4 == stateReg ? 3'h5 : _GEN_714; // @[src/main/scala/PlayerController.scala 132:20 309:16]
  wire [3:0] _GEN_721 = 3'h3 == stateReg ? _GEN_692 : checkPointCntReg; // @[src/main/scala/PlayerController.scala 132:20 55:33]
  wire [3:0] _GEN_722 = 3'h3 == stateReg ? _GEN_691 : lapCntReg; // @[src/main/scala/PlayerController.scala 132:20 56:26]
  wire [2:0] _GEN_723 = 3'h3 == stateReg ? 3'h4 : _GEN_719; // @[src/main/scala/PlayerController.scala 132:20 277:16]
  wire [31:0] _GEN_724 = 3'h3 == stateReg ? $signed(playerXPositionReg) : $signed(_GEN_715); // @[src/main/scala/PlayerController.scala 132:20 69:35]
  wire [31:0] _GEN_725 = 3'h3 == stateReg ? $signed(playerYPositionReg) : $signed(_GEN_716); // @[src/main/scala/PlayerController.scala 132:20 70:35]
  wire [31:0] _GEN_726 = 3'h3 == stateReg ? $signed(sprite0SpeedReg) : $signed(_GEN_717); // @[src/main/scala/PlayerController.scala 132:20 71:32]
  wire [7:0] _GEN_727 = 3'h3 == stateReg ? sprite0AngleReg : _GEN_718; // @[src/main/scala/PlayerController.scala 132:20 72:32]
  wire [39:0] _GEN_729 = 3'h2 == stateReg ? $signed(_playerXPositionReg_T_4) : $signed({{8{_GEN_724[31]}},_GEN_724}); // @[src/main/scala/PlayerController.scala 132:20 254:26]
  wire [39:0] _GEN_730 = 3'h2 == stateReg ? $signed(_playerYPositionReg_T_4) : $signed({{8{_GEN_725[31]}},_GEN_725}); // @[src/main/scala/PlayerController.scala 132:20 255:26]
  wire  _GEN_740 = 3'h1 == stateReg ? _GEN_86 : sprite0Visible; // @[src/main/scala/PlayerController.scala 132:20 97:31]
  wire [39:0] _GEN_751 = 3'h1 == stateReg ? $signed({{8{playerXPositionReg[31]}},playerXPositionReg}) : $signed(_GEN_729
    ); // @[src/main/scala/PlayerController.scala 132:20 69:35]
  wire [39:0] _GEN_752 = 3'h1 == stateReg ? $signed({{8{playerYPositionReg[31]}},playerYPositionReg}) : $signed(_GEN_730
    ); // @[src/main/scala/PlayerController.scala 132:20 70:35]
  wire [39:0] _GEN_758 = 3'h0 == stateReg ? $signed({{8{_GEN_23[31]}},_GEN_23}) : $signed(_GEN_751); // @[src/main/scala/PlayerController.scala 132:20]
  wire [39:0] _GEN_759 = 3'h0 == stateReg ? $signed({{8{_GEN_24[31]}},_GEN_24}) : $signed(_GEN_752); // @[src/main/scala/PlayerController.scala 132:20]
  wire  _GEN_764 = 3'h0 == stateReg ? sprite0Visible : _GEN_740; // @[src/main/scala/PlayerController.scala 132:20 97:31]
  wire [39:0] _GEN_938 = reset ? $signed(40'sh2400000) : $signed(_GEN_758); // @[src/main/scala/PlayerController.scala 69:{35,35}]
  wire [39:0] _GEN_940 = reset ? $signed(40'sha00000) : $signed(_GEN_759); // @[src/main/scala/PlayerController.scala 70:{35,35}]
  ...
  always @(posedge clock) begin
    if (reset) begin // @[src/main/scala/PlayerController.scala 55:33]
      ...
      if (!(io_enable)) begin // @[src/main/scala/PlayerController.scala 134:22]
        checkPointCntReg <= 4'h0; // @[src/main/scala/PlayerController.scala 145:26]
      end
    ...
    if (reset) begin // @[src/main/scala/PlayerController.scala 56:26]
      ...
      if (!(io_enable)) begin // @[src/main/scala/PlayerController.scala 134:22]
        lapCntReg <= 4'h1; // @[src/main/scala/PlayerController.scala 144:19]
      end
    end else if (!(3'h1 == stateReg)) begin // @[src/main/scala/PlayerController.scala 132:20]
      if (!(3'h2 == stateReg)) begin // @[src/main/scala/PlayerController.scala 132:20]
        lapCntReg <= _GEN_722;
    ...
    if (reset) begin // @[src/main/scala/PlayerController.scala 66:25]
      ...
      stateReg <= 3'h2; // @[src/main/scala/PlayerController.scala 249:16]
    end else if (3'h2 == stateReg) begin // @[src/main/scala/PlayerController.scala 132:20]
      stateReg <= 3'h3; // @[src/main/scala/PlayerController.scala 259:16]
    end else begin
      stateReg <= _GEN_723;
    end
    playerXPositionReg <= _GEN_938[31:0]; // @[src/main/scala/PlayerController.scala 69:{35,35}]
    playerYPositionReg <= _GEN_940[31:0]; // @[src/main/scala/PlayerController.scala 70:{35,35}]
    if (reset) begin // @[src/main/scala/PlayerController.scala 71:32]
      ...
      if (!(io_enable)) begin // @[src/main/scala/PlayerController.scala 134:22]
        sprite0SpeedReg <= 32'sh0; // @[src/main/scala/PlayerController.scala 141:25]
      end
    end else if (3'h1 == stateReg) begin // @[src/main/scala/PlayerController.scala 132:20]
      if (io_btnD) begin // @[src/main/scala/PlayerController.scala 150:20]
        sprite0SpeedReg <= _GEN_29;
      end else begin
        sprite0SpeedReg <= _GEN_33;
      end
    end else if (!(3'h2 == stateReg)) begin // @[src/main/scala/PlayerController.scala 132:20]
      sprite0SpeedReg <= _GEN_726;
    end
    if (reset) begin // @[src/main/scala/PlayerController.scala 72:32]
      ...
      if (!(io_enable)) begin // @[src/main/scala/PlayerController.scala 134:22]
        sprite0AngleReg <= 8'h80; // @[src/main/scala/PlayerController.scala 142:25]
      end
    end else if (3'h1 == stateReg) begin // @[src/main/scala/PlayerController.scala 132:20]
      if (io_btnR) begin // @[src/main/scala/PlayerController.scala 168:21]
        sprite0AngleReg <= _sprite0AngleReg_T_1; // @[src/main/scala/PlayerController.scala 169:25]
      end else begin
        sprite0AngleReg <= _GEN_35;
      end
    end else if (!(3'h2 == stateReg)) begin // @[src/main/scala/PlayerController.scala 132:20]
      sprite0AngleReg <= _GEN_727;
    end
    if (reset) begin // @[src/main/scala/PlayerController.scala 74:23]
      ...
      if (3'h1 == stateReg) begin // @[src/main/scala/PlayerController.scala 132:20]
        if (8'hff == sprite0AngleReg) begin // @[src/main/scala/PlayerController.scala 246:14]
          cosReg <= 16'shff; // @[src/main/scala/PlayerController.scala 246:14]
        end else begin
          cosReg <= _GEN_348;
        end
      end
    ...
    if (reset) begin // @[src/main/scala/PlayerController.scala 75:23]
      ...
      if (3'h1 == stateReg) begin // @[src/main/scala/PlayerController.scala 132:20]
        if (8'hff == sprite0AngleReg) begin // @[src/main/scala/PlayerController.scala 247:14]
          sinReg <= -16'sh6; // @[src/main/scala/PlayerController.scala 247:14]
        end else begin
          sinReg <= _GEN_604;
        end
      end
    ...
    if (reset) begin // @[src/main/scala/PlayerController.scala 89:41]
      ...
      if (3'h1 == stateReg) begin // @[src/main/scala/PlayerController.scala 132:20]
        if (sprite0AngleReg >= 8'h71 & sprite0AngleReg <= 8'h90) begin // @[src/main/scala/PlayerController.scala 176:66]
          sprite0FlipHorizontalReg <= 1'h0; // @[src/main/scala/PlayerController.scala 181:36]
        end else begin
          sprite0FlipHorizontalReg <= _GEN_84;
        end
      end
    end
    if (reset) begin // @[src/main/scala/PlayerController.scala 92:41]
      ...
      if (3'h1 == stateReg) begin // @[src/main/scala/PlayerController.scala 132:20]
        if (!(sprite0AngleReg >= 8'h71 & sprite0AngleReg <= 8'h90)) begin // @[src/main/scala/PlayerController.scala 176:66]
          sprite1FlipHorizontalReg <= _GEN_81;
        end
      end
    end
    if (reset) begin // @[src/main/scala/PlayerController.scala 93:39]
      ...
      if (3'h1 == stateReg) begin // @[src/main/scala/PlayerController.scala 132:20]
        if (!(sprite0AngleReg >= 8'h71 & sprite0AngleReg <= 8'h90)) begin // @[src/main/scala/PlayerController.scala 176:66]
          sprite1FlipVerticalReg <= _GEN_82;
        end
      end
    end
    if (reset) begin // @[src/main/scala/PlayerController.scala 95:39]
      ...
      if (3'h1 == stateReg) begin // @[src/main/scala/PlayerController.scala 132:20]
        if (!(sprite0AngleReg >= 8'h71 & sprite0AngleReg <= 8'h90)) begin // @[src/main/scala/PlayerController.scala 176:66]
          sprite2FlipVerticalReg <= _GEN_83;
        end
      end
    end
    sprite0Visible <= reset | _GEN_764; // @[src/main/scala/PlayerController.scala 97:{31,31}]
    if (reset) begin // @[src/main/scala/PlayerController.scala 98:31]
      ...
      if (3'h1 == stateReg) begin // @[src/main/scala/PlayerController.scala 132:20]
        if (sprite0AngleReg >= 8'h71 & sprite0AngleReg <= 8'h90) begin // @[src/main/scala/PlayerController.scala 176:66]
          sprite1Visible <= 1'h0; // @[src/main/scala/PlayerController.scala 178:26]
        end else begin
          sprite1Visible <= _GEN_79;
        end
      end
    end
    if (reset) begin // @[src/main/scala/PlayerController.scala 99:31]
      ...
      if (3'h1 == stateReg) begin // @[src/main/scala/PlayerController.scala 132:20]
        if (sprite0AngleReg >= 8'h71 & sprite0AngleReg <= 8'h90) begin // @[src/main/scala/PlayerController.scala 176:66]
          sprite2Visible <= 1'h0; // @[src/main/scala/PlayerController.scala 179:26]
        end else begin
          sprite2Visible <= _GEN_80;
        end
      end
    end
    if (reset) begin // @[src/main/scala/PlayerController.scala 105:38]
      ...
      if (!(3'h1 == stateReg)) begin // @[src/main/scala/PlayerController.scala 132:20]
        if (3'h2 == stateReg) begin // @[src/main/scala/PlayerController.scala 132:20]
          tilemapRomTileAddrReg <= posToAddress_io_address; // @[src/main/scala/PlayerController.scala 257:29]
        end
      end
    end
  end
...
module BCDCounter(
  ...
  input        io_reset // @[src/main/scala/BCDCounter.scala 5:16]
);
`ifdef RANDOMIZE_REG_INIT
  reg [31:0] _RAND_0;
  reg [31:0] _RAND_1;
  ...
  reg [31:0] _RAND_4;
`endif // RANDOMIZE_REG_INIT
  reg [7:0] digits_0; // @[src/main/scala/BCDCounter.scala 11:25]
  reg [7:0] digits_1; // @[src/main/scala/BCDCounter.scala 11:25]
  reg [7:0] digits_2; // @[src/main/scala/BCDCounter.scala 11:25]
  reg [7:0] digits_3; // @[src/main/scala/BCDCounter.scala 11:25]
  reg [7:0] digits_4; // @[src/main/scala/BCDCounter.scala 11:25]
  wire [7:0] _GEN_1 = io_reset ? 8'h0 : digits_1; // @[src/main/scala/BCDCounter.scala 12:20 13:16 11:25]
  wire [7:0] _GEN_2 = io_reset ? 8'h0 : digits_2; // @[src/main/scala/BCDCounter.scala 12:20 13:16 11:25]
  wire [7:0] _GEN_3 = io_reset ? 8'h0 : digits_3; // @[src/main/scala/BCDCounter.scala 12:20 13:16 11:25]
  wire [7:0] _GEN_4 = io_reset ? 8'h0 : digits_4; // @[src/main/scala/BCDCounter.scala 12:20 13:16 11:25]
  wire [7:0] _digits_4_T_1 = digits_4 + 8'h1; // @[src/main/scala/BCDCounter.scala 28:52]
  wire [7:0] _GEN_5 = digits_4 == 8'h9 ? 8'h0 : _digits_4_T_1; // @[src/main/scala/BCDCounter.scala 25:49 26:39 28:39]
  wire [7:0] _digits_3_T_1 = digits_3 + 8'h1; // @[src/main/scala/BCDCounter.scala 31:48]
  wire [7:0] _GEN_6 = digits_3 == 8'h9 ? 8'h0 : _digits_3_T_1; // @[src/main/scala/BCDCounter.scala 23:45 24:35 31:35]
  wire [7:0] _GEN_7 = digits_3 == 8'h9 ? _GEN_5 : _GEN_4; // @[src/main/scala/BCDCounter.scala 23:45]
  wire [7:0] _digits_2_T_1 = digits_2 + 8'h1; // @[src/main/scala/BCDCounter.scala 34:44]
  wire [7:0] _GEN_8 = digits_2 == 8'h9 ? 8'h0 : _digits_2_T_1; // @[src/main/scala/BCDCounter.scala 21:41 22:31 34:31]
  wire [7:0] _GEN_9 = digits_2 == 8'h9 ? _GEN_6 : _GEN_3; // @[src/main/scala/BCDCounter.scala 21:41]
  wire [7:0] _GEN_10 = digits_2 == 8'h9 ? _GEN_7 : _GEN_4; // @[src/main/scala/BCDCounter.scala 21:41]
  wire [7:0] _digits_1_T_1 = digits_1 + 8'h1; // @[src/main/scala/BCDCounter.scala 37:40]
  wire [7:0] _digits_0_T_1 = digits_0 + 8'h1; // @[src/main/scala/BCDCounter.scala 40:36]
  assign io_data_0 = digits_1; // @[src/main/scala/BCDCounter.scala 44:16]
  assign io_data_1 = digits_2; // @[src/main/scala/BCDCounter.scala 45:16]
  assign io_data_2 = digits_3; // @[src/main/scala/BCDCounter.scala 46:16]
  assign io_data_3 = digits_4; // @[src/main/scala/BCDCounter.scala 47:16]
  always @(posedge clock) begin
    if (reset) begin // @[src/main/scala/BCDCounter.scala 11:25]
      digits_0 <= 8'h0; // @[src/main/scala/BCDCounter.scala 11:25]
    end else if (io_inc) begin // @[src/main/scala/BCDCounter.scala 16:18]
      if (digits_0 == 8'h3c) begin // @[src/main/scala/BCDCounter.scala 17:34]
        digits_0 <= 8'h0; // @[src/main/scala/BCDCounter.scala 18:23]
      end else begin
        digits_0 <= _digits_0_T_1; // @[src/main/scala/BCDCounter.scala 40:23]
      end
    end else if (io_reset) begin // @[src/main/scala/BCDCounter.scala 12:20]
      digits_0 <= 8'h0; // @[src/main/scala/BCDCounter.scala 13:16]
    end
    if (reset) begin // @[src/main/scala/BCDCounter.scala 11:25]
      digits_1 <= 8'h0; // @[src/main/scala/BCDCounter.scala 11:25]
    end else if (io_inc) begin // @[src/main/scala/BCDCounter.scala 16:18]
      if (digits_0 == 8'h3c) begin // @[src/main/scala/BCDCounter.scala 17:34]
        if (digits_1 == 8'h9) begin // @[src/main/scala/BCDCounter.scala 19:37]
          digits_1 <= 8'h0; // @[src/main/scala/BCDCounter.scala 20:27]
        end else begin
          digits_1 <= _digits_1_T_1; // @[src/main/scala/BCDCounter.scala 37:27]
        end
      end else begin
        digits_1 <= _GEN_1;
      end
    ...
    if (reset) begin // @[src/main/scala/BCDCounter.scala 11:25]
      digits_2 <= 8'h0; // @[src/main/scala/BCDCounter.scala 11:25]
    end else if (io_inc) begin // @[src/main/scala/BCDCounter.scala 16:18]
      if (digits_0 == 8'h3c) begin // @[src/main/scala/BCDCounter.scala 17:34]
        if (digits_1 == 8'h9) begin // @[src/main/scala/BCDCounter.scala 19:37]
          digits_2 <= _GEN_8;
    ...
    if (reset) begin // @[src/main/scala/BCDCounter.scala 11:25]
      digits_3 <= 8'h0; // @[src/main/scala/BCDCounter.scala 11:25]
    end else if (io_inc) begin // @[src/main/scala/BCDCounter.scala 16:18]
      if (digits_0 == 8'h3c) begin // @[src/main/scala/BCDCounter.scala 17:34]
        if (digits_1 == 8'h9) begin // @[src/main/scala/BCDCounter.scala 19:37]
          digits_3 <= _GEN_9;
    ...
    if (reset) begin // @[src/main/scala/BCDCounter.scala 11:25]
      digits_4 <= 8'h0; // @[src/main/scala/BCDCounter.scala 11:25]
    end else if (io_inc) begin // @[src/main/scala/BCDCounter.scala 16:18]
      if (digits_0 == 8'h3c) begin // @[src/main/scala/BCDCounter.scala 17:34]
        if (digits_1 == 8'h9) begin // @[src/main/scala/BCDCounter.scala 19:37]
          digits_4 <= _GEN_10;
...
module RaceManager(
  ...
  output [7:0]  io_time_0, // @[src/main/scala/RaceManager.scala 5:14]
  output [7:0]  io_time_1, // @[src/main/scala/RaceManager.scala 5:14]
  output [7:0]  io_time_2, // @[src/main/scala/RaceManager.scala 5:14]
  output [7:0]  io_time_3, // @[src/main/scala/RaceManager.scala 5:14]
...
`ifdef RANDOMIZE_REG_INIT
  ...
  reg [31:0] _RAND_11;
`endif // RANDOMIZE_REG_INIT
  wire  playerController_clock; // @[src/main/scala/RaceManager.scala 85:32]
  wire  playerController_reset; // @[src/main/scala/RaceManager.scala 85:32]
  wire [10:0] playerController_io_tilemapRomTileAddress; // @[src/main/scala/RaceManager.scala 85:32]
  wire  playerController_io_tilemapRomCollisionData; // @[src/main/scala/RaceManager.scala 85:32]
  wire  playerController_io_btnU; // @[src/main/scala/RaceManager.scala 85:32]
  wire  playerController_io_btnL; // @[src/main/scala/RaceManager.scala 85:32]
  wire  playerController_io_btnR; // @[src/main/scala/RaceManager.scala 85:32]
  wire  playerController_io_btnD; // @[src/main/scala/RaceManager.scala 85:32]
  wire [10:0] playerController_io_playerXPosition; // @[src/main/scala/RaceManager.scala 85:32]
  wire [9:0] playerController_io_playerYPosition; // @[src/main/scala/RaceManager.scala 85:32]
  wire  playerController_io_spriteVisible_0; // @[src/main/scala/RaceManager.scala 85:32]
  wire  playerController_io_spriteVisible_1; // @[src/main/scala/RaceManager.scala 85:32]
  wire  playerController_io_spriteVisible_2; // @[src/main/scala/RaceManager.scala 85:32]
  wire  playerController_io_spriteFlipHorizontal_0; // @[src/main/scala/RaceManager.scala 85:32]
  wire  playerController_io_spriteFlipHorizontal_1; // @[src/main/scala/RaceManager.scala 85:32]
  wire  playerController_io_spriteFlipVertical_1; // @[src/main/scala/RaceManager.scala 85:32]
  wire  playerController_io_spriteFlipVertical_2; // @[src/main/scala/RaceManager.scala 85:32]
  wire  playerController_io_newFrame; // @[src/main/scala/RaceManager.scala 85:32]
  wire [3:0] playerController_io_lapCnt; // @[src/main/scala/RaceManager.scala 85:32]
  wire  playerController_io_enable; // @[src/main/scala/RaceManager.scala 85:32]
  wire [3:0] playerController_io_raceMapIndex; // @[src/main/scala/RaceManager.scala 85:32]
  wire  bcdCounter_clock; // @[src/main/scala/RaceManager.scala 115:26]
  wire  bcdCounter_reset; // @[src/main/scala/RaceManager.scala 115:26]
  wire  bcdCounter_io_inc; // @[src/main/scala/RaceManager.scala 115:26]
  wire [7:0] bcdCounter_io_data_0; // @[src/main/scala/RaceManager.scala 115:26]
  wire [7:0] bcdCounter_io_data_1; // @[src/main/scala/RaceManager.scala 115:26]
  wire [7:0] bcdCounter_io_data_2; // @[src/main/scala/RaceManager.scala 115:26]
  wire [7:0] bcdCounter_io_data_3; // @[src/main/scala/RaceManager.scala 115:26]
  wire  bcdCounter_io_reset; // @[src/main/scala/RaceManager.scala 115:26]
  wire  raceScoreboardPrinter_clock; // @[src/main/scala/RaceManager.scala 121:37]
  wire  raceScoreboardPrinter_reset; // @[src/main/scala/RaceManager.scala 121:37]
  wire  raceScoreboardPrinter_io_load; // @[src/main/scala/RaceManager.scala 121:37]
  wire  raceScoreboardPrinter_io_done; // @[src/main/scala/RaceManager.scala 121:37]
  wire [7:0] raceScoreboardPrinter_io_time_0; // @[src/main/scala/RaceManager.scala 121:37]
  wire [7:0] raceScoreboardPrinter_io_time_1; // @[src/main/scala/RaceManager.scala 121:37]
  wire [7:0] raceScoreboardPrinter_io_time_2; // @[src/main/scala/RaceManager.scala 121:37]
  wire [7:0] raceScoreboardPrinter_io_time_3; // @[src/main/scala/RaceManager.scala 121:37]
  wire [3:0] raceScoreboardPrinter_io_screen; // @[src/main/scala/RaceManager.scala 121:37]
  wire [5:0] raceScoreboardPrinter_io_backBufferWriteData; // @[src/main/scala/RaceManager.scala 121:37]
  wire [10:0] raceScoreboardPrinter_io_backBufferWriteAddress; // @[src/main/scala/RaceManager.scala 121:37]
  wire  raceScoreboardPrinter_io_backBufferWriteEnable; // @[src/main/scala/RaceManager.scala 121:37]
  wire [3:0] raceScoreboardPrinter_io_lapCnt; // @[src/main/scala/RaceManager.scala 121:37]
  reg [9:0] viewBoxXReg; // @[src/main/scala/RaceManager.scala 63:28]
  reg [8:0] viewBoxYReg; // @[src/main/scala/RaceManager.scala 64:28]
  reg [5:0] backBufferWriteDataReg; // @[src/main/scala/RaceManager.scala 69:39]
  reg [10:0] backBufferWriteAddressReg; // @[src/main/scala/RaceManager.scala 70:42]
  reg  backBufferWriteEnableReg; // @[src/main/scala/RaceManager.scala 71:41]
  reg  raceStarted; // @[src/main/scala/RaceManager.scala 80:28]
  reg  raceFinished; // @[src/main/scala/RaceManager.scala 81:29]
  reg [10:0] playerScreenXPosition; // @[src/main/scala/RaceManager.scala 101:34]
  reg [9:0] playerScreenYPosition; // @[src/main/scala/RaceManager.scala 102:34]
  wire [10:0] _GEN_23 = {{1'd0}, viewBoxXReg}; // @[src/main/scala/RaceManager.scala 103:65]
  wire [9:0] _GEN_33 = {{1'd0}, viewBoxYReg}; // @[src/main/scala/RaceManager.scala 104:65]
  reg [15:0] screenAnimationCounter; // @[src/main/scala/RaceManager.scala 116:39]
  reg [2:0] scoreboardScreen; // @[src/main/scala/RaceManager.scala 117:33]
  reg [1:0] raceManagerStateReg; // @[src/main/scala/RaceManager.scala 128:36]
  wire  _GEN_2 = io_enable & raceStarted; // @[src/main/scala/RaceManager.scala 133:24 138:23 80:28]
  wire  _GEN_3 = io_enable & raceFinished; // @[src/main/scala/RaceManager.scala 133:24 139:24 81:29]
  wire  _GEN_4 = io_enable ? 1'h0 : 1'h1; // @[src/main/scala/RaceManager.scala 119:23 133:24 140:31]
  wire [10:0] tempViewBoxX = playerController_io_playerXPosition + 11'h10; // @[src/main/scala/RaceManager.scala 149:63]
  wire [9:0] tempViewBoxY = playerController_io_playerYPosition + 10'h10; // @[src/main/scala/RaceManager.scala 150:63]
  wire [10:0] _viewBoxXReg_T_1 = tempViewBoxX - 11'h140; // @[src/main/scala/RaceManager.scala 152:35]
  wire [9:0] _viewBoxYReg_T_1 = tempViewBoxY - 10'hf0; // @[src/main/scala/RaceManager.scala 153:35]
  wire [10:0] _GEN_7 = tempViewBoxX < 11'h140 ? 11'h0 : _viewBoxXReg_T_1; // @[src/main/scala/RaceManager.scala 152:19 155:34 156:21]
  wire [9:0] _GEN_8 = tempViewBoxY < 10'hf0 ? 10'h0 : _viewBoxYReg_T_1; // @[src/main/scala/RaceManager.scala 153:19 159:34 160:21]
  wire [10:0] _GEN_9 = tempViewBoxX > 11'h3c0 ? 11'h280 : _GEN_7; // @[src/main/scala/RaceManager.scala 163:42 164:21]
  wire [9:0] _GEN_10 = tempViewBoxY > 10'h2d0 ? 10'h1e0 : _GEN_8; // @[src/main/scala/RaceManager.scala 167:42 168:21]
  wire  _T_6 = screenAnimationCounter < 16'h190; // @[src/main/scala/RaceManager.scala 171:35]
  wire [15:0] _screenAnimationCounter_T_1 = screenAnimationCounter + 16'h1; // @[src/main/scala/RaceManager.scala 172:58]
  wire [2:0] _GEN_12 = _T_6 ? 3'h3 : 3'h4; // @[src/main/scala/RaceManager.scala 185:50 186:26 188:26]
  wire  _GEN_13 = _T_6 ? raceStarted : 1'h1; // @[src/main/scala/RaceManager.scala 185:50 189:21 80:28]
  wire [2:0] _GEN_14 = screenAnimationCounter < 16'h12c ? 3'h2 : _GEN_12; // @[src/main/scala/RaceManager.scala 183:50 184:26]
  wire  _GEN_15 = screenAnimationCounter < 16'h12c ? raceStarted : _GEN_13; // @[src/main/scala/RaceManager.scala 183:50 80:28]
  wire [2:0] _GEN_16 = screenAnimationCounter < 16'hc8 ? 3'h1 : _GEN_14; // @[src/main/scala/RaceManager.scala 181:50 182:26]
  wire  _GEN_17 = screenAnimationCounter < 16'hc8 ? raceStarted : _GEN_15; // @[src/main/scala/RaceManager.scala 181:50 80:28]
  wire [2:0] _GEN_18 = screenAnimationCounter < 16'h64 ? 3'h0 : _GEN_16; // @[src/main/scala/RaceManager.scala 179:44 180:26]
  wire  _GEN_19 = screenAnimationCounter < 16'h64 ? raceStarted : _GEN_17; // @[src/main/scala/RaceManager.scala 179:44 80:28]
  wire [1:0] _GEN_20 = raceScoreboardPrinter_io_done ? 2'h3 : raceManagerStateReg; // @[src/main/scala/RaceManager.scala 197:43 198:29 128:36]
  wire  _GEN_21 = playerController_io_lapCnt == 4'h4 | raceFinished; // @[src/main/scala/RaceManager.scala 201:48 202:22 81:29]
  wire  _GEN_22 = playerController_io_lapCnt == 4'h4 ? 1'h0 : _GEN_19; // @[src/main/scala/RaceManager.scala 201:48 203:21]
  wire [1:0] _GEN_24 = 2'h3 == raceManagerStateReg ? 2'h0 : raceManagerStateReg; // @[src/main/scala/RaceManager.scala 131:31 209:29 128:36]
  wire  _GEN_34 = 2'h1 == raceManagerStateReg & raceStarted; // @[src/main/scala/RaceManager.scala 118:21 131:31 147:25]
  wire [10:0] _GEN_35 = 2'h1 == raceManagerStateReg ? _GEN_9 : {{1'd0}, viewBoxXReg}; // @[src/main/scala/RaceManager.scala 131:31 63:28]
  wire [9:0] _GEN_36 = 2'h1 == raceManagerStateReg ? _GEN_10 : {{1'd0}, viewBoxYReg}; // @[src/main/scala/RaceManager.scala 131:31 64:28]
  wire  _GEN_41 = 2'h1 == raceManagerStateReg ? 1'h0 : 2'h2 == raceManagerStateReg; // @[src/main/scala/RaceManager.scala 131:31 123:33]
  wire [10:0] _GEN_54 = 2'h0 == raceManagerStateReg ? {{1'd0}, viewBoxXReg} : _GEN_35; // @[src/main/scala/RaceManager.scala 131:31 63:28]
  wire [9:0] _GEN_55 = 2'h0 == raceManagerStateReg ? {{1'd0}, viewBoxYReg} : _GEN_36; // @[src/main/scala/RaceManager.scala 131:31 64:28]
  wire [10:0] _GEN_46 = reset ? 11'h0 : _GEN_54; // @[src/main/scala/RaceManager.scala 63:{28,28}]
  wire [9:0] _GEN_60 = reset ? 10'h0 : _GEN_55; // @[src/main/scala/RaceManager.scala 64:{28,28}]
  PlayerController playerController ( // @[src/main/scala/RaceManager.scala 85:32]
  ...
  BCDCounter bcdCounter ( // @[src/main/scala/RaceManager.scala 115:26]
    .clock(bcdCounter_clock),
    .reset(bcdCounter_reset),
    .io_inc(bcdCounter_io_inc),
    .io_data_0(bcdCounter_io_data_0),
    .io_data_1(bcdCounter_io_data_1),
    .io_data_2(bcdCounter_io_data_2),
    .io_data_3(bcdCounter_io_data_3),
    .io_reset(bcdCounter_io_reset)
  );
  RaceScoreboardPrinter raceScoreboardPrinter ( // @[src/main/scala/RaceManager.scala 121:37]
  ...
  assign io_spriteXPosition_0 = playerScreenXPosition; // @[src/main/scala/RaceManager.scala 108:32]
  assign io_spriteXPosition_1 = playerScreenXPosition; // @[src/main/scala/RaceManager.scala 108:32]
  assign io_spriteXPosition_2 = playerScreenXPosition; // @[src/main/scala/RaceManager.scala 108:32]
  assign io_spriteYPosition_0 = playerScreenYPosition; // @[src/main/scala/RaceManager.scala 109:32]
  assign io_spriteYPosition_1 = playerScreenYPosition; // @[src/main/scala/RaceManager.scala 109:32]
  assign io_spriteYPosition_2 = playerScreenYPosition; // @[src/main/scala/RaceManager.scala 109:32]
  assign io_spriteVisible_0 = playerController_io_spriteVisible_0; // @[src/main/scala/RaceManager.scala 107:32]
  assign io_spriteVisible_1 = playerController_io_spriteVisible_1; // @[src/main/scala/RaceManager.scala 107:32]
  assign io_spriteVisible_2 = playerController_io_spriteVisible_2; // @[src/main/scala/RaceManager.scala 107:32]
  assign io_spriteFlipHorizontal_0 = playerController_io_spriteFlipHorizontal_0; // @[src/main/scala/RaceManager.scala 110:32]
  assign io_spriteFlipHorizontal_1 = playerController_io_spriteFlipHorizontal_1; // @[src/main/scala/RaceManager.scala 110:32]
  assign io_spriteFlipVertical_1 = playerController_io_spriteFlipVertical_1; // @[src/main/scala/RaceManager.scala 111:32]
  assign io_spriteFlipVertical_2 = playerController_io_spriteFlipVertical_2; // @[src/main/scala/RaceManager.scala 111:32]
  assign io_viewBoxX = viewBoxXReg; // @[src/main/scala/RaceManager.scala 65:15]
  assign io_viewBoxY = viewBoxYReg; // @[src/main/scala/RaceManager.scala 66:15]
  assign io_backBufferWriteData = backBufferWriteDataReg; // @[src/main/scala/RaceManager.scala 72:26]
  assign io_backBufferWriteAddress = backBufferWriteAddressReg; // @[src/main/scala/RaceManager.scala 73:29]
  assign io_backBufferWriteEnable = backBufferWriteEnableReg; // @[src/main/scala/RaceManager.scala 74:28]
  assign io_finished = raceFinished; // @[src/main/scala/RaceManager.scala 82:15]
  assign io_time_0 = bcdCounter_io_data_0; // @[src/main/scala/RaceManager.scala 120:11]
  assign io_time_1 = bcdCounter_io_data_1; // @[src/main/scala/RaceManager.scala 120:11]
  assign io_time_2 = bcdCounter_io_data_2; // @[src/main/scala/RaceManager.scala 120:11]
  assign io_time_3 = bcdCounter_io_data_3; // @[src/main/scala/RaceManager.scala 120:11]
  assign io_tilemapRomTileAddress = playerController_io_tilemapRomTileAddress; // @[src/main/scala/RaceManager.scala 86:28]
  assign playerController_clock = clock;
  assign playerController_reset = reset;
  assign playerController_io_tilemapRomCollisionData = io_tilemapRomCollisionData; // @[src/main/scala/RaceManager.scala 88:47]
  assign playerController_io_btnU = io_btnU; // @[src/main/scala/RaceManager.scala 89:28]
  assign playerController_io_btnL = io_btnL; // @[src/main/scala/RaceManager.scala 90:28]
  assign playerController_io_btnR = io_btnR; // @[src/main/scala/RaceManager.scala 93:28]
  assign playerController_io_btnD = io_btnD; // @[src/main/scala/RaceManager.scala 91:28]
  assign playerController_io_newFrame = io_newFrame; // @[src/main/scala/RaceManager.scala 94:32]
  assign playerController_io_enable = raceStarted; // @[src/main/scala/RaceManager.scala 95:30]
  assign playerController_io_raceMapIndex = io_selectedTrackIndex; // @[src/main/scala/RaceManager.scala 98:36]
  assign bcdCounter_clock = clock;
  assign bcdCounter_reset = reset;
  assign bcdCounter_io_inc = 2'h0 == raceManagerStateReg ? 1'h0 : _GEN_34; // @[src/main/scala/RaceManager.scala 118:21 131:31]
  assign bcdCounter_io_reset = 2'h0 == raceManagerStateReg & _GEN_4; // @[src/main/scala/RaceManager.scala 119:23 131:31]
  assign raceScoreboardPrinter_clock = clock;
  assign raceScoreboardPrinter_reset = reset;
  assign raceScoreboardPrinter_io_load = 2'h0 == raceManagerStateReg ? 1'h0 : _GEN_41; // @[src/main/scala/RaceManager.scala 131:31 123:33]
  assign raceScoreboardPrinter_io_time_0 = bcdCounter_io_data_0; // @[src/main/scala/RaceManager.scala 124:33]
  assign raceScoreboardPrinter_io_time_1 = bcdCounter_io_data_1; // @[src/main/scala/RaceManager.scala 124:33]
  assign raceScoreboardPrinter_io_time_2 = bcdCounter_io_data_2; // @[src/main/scala/RaceManager.scala 124:33]
  assign raceScoreboardPrinter_io_time_3 = bcdCounter_io_data_3; // @[src/main/scala/RaceManager.scala 124:33]
  assign raceScoreboardPrinter_io_screen = {{1'd0}, scoreboardScreen}; // @[src/main/scala/RaceManager.scala 125:35]
  assign raceScoreboardPrinter_io_lapCnt = playerController_io_lapCnt; // @[src/main/scala/RaceManager.scala 122:35]
  always @(posedge clock) begin
    viewBoxXReg <= _GEN_46[9:0]; // @[src/main/scala/RaceManager.scala 63:{28,28}]
    viewBoxYReg <= _GEN_60[8:0]; // @[src/main/scala/RaceManager.scala 64:{28,28}]
    if (reset) begin // @[src/main/scala/RaceManager.scala 69:39]
      backBufferWriteDataReg <= 6'h0; // @[src/main/scala/RaceManager.scala 69:39]
    end else if (!(2'h0 == raceManagerStateReg)) begin // @[src/main/scala/RaceManager.scala 131:31]
      if (!(2'h1 == raceManagerStateReg)) begin // @[src/main/scala/RaceManager.scala 131:31]
        if (2'h2 == raceManagerStateReg) begin // @[src/main/scala/RaceManager.scala 131:31]
          backBufferWriteDataReg <= raceScoreboardPrinter_io_backBufferWriteData; // @[src/main/scala/RaceManager.scala 193:30]
        end
      end
    end
    if (reset) begin // @[src/main/scala/RaceManager.scala 70:42]
      backBufferWriteAddressReg <= 11'h0; // @[src/main/scala/RaceManager.scala 70:42]
    end else if (!(2'h0 == raceManagerStateReg)) begin // @[src/main/scala/RaceManager.scala 131:31]
      if (!(2'h1 == raceManagerStateReg)) begin // @[src/main/scala/RaceManager.scala 131:31]
        if (2'h2 == raceManagerStateReg) begin // @[src/main/scala/RaceManager.scala 131:31]
          backBufferWriteAddressReg <= raceScoreboardPrinter_io_backBufferWriteAddress; // @[src/main/scala/RaceManager.scala 194:33]
        end
      end
    end
    if (reset) begin // @[src/main/scala/RaceManager.scala 71:41]
      backBufferWriteEnableReg <= 1'h0; // @[src/main/scala/RaceManager.scala 71:41]
    end else if (!(2'h0 == raceManagerStateReg)) begin // @[src/main/scala/RaceManager.scala 131:31]
      if (!(2'h1 == raceManagerStateReg)) begin // @[src/main/scala/RaceManager.scala 131:31]
        if (2'h2 == raceManagerStateReg) begin // @[src/main/scala/RaceManager.scala 131:31]
          backBufferWriteEnableReg <= raceScoreboardPrinter_io_backBufferWriteEnable; // @[src/main/scala/RaceManager.scala 195:32]
        end
      end
    end
    if (reset) begin // @[src/main/scala/RaceManager.scala 80:28]
      raceStarted <= 1'h0; // @[src/main/scala/RaceManager.scala 80:28]
    end else if (2'h0 == raceManagerStateReg) begin // @[src/main/scala/RaceManager.scala 131:31]
      raceStarted <= _GEN_2;
    end else if (!(2'h1 == raceManagerStateReg)) begin // @[src/main/scala/RaceManager.scala 131:31]
      if (2'h2 == raceManagerStateReg) begin // @[src/main/scala/RaceManager.scala 131:31]
        raceStarted <= _GEN_22;
      end
    end
    if (reset) begin // @[src/main/scala/RaceManager.scala 81:29]
      raceFinished <= 1'h0; // @[src/main/scala/RaceManager.scala 81:29]
    end else if (2'h0 == raceManagerStateReg) begin // @[src/main/scala/RaceManager.scala 131:31]
      raceFinished <= _GEN_3;
    end else if (!(2'h1 == raceManagerStateReg)) begin // @[src/main/scala/RaceManager.scala 131:31]
      if (2'h2 == raceManagerStateReg) begin // @[src/main/scala/RaceManager.scala 131:31]
        raceFinished <= _GEN_21;
      end
    end
    playerScreenXPosition <= playerController_io_playerXPosition - _GEN_23; // @[src/main/scala/RaceManager.scala 103:80]
    playerScreenYPosition <= playerController_io_playerYPosition - _GEN_33; // @[src/main/scala/RaceManager.scala 104:80]
    if (reset) begin // @[src/main/scala/RaceManager.scala 116:39]
      screenAnimationCounter <= 16'h0; // @[src/main/scala/RaceManager.scala 116:39]
    end else if (2'h0 == raceManagerStateReg) begin // @[src/main/scala/RaceManager.scala 131:31]
      if (!(io_enable)) begin // @[src/main/scala/RaceManager.scala 133:24]
        screenAnimationCounter <= 16'h0; // @[src/main/scala/RaceManager.scala 141:34]
      end
    end else if (2'h1 == raceManagerStateReg) begin // @[src/main/scala/RaceManager.scala 131:31]
      if (screenAnimationCounter < 16'h190) begin // @[src/main/scala/RaceManager.scala 171:44]
        screenAnimationCounter <= _screenAnimationCounter_T_1; // @[src/main/scala/RaceManager.scala 172:32]
      end
    end
    if (reset) begin // @[src/main/scala/RaceManager.scala 117:33]
      scoreboardScreen <= 3'h0; // @[src/main/scala/RaceManager.scala 117:33]
    end else if (2'h0 == raceManagerStateReg) begin // @[src/main/scala/RaceManager.scala 131:31]
      if (!(io_enable)) begin // @[src/main/scala/RaceManager.scala 133:24]
        scoreboardScreen <= 3'h0; // @[src/main/scala/RaceManager.scala 142:28]
      end
    end else if (!(2'h1 == raceManagerStateReg)) begin // @[src/main/scala/RaceManager.scala 131:31]
      if (2'h2 == raceManagerStateReg) begin // @[src/main/scala/RaceManager.scala 131:31]
        scoreboardScreen <= _GEN_18;
      end
    end
    if (reset) begin // @[src/main/scala/RaceManager.scala 128:36]
      raceManagerStateReg <= 2'h0; // @[src/main/scala/RaceManager.scala 128:36]
    end else if (2'h0 == raceManagerStateReg) begin // @[src/main/scala/RaceManager.scala 131:31]
      if (io_enable) begin // @[src/main/scala/RaceManager.scala 133:24]
        if (io_newFrame) begin // @[src/main/scala/RaceManager.scala 134:31]
          raceManagerStateReg <= 2'h1; // @[src/main/scala/RaceManager.scala 135:37]
        end
      end
    end else if (2'h1 == raceManagerStateReg) begin // @[src/main/scala/RaceManager.scala 131:31]
      raceManagerStateReg <= 2'h2; // @[src/main/scala/RaceManager.scala 175:27]
    end else if (2'h2 == raceManagerStateReg) begin // @[src/main/scala/RaceManager.scala 131:31]
      raceManagerStateReg <= _GEN_20;
    end else begin
      raceManagerStateReg <= _GEN_24;
    end
  end
// Register and memory initialization
`ifdef RANDOMIZE_GARBAGE_ASSIGN
...
module ScoreboardPrinter(
  ...
  input  [7:0]  io_time_0, // @[src/main/scala/ScoreboardPrinter.scala 10:16]
  input  [7:0]  io_time_1, // @[src/main/scala/ScoreboardPrinter.scala 10:16]
  input  [7:0]  io_time_2, // @[src/main/scala/ScoreboardPrinter.scala 10:16]
  input  [7:0]  io_time_3, // @[src/main/scala/ScoreboardPrinter.scala 10:16]
...
`endif // RANDOMIZE_REG_INIT
  ...
  wire [6:0] _timeTextAddress_T = 6'hc - xIdx; // @[src/main/scala/ScoreboardPrinter.scala 146:54]
  wire [7:0] timeTextAddress = 7'h3 + _timeTextAddress_T; // @[src/main/scala/ScoreboardPrinter.scala 146:31]
  ...
  wire [7:0] _GEN_105 = 2'h1 == timeTextAddress[1:0] ? io_time_1 : io_time_0; // @[src/main/scala/ScoreboardPrinter.scala 170:{60,60}]
  wire [7:0] _GEN_106 = 2'h2 == timeTextAddress[1:0] ? io_time_2 : _GEN_105; // @[src/main/scala/ScoreboardPrinter.scala 170:{60,60}]
  wire [7:0] _GEN_107 = 2'h3 == timeTextAddress[1:0] ? io_time_3 : _GEN_106; // @[src/main/scala/ScoreboardPrinter.scala 170:{60,60}]
  wire [7:0] _io_backBufferWriteData_T_9 = _GEN_107 + 8'h1a; // @[src/main/scala/ScoreboardPrinter.scala 170:60]
  wire [7:0] _GEN_108 = yIdx == 5'h15 ? _io_backBufferWriteData_T_9 : 8'h0; // @[src/main/scala/ScoreboardPrinter.scala 151:28 169:37 170:32]
...
`endif // RANDOMIZE_REG_INIT
  ...
  wire [7:0] raceManager_io_time_0; // @[src/main/scala/ScreenManager.scala 119:27]
  wire [7:0] raceManager_io_time_1; // @[src/main/scala/ScreenManager.scala 119:27]
  wire [7:0] raceManager_io_time_2; // @[src/main/scala/ScreenManager.scala 119:27]
  wire [7:0] raceManager_io_time_3; // @[src/main/scala/ScreenManager.scala 119:27]
  ...
  wire [7:0] scoreboardPrinter_io_time_0; // @[src/main/scala/ScreenManager.scala 145:33]
  wire [7:0] scoreboardPrinter_io_time_1; // @[src/main/scala/ScreenManager.scala 145:33]
  wire [7:0] scoreboardPrinter_io_time_2; // @[src/main/scala/ScreenManager.scala 145:33]
  wire [7:0] scoreboardPrinter_io_time_3; // @[src/main/scala/ScreenManager.scala 145:33]
  ...
  reg [7:0] finishTimeReg_0; // @[src/main/scala/ScreenManager.scala 148:30]
  reg [7:0] finishTimeReg_1; // @[src/main/scala/ScreenManager.scala 148:30]
  reg [7:0] finishTimeReg_2; // @[src/main/scala/ScreenManager.scala 148:30]
  reg [7:0] finishTimeReg_3; // @[src/main/scala/ScreenManager.scala 148:30]
  reg  btnCPressed; // @[src/main/scala/ScreenManager.scala 151:28]
  reg  btnLPressed; // @[src/main/scala/ScreenManager.scala 152:28]
  reg  btnRPressed; // @[src/main/scala/ScreenManager.scala 153:28]
  wire  _T_2 = currentScreenReg == 2'h0; // @[src/main/scala/ScreenManager.scala 177:29]
  wire  _T_3 = currentScreenReg == 2'h2; // @[src/main/scala/ScreenManager.scala 180:35]
  wire [9:0] _GEN_4 = currentScreenReg == 2'h2 ? 10'h0 : viewBoxXReg; // @[src/main/scala/ScreenManager.scala 180:51 181:21 100:28]
  wire [8:0] _GEN_5 = currentScreenReg == 2'h2 ? 9'h1e0 : viewBoxYReg; // @[src/main/scala/ScreenManager.scala 180:51 182:21 101:28]
  wire [9:0] _viewBoxXReg_T_1 = viewBoxXReg + 10'h10; // @[src/main/scala/ScreenManager.scala 189:36]
  wire [9:0] _GEN_8 = io_newFrame ? _viewBoxXReg_T_1 : viewBoxXReg; // @[src/main/scala/ScreenManager.scala 188:25 189:21 100:28]
  wire [3:0] _GEN_9 = io_newFrame ? 4'h3 : screenManagerStateReg; // @[src/main/scala/ScreenManager.scala 188:25 190:31 106:38]
  wire [3:0] _GEN_10 = viewBoxXReg >= 10'h280 ? 4'h8 : 4'h2; // @[src/main/scala/ScreenManager.scala 197:34 198:31 201:31]
  wire [1:0] _GEN_11 = viewBoxXReg >= 10'h280 ? 2'h1 : currentScreenReg; // @[src/main/scala/ScreenManager.scala 197:34 199:26 107:33]
  wire [3:0] _GEN_12 = menuPrinter_io_done ? 4'h9 : screenManagerStateReg; // @[src/main/scala/ScreenManager.scala 211:33 212:31 106:38]
  wire [3:0] _GEN_13 = screenLoader_io_done ? 4'h6 : screenManagerStateReg; // @[src/main/scala/ScreenManager.scala 222:34 224:31 106:38]
  wire [3:0] _GEN_14 = scoreboardPrinter_io_done ? 4'h9 : screenManagerStateReg; // @[src/main/scala/ScreenManager.scala 234:39 235:31 106:38]
  wire [3:0] _GEN_15 = raceManager_io_finished ? 4'h1 : screenManagerStateReg; // @[src/main/scala/ScreenManager.scala 264:37 265:31 106:38]
  wire [1:0] _GEN_16 = raceManager_io_finished ? 2'h2 : currentScreenReg; // @[src/main/scala/ScreenManager.scala 264:37 266:26 107:33]
  wire [7:0] _GEN_17 = raceManager_io_finished ? raceManager_io_time_0 : finishTimeReg_0; // @[src/main/scala/ScreenManager.scala 264:37 267:23 148:30]
  wire [7:0] _GEN_18 = raceManager_io_finished ? raceManager_io_time_1 : finishTimeReg_1; // @[src/main/scala/ScreenManager.scala 264:37 267:23 148:30]
  wire [7:0] _GEN_19 = raceManager_io_finished ? raceManager_io_time_2 : finishTimeReg_2; // @[src/main/scala/ScreenManager.scala 264:37 267:23 148:30]
  wire [7:0] _GEN_20 = raceManager_io_finished ? raceManager_io_time_3 : finishTimeReg_3; // @[src/main/scala/ScreenManager.scala 264:37 267:23 148:30]
  wire [3:0] _GEN_21 = _T_2 ? 4'h2 : 4'h9; // @[src/main/scala/ScreenManager.scala 274:31 278:50 279:35]
  wire  _T_15 = currentScreenReg == 2'h1; // @[src/main/scala/ScreenManager.scala 281:33]
  wire [3:0] _GEN_22 = currentScreenReg == 2'h1 ? 4'h5 : _GEN_21; // @[src/main/scala/ScreenManager.scala 281:56 282:35]
  wire [8:0] _GEN_24 = _T_3 ? 9'h0 : viewBoxYReg; // @[src/main/scala/ScreenManager.scala 284:49 286:25 101:28]
  wire [1:0] _GEN_25 = _T_3 ? 2'h0 : currentScreenReg; // @[src/main/scala/ScreenManager.scala 284:49 287:30 107:33]
  wire [3:0] _GEN_26 = _T_3 ? 4'h1 : selectedTrackReg; // @[src/main/scala/ScreenManager.scala 284:49 288:30 138:33]
  wire  _GEN_27 = io_btnC & ~btnCPressed | btnCPressed; // @[src/main/scala/ScreenManager.scala 276:50 277:23 151:28]
  wire [3:0] _GEN_28 = io_btnC & ~btnCPressed ? _GEN_22 : 4'h9; // @[src/main/scala/ScreenManager.scala 274:31 276:50]
  wire [9:0] _GEN_29 = io_btnC & ~btnCPressed ? _GEN_4 : viewBoxXReg; // @[src/main/scala/ScreenManager.scala 100:28 276:50]
  wire [8:0] _GEN_30 = io_btnC & ~btnCPressed ? _GEN_24 : viewBoxYReg; // @[src/main/scala/ScreenManager.scala 101:28 276:50]
  wire [1:0] _GEN_31 = io_btnC & ~btnCPressed ? _GEN_25 : currentScreenReg; // @[src/main/scala/ScreenManager.scala 107:33 276:50]
  wire [3:0] _GEN_32 = io_btnC & ~btnCPressed ? _GEN_26 : selectedTrackReg; // @[src/main/scala/ScreenManager.scala 138:33 276:50]
  wire [3:0] _selectedTrackReg_T_1 = selectedTrackReg + 4'h1; // @[src/main/scala/ScreenManager.scala 295:50]
  wire [3:0] _GEN_33 = selectedTrackReg == 4'h7 ? 4'h1 : _selectedTrackReg_T_1; // @[src/main/scala/ScreenManager.scala 295:30 296:62 297:32]
  wire [3:0] _GEN_34 = _T_15 ? _GEN_33 : _GEN_32; // @[src/main/scala/ScreenManager.scala 294:56]
  wire [3:0] _GEN_35 = _T_15 ? 4'h4 : _GEN_28; // @[src/main/scala/ScreenManager.scala 294:56 299:35]
  wire  _GEN_36 = io_btnR & ~btnRPressed | btnRPressed; // @[src/main/scala/ScreenManager.scala 292:50 293:23 153:28]
  wire [3:0] _GEN_37 = io_btnR & ~btnRPressed ? _GEN_34 : _GEN_32; // @[src/main/scala/ScreenManager.scala 292:50]
  wire [3:0] _GEN_38 = io_btnR & ~btnRPressed ? _GEN_35 : _GEN_28; // @[src/main/scala/ScreenManager.scala 292:50]
  wire [3:0] _selectedTrackReg_T_3 = selectedTrackReg - 4'h1; // @[src/main/scala/ScreenManager.scala 306:50]
  wire [3:0] _GEN_39 = selectedTrackReg == 4'h1 ? 4'h7 : _selectedTrackReg_T_3; // @[src/main/scala/ScreenManager.scala 306:30 307:44 308:32]
  wire [3:0] _GEN_40 = _T_15 ? _GEN_39 : _GEN_37; // @[src/main/scala/ScreenManager.scala 305:56]
  wire [3:0] _GEN_41 = _T_15 ? 4'h4 : _GEN_38; // @[src/main/scala/ScreenManager.scala 305:56 310:35]
  wire  _GEN_42 = io_btnL & ~btnLPressed | btnLPressed; // @[src/main/scala/ScreenManager.scala 303:50 304:23 152:28]
  wire [3:0] _GEN_43 = io_btnL & ~btnLPressed ? _GEN_40 : _GEN_37; // @[src/main/scala/ScreenManager.scala 303:50]
  wire [3:0] _GEN_44 = io_btnL & ~btnLPressed ? _GEN_41 : _GEN_38; // @[src/main/scala/ScreenManager.scala 303:50]
  wire  _GEN_45 = ~io_btnC ? 1'h0 : _GEN_27; // @[src/main/scala/ScreenManager.scala 314:24 315:23]
  wire  _GEN_46 = ~io_btnR ? 1'h0 : _GEN_36; // @[src/main/scala/ScreenManager.scala 318:24 319:23]
  wire  _GEN_47 = ~io_btnL ? 1'h0 : _GEN_42; // @[src/main/scala/ScreenManager.scala 322:24 323:23]
  wire [3:0] _GEN_48 = io_newFrame ? _GEN_44 : screenManagerStateReg; // @[src/main/scala/ScreenManager.scala 273:25 106:38]
  wire  _GEN_49 = io_newFrame ? _GEN_45 : btnCPressed; // @[src/main/scala/ScreenManager.scala 273:25 151:28]
  wire [9:0] _GEN_50 = io_newFrame ? _GEN_29 : viewBoxXReg; // @[src/main/scala/ScreenManager.scala 273:25 100:28]
  wire [8:0] _GEN_51 = io_newFrame ? _GEN_30 : viewBoxYReg; // @[src/main/scala/ScreenManager.scala 273:25 101:28]
  wire [1:0] _GEN_52 = io_newFrame ? _GEN_31 : currentScreenReg; // @[src/main/scala/ScreenManager.scala 273:25 107:33]
  wire [3:0] _GEN_53 = io_newFrame ? _GEN_43 : selectedTrackReg; // @[src/main/scala/ScreenManager.scala 273:25 138:33]
  wire  _GEN_54 = io_newFrame ? _GEN_46 : btnRPressed; // @[src/main/scala/ScreenManager.scala 273:25 153:28]
  wire  _GEN_55 = io_newFrame ? _GEN_47 : btnLPressed; // @[src/main/scala/ScreenManager.scala 273:25 152:28]
  wire [3:0] _GEN_57 = 4'h9 == screenManagerStateReg ? 4'h8 : screenManagerStateReg; // @[src/main/scala/ScreenManager.scala 157:33 331:29 106:38]
  wire [3:0] _GEN_58 = 4'h8 == screenManagerStateReg ? _GEN_48 : _GEN_57; // @[src/main/scala/ScreenManager.scala 157:33]
  wire  _GEN_59 = 4'h8 == screenManagerStateReg ? _GEN_49 : btnCPressed; // @[src/main/scala/ScreenManager.scala 151:28 157:33]
  wire [9:0] _GEN_60 = 4'h8 == screenManagerStateReg ? _GEN_50 : viewBoxXReg; // @[src/main/scala/ScreenManager.scala 100:28 157:33]
  wire [8:0] _GEN_61 = 4'h8 == screenManagerStateReg ? _GEN_51 : viewBoxYReg; // @[src/main/scala/ScreenManager.scala 101:28 157:33]
  wire [1:0] _GEN_62 = 4'h8 == screenManagerStateReg ? _GEN_52 : currentScreenReg; // @[src/main/scala/ScreenManager.scala 107:33 157:33]
  wire [3:0] _GEN_63 = 4'h8 == screenManagerStateReg ? _GEN_53 : selectedTrackReg; // @[src/main/scala/ScreenManager.scala 138:33 157:33]
  wire  _GEN_64 = 4'h8 == screenManagerStateReg ? _GEN_54 : btnRPressed; // @[src/main/scala/ScreenManager.scala 153:28 157:33]
  wire  _GEN_65 = 4'h8 == screenManagerStateReg ? _GEN_55 : btnLPressed; // @[src/main/scala/ScreenManager.scala 152:28 157:33]
  wire [10:0] _GEN_75 = 4'h6 == screenManagerStateReg ? $signed(raceManager_io_spriteXPosition_0) : $signed(11'sh0); // @[src/main/scala/ScreenManager.scala 157:33 243:26 72:22]
  wire [10:0] _GEN_76 = 4'h6 == screenManagerStateReg ? $signed(raceManager_io_spriteXPosition_1) : $signed(11'sh0); // @[src/main/scala/ScreenManager.scala 157:33 243:26 72:22]
  wire [10:0] _GEN_77 = 4'h6 == screenManagerStateReg ? $signed(raceManager_io_spriteXPosition_2) : $signed(11'sh0); // @[src/main/scala/ScreenManager.scala 157:33 243:26 72:22]
  wire [9:0] _GEN_91 = 4'h6 == screenManagerStateReg ? $signed(raceManager_io_spriteYPosition_0) : $signed(10'sh0); // @[src/main/scala/ScreenManager.scala 157:33 244:26 73:22]
  wire [9:0] _GEN_92 = 4'h6 == screenManagerStateReg ? $signed(raceManager_io_spriteYPosition_1) : $signed(10'sh0); // @[src/main/scala/ScreenManager.scala 157:33 244:26 73:22]
  wire [9:0] _GEN_93 = 4'h6 == screenManagerStateReg ? $signed(raceManager_io_spriteYPosition_2) : $signed(10'sh0); // @[src/main/scala/ScreenManager.scala 157:33 244:26 73:22]
  wire  _GEN_107 = 4'h6 == screenManagerStateReg & raceManager_io_spriteVisible_0; // @[src/main/scala/ScreenManager.scala 157:33 245:24 74:20]
  wire  _GEN_108 = 4'h6 == screenManagerStateReg & raceManager_io_spriteVisible_1; // @[src/main/scala/ScreenManager.scala 157:33 245:24 74:20]
  wire  _GEN_109 = 4'h6 == screenManagerStateReg & raceManager_io_spriteVisible_2; // @[src/main/scala/ScreenManager.scala 157:33 245:24 74:20]
  wire  _GEN_123 = 4'h6 == screenManagerStateReg & raceManager_io_spriteFlipHorizontal_0; // @[src/main/scala/ScreenManager.scala 157:33 246:31 75:27]
  wire  _GEN_124 = 4'h6 == screenManagerStateReg & raceManager_io_spriteFlipHorizontal_1; // @[src/main/scala/ScreenManager.scala 157:33 246:31 75:27]
  wire  _GEN_140 = 4'h6 == screenManagerStateReg & raceManager_io_spriteFlipVertical_1; // @[src/main/scala/ScreenManager.scala 157:33 247:29 76:25]
  wire  _GEN_141 = 4'h6 == screenManagerStateReg & raceManager_io_spriteFlipVertical_2; // @[src/main/scala/ScreenManager.scala 157:33 247:29 76:25]
  wire [9:0] _GEN_155 = 4'h6 == screenManagerStateReg ? raceManager_io_viewBoxX : viewBoxXReg; // @[src/main/scala/ScreenManager.scala 102:15 157:33 248:19]
  wire [8:0] _GEN_156 = 4'h6 == screenManagerStateReg ? raceManager_io_viewBoxY : viewBoxYReg; // @[src/main/scala/ScreenManager.scala 103:15 157:33 249:19]
  wire [5:0] _GEN_157 = 4'h6 == screenManagerStateReg ? raceManager_io_backBufferWriteData :
    screenLoader_io_backBufferWriteData; // @[src/main/scala/ScreenManager.scala 133:26 157:33 250:30]
  wire [10:0] _GEN_158 = 4'h6 == screenManagerStateReg ? raceManager_io_backBufferWriteAddress :
    screenLoader_io_backBufferWriteAddress; // @[src/main/scala/ScreenManager.scala 134:29 157:33 251:33]
  wire  _GEN_159 = 4'h6 == screenManagerStateReg ? raceManager_io_backBufferWriteEnable :
    screenLoader_io_backBufferWriteEnable; // @[src/main/scala/ScreenManager.scala 135:28 157:33 252:32]
  wire [3:0] _GEN_161 = 4'h6 == screenManagerStateReg ? selectedTrackReg : 4'h0; // @[src/main/scala/ScreenManager.scala 113:28 157:33 256:32]
  wire [10:0] _GEN_162 = 4'h6 == screenManagerStateReg ? raceManager_io_tilemapRomTileAddress :
    screenLoader_io_tileAddress; // @[src/main/scala/ScreenManager.scala 114:29 157:33 257:33]
  wire  _GEN_164 = 4'h6 == screenManagerStateReg & tilemapRom_io_collisionData; // @[src/main/scala/ScreenManager.scala 157:33 130:42 259:46]
  wire [3:0] _GEN_166 = 4'h6 == screenManagerStateReg ? _GEN_15 : _GEN_58; // @[src/main/scala/ScreenManager.scala 157:33]
  wire [1:0] _GEN_167 = 4'h6 == screenManagerStateReg ? _GEN_16 : _GEN_62; // @[src/main/scala/ScreenManager.scala 157:33]
  wire [7:0] _GEN_168 = 4'h6 == screenManagerStateReg ? _GEN_17 : finishTimeReg_0; // @[src/main/scala/ScreenManager.scala 148:30 157:33]
  wire [7:0] _GEN_169 = 4'h6 == screenManagerStateReg ? _GEN_18 : finishTimeReg_1; // @[src/main/scala/ScreenManager.scala 148:30 157:33]
  wire [7:0] _GEN_170 = 4'h6 == screenManagerStateReg ? _GEN_19 : finishTimeReg_2; // @[src/main/scala/ScreenManager.scala 148:30 157:33]
  wire [7:0] _GEN_171 = 4'h6 == screenManagerStateReg ? _GEN_20 : finishTimeReg_3; // @[src/main/scala/ScreenManager.scala 148:30 157:33]
  wire  _GEN_172 = 4'h6 == screenManagerStateReg ? btnCPressed : _GEN_59; // @[src/main/scala/ScreenManager.scala 151:28 157:33]
  wire [9:0] _GEN_173 = 4'h6 == screenManagerStateReg ? viewBoxXReg : _GEN_60; // @[src/main/scala/ScreenManager.scala 100:28 157:33]
  wire [8:0] _GEN_174 = 4'h6 == screenManagerStateReg ? viewBoxYReg : _GEN_61; // @[src/main/scala/ScreenManager.scala 101:28 157:33]
  wire [3:0] _GEN_175 = 4'h6 == screenManagerStateReg ? selectedTrackReg : _GEN_63; // @[src/main/scala/ScreenManager.scala 138:33 157:33]
  wire  _GEN_176 = 4'h6 == screenManagerStateReg ? btnRPressed : _GEN_64; // @[src/main/scala/ScreenManager.scala 153:28 157:33]
  wire  _GEN_177 = 4'h6 == screenManagerStateReg ? btnLPressed : _GEN_65; // @[src/main/scala/ScreenManager.scala 152:28 157:33]
  wire [5:0] _GEN_179 = 4'h7 == screenManagerStateReg ? scoreboardPrinter_io_backBufferWriteData : _GEN_157; // @[src/main/scala/ScreenManager.scala 157:33 230:30]
  wire [10:0] _GEN_180 = 4'h7 == screenManagerStateReg ? scoreboardPrinter_io_backBufferWriteAddress : _GEN_158; // @[src/main/scala/ScreenManager.scala 157:33 231:33]
  wire  _GEN_181 = 4'h7 == screenManagerStateReg ? scoreboardPrinter_io_backBufferWriteEnable : _GEN_159; // @[src/main/scala/ScreenManager.scala 157:33 232:32]
  wire [3:0] _GEN_182 = 4'h7 == screenManagerStateReg ? _GEN_14 : _GEN_166; // @[src/main/scala/ScreenManager.scala 157:33]
  wire [10:0] _GEN_191 = 4'h7 == screenManagerStateReg ? $signed(11'sh0) : $signed(_GEN_75); // @[src/main/scala/ScreenManager.scala 157:33 72:22]
  wire [10:0] _GEN_192 = 4'h7 == screenManagerStateReg ? $signed(11'sh0) : $signed(_GEN_76); // @[src/main/scala/ScreenManager.scala 157:33 72:22]
  wire [10:0] _GEN_193 = 4'h7 == screenManagerStateReg ? $signed(11'sh0) : $signed(_GEN_77); // @[src/main/scala/ScreenManager.scala 157:33 72:22]
  wire [9:0] _GEN_207 = 4'h7 == screenManagerStateReg ? $signed(10'sh0) : $signed(_GEN_91); // @[src/main/scala/ScreenManager.scala 157:33 73:22]
  wire [9:0] _GEN_208 = 4'h7 == screenManagerStateReg ? $signed(10'sh0) : $signed(_GEN_92); // @[src/main/scala/ScreenManager.scala 157:33 73:22]
  wire [9:0] _GEN_209 = 4'h7 == screenManagerStateReg ? $signed(10'sh0) : $signed(_GEN_93); // @[src/main/scala/ScreenManager.scala 157:33 73:22]
  wire  _GEN_223 = 4'h7 == screenManagerStateReg ? 1'h0 : _GEN_107; // @[src/main/scala/ScreenManager.scala 157:33 74:20]
  wire  _GEN_224 = 4'h7 == screenManagerStateReg ? 1'h0 : _GEN_108; // @[src/main/scala/ScreenManager.scala 157:33 74:20]
  wire  _GEN_225 = 4'h7 == screenManagerStateReg ? 1'h0 : _GEN_109; // @[src/main/scala/ScreenManager.scala 157:33 74:20]
  wire  _GEN_239 = 4'h7 == screenManagerStateReg ? 1'h0 : _GEN_123; // @[src/main/scala/ScreenManager.scala 157:33 75:27]
  wire  _GEN_240 = 4'h7 == screenManagerStateReg ? 1'h0 : _GEN_124; // @[src/main/scala/ScreenManager.scala 157:33 75:27]
  wire  _GEN_256 = 4'h7 == screenManagerStateReg ? 1'h0 : _GEN_140; // @[src/main/scala/ScreenManager.scala 157:33 76:25]
  wire  _GEN_257 = 4'h7 == screenManagerStateReg ? 1'h0 : _GEN_141; // @[src/main/scala/ScreenManager.scala 157:33 76:25]
  wire [9:0] _GEN_271 = 4'h7 == screenManagerStateReg ? viewBoxXReg : _GEN_155; // @[src/main/scala/ScreenManager.scala 102:15 157:33]
  wire [8:0] _GEN_272 = 4'h7 == screenManagerStateReg ? viewBoxYReg : _GEN_156; // @[src/main/scala/ScreenManager.scala 103:15 157:33]
  wire [3:0] _GEN_274 = 4'h7 == screenManagerStateReg ? 4'h0 : _GEN_161; // @[src/main/scala/ScreenManager.scala 113:28 157:33]
  wire [10:0] _GEN_275 = 4'h7 == screenManagerStateReg ? screenLoader_io_tileAddress : _GEN_162; // @[src/main/scala/ScreenManager.scala 114:29 157:33]
  wire  _GEN_277 = 4'h7 == screenManagerStateReg ? 1'h0 : _GEN_164; // @[src/main/scala/ScreenManager.scala 157:33 130:42]
  wire  _GEN_278 = 4'h7 == screenManagerStateReg ? 1'h0 : 4'h6 == screenManagerStateReg; // @[src/main/scala/ScreenManager.scala 121:25 157:33]
  wire [1:0] _GEN_279 = 4'h7 == screenManagerStateReg ? currentScreenReg : _GEN_167; // @[src/main/scala/ScreenManager.scala 107:33 157:33]
  wire [7:0] _GEN_280 = 4'h7 == screenManagerStateReg ? finishTimeReg_0 : _GEN_168; // @[src/main/scala/ScreenManager.scala 148:30 157:33]
  wire [7:0] _GEN_281 = 4'h7 == screenManagerStateReg ? finishTimeReg_1 : _GEN_169; // @[src/main/scala/ScreenManager.scala 148:30 157:33]
  wire [7:0] _GEN_282 = 4'h7 == screenManagerStateReg ? finishTimeReg_2 : _GEN_170; // @[src/main/scala/ScreenManager.scala 148:30 157:33]
  wire [7:0] _GEN_283 = 4'h7 == screenManagerStateReg ? finishTimeReg_3 : _GEN_171; // @[src/main/scala/ScreenManager.scala 148:30 157:33]
  wire  _GEN_284 = 4'h7 == screenManagerStateReg ? btnCPressed : _GEN_172; // @[src/main/scala/ScreenManager.scala 151:28 157:33]
  wire [9:0] _GEN_285 = 4'h7 == screenManagerStateReg ? viewBoxXReg : _GEN_173; // @[src/main/scala/ScreenManager.scala 100:28 157:33]
  wire [8:0] _GEN_286 = 4'h7 == screenManagerStateReg ? viewBoxYReg : _GEN_174; // @[src/main/scala/ScreenManager.scala 101:28 157:33]
  wire [3:0] _GEN_287 = 4'h7 == screenManagerStateReg ? selectedTrackReg : _GEN_175; // @[src/main/scala/ScreenManager.scala 138:33 157:33]
  wire  _GEN_288 = 4'h7 == screenManagerStateReg ? btnRPressed : _GEN_176; // @[src/main/scala/ScreenManager.scala 153:28 157:33]
  wire  _GEN_289 = 4'h7 == screenManagerStateReg ? btnLPressed : _GEN_177; // @[src/main/scala/ScreenManager.scala 152:28 157:33]
  wire [3:0] _GEN_291 = 4'h5 == screenManagerStateReg ? selectedTrackReg : _GEN_274; // @[src/main/scala/ScreenManager.scala 157:33 219:32]
  wire [3:0] _GEN_293 = 4'h5 == screenManagerStateReg ? _GEN_13 : _GEN_182; // @[src/main/scala/ScreenManager.scala 157:33]
  wire  _GEN_294 = 4'h5 == screenManagerStateReg ? 1'h0 : 4'h7 == screenManagerStateReg; // @[src/main/scala/ScreenManager.scala 146:29 157:33]
  wire [5:0] _GEN_295 = 4'h5 == screenManagerStateReg ? screenLoader_io_backBufferWriteData : _GEN_179; // @[src/main/scala/ScreenManager.scala 133:26 157:33]
  wire [10:0] _GEN_296 = 4'h5 == screenManagerStateReg ? screenLoader_io_backBufferWriteAddress : _GEN_180; // @[src/main/scala/ScreenManager.scala 134:29 157:33]
  wire  _GEN_297 = 4'h5 == screenManagerStateReg ? screenLoader_io_backBufferWriteEnable : _GEN_181; // @[src/main/scala/ScreenManager.scala 135:28 157:33]
  wire [10:0] _GEN_306 = 4'h5 == screenManagerStateReg ? $signed(11'sh0) : $signed(_GEN_191); // @[src/main/scala/ScreenManager.scala 157:33 72:22]
  wire [10:0] _GEN_307 = 4'h5 == screenManagerStateReg ? $signed(11'sh0) : $signed(_GEN_192); // @[src/main/scala/ScreenManager.scala 157:33 72:22]
  wire [10:0] _GEN_308 = 4'h5 == screenManagerStateReg ? $signed(11'sh0) : $signed(_GEN_193); // @[src/main/scala/ScreenManager.scala 157:33 72:22]
  wire [9:0] _GEN_322 = 4'h5 == screenManagerStateReg ? $signed(10'sh0) : $signed(_GEN_207); // @[src/main/scala/ScreenManager.scala 157:33 73:22]
  wire [9:0] _GEN_323 = 4'h5 == screenManagerStateReg ? $signed(10'sh0) : $signed(_GEN_208); // @[src/main/scala/ScreenManager.scala 157:33 73:22]
  wire [9:0] _GEN_324 = 4'h5 == screenManagerStateReg ? $signed(10'sh0) : $signed(_GEN_209); // @[src/main/scala/ScreenManager.scala 157:33 73:22]
  wire  _GEN_338 = 4'h5 == screenManagerStateReg ? 1'h0 : _GEN_223; // @[src/main/scala/ScreenManager.scala 157:33 74:20]
  wire  _GEN_339 = 4'h5 == screenManagerStateReg ? 1'h0 : _GEN_224; // @[src/main/scala/ScreenManager.scala 157:33 74:20]
  wire  _GEN_340 = 4'h5 == screenManagerStateReg ? 1'h0 : _GEN_225; // @[src/main/scala/ScreenManager.scala 157:33 74:20]
  wire  _GEN_354 = 4'h5 == screenManagerStateReg ? 1'h0 : _GEN_239; // @[src/main/scala/ScreenManager.scala 157:33 75:27]
  wire  _GEN_355 = 4'h5 == screenManagerStateReg ? 1'h0 : _GEN_240; // @[src/main/scala/ScreenManager.scala 157:33 75:27]
  wire  _GEN_371 = 4'h5 == screenManagerStateReg ? 1'h0 : _GEN_256; // @[src/main/scala/ScreenManager.scala 157:33 76:25]
  wire  _GEN_372 = 4'h5 == screenManagerStateReg ? 1'h0 : _GEN_257; // @[src/main/scala/ScreenManager.scala 157:33 76:25]
  wire [9:0] _GEN_386 = 4'h5 == screenManagerStateReg ? viewBoxXReg : _GEN_271; // @[src/main/scala/ScreenManager.scala 102:15 157:33]
  wire [8:0] _GEN_387 = 4'h5 == screenManagerStateReg ? viewBoxYReg : _GEN_272; // @[src/main/scala/ScreenManager.scala 103:15 157:33]
  wire [10:0] _GEN_388 = 4'h5 == screenManagerStateReg ? screenLoader_io_tileAddress : _GEN_275; // @[src/main/scala/ScreenManager.scala 114:29 157:33]
  wire  _GEN_390 = 4'h5 == screenManagerStateReg ? 1'h0 : _GEN_277; // @[src/main/scala/ScreenManager.scala 157:33 130:42]
  wire  _GEN_391 = 4'h5 == screenManagerStateReg ? 1'h0 : _GEN_278; // @[src/main/scala/ScreenManager.scala 121:25 157:33]
  wire [1:0] _GEN_392 = 4'h5 == screenManagerStateReg ? currentScreenReg : _GEN_279; // @[src/main/scala/ScreenManager.scala 107:33 157:33]
  wire [7:0] _GEN_393 = 4'h5 == screenManagerStateReg ? finishTimeReg_0 : _GEN_280; // @[src/main/scala/ScreenManager.scala 148:30 157:33]
  wire [7:0] _GEN_394 = 4'h5 == screenManagerStateReg ? finishTimeReg_1 : _GEN_281; // @[src/main/scala/ScreenManager.scala 148:30 157:33]
  wire [7:0] _GEN_395 = 4'h5 == screenManagerStateReg ? finishTimeReg_2 : _GEN_282; // @[src/main/scala/ScreenManager.scala 148:30 157:33]
  wire [7:0] _GEN_396 = 4'h5 == screenManagerStateReg ? finishTimeReg_3 : _GEN_283; // @[src/main/scala/ScreenManager.scala 148:30 157:33]
  wire  _GEN_397 = 4'h5 == screenManagerStateReg ? btnCPressed : _GEN_284; // @[src/main/scala/ScreenManager.scala 151:28 157:33]
  wire [9:0] _GEN_398 = 4'h5 == screenManagerStateReg ? viewBoxXReg : _GEN_285; // @[src/main/scala/ScreenManager.scala 100:28 157:33]
  wire [8:0] _GEN_399 = 4'h5 == screenManagerStateReg ? viewBoxYReg : _GEN_286; // @[src/main/scala/ScreenManager.scala 101:28 157:33]
  wire [3:0] _GEN_400 = 4'h5 == screenManagerStateReg ? selectedTrackReg : _GEN_287; // @[src/main/scala/ScreenManager.scala 138:33 157:33]
  wire  _GEN_401 = 4'h5 == screenManagerStateReg ? btnRPressed : _GEN_288; // @[src/main/scala/ScreenManager.scala 153:28 157:33]
  wire  _GEN_402 = 4'h5 == screenManagerStateReg ? btnLPressed : _GEN_289; // @[src/main/scala/ScreenManager.scala 152:28 157:33]
  wire [5:0] _GEN_404 = 4'h4 == screenManagerStateReg ? menuPrinter_io_backBufferWriteData : _GEN_295; // @[src/main/scala/ScreenManager.scala 157:33 207:30]
  wire [10:0] _GEN_405 = 4'h4 == screenManagerStateReg ? menuPrinter_io_backBufferWriteAddress : _GEN_296; // @[src/main/scala/ScreenManager.scala 157:33 208:33]
  wire  _GEN_406 = 4'h4 == screenManagerStateReg ? menuPrinter_io_backBufferWriteEnable : _GEN_297; // @[src/main/scala/ScreenManager.scala 157:33 209:32]
  wire [3:0] _GEN_407 = 4'h4 == screenManagerStateReg ? _GEN_12 : _GEN_293; // @[src/main/scala/ScreenManager.scala 157:33]
  wire  _GEN_408 = 4'h4 == screenManagerStateReg ? 1'h0 : 4'h5 == screenManagerStateReg; // @[src/main/scala/ScreenManager.scala 115:24 157:33]
  wire [3:0] _GEN_409 = 4'h4 == screenManagerStateReg ? 4'h0 : _GEN_291; // @[src/main/scala/ScreenManager.scala 113:28 157:33]
  wire  _GEN_411 = 4'h4 == screenManagerStateReg ? 1'h0 : _GEN_294; // @[src/main/scala/ScreenManager.scala 146:29 157:33]
  wire [10:0] _GEN_420 = 4'h4 == screenManagerStateReg ? $signed(11'sh0) : $signed(_GEN_306); // @[src/main/scala/ScreenManager.scala 157:33 72:22]
  wire [10:0] _GEN_421 = 4'h4 == screenManagerStateReg ? $signed(11'sh0) : $signed(_GEN_307); // @[src/main/scala/ScreenManager.scala 157:33 72:22]
  wire [10:0] _GEN_422 = 4'h4 == screenManagerStateReg ? $signed(11'sh0) : $signed(_GEN_308); // @[src/main/scala/ScreenManager.scala 157:33 72:22]
  wire [9:0] _GEN_436 = 4'h4 == screenManagerStateReg ? $signed(10'sh0) : $signed(_GEN_322); // @[src/main/scala/ScreenManager.scala 157:33 73:22]
  wire [9:0] _GEN_437 = 4'h4 == screenManagerStateReg ? $signed(10'sh0) : $signed(_GEN_323); // @[src/main/scala/ScreenManager.scala 157:33 73:22]
  wire [9:0] _GEN_438 = 4'h4 == screenManagerStateReg ? $signed(10'sh0) : $signed(_GEN_324); // @[src/main/scala/ScreenManager.scala 157:33 73:22]
  wire  _GEN_452 = 4'h4 == screenManagerStateReg ? 1'h0 : _GEN_338; // @[src/main/scala/ScreenManager.scala 157:33 74:20]
  wire  _GEN_453 = 4'h4 == screenManagerStateReg ? 1'h0 : _GEN_339; // @[src/main/scala/ScreenManager.scala 157:33 74:20]
  wire  _GEN_454 = 4'h4 == screenManagerStateReg ? 1'h0 : _GEN_340; // @[src/main/scala/ScreenManager.scala 157:33 74:20]
  wire  _GEN_468 = 4'h4 == screenManagerStateReg ? 1'h0 : _GEN_354; // @[src/main/scala/ScreenManager.scala 157:33 75:27]
  wire  _GEN_469 = 4'h4 == screenManagerStateReg ? 1'h0 : _GEN_355; // @[src/main/scala/ScreenManager.scala 157:33 75:27]
  wire  _GEN_485 = 4'h4 == screenManagerStateReg ? 1'h0 : _GEN_371; // @[src/main/scala/ScreenManager.scala 157:33 76:25]
  wire  _GEN_486 = 4'h4 == screenManagerStateReg ? 1'h0 : _GEN_372; // @[src/main/scala/ScreenManager.scala 157:33 76:25]
  wire [9:0] _GEN_500 = 4'h4 == screenManagerStateReg ? viewBoxXReg : _GEN_386; // @[src/main/scala/ScreenManager.scala 102:15 157:33]
  wire [8:0] _GEN_501 = 4'h4 == screenManagerStateReg ? viewBoxYReg : _GEN_387; // @[src/main/scala/ScreenManager.scala 103:15 157:33]
  wire [10:0] _GEN_502 = 4'h4 == screenManagerStateReg ? screenLoader_io_tileAddress : _GEN_388; // @[src/main/scala/ScreenManager.scala 114:29 157:33]
  wire  _GEN_504 = 4'h4 == screenManagerStateReg ? 1'h0 : _GEN_390; // @[src/main/scala/ScreenManager.scala 157:33 130:42]
  wire  _GEN_505 = 4'h4 == screenManagerStateReg ? 1'h0 : _GEN_391; // @[src/main/scala/ScreenManager.scala 121:25 157:33]
  wire [1:0] _GEN_506 = 4'h4 == screenManagerStateReg ? currentScreenReg : _GEN_392; // @[src/main/scala/ScreenManager.scala 107:33 157:33]
  wire [7:0] _GEN_507 = 4'h4 == screenManagerStateReg ? finishTimeReg_0 : _GEN_393; // @[src/main/scala/ScreenManager.scala 148:30 157:33]
  wire [7:0] _GEN_508 = 4'h4 == screenManagerStateReg ? finishTimeReg_1 : _GEN_394; // @[src/main/scala/ScreenManager.scala 148:30 157:33]
  wire [7:0] _GEN_509 = 4'h4 == screenManagerStateReg ? finishTimeReg_2 : _GEN_395; // @[src/main/scala/ScreenManager.scala 148:30 157:33]
  wire [7:0] _GEN_510 = 4'h4 == screenManagerStateReg ? finishTimeReg_3 : _GEN_396; // @[src/main/scala/ScreenManager.scala 148:30 157:33]
  wire  _GEN_511 = 4'h4 == screenManagerStateReg ? btnCPressed : _GEN_397; // @[src/main/scala/ScreenManager.scala 151:28 157:33]
  wire [9:0] _GEN_512 = 4'h4 == screenManagerStateReg ? viewBoxXReg : _GEN_398; // @[src/main/scala/ScreenManager.scala 100:28 157:33]
  wire [8:0] _GEN_513 = 4'h4 == screenManagerStateReg ? viewBoxYReg : _GEN_399; // @[src/main/scala/ScreenManager.scala 101:28 157:33]
  wire [3:0] _GEN_514 = 4'h4 == screenManagerStateReg ? selectedTrackReg : _GEN_400; // @[src/main/scala/ScreenManager.scala 138:33 157:33]
  wire  _GEN_515 = 4'h4 == screenManagerStateReg ? btnRPressed : _GEN_401; // @[src/main/scala/ScreenManager.scala 153:28 157:33]
  wire  _GEN_516 = 4'h4 == screenManagerStateReg ? btnLPressed : _GEN_402; // @[src/main/scala/ScreenManager.scala 152:28 157:33]
  wire [3:0] _GEN_518 = 4'h3 == screenManagerStateReg ? _GEN_10 : _GEN_407; // @[src/main/scala/ScreenManager.scala 157:33]
  wire [1:0] _GEN_519 = 4'h3 == screenManagerStateReg ? _GEN_11 : _GEN_506; // @[src/main/scala/ScreenManager.scala 157:33]
  wire  _GEN_520 = 4'h3 == screenManagerStateReg ? 1'h0 : 4'h4 == screenManagerStateReg; // @[src/main/scala/ScreenManager.scala 141:23 157:33]
  wire [5:0] _GEN_521 = 4'h3 == screenManagerStateReg ? screenLoader_io_backBufferWriteData : _GEN_404; // @[src/main/scala/ScreenManager.scala 133:26 157:33]
  wire [10:0] _GEN_522 = 4'h3 == screenManagerStateReg ? screenLoader_io_backBufferWriteAddress : _GEN_405; // @[src/main/scala/ScreenManager.scala 134:29 157:33]
  wire  _GEN_523 = 4'h3 == screenManagerStateReg ? screenLoader_io_backBufferWriteEnable : _GEN_406; // @[src/main/scala/ScreenManager.scala 135:28 157:33]
  wire  _GEN_524 = 4'h3 == screenManagerStateReg ? 1'h0 : _GEN_408; // @[src/main/scala/ScreenManager.scala 115:24 157:33]
  wire [3:0] _GEN_525 = 4'h3 == screenManagerStateReg ? 4'h0 : _GEN_409; // @[src/main/scala/ScreenManager.scala 113:28 157:33]
  wire  _GEN_526 = 4'h3 == screenManagerStateReg ? 1'h0 : _GEN_411; // @[src/main/scala/ScreenManager.scala 146:29 157:33]
  wire [10:0] _GEN_535 = 4'h3 == screenManagerStateReg ? $signed(11'sh0) : $signed(_GEN_420); // @[src/main/scala/ScreenManager.scala 157:33 72:22]
  wire [10:0] _GEN_536 = 4'h3 == screenManagerStateReg ? $signed(11'sh0) : $signed(_GEN_421); // @[src/main/scala/ScreenManager.scala 157:33 72:22]
  wire [10:0] _GEN_537 = 4'h3 == screenManagerStateReg ? $signed(11'sh0) : $signed(_GEN_422); // @[src/main/scala/ScreenManager.scala 157:33 72:22]
  wire [9:0] _GEN_551 = 4'h3 == screenManagerStateReg ? $signed(10'sh0) : $signed(_GEN_436); // @[src/main/scala/ScreenManager.scala 157:33 73:22]
  wire [9:0] _GEN_552 = 4'h3 == screenManagerStateReg ? $signed(10'sh0) : $signed(_GEN_437); // @[src/main/scala/ScreenManager.scala 157:33 73:22]
  wire [9:0] _GEN_553 = 4'h3 == screenManagerStateReg ? $signed(10'sh0) : $signed(_GEN_438); // @[src/main/scala/ScreenManager.scala 157:33 73:22]
  wire  _GEN_567 = 4'h3 == screenManagerStateReg ? 1'h0 : _GEN_452; // @[src/main/scala/ScreenManager.scala 157:33 74:20]
  wire  _GEN_568 = 4'h3 == screenManagerStateReg ? 1'h0 : _GEN_453; // @[src/main/scala/ScreenManager.scala 157:33 74:20]
  wire  _GEN_569 = 4'h3 == screenManagerStateReg ? 1'h0 : _GEN_454; // @[src/main/scala/ScreenManager.scala 157:33 74:20]
  wire  _GEN_583 = 4'h3 == screenManagerStateReg ? 1'h0 : _GEN_468; // @[src/main/scala/ScreenManager.scala 157:33 75:27]
  wire  _GEN_584 = 4'h3 == screenManagerStateReg ? 1'h0 : _GEN_469; // @[src/main/scala/ScreenManager.scala 157:33 75:27]
  wire  _GEN_600 = 4'h3 == screenManagerStateReg ? 1'h0 : _GEN_485; // @[src/main/scala/ScreenManager.scala 157:33 76:25]
  wire  _GEN_601 = 4'h3 == screenManagerStateReg ? 1'h0 : _GEN_486; // @[src/main/scala/ScreenManager.scala 157:33 76:25]
  wire [9:0] _GEN_615 = 4'h3 == screenManagerStateReg ? viewBoxXReg : _GEN_500; // @[src/main/scala/ScreenManager.scala 102:15 157:33]
  wire [8:0] _GEN_616 = 4'h3 == screenManagerStateReg ? viewBoxYReg : _GEN_501; // @[src/main/scala/ScreenManager.scala 103:15 157:33]
  wire [10:0] _GEN_617 = 4'h3 == screenManagerStateReg ? screenLoader_io_tileAddress : _GEN_502; // @[src/main/scala/ScreenManager.scala 114:29 157:33]
  wire  _GEN_619 = 4'h3 == screenManagerStateReg ? 1'h0 : _GEN_504; // @[src/main/scala/ScreenManager.scala 157:33 130:42]
  wire  _GEN_620 = 4'h3 == screenManagerStateReg ? 1'h0 : _GEN_505; // @[src/main/scala/ScreenManager.scala 121:25 157:33]
  wire [7:0] _GEN_621 = 4'h3 == screenManagerStateReg ? finishTimeReg_0 : _GEN_507; // @[src/main/scala/ScreenManager.scala 148:30 157:33]
  wire [7:0] _GEN_622 = 4'h3 == screenManagerStateReg ? finishTimeReg_1 : _GEN_508; // @[src/main/scala/ScreenManager.scala 148:30 157:33]
  wire [7:0] _GEN_623 = 4'h3 == screenManagerStateReg ? finishTimeReg_2 : _GEN_509; // @[src/main/scala/ScreenManager.scala 148:30 157:33]
  wire [7:0] _GEN_624 = 4'h3 == screenManagerStateReg ? finishTimeReg_3 : _GEN_510; // @[src/main/scala/ScreenManager.scala 148:30 157:33]
  wire  _GEN_625 = 4'h3 == screenManagerStateReg ? btnCPressed : _GEN_511; // @[src/main/scala/ScreenManager.scala 151:28 157:33]
  wire [9:0] _GEN_626 = 4'h3 == screenManagerStateReg ? viewBoxXReg : _GEN_512; // @[src/main/scala/ScreenManager.scala 100:28 157:33]
  wire [8:0] _GEN_627 = 4'h3 == screenManagerStateReg ? viewBoxYReg : _GEN_513; // @[src/main/scala/ScreenManager.scala 101:28 157:33]
  wire [3:0] _GEN_628 = 4'h3 == screenManagerStateReg ? selectedTrackReg : _GEN_514; // @[src/main/scala/ScreenManager.scala 138:33 157:33]
  wire  _GEN_629 = 4'h3 == screenManagerStateReg ? btnRPressed : _GEN_515; // @[src/main/scala/ScreenManager.scala 153:28 157:33]
  wire  _GEN_630 = 4'h3 == screenManagerStateReg ? btnLPressed : _GEN_516; // @[src/main/scala/ScreenManager.scala 152:28 157:33]
  wire  _GEN_635 = 4'h2 == screenManagerStateReg ? 1'h0 : _GEN_520; // @[src/main/scala/ScreenManager.scala 141:23 157:33]
  wire [5:0] _GEN_636 = 4'h2 == screenManagerStateReg ? screenLoader_io_backBufferWriteData : _GEN_521; // @[src/main/scala/ScreenManager.scala 133:26 157:33]
  wire [10:0] _GEN_637 = 4'h2 == screenManagerStateReg ? screenLoader_io_backBufferWriteAddress : _GEN_522; // @[src/main/scala/ScreenManager.scala 134:29 157:33]
  wire  _GEN_638 = 4'h2 == screenManagerStateReg ? screenLoader_io_backBufferWriteEnable : _GEN_523; // @[src/main/scala/ScreenManager.scala 135:28 157:33]
  wire  _GEN_639 = 4'h2 == screenManagerStateReg ? 1'h0 : _GEN_524; // @[src/main/scala/ScreenManager.scala 115:24 157:33]
  wire [3:0] _GEN_640 = 4'h2 == screenManagerStateReg ? 4'h0 : _GEN_525; // @[src/main/scala/ScreenManager.scala 113:28 157:33]
  wire  _GEN_641 = 4'h2 == screenManagerStateReg ? 1'h0 : _GEN_526; // @[src/main/scala/ScreenManager.scala 146:29 157:33]
  wire [10:0] _GEN_650 = 4'h2 == screenManagerStateReg ? $signed(11'sh0) : $signed(_GEN_535); // @[src/main/scala/ScreenManager.scala 157:33 72:22]
  wire [10:0] _GEN_651 = 4'h2 == screenManagerStateReg ? $signed(11'sh0) : $signed(_GEN_536); // @[src/main/scala/ScreenManager.scala 157:33 72:22]
  wire [10:0] _GEN_652 = 4'h2 == screenManagerStateReg ? $signed(11'sh0) : $signed(_GEN_537); // @[src/main/scala/ScreenManager.scala 157:33 72:22]
  wire [9:0] _GEN_666 = 4'h2 == screenManagerStateReg ? $signed(10'sh0) : $signed(_GEN_551); // @[src/main/scala/ScreenManager.scala 157:33 73:22]
  wire [9:0] _GEN_667 = 4'h2 == screenManagerStateReg ? $signed(10'sh0) : $signed(_GEN_552); // @[src/main/scala/ScreenManager.scala 157:33 73:22]
  wire [9:0] _GEN_668 = 4'h2 == screenManagerStateReg ? $signed(10'sh0) : $signed(_GEN_553); // @[src/main/scala/ScreenManager.scala 157:33 73:22]
  wire  _GEN_682 = 4'h2 == screenManagerStateReg ? 1'h0 : _GEN_567; // @[src/main/scala/ScreenManager.scala 157:33 74:20]
  wire  _GEN_683 = 4'h2 == screenManagerStateReg ? 1'h0 : _GEN_568; // @[src/main/scala/ScreenManager.scala 157:33 74:20]
  wire  _GEN_684 = 4'h2 == screenManagerStateReg ? 1'h0 : _GEN_569; // @[src/main/scala/ScreenManager.scala 157:33 74:20]
  wire  _GEN_698 = 4'h2 == screenManagerStateReg ? 1'h0 : _GEN_583; // @[src/main/scala/ScreenManager.scala 157:33 75:27]
  wire  _GEN_699 = 4'h2 == screenManagerStateReg ? 1'h0 : _GEN_584; // @[src/main/scala/ScreenManager.scala 157:33 75:27]
  wire  _GEN_715 = 4'h2 == screenManagerStateReg ? 1'h0 : _GEN_600; // @[src/main/scala/ScreenManager.scala 157:33 76:25]
  wire  _GEN_716 = 4'h2 == screenManagerStateReg ? 1'h0 : _GEN_601; // @[src/main/scala/ScreenManager.scala 157:33 76:25]
  wire [9:0] _GEN_730 = 4'h2 == screenManagerStateReg ? viewBoxXReg : _GEN_615; // @[src/main/scala/ScreenManager.scala 102:15 157:33]
  wire [8:0] _GEN_731 = 4'h2 == screenManagerStateReg ? viewBoxYReg : _GEN_616; // @[src/main/scala/ScreenManager.scala 103:15 157:33]
  wire [10:0] _GEN_732 = 4'h2 == screenManagerStateReg ? screenLoader_io_tileAddress : _GEN_617; // @[src/main/scala/ScreenManager.scala 114:29 157:33]
  wire  _GEN_734 = 4'h2 == screenManagerStateReg ? 1'h0 : _GEN_619; // @[src/main/scala/ScreenManager.scala 157:33 130:42]
  wire  _GEN_735 = 4'h2 == screenManagerStateReg ? 1'h0 : _GEN_620; // @[src/main/scala/ScreenManager.scala 121:25 157:33]
  wire  _GEN_745 = 4'h1 == screenManagerStateReg | _GEN_639; // @[src/main/scala/ScreenManager.scala 157:33 168:28]
  wire [3:0] _GEN_746 = 4'h1 == screenManagerStateReg ? 4'h0 : _GEN_640; // @[src/main/scala/ScreenManager.scala 157:33 169:32]
  wire  _GEN_752 = 4'h1 == screenManagerStateReg ? 1'h0 : _GEN_635; // @[src/main/scala/ScreenManager.scala 141:23 157:33]
  wire [5:0] _GEN_753 = 4'h1 == screenManagerStateReg ? screenLoader_io_backBufferWriteData : _GEN_636; // @[src/main/scala/ScreenManager.scala 133:26 157:33]
  wire [10:0] _GEN_754 = 4'h1 == screenManagerStateReg ? screenLoader_io_backBufferWriteAddress : _GEN_637; // @[src/main/scala/ScreenManager.scala 134:29 157:33]
  wire  _GEN_755 = 4'h1 == screenManagerStateReg ? screenLoader_io_backBufferWriteEnable : _GEN_638; // @[src/main/scala/ScreenManager.scala 135:28 157:33]
  wire  _GEN_756 = 4'h1 == screenManagerStateReg ? 1'h0 : _GEN_641; // @[src/main/scala/ScreenManager.scala 146:29 157:33]
  wire [10:0] _GEN_765 = 4'h1 == screenManagerStateReg ? $signed(11'sh0) : $signed(_GEN_650); // @[src/main/scala/ScreenManager.scala 157:33 72:22]
  wire [10:0] _GEN_766 = 4'h1 == screenManagerStateReg ? $signed(11'sh0) : $signed(_GEN_651); // @[src/main/scala/ScreenManager.scala 157:33 72:22]
  wire [10:0] _GEN_767 = 4'h1 == screenManagerStateReg ? $signed(11'sh0) : $signed(_GEN_652); // @[src/main/scala/ScreenManager.scala 157:33 72:22]
  wire [9:0] _GEN_781 = 4'h1 == screenManagerStateReg ? $signed(10'sh0) : $signed(_GEN_666); // @[src/main/scala/ScreenManager.scala 157:33 73:22]
  wire [9:0] _GEN_782 = 4'h1 == screenManagerStateReg ? $signed(10'sh0) : $signed(_GEN_667); // @[src/main/scala/ScreenManager.scala 157:33 73:22]
  wire [9:0] _GEN_783 = 4'h1 == screenManagerStateReg ? $signed(10'sh0) : $signed(_GEN_668); // @[src/main/scala/ScreenManager.scala 157:33 73:22]
  wire  _GEN_797 = 4'h1 == screenManagerStateReg ? 1'h0 : _GEN_682; // @[src/main/scala/ScreenManager.scala 157:33 74:20]
  wire  _GEN_798 = 4'h1 == screenManagerStateReg ? 1'h0 : _GEN_683; // @[src/main/scala/ScreenManager.scala 157:33 74:20]
  wire  _GEN_799 = 4'h1 == screenManagerStateReg ? 1'h0 : _GEN_684; // @[src/main/scala/ScreenManager.scala 157:33 74:20]
  wire  _GEN_813 = 4'h1 == screenManagerStateReg ? 1'h0 : _GEN_698; // @[src/main/scala/ScreenManager.scala 157:33 75:27]
  wire  _GEN_814 = 4'h1 == screenManagerStateReg ? 1'h0 : _GEN_699; // @[src/main/scala/ScreenManager.scala 157:33 75:27]
  wire  _GEN_830 = 4'h1 == screenManagerStateReg ? 1'h0 : _GEN_715; // @[src/main/scala/ScreenManager.scala 157:33 76:25]
  wire  _GEN_831 = 4'h1 == screenManagerStateReg ? 1'h0 : _GEN_716; // @[src/main/scala/ScreenManager.scala 157:33 76:25]
  wire [9:0] _GEN_845 = 4'h1 == screenManagerStateReg ? viewBoxXReg : _GEN_730; // @[src/main/scala/ScreenManager.scala 102:15 157:33]
  wire [8:0] _GEN_846 = 4'h1 == screenManagerStateReg ? viewBoxYReg : _GEN_731; // @[src/main/scala/ScreenManager.scala 103:15 157:33]
  wire [10:0] _GEN_847 = 4'h1 == screenManagerStateReg ? screenLoader_io_tileAddress : _GEN_732; // @[src/main/scala/ScreenManager.scala 114:29 157:33]
  wire  _GEN_849 = 4'h1 == screenManagerStateReg ? 1'h0 : _GEN_734; // @[src/main/scala/ScreenManager.scala 157:33 130:42]
  wire  _GEN_850 = 4'h1 == screenManagerStateReg ? 1'h0 : _GEN_735; // @[src/main/scala/ScreenManager.scala 121:25 157:33]
  wire [3:0] _GEN_862 = 4'h0 == screenManagerStateReg ? 4'h0 : _GEN_746; // @[src/main/scala/ScreenManager.scala 113:28 157:33]
  reg  io_frameUpdateDone_REG; // @[src/main/scala/ScreenManager.scala 337:40]
  reg  io_frameUpdateDone_REG_1; // @[src/main/scala/ScreenManager.scala 337:32]
  ...
  RaceManager raceManager ( // @[src/main/scala/ScreenManager.scala 119:27]
    ...
    .io_time_0(raceManager_io_time_0),
    .io_time_1(raceManager_io_time_1),
    .io_time_2(raceManager_io_time_2),
    .io_time_3(raceManager_io_time_3),
  ...
  ScoreboardPrinter scoreboardPrinter ( // @[src/main/scala/ScreenManager.scala 145:33]
    ...
    .io_time_0(scoreboardPrinter_io_time_0),
    .io_time_1(scoreboardPrinter_io_time_1),
    .io_time_2(scoreboardPrinter_io_time_2),
    .io_time_3(scoreboardPrinter_io_time_3),
  ...
  assign io_spriteXPosition_0 = 4'h0 == screenManagerStateReg ? $signed(11'sh0) : $signed(_GEN_765); // @[src/main/scala/ScreenManager.scala 157:33 72:22]
  assign io_spriteXPosition_1 = 4'h0 == screenManagerStateReg ? $signed(11'sh0) : $signed(_GEN_766); // @[src/main/scala/ScreenManager.scala 157:33 72:22]
  assign io_spriteXPosition_2 = 4'h0 == screenManagerStateReg ? $signed(11'sh0) : $signed(_GEN_767); // @[src/main/scala/ScreenManager.scala 157:33 72:22]
  assign io_spriteYPosition_0 = 4'h0 == screenManagerStateReg ? $signed(10'sh0) : $signed(_GEN_781); // @[src/main/scala/ScreenManager.scala 157:33 73:22]
  assign io_spriteYPosition_1 = 4'h0 == screenManagerStateReg ? $signed(10'sh0) : $signed(_GEN_782); // @[src/main/scala/ScreenManager.scala 157:33 73:22]
  assign io_spriteYPosition_2 = 4'h0 == screenManagerStateReg ? $signed(10'sh0) : $signed(_GEN_783); // @[src/main/scala/ScreenManager.scala 157:33 73:22]
  assign io_spriteVisible_0 = 4'h0 == screenManagerStateReg ? 1'h0 : _GEN_797; // @[src/main/scala/ScreenManager.scala 157:33 74:20]
  assign io_spriteVisible_1 = 4'h0 == screenManagerStateReg ? 1'h0 : _GEN_798; // @[src/main/scala/ScreenManager.scala 157:33 74:20]
  assign io_spriteVisible_2 = 4'h0 == screenManagerStateReg ? 1'h0 : _GEN_799; // @[src/main/scala/ScreenManager.scala 157:33 74:20]
  assign io_spriteFlipHorizontal_0 = 4'h0 == screenManagerStateReg ? 1'h0 : _GEN_813; // @[src/main/scala/ScreenManager.scala 157:33 75:27]
  assign io_spriteFlipHorizontal_1 = 4'h0 == screenManagerStateReg ? 1'h0 : _GEN_814; // @[src/main/scala/ScreenManager.scala 157:33 75:27]
  assign io_spriteFlipVertical_1 = 4'h0 == screenManagerStateReg ? 1'h0 : _GEN_830; // @[src/main/scala/ScreenManager.scala 157:33 76:25]
  assign io_spriteFlipVertical_2 = 4'h0 == screenManagerStateReg ? 1'h0 : _GEN_831; // @[src/main/scala/ScreenManager.scala 157:33 76:25]
  assign io_viewBoxX = 4'h0 == screenManagerStateReg ? viewBoxXReg : _GEN_845; // @[src/main/scala/ScreenManager.scala 102:15 157:33]
  assign io_viewBoxY = 4'h0 == screenManagerStateReg ? viewBoxYReg : _GEN_846; // @[src/main/scala/ScreenManager.scala 103:15 157:33]
  assign io_backBufferWriteData = 4'h0 == screenManagerStateReg ? screenLoader_io_backBufferWriteData : _GEN_753; // @[src/main/scala/ScreenManager.scala 133:26 157:33]
  assign io_backBufferWriteAddress = 4'h0 == screenManagerStateReg ? screenLoader_io_backBufferWriteAddress : _GEN_754; // @[src/main/scala/ScreenManager.scala 134:29 157:33]
  assign io_backBufferWriteEnable = 4'h0 == screenManagerStateReg ? screenLoader_io_backBufferWriteEnable : _GEN_755; // @[src/main/scala/ScreenManager.scala 135:28 157:33]
  assign io_frameUpdateDone = io_frameUpdateDone_REG_1; // @[src/main/scala/ScreenManager.scala 337:22]
  assign tilemapRom_clock = clock;
  assign tilemapRom_io_tileAddress = 4'h0 == screenManagerStateReg ? screenLoader_io_tileAddress : _GEN_847; // @[src/main/scala/ScreenManager.scala 114:29 157:33]
  assign tilemapRom_io_tilemapIdx = _GEN_862[2:0];
  assign screenLoader_clock = clock;
  assign screenLoader_reset = reset;
  assign screenLoader_io_load = 4'h0 == screenManagerStateReg ? 1'h0 : _GEN_745; // @[src/main/scala/ScreenManager.scala 115:24 157:33]
  ...
  assign raceManager_io_enable = 4'h0 == screenManagerStateReg ? 1'h0 : _GEN_850; // @[src/main/scala/ScreenManager.scala 121:25 157:33]
  assign raceManager_io_tilemapRomCollisionData = 4'h0 == screenManagerStateReg ? 1'h0 : _GEN_849; // @[src/main/scala/ScreenManager.scala 157:33 130:42]
  ...
  assign menuPrinter_io_load = 4'h0 == screenManagerStateReg ? 1'h0 : _GEN_752; // @[src/main/scala/ScreenManager.scala 141:23 157:33]
  ...
  assign scoreboardPrinter_io_load = 4'h0 == screenManagerStateReg ? 1'h0 : _GEN_756; // @[src/main/scala/ScreenManager.scala 146:29 157:33]
  assign scoreboardPrinter_io_time_0 = finishTimeReg_0; // @[src/main/scala/ScreenManager.scala 149:29]
  assign scoreboardPrinter_io_time_1 = finishTimeReg_1; // @[src/main/scala/ScreenManager.scala 149:29]
  assign scoreboardPrinter_io_time_2 = finishTimeReg_2; // @[src/main/scala/ScreenManager.scala 149:29]
  assign scoreboardPrinter_io_time_3 = finishTimeReg_3; // @[src/main/scala/ScreenManager.scala 149:29]
  ...
  always @(posedge clock) begin
    ...
    end else if (!(4'h0 == screenManagerStateReg)) begin // @[src/main/scala/ScreenManager.scala 157:33]
      if (4'h1 == screenManagerStateReg) begin // @[src/main/scala/ScreenManager.scala 157:33]
        if (currentScreenReg == 2'h0) begin // @[src/main/scala/ScreenManager.scala 177:46]
          viewBoxXReg <= 10'h0; // @[src/main/scala/ScreenManager.scala 178:21]
        end else begin
          viewBoxXReg <= _GEN_4;
        end
      end else if (4'h2 == screenManagerStateReg) begin // @[src/main/scala/ScreenManager.scala 157:33]
        viewBoxXReg <= _GEN_8;
      end else begin
        viewBoxXReg <= _GEN_626;
      end
    end
    if (reset) begin // @[src/main/scala/ScreenManager.scala 101:28]
      ...
      if (4'h1 == screenManagerStateReg) begin // @[src/main/scala/ScreenManager.scala 157:33]
        if (currentScreenReg == 2'h0) begin // @[src/main/scala/ScreenManager.scala 177:46]
          viewBoxYReg <= 9'h0; // @[src/main/scala/ScreenManager.scala 179:21]
        end else begin
          viewBoxYReg <= _GEN_5;
        end
      end else if (!(4'h2 == screenManagerStateReg)) begin // @[src/main/scala/ScreenManager.scala 157:33]
        viewBoxYReg <= _GEN_627;
      end
    end
    if (reset) begin // @[src/main/scala/ScreenManager.scala 106:38]
      ...
      if (io_newFrame) begin // @[src/main/scala/ScreenManager.scala 160:25]
        screenManagerStateReg <= 4'h1; // @[src/main/scala/ScreenManager.scala 162:31]
      end
    end else if (4'h1 == screenManagerStateReg) begin // @[src/main/scala/ScreenManager.scala 157:33]
      if (screenLoader_io_done) begin // @[src/main/scala/ScreenManager.scala 172:34]
        screenManagerStateReg <= 4'h7; // @[src/main/scala/ScreenManager.scala 174:31]
      end
    end else if (4'h2 == screenManagerStateReg) begin // @[src/main/scala/ScreenManager.scala 157:33]
      screenManagerStateReg <= _GEN_9;
    end else begin
      screenManagerStateReg <= _GEN_518;
    end
    if (reset) begin // @[src/main/scala/ScreenManager.scala 107:33]
      currentScreenReg <= 2'h0; // @[src/main/scala/ScreenManager.scala 107:33]
    end else if (4'h0 == screenManagerStateReg) begin // @[src/main/scala/ScreenManager.scala 157:33]
      if (io_newFrame) begin // @[src/main/scala/ScreenManager.scala 160:25]
        currentScreenReg <= 2'h0; // @[src/main/scala/ScreenManager.scala 161:26]
      end
    end else if (!(4'h1 == screenManagerStateReg)) begin // @[src/main/scala/ScreenManager.scala 157:33]
      if (!(4'h2 == screenManagerStateReg)) begin // @[src/main/scala/ScreenManager.scala 157:33]
        currentScreenReg <= _GEN_519;
      end
    end
    if (reset) begin // @[src/main/scala/ScreenManager.scala 138:33]
      ...
      if (!(4'h1 == screenManagerStateReg)) begin // @[src/main/scala/ScreenManager.scala 157:33]
        if (!(4'h2 == screenManagerStateReg)) begin // @[src/main/scala/ScreenManager.scala 157:33]
          selectedTrackReg <= _GEN_628;
        end
      end
    end
    if (reset) begin // @[src/main/scala/ScreenManager.scala 148:30]
      finishTimeReg_0 <= 8'h0; // @[src/main/scala/ScreenManager.scala 148:30]
    end else if (!(4'h0 == screenManagerStateReg)) begin // @[src/main/scala/ScreenManager.scala 157:33]
      if (!(4'h1 == screenManagerStateReg)) begin // @[src/main/scala/ScreenManager.scala 157:33]
        if (!(4'h2 == screenManagerStateReg)) begin // @[src/main/scala/ScreenManager.scala 157:33]
          finishTimeReg_0 <= _GEN_621;
        end
      end
    end
    if (reset) begin // @[src/main/scala/ScreenManager.scala 148:30]
      finishTimeReg_1 <= 8'h0; // @[src/main/scala/ScreenManager.scala 148:30]
    end else if (!(4'h0 == screenManagerStateReg)) begin // @[src/main/scala/ScreenManager.scala 157:33]
      if (!(4'h1 == screenManagerStateReg)) begin // @[src/main/scala/ScreenManager.scala 157:33]
        if (!(4'h2 == screenManagerStateReg)) begin // @[src/main/scala/ScreenManager.scala 157:33]
          finishTimeReg_1 <= _GEN_622;
        end
      end
    end
    if (reset) begin // @[src/main/scala/ScreenManager.scala 148:30]
      finishTimeReg_2 <= 8'h0; // @[src/main/scala/ScreenManager.scala 148:30]
    end else if (!(4'h0 == screenManagerStateReg)) begin // @[src/main/scala/ScreenManager.scala 157:33]
      if (!(4'h1 == screenManagerStateReg)) begin // @[src/main/scala/ScreenManager.scala 157:33]
        if (!(4'h2 == screenManagerStateReg)) begin // @[src/main/scala/ScreenManager.scala 157:33]
          finishTimeReg_2 <= _GEN_623;
        end
      end
    end
    if (reset) begin // @[src/main/scala/ScreenManager.scala 148:30]
      finishTimeReg_3 <= 8'h0; // @[src/main/scala/ScreenManager.scala 148:30]
    end else if (!(4'h0 == screenManagerStateReg)) begin // @[src/main/scala/ScreenManager.scala 157:33]
      if (!(4'h1 == screenManagerStateReg)) begin // @[src/main/scala/ScreenManager.scala 157:33]
        if (!(4'h2 == screenManagerStateReg)) begin // @[src/main/scala/ScreenManager.scala 157:33]
          finishTimeReg_3 <= _GEN_624;
        end
      end
    end
    if (reset) begin // @[src/main/scala/ScreenManager.scala 151:28]
      btnCPressed <= 1'h0; // @[src/main/scala/ScreenManager.scala 151:28]
    end else if (!(4'h0 == screenManagerStateReg)) begin // @[src/main/scala/ScreenManager.scala 157:33]
      if (!(4'h1 == screenManagerStateReg)) begin // @[src/main/scala/ScreenManager.scala 157:33]
        if (!(4'h2 == screenManagerStateReg)) begin // @[src/main/scala/ScreenManager.scala 157:33]
          btnCPressed <= _GEN_625;
        end
      end
    end
    if (reset) begin // @[src/main/scala/ScreenManager.scala 152:28]
      btnLPressed <= 1'h0; // @[src/main/scala/ScreenManager.scala 152:28]
    end else if (!(4'h0 == screenManagerStateReg)) begin // @[src/main/scala/ScreenManager.scala 157:33]
      if (!(4'h1 == screenManagerStateReg)) begin // @[src/main/scala/ScreenManager.scala 157:33]
        if (!(4'h2 == screenManagerStateReg)) begin // @[src/main/scala/ScreenManager.scala 157:33]
          btnLPressed <= _GEN_630;
        end
      end
    end
    if (reset) begin // @[src/main/scala/ScreenManager.scala 153:28]
      btnRPressed <= 1'h0; // @[src/main/scala/ScreenManager.scala 153:28]
    end else if (!(4'h0 == screenManagerStateReg)) begin // @[src/main/scala/ScreenManager.scala 157:33]
      if (!(4'h1 == screenManagerStateReg)) begin // @[src/main/scala/ScreenManager.scala 157:33]
        if (!(4'h2 == screenManagerStateReg)) begin // @[src/main/scala/ScreenManager.scala 157:33]
          btnRPressed <= _GEN_629;
        end
      end
    end
    io_frameUpdateDone_REG <= io_newFrame; // @[src/main/scala/ScreenManager.scala 337:40]
    io_frameUpdateDone_REG_1 <= io_frameUpdateDone_REG; // @[src/main/scala/ScreenManager.scala 337:32]
  end
// Register and memory initialization
`ifdef RANDOMIZE_GARBAGE_ASSIGN
`define RANDOMIZE
...
`ifdef RANDOMIZE_REG_INIT
  ...
  _RAND_5 = {1{`RANDOM}};
  finishTimeReg_0 = _RAND_5[7:0];
  _RAND_6 = {1{`RANDOM}};
  finishTimeReg_1 = _RAND_6[7:0];
  _RAND_7 = {1{`RANDOM}};
  finishTimeReg_2 = _RAND_7[7:0];
  _RAND_8 = {1{`RANDOM}};
  finishTimeReg_3 = _RAND_8[7:0];
  _RAND_9 = {1{`RANDOM}};
  btnCPressed = _RAND_9[0:0];
  _RAND_10 = {1{`RANDOM}};
  btnLPressed = _RAND_10[0:0];
  _RAND_11 = {1{`RANDOM}};
  btnRPressed = _RAND_11[0:0];
  _RAND_12 = {1{`RANDOM}};
  io_frameUpdateDone_REG = _RAND_12[0:0];
  _RAND_13 = {1{`RANDOM}};
  io_frameUpdateDone_REG_1 = _RAND_13[0:0];
`endif // RANDOMIZE_REG_INIT
  `endif // RANDOMIZE
end // initial
`ifdef FIRRTL_AFTER_INITIAL

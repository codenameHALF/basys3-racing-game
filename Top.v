...
`endif // RANDOMIZE_REG_INIT
  ...
  reg [31:0] sprite0XReg; // @[src/main/scala/PlayerController.scala 50:28]
  reg [31:0] sprite0YReg; // @[src/main/scala/PlayerController.scala 51:28]
  ...
  wire [15:0] _posToAddress_io_posX_T_1 = sprite0XReg[31:16]; // @[src/main/scala/PlayerController.scala 85:47]
  wire [15:0] _posToAddress_io_posY_T_1 = sprite0YReg[31:16]; // @[src/main/scala/PlayerController.scala 86:47]
  ...
  wire [47:0] _sprite0XReg_T = $signed(sprite0SpeedReg) * $signed(cosReg); // @[src/main/scala/PlayerController.scala 225:54]
  wire [39:0] _sprite0XReg_T_1 = _sprite0XReg_T[47:8]; // @[src/main/scala/PlayerController.scala 225:64]
  wire [39:0] _GEN_581 = {{8{sprite0XReg[31]}},sprite0XReg}; // @[src/main/scala/PlayerController.scala 225:34]
  wire [39:0] _sprite0XReg_T_4 = $signed(_GEN_581) + $signed(_sprite0XReg_T_1); // @[src/main/scala/PlayerController.scala 225:34]
  wire [47:0] _sprite0YReg_T = $signed(sprite0SpeedReg) * $signed(sinReg); // @[src/main/scala/PlayerController.scala 226:54]
  wire [39:0] _sprite0YReg_T_1 = _sprite0YReg_T[47:8]; // @[src/main/scala/PlayerController.scala 226:64]
  wire [39:0] _GEN_586 = {{8{sprite0YReg[31]}},sprite0YReg}; // @[src/main/scala/PlayerController.scala 226:34]
  wire [39:0] _sprite0YReg_T_4 = $signed(_GEN_586) + $signed(_sprite0YReg_T_1); // @[src/main/scala/PlayerController.scala 226:34]
  wire [31:0] _GEN_579 = io_tilemapRomCollisionData ? $signed(32'sh2400000) : $signed(sprite0XReg); // @[src/main/scala/PlayerController.scala 243:40 244:21 50:28]
  wire [31:0] _GEN_580 = io_tilemapRomCollisionData ? $signed(32'sha00000) : $signed(sprite0YReg); // @[src/main/scala/PlayerController.scala 243:40 245:21 51:28]
  wire [2:0] _GEN_582 = 3'h6 == stateReg ? 3'h0 : stateReg; // @[src/main/scala/PlayerController.scala 108:20 253:16 47:25]
  wire [31:0] _GEN_583 = 3'h4 == stateReg ? $signed(_GEN_579) : $signed(sprite0XReg); // @[src/main/scala/PlayerController.scala 108:20 50:28]
  wire [31:0] _GEN_584 = 3'h4 == stateReg ? $signed(_GEN_580) : $signed(sprite0YReg); // @[src/main/scala/PlayerController.scala 108:20 51:28]
  wire [2:0] _GEN_585 = 3'h4 == stateReg ? 3'h6 : _GEN_582; // @[src/main/scala/PlayerController.scala 108:20 248:16]
  wire [10:0] _GEN_587 = 3'h5 == stateReg ? posToAddress_io_address : tilemapRomTileAddrReg; // @[src/main/scala/PlayerController.scala 108:20 237:31 88:38]
  wire [2:0] _GEN_588 = 3'h5 == stateReg ? 3'h4 : _GEN_585; // @[src/main/scala/PlayerController.scala 108:20 239:18]
  wire [31:0] _GEN_589 = 3'h5 == stateReg ? $signed(sprite0XReg) : $signed(_GEN_583); // @[src/main/scala/PlayerController.scala 108:20 50:28]
  wire [31:0] _GEN_590 = 3'h5 == stateReg ? $signed(sprite0YReg) : $signed(_GEN_584); // @[src/main/scala/PlayerController.scala 108:20 51:28]
  wire [2:0] _GEN_592 = 3'h3 == stateReg ? 3'h5 : _GEN_588; // @[src/main/scala/PlayerController.scala 108:20 233:16]
  wire [10:0] _GEN_593 = 3'h3 == stateReg ? tilemapRomTileAddrReg : _GEN_587; // @[src/main/scala/PlayerController.scala 108:20 88:38]
  wire [31:0] _GEN_594 = 3'h3 == stateReg ? $signed(sprite0XReg) : $signed(_GEN_589); // @[src/main/scala/PlayerController.scala 108:20 50:28]
  wire [31:0] _GEN_595 = 3'h3 == stateReg ? $signed(sprite0YReg) : $signed(_GEN_590); // @[src/main/scala/PlayerController.scala 108:20 51:28]
  wire [39:0] _GEN_597 = 3'h2 == stateReg ? $signed(_sprite0XReg_T_4) : $signed({{8{_GEN_594[31]}},_GEN_594}); // @[src/main/scala/PlayerController.scala 108:20 225:19]
  wire [39:0] _GEN_598 = 3'h2 == stateReg ? $signed(_sprite0YReg_T_4) : $signed({{8{_GEN_595[31]}},_GEN_595}); // @[src/main/scala/PlayerController.scala 108:20 226:19]
  wire  _GEN_604 = 3'h1 == stateReg ? _GEN_59 : sprite0Visible; // @[src/main/scala/PlayerController.scala 108:20 80:31]
  wire [39:0] _GEN_615 = 3'h1 == stateReg ? $signed({{8{sprite0XReg[31]}},sprite0XReg}) : $signed(_GEN_597); // @[src/main/scala/PlayerController.scala 108:20 50:28]
  wire [39:0] _GEN_616 = 3'h1 == stateReg ? $signed({{8{sprite0YReg[31]}},sprite0YReg}) : $signed(_GEN_598); // @[src/main/scala/PlayerController.scala 108:20 51:28]
  wire  _GEN_622 = 3'h0 == stateReg ? sprite0Visible : _GEN_604; // @[src/main/scala/PlayerController.scala 108:20 80:31]
  wire [39:0] _GEN_632 = 3'h0 == stateReg ? $signed({{8{sprite0XReg[31]}},sprite0XReg}) : $signed(_GEN_615); // @[src/main/scala/PlayerController.scala 108:20 50:28]
  wire [39:0] _GEN_633 = 3'h0 == stateReg ? $signed({{8{sprite0YReg[31]}},sprite0YReg}) : $signed(_GEN_616); // @[src/main/scala/PlayerController.scala 108:20 51:28]
  wire [39:0] _GEN_591 = reset ? $signed(40'sh2400000) : $signed(_GEN_632); // @[src/main/scala/PlayerController.scala 50:{28,28}]
  wire [39:0] _GEN_601 = reset ? $signed(40'sha00000) : $signed(_GEN_633); // @[src/main/scala/PlayerController.scala 51:{28,28}]
  ...
  always @(posedge clock) begin
    ...
    sprite0XReg <= _GEN_591[31:0]; // @[src/main/scala/PlayerController.scala 50:{28,28}]
    sprite0YReg <= _GEN_601[31:0]; // @[src/main/scala/PlayerController.scala 51:{28,28}]
...
`ifdef RANDOMIZE_REG_INIT
  ...
  _RAND_1 = {1{`RANDOM}};
  sprite0XReg = _RAND_1[31:0];
  _RAND_2 = {1{`RANDOM}};
  sprite0YReg = _RAND_2[31:0];
  _RAND_3 = {1{`RANDOM}};

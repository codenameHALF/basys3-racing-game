...
module AddressToPosition(
  ...
  wire [26:0] addressY = io_address * 11'h667; // @[src/main/scala/AddressToPosition.scala 11:31]
  wire [10:0] y_tile = addressY[26:16]; // @[src/main/scala/AddressToPosition.scala 12:27]
  wire [15:0] _x_tile_T = {y_tile, 5'h0}; // @[src/main/scala/AddressToPosition.scala 13:44]
  wire [13:0] _x_tile_T_1 = {y_tile, 3'h0}; // @[src/main/scala/AddressToPosition.scala 13:60]
  wire [15:0] _GEN_0 = {{2'd0}, _x_tile_T_1}; // @[src/main/scala/AddressToPosition.scala 13:50]
  wire [15:0] _x_tile_T_3 = _x_tile_T + _GEN_0; // @[src/main/scala/AddressToPosition.scala 13:50]
  wire [15:0] x_tile = io_address - _x_tile_T_3; // @[src/main/scala/AddressToPosition.scala 13:33]
  wire [20:0] _io_posX_T = {x_tile, 5'h0}; // @[src/main/scala/AddressToPosition.scala 15:23]
  assign io_posX = _io_posX_T[15:0]; // @[src/main/scala/AddressToPosition.scala 15:13]
  assign io_posY = {y_tile, 5'h0}; // @[src/main/scala/AddressToPosition.scala 14:23]
endmodule
...
`ifdef RANDOMIZE_REG_INIT
  ...
  reg [31:0] _RAND_15;
`endif // RANDOMIZE_REG_INIT
  wire [10:0] posToAddress_io_posX; // @[src/main/scala/PlayerController.scala 99:28]
  wire [9:0] posToAddress_io_posY; // @[src/main/scala/PlayerController.scala 99:28]
  wire [10:0] posToAddress_io_address; // @[src/main/scala/PlayerController.scala 99:28]
  wire [15:0] addressToPosition_io_posX; // @[src/main/scala/PlayerController.scala 106:33]
  wire [15:0] addressToPosition_io_posY; // @[src/main/scala/PlayerController.scala 106:33]
  wire [15:0] addressToPosition_io_address; // @[src/main/scala/PlayerController.scala 106:33]
  reg [3:0] checkPointCntReg; // @[src/main/scala/PlayerController.scala 54:31]
  reg [2:0] stateReg; // @[src/main/scala/PlayerController.scala 64:25]
  reg [31:0] playerXPositionReg; // @[src/main/scala/PlayerController.scala 67:35]
  reg [31:0] playerYPositionReg; // @[src/main/scala/PlayerController.scala 68:35]
  reg [31:0] sprite0SpeedReg; // @[src/main/scala/PlayerController.scala 69:32]
  reg [7:0] sprite0AngleReg; // @[src/main/scala/PlayerController.scala 70:32]
  reg [15:0] cosReg; // @[src/main/scala/PlayerController.scala 72:23]
  reg [15:0] sinReg; // @[src/main/scala/PlayerController.scala 73:23]
  reg  sprite0FlipHorizontalReg; // @[src/main/scala/PlayerController.scala 87:41]
  reg  sprite1FlipHorizontalReg; // @[src/main/scala/PlayerController.scala 90:41]
  reg  sprite1FlipVerticalReg; // @[src/main/scala/PlayerController.scala 91:39]
  reg  sprite2FlipVerticalReg; // @[src/main/scala/PlayerController.scala 93:39]
  reg  sprite0Visible; // @[src/main/scala/PlayerController.scala 95:31]
  reg  sprite1Visible; // @[src/main/scala/PlayerController.scala 96:31]
  reg  sprite2Visible; // @[src/main/scala/PlayerController.scala 97:31]
  wire [15:0] _posToAddress_io_posX_T_1 = playerXPositionReg[31:16]; // @[src/main/scala/PlayerController.scala 100:54]
  wire [15:0] _posToAddress_io_posY_T_1 = playerYPositionReg[31:16]; // @[src/main/scala/PlayerController.scala 101:54]
  reg [10:0] tilemapRomTileAddrReg; // @[src/main/scala/PlayerController.scala 103:38]
  wire [10:0] _addressToPosition_io_address_T_4 = 4'h1 == checkPointCntReg ? 11'h285 : 11'h0; // @[src/main/scala/PlayerController.scala 108:67]
  wire [10:0] _addressToPosition_io_address_T_6 = 4'h2 == checkPointCntReg ? 11'h3f9 : _addressToPosition_io_address_T_4
    ; // @[src/main/scala/PlayerController.scala 108:67]
  wire [10:0] _addressToPosition_io_address_T_8 = 4'h3 == checkPointCntReg ? 11'h2a3 : _addressToPosition_io_address_T_6
    ; // @[src/main/scala/PlayerController.scala 108:67]
  wire [31:0] _T_4 = 32'sh0 - 32'sh7a120; // @[src/main/scala/PlayerController.scala 141:32]
  wire [31:0] _sprite0SpeedReg_T_2 = $signed(sprite0SpeedReg) - 32'sh5dc; // @[src/main/scala/PlayerController.scala 142:46]
  wire [31:0] _GEN_2 = $signed(sprite0SpeedReg) > $signed(_T_4) ? $signed(_sprite0SpeedReg_T_2) : $signed(
    sprite0SpeedReg); // @[src/main/scala/PlayerController.scala 141:42 142:27 69:32]
  wire [31:0] _sprite0SpeedReg_T_5 = $signed(sprite0SpeedReg) + 32'sh3e8; // @[src/main/scala/PlayerController.scala 146:46]
  wire [31:0] _GEN_3 = $signed(sprite0SpeedReg) < 32'sh7a120 ? $signed(_sprite0SpeedReg_T_5) : $signed(sprite0SpeedReg); // @[src/main/scala/PlayerController.scala 145:41 146:27 69:32]
  wire [31:0] _sprite0SpeedReg_T_8 = $signed(sprite0SpeedReg) - 32'sh190; // @[src/main/scala/PlayerController.scala 150:46]
  wire [31:0] _T_10 = 32'sh0 - 32'sh190; // @[src/main/scala/PlayerController.scala 151:38]
  wire [31:0] _sprite0SpeedReg_T_11 = $signed(sprite0SpeedReg) + 32'sh190; // @[src/main/scala/PlayerController.scala 152:46]
  wire [31:0] _GEN_4 = $signed(sprite0SpeedReg) < $signed(_T_10) ? $signed(_sprite0SpeedReg_T_11) : $signed(32'sh0); // @[src/main/scala/PlayerController.scala 151:49 152:27 154:27]
  wire [31:0] _GEN_5 = $signed(sprite0SpeedReg) > 32'sh190 ? $signed(_sprite0SpeedReg_T_8) : $signed(_GEN_4); // @[src/main/scala/PlayerController.scala 149:42 150:27]
  wire [31:0] _GEN_6 = io_btnU ? $signed(_GEN_3) : $signed(_GEN_5); // @[src/main/scala/PlayerController.scala 144:27]
  wire [7:0] _sprite0AngleReg_T_1 = sprite0AngleReg + 8'h1; // @[src/main/scala/PlayerController.scala 159:44]
  wire [7:0] _sprite0AngleReg_T_3 = sprite0AngleReg - 8'h1; // @[src/main/scala/PlayerController.scala 161:44]
  wire [7:0] _GEN_8 = io_btnL ? _sprite0AngleReg_T_3 : sprite0AngleReg; // @[src/main/scala/PlayerController.scala 160:26 161:25 70:32]
  wire  _GEN_10 = sprite0AngleReg >= 8'h51 & sprite0AngleReg <= 8'h70 ? 1'h0 : sprite0Visible; // @[src/main/scala/PlayerController.scala 227:69 228:26 95:31]
  wire  _GEN_11 = sprite0AngleReg >= 8'h51 & sprite0AngleReg <= 8'h70 | sprite1Visible; // @[src/main/scala/PlayerController.scala 227:69 229:26 96:31]
  wire  _GEN_12 = sprite0AngleReg >= 8'h51 & sprite0AngleReg <= 8'h70 ? 1'h0 : sprite2Visible; // @[src/main/scala/PlayerController.scala 227:69 230:26 97:31]
  wire  _GEN_13 = sprite0AngleReg >= 8'h51 & sprite0AngleReg <= 8'h70 ? 1'h0 : sprite1FlipHorizontalReg; // @[src/main/scala/PlayerController.scala 227:69 232:36 90:41]
  wire  _GEN_14 = sprite0AngleReg >= 8'h51 & sprite0AngleReg <= 8'h70 | sprite1FlipVerticalReg; // @[src/main/scala/PlayerController.scala 227:69 233:34 91:39]
  wire  _GEN_15 = sprite0AngleReg >= 8'h31 & sprite0AngleReg <= 8'h50 ? 1'h0 : _GEN_10; // @[src/main/scala/PlayerController.scala 219:68 220:26]
  wire  _GEN_16 = sprite0AngleReg >= 8'h31 & sprite0AngleReg <= 8'h50 ? 1'h0 : _GEN_11; // @[src/main/scala/PlayerController.scala 219:68 221:26]
  wire  _GEN_17 = sprite0AngleReg >= 8'h31 & sprite0AngleReg <= 8'h50 | _GEN_12; // @[src/main/scala/PlayerController.scala 219:68 222:26]
  wire  _GEN_18 = sprite0AngleReg >= 8'h31 & sprite0AngleReg <= 8'h50 | sprite2FlipVerticalReg; // @[src/main/scala/PlayerController.scala 219:68 224:34 93:39]
  wire  _GEN_19 = sprite0AngleReg >= 8'h31 & sprite0AngleReg <= 8'h50 ? sprite1FlipHorizontalReg : _GEN_13; // @[src/main/scala/PlayerController.scala 219:68 90:41]
  wire  _GEN_20 = sprite0AngleReg >= 8'h31 & sprite0AngleReg <= 8'h50 ? sprite1FlipVerticalReg : _GEN_14; // @[src/main/scala/PlayerController.scala 219:68 91:39]
  wire  _GEN_21 = sprite0AngleReg >= 8'h11 & sprite0AngleReg <= 8'h30 ? 1'h0 : _GEN_15; // @[src/main/scala/PlayerController.scala 210:68 211:26]
  wire  _GEN_22 = sprite0AngleReg >= 8'h11 & sprite0AngleReg <= 8'h30 | _GEN_16; // @[src/main/scala/PlayerController.scala 210:68 212:26]
  wire  _GEN_23 = sprite0AngleReg >= 8'h11 & sprite0AngleReg <= 8'h30 ? 1'h0 : _GEN_17; // @[src/main/scala/PlayerController.scala 210:68 213:26]
  wire  _GEN_24 = sprite0AngleReg >= 8'h11 & sprite0AngleReg <= 8'h30 | _GEN_19; // @[src/main/scala/PlayerController.scala 210:68 215:36]
  wire  _GEN_25 = sprite0AngleReg >= 8'h11 & sprite0AngleReg <= 8'h30 | _GEN_20; // @[src/main/scala/PlayerController.scala 210:68 216:34]
  wire  _GEN_26 = sprite0AngleReg >= 8'h11 & sprite0AngleReg <= 8'h30 ? sprite2FlipVerticalReg : _GEN_18; // @[src/main/scala/PlayerController.scala 210:68 93:39]
  wire  _GEN_27 = sprite0AngleReg >= 8'hf1 | sprite0AngleReg <= 8'h10 | _GEN_21; // @[src/main/scala/PlayerController.scala 201:127 202:26]
  wire  _GEN_28 = sprite0AngleReg >= 8'hf1 | sprite0AngleReg <= 8'h10 ? 1'h0 : _GEN_22; // @[src/main/scala/PlayerController.scala 201:127 203:26]
  wire  _GEN_29 = sprite0AngleReg >= 8'hf1 | sprite0AngleReg <= 8'h10 ? 1'h0 : _GEN_23; // @[src/main/scala/PlayerController.scala 201:127 204:26]
  wire  _GEN_30 = sprite0AngleReg >= 8'hf1 | sprite0AngleReg <= 8'h10 | sprite0FlipHorizontalReg; // @[src/main/scala/PlayerController.scala 201:127 206:36 87:41]
  wire  _GEN_32 = sprite0AngleReg >= 8'hf1 | sprite0AngleReg <= 8'h10 ? sprite1FlipHorizontalReg : _GEN_24; // @[src/main/scala/PlayerController.scala 201:127 90:41]
  wire  _GEN_33 = sprite0AngleReg >= 8'hf1 | sprite0AngleReg <= 8'h10 ? sprite1FlipVerticalReg : _GEN_25; // @[src/main/scala/PlayerController.scala 201:127 91:39]
  wire  _GEN_34 = sprite0AngleReg >= 8'hf1 | sprite0AngleReg <= 8'h10 ? sprite2FlipVerticalReg : _GEN_26; // @[src/main/scala/PlayerController.scala 201:127 93:39]
  wire  _GEN_35 = sprite0AngleReg >= 8'hd1 & sprite0AngleReg <= 8'hf0 ? 1'h0 : _GEN_27; // @[src/main/scala/PlayerController.scala 192:70 193:26]
  wire  _GEN_36 = sprite0AngleReg >= 8'hd1 & sprite0AngleReg <= 8'hf0 | _GEN_28; // @[src/main/scala/PlayerController.scala 192:70 194:26]
  wire  _GEN_37 = sprite0AngleReg >= 8'hd1 & sprite0AngleReg <= 8'hf0 ? 1'h0 : _GEN_29; // @[src/main/scala/PlayerController.scala 192:70 195:26]
  wire  _GEN_38 = sprite0AngleReg >= 8'hd1 & sprite0AngleReg <= 8'hf0 | _GEN_32; // @[src/main/scala/PlayerController.scala 192:70 197:36]
  wire  _GEN_39 = sprite0AngleReg >= 8'hd1 & sprite0AngleReg <= 8'hf0 ? 1'h0 : _GEN_33; // @[src/main/scala/PlayerController.scala 192:70 198:34]
  wire  _GEN_40 = sprite0AngleReg >= 8'hd1 & sprite0AngleReg <= 8'hf0 ? sprite0FlipHorizontalReg : _GEN_30; // @[src/main/scala/PlayerController.scala 192:70 87:41]
  wire  _GEN_42 = sprite0AngleReg >= 8'hd1 & sprite0AngleReg <= 8'hf0 ? sprite2FlipVerticalReg : _GEN_34; // @[src/main/scala/PlayerController.scala 192:70 93:39]
  wire  _GEN_43 = sprite0AngleReg >= 8'hb1 & sprite0AngleReg <= 8'hd0 ? 1'h0 : _GEN_35; // @[src/main/scala/PlayerController.scala 184:70 185:26]
  wire  _GEN_44 = sprite0AngleReg >= 8'hb1 & sprite0AngleReg <= 8'hd0 ? 1'h0 : _GEN_36; // @[src/main/scala/PlayerController.scala 184:70 186:26]
  wire  _GEN_45 = sprite0AngleReg >= 8'hb1 & sprite0AngleReg <= 8'hd0 | _GEN_37; // @[src/main/scala/PlayerController.scala 184:70 187:26]
  wire  _GEN_46 = sprite0AngleReg >= 8'hb1 & sprite0AngleReg <= 8'hd0 ? 1'h0 : _GEN_42; // @[src/main/scala/PlayerController.scala 184:70 189:34]
  wire  _GEN_47 = sprite0AngleReg >= 8'hb1 & sprite0AngleReg <= 8'hd0 ? sprite1FlipHorizontalReg : _GEN_38; // @[src/main/scala/PlayerController.scala 184:70 90:41]
  wire  _GEN_48 = sprite0AngleReg >= 8'hb1 & sprite0AngleReg <= 8'hd0 ? sprite1FlipVerticalReg : _GEN_39; // @[src/main/scala/PlayerController.scala 184:70 91:39]
  wire  _GEN_49 = sprite0AngleReg >= 8'hb1 & sprite0AngleReg <= 8'hd0 ? sprite0FlipHorizontalReg : _GEN_40; // @[src/main/scala/PlayerController.scala 184:70 87:41]
  wire  _GEN_51 = sprite0AngleReg >= 8'h91 & sprite0AngleReg <= 8'hb0 ? 1'h0 : _GEN_43; // @[src/main/scala/PlayerController.scala 175:70 176:26]
  wire  _GEN_52 = sprite0AngleReg >= 8'h91 & sprite0AngleReg <= 8'hb0 | _GEN_44; // @[src/main/scala/PlayerController.scala 175:70 177:26]
  wire  _GEN_53 = sprite0AngleReg >= 8'h91 & sprite0AngleReg <= 8'hb0 ? 1'h0 : _GEN_45; // @[src/main/scala/PlayerController.scala 175:70 178:26]
  wire  _GEN_54 = sprite0AngleReg >= 8'h91 & sprite0AngleReg <= 8'hb0 ? 1'h0 : _GEN_47; // @[src/main/scala/PlayerController.scala 175:70 180:36]
  wire  _GEN_55 = sprite0AngleReg >= 8'h91 & sprite0AngleReg <= 8'hb0 ? 1'h0 : _GEN_48; // @[src/main/scala/PlayerController.scala 175:70 181:34]
  wire  _GEN_56 = sprite0AngleReg >= 8'h91 & sprite0AngleReg <= 8'hb0 ? sprite2FlipVerticalReg : _GEN_46; // @[src/main/scala/PlayerController.scala 175:70 93:39]
  wire  _GEN_57 = sprite0AngleReg >= 8'h91 & sprite0AngleReg <= 8'hb0 ? sprite0FlipHorizontalReg : _GEN_49; // @[src/main/scala/PlayerController.scala 175:70 87:41]
  wire  _GEN_59 = sprite0AngleReg >= 8'h71 & sprite0AngleReg <= 8'h90 | _GEN_51; // @[src/main/scala/PlayerController.scala 166:66 167:26]
  wire [15:0] _GEN_68 = 8'h1 == sprite0AngleReg ? $signed(16'shff) : $signed(16'sh100); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_69 = 8'h2 == sprite0AngleReg ? $signed(16'shff) : $signed(_GEN_68); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_70 = 8'h3 == sprite0AngleReg ? $signed(16'shff) : $signed(_GEN_69); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_71 = 8'h4 == sprite0AngleReg ? $signed(16'shfe) : $signed(_GEN_70); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_72 = 8'h5 == sprite0AngleReg ? $signed(16'shfe) : $signed(_GEN_71); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_73 = 8'h6 == sprite0AngleReg ? $signed(16'shfd) : $signed(_GEN_72); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_74 = 8'h7 == sprite0AngleReg ? $signed(16'shfc) : $signed(_GEN_73); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_75 = 8'h8 == sprite0AngleReg ? $signed(16'shfb) : $signed(_GEN_74); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_76 = 8'h9 == sprite0AngleReg ? $signed(16'shf9) : $signed(_GEN_75); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_77 = 8'ha == sprite0AngleReg ? $signed(16'shf8) : $signed(_GEN_76); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_78 = 8'hb == sprite0AngleReg ? $signed(16'shf6) : $signed(_GEN_77); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_79 = 8'hc == sprite0AngleReg ? $signed(16'shf4) : $signed(_GEN_78); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_80 = 8'hd == sprite0AngleReg ? $signed(16'shf3) : $signed(_GEN_79); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_81 = 8'he == sprite0AngleReg ? $signed(16'shf1) : $signed(_GEN_80); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_82 = 8'hf == sprite0AngleReg ? $signed(16'shee) : $signed(_GEN_81); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_83 = 8'h10 == sprite0AngleReg ? $signed(16'shec) : $signed(_GEN_82); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_84 = 8'h11 == sprite0AngleReg ? $signed(16'shea) : $signed(_GEN_83); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_85 = 8'h12 == sprite0AngleReg ? $signed(16'she7) : $signed(_GEN_84); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_86 = 8'h13 == sprite0AngleReg ? $signed(16'she4) : $signed(_GEN_85); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_87 = 8'h14 == sprite0AngleReg ? $signed(16'she1) : $signed(_GEN_86); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_88 = 8'h15 == sprite0AngleReg ? $signed(16'shde) : $signed(_GEN_87); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_89 = 8'h16 == sprite0AngleReg ? $signed(16'shdb) : $signed(_GEN_88); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_90 = 8'h17 == sprite0AngleReg ? $signed(16'shd8) : $signed(_GEN_89); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_91 = 8'h18 == sprite0AngleReg ? $signed(16'shd4) : $signed(_GEN_90); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_92 = 8'h19 == sprite0AngleReg ? $signed(16'shd1) : $signed(_GEN_91); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_93 = 8'h1a == sprite0AngleReg ? $signed(16'shcd) : $signed(_GEN_92); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_94 = 8'h1b == sprite0AngleReg ? $signed(16'shc9) : $signed(_GEN_93); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_95 = 8'h1c == sprite0AngleReg ? $signed(16'shc5) : $signed(_GEN_94); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_96 = 8'h1d == sprite0AngleReg ? $signed(16'shc1) : $signed(_GEN_95); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_97 = 8'h1e == sprite0AngleReg ? $signed(16'shbd) : $signed(_GEN_96); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_98 = 8'h1f == sprite0AngleReg ? $signed(16'shb9) : $signed(_GEN_97); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_99 = 8'h20 == sprite0AngleReg ? $signed(16'shb5) : $signed(_GEN_98); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_100 = 8'h21 == sprite0AngleReg ? $signed(16'shb0) : $signed(_GEN_99); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_101 = 8'h22 == sprite0AngleReg ? $signed(16'shab) : $signed(_GEN_100); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_102 = 8'h23 == sprite0AngleReg ? $signed(16'sha7) : $signed(_GEN_101); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_103 = 8'h24 == sprite0AngleReg ? $signed(16'sha2) : $signed(_GEN_102); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_104 = 8'h25 == sprite0AngleReg ? $signed(16'sh9d) : $signed(_GEN_103); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_105 = 8'h26 == sprite0AngleReg ? $signed(16'sh98) : $signed(_GEN_104); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_106 = 8'h27 == sprite0AngleReg ? $signed(16'sh93) : $signed(_GEN_105); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_107 = 8'h28 == sprite0AngleReg ? $signed(16'sh8e) : $signed(_GEN_106); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_108 = 8'h29 == sprite0AngleReg ? $signed(16'sh88) : $signed(_GEN_107); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_109 = 8'h2a == sprite0AngleReg ? $signed(16'sh83) : $signed(_GEN_108); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_110 = 8'h2b == sprite0AngleReg ? $signed(16'sh7e) : $signed(_GEN_109); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_111 = 8'h2c == sprite0AngleReg ? $signed(16'sh78) : $signed(_GEN_110); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_112 = 8'h2d == sprite0AngleReg ? $signed(16'sh73) : $signed(_GEN_111); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_113 = 8'h2e == sprite0AngleReg ? $signed(16'sh6d) : $signed(_GEN_112); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_114 = 8'h2f == sprite0AngleReg ? $signed(16'sh67) : $signed(_GEN_113); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_115 = 8'h30 == sprite0AngleReg ? $signed(16'sh61) : $signed(_GEN_114); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_116 = 8'h31 == sprite0AngleReg ? $signed(16'sh5c) : $signed(_GEN_115); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_117 = 8'h32 == sprite0AngleReg ? $signed(16'sh56) : $signed(_GEN_116); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_118 = 8'h33 == sprite0AngleReg ? $signed(16'sh50) : $signed(_GEN_117); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_119 = 8'h34 == sprite0AngleReg ? $signed(16'sh4a) : $signed(_GEN_118); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_120 = 8'h35 == sprite0AngleReg ? $signed(16'sh44) : $signed(_GEN_119); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_121 = 8'h36 == sprite0AngleReg ? $signed(16'sh3e) : $signed(_GEN_120); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_122 = 8'h37 == sprite0AngleReg ? $signed(16'sh38) : $signed(_GEN_121); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_123 = 8'h38 == sprite0AngleReg ? $signed(16'sh31) : $signed(_GEN_122); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_124 = 8'h39 == sprite0AngleReg ? $signed(16'sh2b) : $signed(_GEN_123); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_125 = 8'h3a == sprite0AngleReg ? $signed(16'sh25) : $signed(_GEN_124); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_126 = 8'h3b == sprite0AngleReg ? $signed(16'sh1f) : $signed(_GEN_125); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_127 = 8'h3c == sprite0AngleReg ? $signed(16'sh19) : $signed(_GEN_126); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_128 = 8'h3d == sprite0AngleReg ? $signed(16'sh12) : $signed(_GEN_127); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_129 = 8'h3e == sprite0AngleReg ? $signed(16'shc) : $signed(_GEN_128); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_130 = 8'h3f == sprite0AngleReg ? $signed(16'sh6) : $signed(_GEN_129); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_131 = 8'h40 == sprite0AngleReg ? $signed(16'sh0) : $signed(_GEN_130); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_132 = 8'h41 == sprite0AngleReg ? $signed(-16'sh6) : $signed(_GEN_131); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_133 = 8'h42 == sprite0AngleReg ? $signed(-16'shc) : $signed(_GEN_132); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_134 = 8'h43 == sprite0AngleReg ? $signed(-16'sh12) : $signed(_GEN_133); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_135 = 8'h44 == sprite0AngleReg ? $signed(-16'sh19) : $signed(_GEN_134); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_136 = 8'h45 == sprite0AngleReg ? $signed(-16'sh1f) : $signed(_GEN_135); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_137 = 8'h46 == sprite0AngleReg ? $signed(-16'sh25) : $signed(_GEN_136); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_138 = 8'h47 == sprite0AngleReg ? $signed(-16'sh2b) : $signed(_GEN_137); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_139 = 8'h48 == sprite0AngleReg ? $signed(-16'sh31) : $signed(_GEN_138); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_140 = 8'h49 == sprite0AngleReg ? $signed(-16'sh38) : $signed(_GEN_139); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_141 = 8'h4a == sprite0AngleReg ? $signed(-16'sh3e) : $signed(_GEN_140); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_142 = 8'h4b == sprite0AngleReg ? $signed(-16'sh44) : $signed(_GEN_141); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_143 = 8'h4c == sprite0AngleReg ? $signed(-16'sh4a) : $signed(_GEN_142); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_144 = 8'h4d == sprite0AngleReg ? $signed(-16'sh50) : $signed(_GEN_143); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_145 = 8'h4e == sprite0AngleReg ? $signed(-16'sh56) : $signed(_GEN_144); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_146 = 8'h4f == sprite0AngleReg ? $signed(-16'sh5c) : $signed(_GEN_145); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_147 = 8'h50 == sprite0AngleReg ? $signed(-16'sh61) : $signed(_GEN_146); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_148 = 8'h51 == sprite0AngleReg ? $signed(-16'sh67) : $signed(_GEN_147); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_149 = 8'h52 == sprite0AngleReg ? $signed(-16'sh6d) : $signed(_GEN_148); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_150 = 8'h53 == sprite0AngleReg ? $signed(-16'sh73) : $signed(_GEN_149); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_151 = 8'h54 == sprite0AngleReg ? $signed(-16'sh78) : $signed(_GEN_150); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_152 = 8'h55 == sprite0AngleReg ? $signed(-16'sh7e) : $signed(_GEN_151); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_153 = 8'h56 == sprite0AngleReg ? $signed(-16'sh83) : $signed(_GEN_152); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_154 = 8'h57 == sprite0AngleReg ? $signed(-16'sh88) : $signed(_GEN_153); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_155 = 8'h58 == sprite0AngleReg ? $signed(-16'sh8e) : $signed(_GEN_154); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_156 = 8'h59 == sprite0AngleReg ? $signed(-16'sh93) : $signed(_GEN_155); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_157 = 8'h5a == sprite0AngleReg ? $signed(-16'sh98) : $signed(_GEN_156); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_158 = 8'h5b == sprite0AngleReg ? $signed(-16'sh9d) : $signed(_GEN_157); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_159 = 8'h5c == sprite0AngleReg ? $signed(-16'sha2) : $signed(_GEN_158); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_160 = 8'h5d == sprite0AngleReg ? $signed(-16'sha7) : $signed(_GEN_159); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_161 = 8'h5e == sprite0AngleReg ? $signed(-16'shab) : $signed(_GEN_160); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_162 = 8'h5f == sprite0AngleReg ? $signed(-16'shb0) : $signed(_GEN_161); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_163 = 8'h60 == sprite0AngleReg ? $signed(-16'shb5) : $signed(_GEN_162); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_164 = 8'h61 == sprite0AngleReg ? $signed(-16'shb9) : $signed(_GEN_163); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_165 = 8'h62 == sprite0AngleReg ? $signed(-16'shbd) : $signed(_GEN_164); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_166 = 8'h63 == sprite0AngleReg ? $signed(-16'shc1) : $signed(_GEN_165); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_167 = 8'h64 == sprite0AngleReg ? $signed(-16'shc5) : $signed(_GEN_166); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_168 = 8'h65 == sprite0AngleReg ? $signed(-16'shc9) : $signed(_GEN_167); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_169 = 8'h66 == sprite0AngleReg ? $signed(-16'shcd) : $signed(_GEN_168); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_170 = 8'h67 == sprite0AngleReg ? $signed(-16'shd1) : $signed(_GEN_169); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_171 = 8'h68 == sprite0AngleReg ? $signed(-16'shd4) : $signed(_GEN_170); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_172 = 8'h69 == sprite0AngleReg ? $signed(-16'shd8) : $signed(_GEN_171); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_173 = 8'h6a == sprite0AngleReg ? $signed(-16'shdb) : $signed(_GEN_172); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_174 = 8'h6b == sprite0AngleReg ? $signed(-16'shde) : $signed(_GEN_173); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_175 = 8'h6c == sprite0AngleReg ? $signed(-16'she1) : $signed(_GEN_174); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_176 = 8'h6d == sprite0AngleReg ? $signed(-16'she4) : $signed(_GEN_175); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_177 = 8'h6e == sprite0AngleReg ? $signed(-16'she7) : $signed(_GEN_176); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_178 = 8'h6f == sprite0AngleReg ? $signed(-16'shea) : $signed(_GEN_177); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_179 = 8'h70 == sprite0AngleReg ? $signed(-16'shec) : $signed(_GEN_178); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_180 = 8'h71 == sprite0AngleReg ? $signed(-16'shee) : $signed(_GEN_179); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_181 = 8'h72 == sprite0AngleReg ? $signed(-16'shf1) : $signed(_GEN_180); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_182 = 8'h73 == sprite0AngleReg ? $signed(-16'shf3) : $signed(_GEN_181); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_183 = 8'h74 == sprite0AngleReg ? $signed(-16'shf4) : $signed(_GEN_182); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_184 = 8'h75 == sprite0AngleReg ? $signed(-16'shf6) : $signed(_GEN_183); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_185 = 8'h76 == sprite0AngleReg ? $signed(-16'shf8) : $signed(_GEN_184); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_186 = 8'h77 == sprite0AngleReg ? $signed(-16'shf9) : $signed(_GEN_185); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_187 = 8'h78 == sprite0AngleReg ? $signed(-16'shfb) : $signed(_GEN_186); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_188 = 8'h79 == sprite0AngleReg ? $signed(-16'shfc) : $signed(_GEN_187); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_189 = 8'h7a == sprite0AngleReg ? $signed(-16'shfd) : $signed(_GEN_188); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_190 = 8'h7b == sprite0AngleReg ? $signed(-16'shfe) : $signed(_GEN_189); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_191 = 8'h7c == sprite0AngleReg ? $signed(-16'shfe) : $signed(_GEN_190); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_192 = 8'h7d == sprite0AngleReg ? $signed(-16'shff) : $signed(_GEN_191); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_193 = 8'h7e == sprite0AngleReg ? $signed(-16'shff) : $signed(_GEN_192); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_194 = 8'h7f == sprite0AngleReg ? $signed(-16'shff) : $signed(_GEN_193); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_195 = 8'h80 == sprite0AngleReg ? $signed(-16'sh100) : $signed(_GEN_194); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_196 = 8'h81 == sprite0AngleReg ? $signed(-16'shff) : $signed(_GEN_195); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_197 = 8'h82 == sprite0AngleReg ? $signed(-16'shff) : $signed(_GEN_196); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_198 = 8'h83 == sprite0AngleReg ? $signed(-16'shff) : $signed(_GEN_197); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_199 = 8'h84 == sprite0AngleReg ? $signed(-16'shfe) : $signed(_GEN_198); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_200 = 8'h85 == sprite0AngleReg ? $signed(-16'shfe) : $signed(_GEN_199); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_201 = 8'h86 == sprite0AngleReg ? $signed(-16'shfd) : $signed(_GEN_200); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_202 = 8'h87 == sprite0AngleReg ? $signed(-16'shfc) : $signed(_GEN_201); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_203 = 8'h88 == sprite0AngleReg ? $signed(-16'shfb) : $signed(_GEN_202); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_204 = 8'h89 == sprite0AngleReg ? $signed(-16'shf9) : $signed(_GEN_203); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_205 = 8'h8a == sprite0AngleReg ? $signed(-16'shf8) : $signed(_GEN_204); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_206 = 8'h8b == sprite0AngleReg ? $signed(-16'shf6) : $signed(_GEN_205); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_207 = 8'h8c == sprite0AngleReg ? $signed(-16'shf4) : $signed(_GEN_206); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_208 = 8'h8d == sprite0AngleReg ? $signed(-16'shf3) : $signed(_GEN_207); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_209 = 8'h8e == sprite0AngleReg ? $signed(-16'shf1) : $signed(_GEN_208); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_210 = 8'h8f == sprite0AngleReg ? $signed(-16'shee) : $signed(_GEN_209); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_211 = 8'h90 == sprite0AngleReg ? $signed(-16'shec) : $signed(_GEN_210); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_212 = 8'h91 == sprite0AngleReg ? $signed(-16'shea) : $signed(_GEN_211); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_213 = 8'h92 == sprite0AngleReg ? $signed(-16'she7) : $signed(_GEN_212); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_214 = 8'h93 == sprite0AngleReg ? $signed(-16'she4) : $signed(_GEN_213); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_215 = 8'h94 == sprite0AngleReg ? $signed(-16'she1) : $signed(_GEN_214); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_216 = 8'h95 == sprite0AngleReg ? $signed(-16'shde) : $signed(_GEN_215); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_217 = 8'h96 == sprite0AngleReg ? $signed(-16'shdb) : $signed(_GEN_216); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_218 = 8'h97 == sprite0AngleReg ? $signed(-16'shd8) : $signed(_GEN_217); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_219 = 8'h98 == sprite0AngleReg ? $signed(-16'shd4) : $signed(_GEN_218); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_220 = 8'h99 == sprite0AngleReg ? $signed(-16'shd1) : $signed(_GEN_219); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_221 = 8'h9a == sprite0AngleReg ? $signed(-16'shcd) : $signed(_GEN_220); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_222 = 8'h9b == sprite0AngleReg ? $signed(-16'shc9) : $signed(_GEN_221); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_223 = 8'h9c == sprite0AngleReg ? $signed(-16'shc5) : $signed(_GEN_222); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_224 = 8'h9d == sprite0AngleReg ? $signed(-16'shc1) : $signed(_GEN_223); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_225 = 8'h9e == sprite0AngleReg ? $signed(-16'shbd) : $signed(_GEN_224); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_226 = 8'h9f == sprite0AngleReg ? $signed(-16'shb9) : $signed(_GEN_225); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_227 = 8'ha0 == sprite0AngleReg ? $signed(-16'shb5) : $signed(_GEN_226); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_228 = 8'ha1 == sprite0AngleReg ? $signed(-16'shb0) : $signed(_GEN_227); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_229 = 8'ha2 == sprite0AngleReg ? $signed(-16'shab) : $signed(_GEN_228); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_230 = 8'ha3 == sprite0AngleReg ? $signed(-16'sha7) : $signed(_GEN_229); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_231 = 8'ha4 == sprite0AngleReg ? $signed(-16'sha2) : $signed(_GEN_230); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_232 = 8'ha5 == sprite0AngleReg ? $signed(-16'sh9d) : $signed(_GEN_231); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_233 = 8'ha6 == sprite0AngleReg ? $signed(-16'sh98) : $signed(_GEN_232); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_234 = 8'ha7 == sprite0AngleReg ? $signed(-16'sh93) : $signed(_GEN_233); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_235 = 8'ha8 == sprite0AngleReg ? $signed(-16'sh8e) : $signed(_GEN_234); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_236 = 8'ha9 == sprite0AngleReg ? $signed(-16'sh88) : $signed(_GEN_235); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_237 = 8'haa == sprite0AngleReg ? $signed(-16'sh83) : $signed(_GEN_236); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_238 = 8'hab == sprite0AngleReg ? $signed(-16'sh7e) : $signed(_GEN_237); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_239 = 8'hac == sprite0AngleReg ? $signed(-16'sh78) : $signed(_GEN_238); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_240 = 8'had == sprite0AngleReg ? $signed(-16'sh73) : $signed(_GEN_239); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_241 = 8'hae == sprite0AngleReg ? $signed(-16'sh6d) : $signed(_GEN_240); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_242 = 8'haf == sprite0AngleReg ? $signed(-16'sh67) : $signed(_GEN_241); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_243 = 8'hb0 == sprite0AngleReg ? $signed(-16'sh61) : $signed(_GEN_242); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_244 = 8'hb1 == sprite0AngleReg ? $signed(-16'sh5c) : $signed(_GEN_243); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_245 = 8'hb2 == sprite0AngleReg ? $signed(-16'sh56) : $signed(_GEN_244); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_246 = 8'hb3 == sprite0AngleReg ? $signed(-16'sh50) : $signed(_GEN_245); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_247 = 8'hb4 == sprite0AngleReg ? $signed(-16'sh4a) : $signed(_GEN_246); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_248 = 8'hb5 == sprite0AngleReg ? $signed(-16'sh44) : $signed(_GEN_247); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_249 = 8'hb6 == sprite0AngleReg ? $signed(-16'sh3e) : $signed(_GEN_248); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_250 = 8'hb7 == sprite0AngleReg ? $signed(-16'sh38) : $signed(_GEN_249); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_251 = 8'hb8 == sprite0AngleReg ? $signed(-16'sh31) : $signed(_GEN_250); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_252 = 8'hb9 == sprite0AngleReg ? $signed(-16'sh2b) : $signed(_GEN_251); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_253 = 8'hba == sprite0AngleReg ? $signed(-16'sh25) : $signed(_GEN_252); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_254 = 8'hbb == sprite0AngleReg ? $signed(-16'sh1f) : $signed(_GEN_253); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_255 = 8'hbc == sprite0AngleReg ? $signed(-16'sh19) : $signed(_GEN_254); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_256 = 8'hbd == sprite0AngleReg ? $signed(-16'sh12) : $signed(_GEN_255); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_257 = 8'hbe == sprite0AngleReg ? $signed(-16'shc) : $signed(_GEN_256); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_258 = 8'hbf == sprite0AngleReg ? $signed(-16'sh6) : $signed(_GEN_257); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_259 = 8'hc0 == sprite0AngleReg ? $signed(16'sh0) : $signed(_GEN_258); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_260 = 8'hc1 == sprite0AngleReg ? $signed(16'sh6) : $signed(_GEN_259); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_261 = 8'hc2 == sprite0AngleReg ? $signed(16'shc) : $signed(_GEN_260); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_262 = 8'hc3 == sprite0AngleReg ? $signed(16'sh12) : $signed(_GEN_261); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_263 = 8'hc4 == sprite0AngleReg ? $signed(16'sh19) : $signed(_GEN_262); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_264 = 8'hc5 == sprite0AngleReg ? $signed(16'sh1f) : $signed(_GEN_263); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_265 = 8'hc6 == sprite0AngleReg ? $signed(16'sh25) : $signed(_GEN_264); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_266 = 8'hc7 == sprite0AngleReg ? $signed(16'sh2b) : $signed(_GEN_265); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_267 = 8'hc8 == sprite0AngleReg ? $signed(16'sh31) : $signed(_GEN_266); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_268 = 8'hc9 == sprite0AngleReg ? $signed(16'sh38) : $signed(_GEN_267); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_269 = 8'hca == sprite0AngleReg ? $signed(16'sh3e) : $signed(_GEN_268); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_270 = 8'hcb == sprite0AngleReg ? $signed(16'sh44) : $signed(_GEN_269); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_271 = 8'hcc == sprite0AngleReg ? $signed(16'sh4a) : $signed(_GEN_270); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_272 = 8'hcd == sprite0AngleReg ? $signed(16'sh50) : $signed(_GEN_271); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_273 = 8'hce == sprite0AngleReg ? $signed(16'sh56) : $signed(_GEN_272); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_274 = 8'hcf == sprite0AngleReg ? $signed(16'sh5c) : $signed(_GEN_273); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_275 = 8'hd0 == sprite0AngleReg ? $signed(16'sh61) : $signed(_GEN_274); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_276 = 8'hd1 == sprite0AngleReg ? $signed(16'sh67) : $signed(_GEN_275); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_277 = 8'hd2 == sprite0AngleReg ? $signed(16'sh6d) : $signed(_GEN_276); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_278 = 8'hd3 == sprite0AngleReg ? $signed(16'sh73) : $signed(_GEN_277); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_279 = 8'hd4 == sprite0AngleReg ? $signed(16'sh78) : $signed(_GEN_278); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_280 = 8'hd5 == sprite0AngleReg ? $signed(16'sh7e) : $signed(_GEN_279); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_281 = 8'hd6 == sprite0AngleReg ? $signed(16'sh83) : $signed(_GEN_280); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_282 = 8'hd7 == sprite0AngleReg ? $signed(16'sh88) : $signed(_GEN_281); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_283 = 8'hd8 == sprite0AngleReg ? $signed(16'sh8e) : $signed(_GEN_282); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_284 = 8'hd9 == sprite0AngleReg ? $signed(16'sh93) : $signed(_GEN_283); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_285 = 8'hda == sprite0AngleReg ? $signed(16'sh98) : $signed(_GEN_284); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_286 = 8'hdb == sprite0AngleReg ? $signed(16'sh9d) : $signed(_GEN_285); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_287 = 8'hdc == sprite0AngleReg ? $signed(16'sha2) : $signed(_GEN_286); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_288 = 8'hdd == sprite0AngleReg ? $signed(16'sha7) : $signed(_GEN_287); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_289 = 8'hde == sprite0AngleReg ? $signed(16'shab) : $signed(_GEN_288); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_290 = 8'hdf == sprite0AngleReg ? $signed(16'shb0) : $signed(_GEN_289); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_291 = 8'he0 == sprite0AngleReg ? $signed(16'shb5) : $signed(_GEN_290); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_292 = 8'he1 == sprite0AngleReg ? $signed(16'shb9) : $signed(_GEN_291); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_293 = 8'he2 == sprite0AngleReg ? $signed(16'shbd) : $signed(_GEN_292); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_294 = 8'he3 == sprite0AngleReg ? $signed(16'shc1) : $signed(_GEN_293); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_295 = 8'he4 == sprite0AngleReg ? $signed(16'shc5) : $signed(_GEN_294); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_296 = 8'he5 == sprite0AngleReg ? $signed(16'shc9) : $signed(_GEN_295); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_297 = 8'he6 == sprite0AngleReg ? $signed(16'shcd) : $signed(_GEN_296); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_298 = 8'he7 == sprite0AngleReg ? $signed(16'shd1) : $signed(_GEN_297); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_299 = 8'he8 == sprite0AngleReg ? $signed(16'shd4) : $signed(_GEN_298); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_300 = 8'he9 == sprite0AngleReg ? $signed(16'shd8) : $signed(_GEN_299); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_301 = 8'hea == sprite0AngleReg ? $signed(16'shdb) : $signed(_GEN_300); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_302 = 8'heb == sprite0AngleReg ? $signed(16'shde) : $signed(_GEN_301); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_303 = 8'hec == sprite0AngleReg ? $signed(16'she1) : $signed(_GEN_302); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_304 = 8'hed == sprite0AngleReg ? $signed(16'she4) : $signed(_GEN_303); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_305 = 8'hee == sprite0AngleReg ? $signed(16'she7) : $signed(_GEN_304); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_306 = 8'hef == sprite0AngleReg ? $signed(16'shea) : $signed(_GEN_305); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_307 = 8'hf0 == sprite0AngleReg ? $signed(16'shec) : $signed(_GEN_306); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_308 = 8'hf1 == sprite0AngleReg ? $signed(16'shee) : $signed(_GEN_307); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_309 = 8'hf2 == sprite0AngleReg ? $signed(16'shf1) : $signed(_GEN_308); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_310 = 8'hf3 == sprite0AngleReg ? $signed(16'shf3) : $signed(_GEN_309); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_311 = 8'hf4 == sprite0AngleReg ? $signed(16'shf4) : $signed(_GEN_310); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_312 = 8'hf5 == sprite0AngleReg ? $signed(16'shf6) : $signed(_GEN_311); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_313 = 8'hf6 == sprite0AngleReg ? $signed(16'shf8) : $signed(_GEN_312); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_314 = 8'hf7 == sprite0AngleReg ? $signed(16'shf9) : $signed(_GEN_313); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_315 = 8'hf8 == sprite0AngleReg ? $signed(16'shfb) : $signed(_GEN_314); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_316 = 8'hf9 == sprite0AngleReg ? $signed(16'shfc) : $signed(_GEN_315); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_317 = 8'hfa == sprite0AngleReg ? $signed(16'shfd) : $signed(_GEN_316); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_318 = 8'hfb == sprite0AngleReg ? $signed(16'shfe) : $signed(_GEN_317); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_319 = 8'hfc == sprite0AngleReg ? $signed(16'shfe) : $signed(_GEN_318); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_320 = 8'hfd == sprite0AngleReg ? $signed(16'shff) : $signed(_GEN_319); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_321 = 8'hfe == sprite0AngleReg ? $signed(16'shff) : $signed(_GEN_320); // @[src/main/scala/PlayerController.scala 236:{14,14}]
  wire [15:0] _GEN_324 = 8'h1 == sprite0AngleReg ? $signed(16'sh6) : $signed(16'sh0); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_325 = 8'h2 == sprite0AngleReg ? $signed(16'shc) : $signed(_GEN_324); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_326 = 8'h3 == sprite0AngleReg ? $signed(16'sh12) : $signed(_GEN_325); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_327 = 8'h4 == sprite0AngleReg ? $signed(16'sh19) : $signed(_GEN_326); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_328 = 8'h5 == sprite0AngleReg ? $signed(16'sh1f) : $signed(_GEN_327); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_329 = 8'h6 == sprite0AngleReg ? $signed(16'sh25) : $signed(_GEN_328); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_330 = 8'h7 == sprite0AngleReg ? $signed(16'sh2b) : $signed(_GEN_329); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_331 = 8'h8 == sprite0AngleReg ? $signed(16'sh31) : $signed(_GEN_330); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_332 = 8'h9 == sprite0AngleReg ? $signed(16'sh38) : $signed(_GEN_331); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_333 = 8'ha == sprite0AngleReg ? $signed(16'sh3e) : $signed(_GEN_332); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_334 = 8'hb == sprite0AngleReg ? $signed(16'sh44) : $signed(_GEN_333); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_335 = 8'hc == sprite0AngleReg ? $signed(16'sh4a) : $signed(_GEN_334); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_336 = 8'hd == sprite0AngleReg ? $signed(16'sh50) : $signed(_GEN_335); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_337 = 8'he == sprite0AngleReg ? $signed(16'sh56) : $signed(_GEN_336); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_338 = 8'hf == sprite0AngleReg ? $signed(16'sh5c) : $signed(_GEN_337); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_339 = 8'h10 == sprite0AngleReg ? $signed(16'sh61) : $signed(_GEN_338); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_340 = 8'h11 == sprite0AngleReg ? $signed(16'sh67) : $signed(_GEN_339); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_341 = 8'h12 == sprite0AngleReg ? $signed(16'sh6d) : $signed(_GEN_340); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_342 = 8'h13 == sprite0AngleReg ? $signed(16'sh73) : $signed(_GEN_341); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_343 = 8'h14 == sprite0AngleReg ? $signed(16'sh78) : $signed(_GEN_342); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_344 = 8'h15 == sprite0AngleReg ? $signed(16'sh7e) : $signed(_GEN_343); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_345 = 8'h16 == sprite0AngleReg ? $signed(16'sh83) : $signed(_GEN_344); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_346 = 8'h17 == sprite0AngleReg ? $signed(16'sh88) : $signed(_GEN_345); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_347 = 8'h18 == sprite0AngleReg ? $signed(16'sh8e) : $signed(_GEN_346); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_348 = 8'h19 == sprite0AngleReg ? $signed(16'sh93) : $signed(_GEN_347); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_349 = 8'h1a == sprite0AngleReg ? $signed(16'sh98) : $signed(_GEN_348); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_350 = 8'h1b == sprite0AngleReg ? $signed(16'sh9d) : $signed(_GEN_349); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_351 = 8'h1c == sprite0AngleReg ? $signed(16'sha2) : $signed(_GEN_350); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_352 = 8'h1d == sprite0AngleReg ? $signed(16'sha7) : $signed(_GEN_351); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_353 = 8'h1e == sprite0AngleReg ? $signed(16'shab) : $signed(_GEN_352); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_354 = 8'h1f == sprite0AngleReg ? $signed(16'shb0) : $signed(_GEN_353); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_355 = 8'h20 == sprite0AngleReg ? $signed(16'shb5) : $signed(_GEN_354); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_356 = 8'h21 == sprite0AngleReg ? $signed(16'shb9) : $signed(_GEN_355); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_357 = 8'h22 == sprite0AngleReg ? $signed(16'shbd) : $signed(_GEN_356); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_358 = 8'h23 == sprite0AngleReg ? $signed(16'shc1) : $signed(_GEN_357); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_359 = 8'h24 == sprite0AngleReg ? $signed(16'shc5) : $signed(_GEN_358); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_360 = 8'h25 == sprite0AngleReg ? $signed(16'shc9) : $signed(_GEN_359); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_361 = 8'h26 == sprite0AngleReg ? $signed(16'shcd) : $signed(_GEN_360); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_362 = 8'h27 == sprite0AngleReg ? $signed(16'shd1) : $signed(_GEN_361); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_363 = 8'h28 == sprite0AngleReg ? $signed(16'shd4) : $signed(_GEN_362); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_364 = 8'h29 == sprite0AngleReg ? $signed(16'shd8) : $signed(_GEN_363); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_365 = 8'h2a == sprite0AngleReg ? $signed(16'shdb) : $signed(_GEN_364); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_366 = 8'h2b == sprite0AngleReg ? $signed(16'shde) : $signed(_GEN_365); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_367 = 8'h2c == sprite0AngleReg ? $signed(16'she1) : $signed(_GEN_366); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_368 = 8'h2d == sprite0AngleReg ? $signed(16'she4) : $signed(_GEN_367); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_369 = 8'h2e == sprite0AngleReg ? $signed(16'she7) : $signed(_GEN_368); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_370 = 8'h2f == sprite0AngleReg ? $signed(16'shea) : $signed(_GEN_369); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_371 = 8'h30 == sprite0AngleReg ? $signed(16'shec) : $signed(_GEN_370); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_372 = 8'h31 == sprite0AngleReg ? $signed(16'shee) : $signed(_GEN_371); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_373 = 8'h32 == sprite0AngleReg ? $signed(16'shf1) : $signed(_GEN_372); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_374 = 8'h33 == sprite0AngleReg ? $signed(16'shf3) : $signed(_GEN_373); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_375 = 8'h34 == sprite0AngleReg ? $signed(16'shf4) : $signed(_GEN_374); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_376 = 8'h35 == sprite0AngleReg ? $signed(16'shf6) : $signed(_GEN_375); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_377 = 8'h36 == sprite0AngleReg ? $signed(16'shf8) : $signed(_GEN_376); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_378 = 8'h37 == sprite0AngleReg ? $signed(16'shf9) : $signed(_GEN_377); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_379 = 8'h38 == sprite0AngleReg ? $signed(16'shfb) : $signed(_GEN_378); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_380 = 8'h39 == sprite0AngleReg ? $signed(16'shfc) : $signed(_GEN_379); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_381 = 8'h3a == sprite0AngleReg ? $signed(16'shfd) : $signed(_GEN_380); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_382 = 8'h3b == sprite0AngleReg ? $signed(16'shfe) : $signed(_GEN_381); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_383 = 8'h3c == sprite0AngleReg ? $signed(16'shfe) : $signed(_GEN_382); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_384 = 8'h3d == sprite0AngleReg ? $signed(16'shff) : $signed(_GEN_383); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_385 = 8'h3e == sprite0AngleReg ? $signed(16'shff) : $signed(_GEN_384); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_386 = 8'h3f == sprite0AngleReg ? $signed(16'shff) : $signed(_GEN_385); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_387 = 8'h40 == sprite0AngleReg ? $signed(16'sh100) : $signed(_GEN_386); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_388 = 8'h41 == sprite0AngleReg ? $signed(16'shff) : $signed(_GEN_387); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_389 = 8'h42 == sprite0AngleReg ? $signed(16'shff) : $signed(_GEN_388); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_390 = 8'h43 == sprite0AngleReg ? $signed(16'shff) : $signed(_GEN_389); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_391 = 8'h44 == sprite0AngleReg ? $signed(16'shfe) : $signed(_GEN_390); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_392 = 8'h45 == sprite0AngleReg ? $signed(16'shfe) : $signed(_GEN_391); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_393 = 8'h46 == sprite0AngleReg ? $signed(16'shfd) : $signed(_GEN_392); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_394 = 8'h47 == sprite0AngleReg ? $signed(16'shfc) : $signed(_GEN_393); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_395 = 8'h48 == sprite0AngleReg ? $signed(16'shfb) : $signed(_GEN_394); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_396 = 8'h49 == sprite0AngleReg ? $signed(16'shf9) : $signed(_GEN_395); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_397 = 8'h4a == sprite0AngleReg ? $signed(16'shf8) : $signed(_GEN_396); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_398 = 8'h4b == sprite0AngleReg ? $signed(16'shf6) : $signed(_GEN_397); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_399 = 8'h4c == sprite0AngleReg ? $signed(16'shf4) : $signed(_GEN_398); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_400 = 8'h4d == sprite0AngleReg ? $signed(16'shf3) : $signed(_GEN_399); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_401 = 8'h4e == sprite0AngleReg ? $signed(16'shf1) : $signed(_GEN_400); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_402 = 8'h4f == sprite0AngleReg ? $signed(16'shee) : $signed(_GEN_401); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_403 = 8'h50 == sprite0AngleReg ? $signed(16'shec) : $signed(_GEN_402); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_404 = 8'h51 == sprite0AngleReg ? $signed(16'shea) : $signed(_GEN_403); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_405 = 8'h52 == sprite0AngleReg ? $signed(16'she7) : $signed(_GEN_404); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_406 = 8'h53 == sprite0AngleReg ? $signed(16'she4) : $signed(_GEN_405); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_407 = 8'h54 == sprite0AngleReg ? $signed(16'she1) : $signed(_GEN_406); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_408 = 8'h55 == sprite0AngleReg ? $signed(16'shde) : $signed(_GEN_407); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_409 = 8'h56 == sprite0AngleReg ? $signed(16'shdb) : $signed(_GEN_408); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_410 = 8'h57 == sprite0AngleReg ? $signed(16'shd8) : $signed(_GEN_409); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_411 = 8'h58 == sprite0AngleReg ? $signed(16'shd4) : $signed(_GEN_410); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_412 = 8'h59 == sprite0AngleReg ? $signed(16'shd1) : $signed(_GEN_411); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_413 = 8'h5a == sprite0AngleReg ? $signed(16'shcd) : $signed(_GEN_412); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_414 = 8'h5b == sprite0AngleReg ? $signed(16'shc9) : $signed(_GEN_413); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_415 = 8'h5c == sprite0AngleReg ? $signed(16'shc5) : $signed(_GEN_414); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_416 = 8'h5d == sprite0AngleReg ? $signed(16'shc1) : $signed(_GEN_415); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_417 = 8'h5e == sprite0AngleReg ? $signed(16'shbd) : $signed(_GEN_416); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_418 = 8'h5f == sprite0AngleReg ? $signed(16'shb9) : $signed(_GEN_417); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_419 = 8'h60 == sprite0AngleReg ? $signed(16'shb5) : $signed(_GEN_418); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_420 = 8'h61 == sprite0AngleReg ? $signed(16'shb0) : $signed(_GEN_419); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_421 = 8'h62 == sprite0AngleReg ? $signed(16'shab) : $signed(_GEN_420); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_422 = 8'h63 == sprite0AngleReg ? $signed(16'sha7) : $signed(_GEN_421); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_423 = 8'h64 == sprite0AngleReg ? $signed(16'sha2) : $signed(_GEN_422); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_424 = 8'h65 == sprite0AngleReg ? $signed(16'sh9d) : $signed(_GEN_423); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_425 = 8'h66 == sprite0AngleReg ? $signed(16'sh98) : $signed(_GEN_424); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_426 = 8'h67 == sprite0AngleReg ? $signed(16'sh93) : $signed(_GEN_425); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_427 = 8'h68 == sprite0AngleReg ? $signed(16'sh8e) : $signed(_GEN_426); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_428 = 8'h69 == sprite0AngleReg ? $signed(16'sh88) : $signed(_GEN_427); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_429 = 8'h6a == sprite0AngleReg ? $signed(16'sh83) : $signed(_GEN_428); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_430 = 8'h6b == sprite0AngleReg ? $signed(16'sh7e) : $signed(_GEN_429); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_431 = 8'h6c == sprite0AngleReg ? $signed(16'sh78) : $signed(_GEN_430); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_432 = 8'h6d == sprite0AngleReg ? $signed(16'sh73) : $signed(_GEN_431); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_433 = 8'h6e == sprite0AngleReg ? $signed(16'sh6d) : $signed(_GEN_432); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_434 = 8'h6f == sprite0AngleReg ? $signed(16'sh67) : $signed(_GEN_433); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_435 = 8'h70 == sprite0AngleReg ? $signed(16'sh61) : $signed(_GEN_434); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_436 = 8'h71 == sprite0AngleReg ? $signed(16'sh5c) : $signed(_GEN_435); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_437 = 8'h72 == sprite0AngleReg ? $signed(16'sh56) : $signed(_GEN_436); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_438 = 8'h73 == sprite0AngleReg ? $signed(16'sh50) : $signed(_GEN_437); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_439 = 8'h74 == sprite0AngleReg ? $signed(16'sh4a) : $signed(_GEN_438); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_440 = 8'h75 == sprite0AngleReg ? $signed(16'sh44) : $signed(_GEN_439); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_441 = 8'h76 == sprite0AngleReg ? $signed(16'sh3e) : $signed(_GEN_440); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_442 = 8'h77 == sprite0AngleReg ? $signed(16'sh38) : $signed(_GEN_441); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_443 = 8'h78 == sprite0AngleReg ? $signed(16'sh31) : $signed(_GEN_442); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_444 = 8'h79 == sprite0AngleReg ? $signed(16'sh2b) : $signed(_GEN_443); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_445 = 8'h7a == sprite0AngleReg ? $signed(16'sh25) : $signed(_GEN_444); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_446 = 8'h7b == sprite0AngleReg ? $signed(16'sh1f) : $signed(_GEN_445); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_447 = 8'h7c == sprite0AngleReg ? $signed(16'sh19) : $signed(_GEN_446); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_448 = 8'h7d == sprite0AngleReg ? $signed(16'sh12) : $signed(_GEN_447); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_449 = 8'h7e == sprite0AngleReg ? $signed(16'shc) : $signed(_GEN_448); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_450 = 8'h7f == sprite0AngleReg ? $signed(16'sh6) : $signed(_GEN_449); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_451 = 8'h80 == sprite0AngleReg ? $signed(16'sh0) : $signed(_GEN_450); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_452 = 8'h81 == sprite0AngleReg ? $signed(-16'sh6) : $signed(_GEN_451); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_453 = 8'h82 == sprite0AngleReg ? $signed(-16'shc) : $signed(_GEN_452); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_454 = 8'h83 == sprite0AngleReg ? $signed(-16'sh12) : $signed(_GEN_453); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_455 = 8'h84 == sprite0AngleReg ? $signed(-16'sh19) : $signed(_GEN_454); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_456 = 8'h85 == sprite0AngleReg ? $signed(-16'sh1f) : $signed(_GEN_455); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_457 = 8'h86 == sprite0AngleReg ? $signed(-16'sh25) : $signed(_GEN_456); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_458 = 8'h87 == sprite0AngleReg ? $signed(-16'sh2b) : $signed(_GEN_457); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_459 = 8'h88 == sprite0AngleReg ? $signed(-16'sh31) : $signed(_GEN_458); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_460 = 8'h89 == sprite0AngleReg ? $signed(-16'sh38) : $signed(_GEN_459); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_461 = 8'h8a == sprite0AngleReg ? $signed(-16'sh3e) : $signed(_GEN_460); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_462 = 8'h8b == sprite0AngleReg ? $signed(-16'sh44) : $signed(_GEN_461); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_463 = 8'h8c == sprite0AngleReg ? $signed(-16'sh4a) : $signed(_GEN_462); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_464 = 8'h8d == sprite0AngleReg ? $signed(-16'sh50) : $signed(_GEN_463); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_465 = 8'h8e == sprite0AngleReg ? $signed(-16'sh56) : $signed(_GEN_464); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_466 = 8'h8f == sprite0AngleReg ? $signed(-16'sh5c) : $signed(_GEN_465); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_467 = 8'h90 == sprite0AngleReg ? $signed(-16'sh61) : $signed(_GEN_466); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_468 = 8'h91 == sprite0AngleReg ? $signed(-16'sh67) : $signed(_GEN_467); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_469 = 8'h92 == sprite0AngleReg ? $signed(-16'sh6d) : $signed(_GEN_468); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_470 = 8'h93 == sprite0AngleReg ? $signed(-16'sh73) : $signed(_GEN_469); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_471 = 8'h94 == sprite0AngleReg ? $signed(-16'sh78) : $signed(_GEN_470); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_472 = 8'h95 == sprite0AngleReg ? $signed(-16'sh7e) : $signed(_GEN_471); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_473 = 8'h96 == sprite0AngleReg ? $signed(-16'sh83) : $signed(_GEN_472); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_474 = 8'h97 == sprite0AngleReg ? $signed(-16'sh88) : $signed(_GEN_473); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_475 = 8'h98 == sprite0AngleReg ? $signed(-16'sh8e) : $signed(_GEN_474); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_476 = 8'h99 == sprite0AngleReg ? $signed(-16'sh93) : $signed(_GEN_475); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_477 = 8'h9a == sprite0AngleReg ? $signed(-16'sh98) : $signed(_GEN_476); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_478 = 8'h9b == sprite0AngleReg ? $signed(-16'sh9d) : $signed(_GEN_477); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_479 = 8'h9c == sprite0AngleReg ? $signed(-16'sha2) : $signed(_GEN_478); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_480 = 8'h9d == sprite0AngleReg ? $signed(-16'sha7) : $signed(_GEN_479); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_481 = 8'h9e == sprite0AngleReg ? $signed(-16'shab) : $signed(_GEN_480); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_482 = 8'h9f == sprite0AngleReg ? $signed(-16'shb0) : $signed(_GEN_481); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_483 = 8'ha0 == sprite0AngleReg ? $signed(-16'shb5) : $signed(_GEN_482); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_484 = 8'ha1 == sprite0AngleReg ? $signed(-16'shb9) : $signed(_GEN_483); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_485 = 8'ha2 == sprite0AngleReg ? $signed(-16'shbd) : $signed(_GEN_484); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_486 = 8'ha3 == sprite0AngleReg ? $signed(-16'shc1) : $signed(_GEN_485); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_487 = 8'ha4 == sprite0AngleReg ? $signed(-16'shc5) : $signed(_GEN_486); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_488 = 8'ha5 == sprite0AngleReg ? $signed(-16'shc9) : $signed(_GEN_487); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_489 = 8'ha6 == sprite0AngleReg ? $signed(-16'shcd) : $signed(_GEN_488); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_490 = 8'ha7 == sprite0AngleReg ? $signed(-16'shd1) : $signed(_GEN_489); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_491 = 8'ha8 == sprite0AngleReg ? $signed(-16'shd4) : $signed(_GEN_490); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_492 = 8'ha9 == sprite0AngleReg ? $signed(-16'shd8) : $signed(_GEN_491); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_493 = 8'haa == sprite0AngleReg ? $signed(-16'shdb) : $signed(_GEN_492); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_494 = 8'hab == sprite0AngleReg ? $signed(-16'shde) : $signed(_GEN_493); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_495 = 8'hac == sprite0AngleReg ? $signed(-16'she1) : $signed(_GEN_494); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_496 = 8'had == sprite0AngleReg ? $signed(-16'she4) : $signed(_GEN_495); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_497 = 8'hae == sprite0AngleReg ? $signed(-16'she7) : $signed(_GEN_496); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_498 = 8'haf == sprite0AngleReg ? $signed(-16'shea) : $signed(_GEN_497); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_499 = 8'hb0 == sprite0AngleReg ? $signed(-16'shec) : $signed(_GEN_498); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_500 = 8'hb1 == sprite0AngleReg ? $signed(-16'shee) : $signed(_GEN_499); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_501 = 8'hb2 == sprite0AngleReg ? $signed(-16'shf1) : $signed(_GEN_500); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_502 = 8'hb3 == sprite0AngleReg ? $signed(-16'shf3) : $signed(_GEN_501); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_503 = 8'hb4 == sprite0AngleReg ? $signed(-16'shf4) : $signed(_GEN_502); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_504 = 8'hb5 == sprite0AngleReg ? $signed(-16'shf6) : $signed(_GEN_503); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_505 = 8'hb6 == sprite0AngleReg ? $signed(-16'shf8) : $signed(_GEN_504); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_506 = 8'hb7 == sprite0AngleReg ? $signed(-16'shf9) : $signed(_GEN_505); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_507 = 8'hb8 == sprite0AngleReg ? $signed(-16'shfb) : $signed(_GEN_506); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_508 = 8'hb9 == sprite0AngleReg ? $signed(-16'shfc) : $signed(_GEN_507); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_509 = 8'hba == sprite0AngleReg ? $signed(-16'shfd) : $signed(_GEN_508); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_510 = 8'hbb == sprite0AngleReg ? $signed(-16'shfe) : $signed(_GEN_509); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_511 = 8'hbc == sprite0AngleReg ? $signed(-16'shfe) : $signed(_GEN_510); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_512 = 8'hbd == sprite0AngleReg ? $signed(-16'shff) : $signed(_GEN_511); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_513 = 8'hbe == sprite0AngleReg ? $signed(-16'shff) : $signed(_GEN_512); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_514 = 8'hbf == sprite0AngleReg ? $signed(-16'shff) : $signed(_GEN_513); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_515 = 8'hc0 == sprite0AngleReg ? $signed(-16'sh100) : $signed(_GEN_514); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_516 = 8'hc1 == sprite0AngleReg ? $signed(-16'shff) : $signed(_GEN_515); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_517 = 8'hc2 == sprite0AngleReg ? $signed(-16'shff) : $signed(_GEN_516); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_518 = 8'hc3 == sprite0AngleReg ? $signed(-16'shff) : $signed(_GEN_517); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_519 = 8'hc4 == sprite0AngleReg ? $signed(-16'shfe) : $signed(_GEN_518); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_520 = 8'hc5 == sprite0AngleReg ? $signed(-16'shfe) : $signed(_GEN_519); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_521 = 8'hc6 == sprite0AngleReg ? $signed(-16'shfd) : $signed(_GEN_520); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_522 = 8'hc7 == sprite0AngleReg ? $signed(-16'shfc) : $signed(_GEN_521); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_523 = 8'hc8 == sprite0AngleReg ? $signed(-16'shfb) : $signed(_GEN_522); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_524 = 8'hc9 == sprite0AngleReg ? $signed(-16'shf9) : $signed(_GEN_523); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_525 = 8'hca == sprite0AngleReg ? $signed(-16'shf8) : $signed(_GEN_524); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_526 = 8'hcb == sprite0AngleReg ? $signed(-16'shf6) : $signed(_GEN_525); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_527 = 8'hcc == sprite0AngleReg ? $signed(-16'shf4) : $signed(_GEN_526); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_528 = 8'hcd == sprite0AngleReg ? $signed(-16'shf3) : $signed(_GEN_527); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_529 = 8'hce == sprite0AngleReg ? $signed(-16'shf1) : $signed(_GEN_528); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_530 = 8'hcf == sprite0AngleReg ? $signed(-16'shee) : $signed(_GEN_529); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_531 = 8'hd0 == sprite0AngleReg ? $signed(-16'shec) : $signed(_GEN_530); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_532 = 8'hd1 == sprite0AngleReg ? $signed(-16'shea) : $signed(_GEN_531); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_533 = 8'hd2 == sprite0AngleReg ? $signed(-16'she7) : $signed(_GEN_532); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_534 = 8'hd3 == sprite0AngleReg ? $signed(-16'she4) : $signed(_GEN_533); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_535 = 8'hd4 == sprite0AngleReg ? $signed(-16'she1) : $signed(_GEN_534); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_536 = 8'hd5 == sprite0AngleReg ? $signed(-16'shde) : $signed(_GEN_535); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_537 = 8'hd6 == sprite0AngleReg ? $signed(-16'shdb) : $signed(_GEN_536); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_538 = 8'hd7 == sprite0AngleReg ? $signed(-16'shd8) : $signed(_GEN_537); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_539 = 8'hd8 == sprite0AngleReg ? $signed(-16'shd4) : $signed(_GEN_538); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_540 = 8'hd9 == sprite0AngleReg ? $signed(-16'shd1) : $signed(_GEN_539); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_541 = 8'hda == sprite0AngleReg ? $signed(-16'shcd) : $signed(_GEN_540); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_542 = 8'hdb == sprite0AngleReg ? $signed(-16'shc9) : $signed(_GEN_541); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_543 = 8'hdc == sprite0AngleReg ? $signed(-16'shc5) : $signed(_GEN_542); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_544 = 8'hdd == sprite0AngleReg ? $signed(-16'shc1) : $signed(_GEN_543); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_545 = 8'hde == sprite0AngleReg ? $signed(-16'shbd) : $signed(_GEN_544); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_546 = 8'hdf == sprite0AngleReg ? $signed(-16'shb9) : $signed(_GEN_545); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_547 = 8'he0 == sprite0AngleReg ? $signed(-16'shb5) : $signed(_GEN_546); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_548 = 8'he1 == sprite0AngleReg ? $signed(-16'shb0) : $signed(_GEN_547); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_549 = 8'he2 == sprite0AngleReg ? $signed(-16'shab) : $signed(_GEN_548); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_550 = 8'he3 == sprite0AngleReg ? $signed(-16'sha7) : $signed(_GEN_549); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_551 = 8'he4 == sprite0AngleReg ? $signed(-16'sha2) : $signed(_GEN_550); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_552 = 8'he5 == sprite0AngleReg ? $signed(-16'sh9d) : $signed(_GEN_551); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_553 = 8'he6 == sprite0AngleReg ? $signed(-16'sh98) : $signed(_GEN_552); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_554 = 8'he7 == sprite0AngleReg ? $signed(-16'sh93) : $signed(_GEN_553); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_555 = 8'he8 == sprite0AngleReg ? $signed(-16'sh8e) : $signed(_GEN_554); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_556 = 8'he9 == sprite0AngleReg ? $signed(-16'sh88) : $signed(_GEN_555); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_557 = 8'hea == sprite0AngleReg ? $signed(-16'sh83) : $signed(_GEN_556); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_558 = 8'heb == sprite0AngleReg ? $signed(-16'sh7e) : $signed(_GEN_557); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_559 = 8'hec == sprite0AngleReg ? $signed(-16'sh78) : $signed(_GEN_558); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_560 = 8'hed == sprite0AngleReg ? $signed(-16'sh73) : $signed(_GEN_559); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_561 = 8'hee == sprite0AngleReg ? $signed(-16'sh6d) : $signed(_GEN_560); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_562 = 8'hef == sprite0AngleReg ? $signed(-16'sh67) : $signed(_GEN_561); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_563 = 8'hf0 == sprite0AngleReg ? $signed(-16'sh61) : $signed(_GEN_562); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_564 = 8'hf1 == sprite0AngleReg ? $signed(-16'sh5c) : $signed(_GEN_563); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_565 = 8'hf2 == sprite0AngleReg ? $signed(-16'sh56) : $signed(_GEN_564); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_566 = 8'hf3 == sprite0AngleReg ? $signed(-16'sh50) : $signed(_GEN_565); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_567 = 8'hf4 == sprite0AngleReg ? $signed(-16'sh4a) : $signed(_GEN_566); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_568 = 8'hf5 == sprite0AngleReg ? $signed(-16'sh44) : $signed(_GEN_567); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_569 = 8'hf6 == sprite0AngleReg ? $signed(-16'sh3e) : $signed(_GEN_568); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_570 = 8'hf7 == sprite0AngleReg ? $signed(-16'sh38) : $signed(_GEN_569); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_571 = 8'hf8 == sprite0AngleReg ? $signed(-16'sh31) : $signed(_GEN_570); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_572 = 8'hf9 == sprite0AngleReg ? $signed(-16'sh2b) : $signed(_GEN_571); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_573 = 8'hfa == sprite0AngleReg ? $signed(-16'sh25) : $signed(_GEN_572); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_574 = 8'hfb == sprite0AngleReg ? $signed(-16'sh1f) : $signed(_GEN_573); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_575 = 8'hfc == sprite0AngleReg ? $signed(-16'sh19) : $signed(_GEN_574); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_576 = 8'hfd == sprite0AngleReg ? $signed(-16'sh12) : $signed(_GEN_575); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [15:0] _GEN_577 = 8'hfe == sprite0AngleReg ? $signed(-16'shc) : $signed(_GEN_576); // @[src/main/scala/PlayerController.scala 237:{14,14}]
  wire [47:0] _playerXPositionReg_T = $signed(sprite0SpeedReg) * $signed(cosReg); // @[src/main/scala/PlayerController.scala 244:68]
  wire [39:0] _playerXPositionReg_T_1 = _playerXPositionReg_T[47:8]; // @[src/main/scala/PlayerController.scala 244:78]
  wire [39:0] _GEN_592 = {{8{playerXPositionReg[31]}},playerXPositionReg}; // @[src/main/scala/PlayerController.scala 244:48]
  wire [39:0] _playerXPositionReg_T_4 = $signed(_GEN_592) + $signed(_playerXPositionReg_T_1); // @[src/main/scala/PlayerController.scala 244:48]
  wire [47:0] _playerYPositionReg_T = $signed(sprite0SpeedReg) * $signed(sinReg); // @[src/main/scala/PlayerController.scala 245:68]
  wire [39:0] _playerYPositionReg_T_1 = _playerYPositionReg_T[47:8]; // @[src/main/scala/PlayerController.scala 245:78]
  wire [39:0] _GEN_614 = {{8{playerYPositionReg[31]}},playerYPositionReg}; // @[src/main/scala/PlayerController.scala 245:48]
  wire [39:0] _playerYPositionReg_T_4 = $signed(_GEN_614) + $signed(_playerYPositionReg_T_1); // @[src/main/scala/PlayerController.scala 245:48]
  wire [5:0] tile1Idx = checkPointCntReg * 2'h2; // @[src/main/scala/PlayerController.scala 257:39]
  wire [5:0] tile2Idx = tile1Idx + 6'h1; // @[src/main/scala/PlayerController.scala 258:47]
  wire [15:0] _GEN_580 = 3'h1 == tile1Idx[2:0] ? 16'h285 : 16'h284; // @[src/main/scala/PlayerController.scala 261:{34,34}]
  wire [15:0] _GEN_581 = 3'h2 == tile1Idx[2:0] ? 16'h3d1 : _GEN_580; // @[src/main/scala/PlayerController.scala 261:{34,34}]
  wire [15:0] _GEN_582 = 3'h3 == tile1Idx[2:0] ? 16'h3f9 : _GEN_581; // @[src/main/scala/PlayerController.scala 261:{34,34}]
  wire [15:0] _GEN_583 = 3'h4 == tile1Idx[2:0] ? 16'h2a2 : _GEN_582; // @[src/main/scala/PlayerController.scala 261:{34,34}]
  wire [15:0] _GEN_584 = 3'h5 == tile1Idx[2:0] ? 16'h2a3 : _GEN_583; // @[src/main/scala/PlayerController.scala 261:{34,34}]
  wire [15:0] _GEN_621 = {{5'd0}, tilemapRomTileAddrReg}; // @[src/main/scala/PlayerController.scala 261:34]
  wire [15:0] _GEN_586 = 3'h1 == tile2Idx[2:0] ? 16'h285 : 16'h284; // @[src/main/scala/PlayerController.scala 262:{34,34}]
  wire [15:0] _GEN_587 = 3'h2 == tile2Idx[2:0] ? 16'h3d1 : _GEN_586; // @[src/main/scala/PlayerController.scala 262:{34,34}]
  wire [15:0] _GEN_588 = 3'h3 == tile2Idx[2:0] ? 16'h3f9 : _GEN_587; // @[src/main/scala/PlayerController.scala 262:{34,34}]
  wire [15:0] _GEN_589 = 3'h4 == tile2Idx[2:0] ? 16'h2a2 : _GEN_588; // @[src/main/scala/PlayerController.scala 262:{34,34}]
  wire [15:0] _GEN_590 = 3'h5 == tile2Idx[2:0] ? 16'h2a3 : _GEN_589; // @[src/main/scala/PlayerController.scala 262:{34,34}]
  wire  _T_46 = _GEN_621 == _GEN_590; // @[src/main/scala/PlayerController.scala 262:34]
  wire  _T_47 = _GEN_621 == _GEN_584 | _T_46; // @[src/main/scala/PlayerController.scala 261:61]
  wire [3:0] _checkPointCntReg_T_1 = checkPointCntReg + 4'h1; // @[src/main/scala/PlayerController.scala 264:46]
  wire [3:0] _GEN_591 = _T_47 ? _checkPointCntReg_T_1 : checkPointCntReg; // @[src/main/scala/PlayerController.scala 262:62 264:26 54:31]
  wire  _T_51 = checkPointCntReg == 4'h3; // @[src/main/scala/PlayerController.scala 266:105]
  wire [3:0] _GEN_593 = (tilemapRomTileAddrReg == 11'hb1 | tilemapRomTileAddrReg == 11'hd9) & checkPointCntReg == 4'h3
     ? 4'h0 : _GEN_591; // @[src/main/scala/PlayerController.scala 266:113 268:26]
  wire [31:0] _GEN_594 = checkPointCntReg == 4'h0 ? $signed(32'sh2400000) : $signed(playerXPositionReg); // @[src/main/scala/PlayerController.scala 276:39 277:30 67:35]
  wire [31:0] _GEN_595 = checkPointCntReg == 4'h0 ? $signed(32'sha00000) : $signed(playerYPositionReg); // @[src/main/scala/PlayerController.scala 276:39 278:30 68:35]
  wire [31:0] _GEN_596 = checkPointCntReg == 4'h0 ? $signed(32'sh0) : $signed(sprite0SpeedReg); // @[src/main/scala/PlayerController.scala 276:39 279:27 69:32]
  wire [7:0] _GEN_597 = checkPointCntReg == 4'h0 ? 8'h80 : sprite0AngleReg; // @[src/main/scala/PlayerController.scala 276:39 280:27 70:32]
  wire [15:0] _playerXPositionReg_T_7 = addressToPosition_io_posX - 16'h10; // @[src/main/scala/PlayerController.scala 283:62]
  wire [31:0] _playerXPositionReg_T_9 = {_playerXPositionReg_T_7, 16'h0}; // @[src/main/scala/PlayerController.scala 283:77]
  wire [15:0] _playerYPositionReg_T_7 = addressToPosition_io_posY - 16'h10; // @[src/main/scala/PlayerController.scala 284:62]
  wire [31:0] _playerYPositionReg_T_9 = {_playerYPositionReg_T_7, 16'h0}; // @[src/main/scala/PlayerController.scala 284:77]
  wire [31:0] _GEN_598 = checkPointCntReg == 4'h1 ? $signed(_playerXPositionReg_T_9) : $signed(_GEN_594); // @[src/main/scala/PlayerController.scala 282:39 283:30]
  wire [31:0] _GEN_599 = checkPointCntReg == 4'h1 ? $signed(_playerYPositionReg_T_9) : $signed(_GEN_595); // @[src/main/scala/PlayerController.scala 282:39 284:30]
  wire [31:0] _GEN_600 = checkPointCntReg == 4'h1 ? $signed(32'sh0) : $signed(_GEN_596); // @[src/main/scala/PlayerController.scala 282:39 285:27]
  wire [7:0] _GEN_601 = checkPointCntReg == 4'h1 ? 8'h40 : _GEN_597; // @[src/main/scala/PlayerController.scala 282:39 286:27]
  wire [31:0] _GEN_602 = checkPointCntReg == 4'h2 ? $signed(_playerXPositionReg_T_9) : $signed(_GEN_598); // @[src/main/scala/PlayerController.scala 288:39 289:30]
  wire [31:0] _GEN_603 = checkPointCntReg == 4'h2 ? $signed(_playerYPositionReg_T_9) : $signed(_GEN_599); // @[src/main/scala/PlayerController.scala 288:39 290:30]
  wire [31:0] _GEN_604 = checkPointCntReg == 4'h2 ? $signed(32'sh0) : $signed(_GEN_600); // @[src/main/scala/PlayerController.scala 288:39 291:27]
  wire [7:0] _GEN_605 = checkPointCntReg == 4'h2 ? 8'h0 : _GEN_601; // @[src/main/scala/PlayerController.scala 288:39 292:27]
  wire [31:0] _GEN_606 = _T_51 ? $signed(_playerXPositionReg_T_9) : $signed(_GEN_602); // @[src/main/scala/PlayerController.scala 294:39 295:30]
  wire [31:0] _GEN_607 = _T_51 ? $signed(_playerYPositionReg_T_9) : $signed(_GEN_603); // @[src/main/scala/PlayerController.scala 294:39 296:30]
  wire [31:0] _GEN_608 = _T_51 ? $signed(32'sh0) : $signed(_GEN_604); // @[src/main/scala/PlayerController.scala 294:39 297:27]
  wire [7:0] _GEN_609 = _T_51 ? 8'hc0 : _GEN_605; // @[src/main/scala/PlayerController.scala 294:39 298:27]
  wire [31:0] _GEN_610 = io_tilemapRomCollisionData ? $signed(_GEN_606) : $signed(playerXPositionReg); // @[src/main/scala/PlayerController.scala 275:40 67:35]
  wire [31:0] _GEN_611 = io_tilemapRomCollisionData ? $signed(_GEN_607) : $signed(playerYPositionReg); // @[src/main/scala/PlayerController.scala 275:40 68:35]
  wire [31:0] _GEN_612 = io_tilemapRomCollisionData ? $signed(_GEN_608) : $signed(sprite0SpeedReg); // @[src/main/scala/PlayerController.scala 275:40 69:32]
  wire [7:0] _GEN_613 = io_tilemapRomCollisionData ? _GEN_609 : sprite0AngleReg; // @[src/main/scala/PlayerController.scala 275:40 70:32]
  wire [2:0] _GEN_615 = 3'h6 == stateReg ? 3'h0 : stateReg; // @[src/main/scala/PlayerController.scala 130:20 307:16 64:25]
  wire [31:0] _GEN_616 = 3'h4 == stateReg ? $signed(_GEN_610) : $signed(playerXPositionReg); // @[src/main/scala/PlayerController.scala 130:20 67:35]
  wire [31:0] _GEN_617 = 3'h4 == stateReg ? $signed(_GEN_611) : $signed(playerYPositionReg); // @[src/main/scala/PlayerController.scala 130:20 68:35]
  wire [31:0] _GEN_618 = 3'h4 == stateReg ? $signed(_GEN_612) : $signed(sprite0SpeedReg); // @[src/main/scala/PlayerController.scala 130:20 69:32]
  wire [7:0] _GEN_619 = 3'h4 == stateReg ? _GEN_613 : sprite0AngleReg; // @[src/main/scala/PlayerController.scala 130:20 70:32]
  wire [2:0] _GEN_620 = 3'h4 == stateReg ? 3'h6 : _GEN_615; // @[src/main/scala/PlayerController.scala 130:20 302:16]
  wire [3:0] _GEN_622 = 3'h3 == stateReg ? _GEN_593 : checkPointCntReg; // @[src/main/scala/PlayerController.scala 130:20 54:31]
  wire [2:0] _GEN_624 = 3'h3 == stateReg ? 3'h4 : _GEN_620; // @[src/main/scala/PlayerController.scala 130:20 270:16]
  wire [31:0] _GEN_625 = 3'h3 == stateReg ? $signed(playerXPositionReg) : $signed(_GEN_616); // @[src/main/scala/PlayerController.scala 130:20 67:35]
  wire [31:0] _GEN_626 = 3'h3 == stateReg ? $signed(playerYPositionReg) : $signed(_GEN_617); // @[src/main/scala/PlayerController.scala 130:20 68:35]
  wire [31:0] _GEN_627 = 3'h3 == stateReg ? $signed(sprite0SpeedReg) : $signed(_GEN_618); // @[src/main/scala/PlayerController.scala 130:20 69:32]
  wire [7:0] _GEN_628 = 3'h3 == stateReg ? sprite0AngleReg : _GEN_619; // @[src/main/scala/PlayerController.scala 130:20 70:32]
  wire [10:0] _GEN_630 = 3'h5 == stateReg ? posToAddress_io_address : tilemapRomTileAddrReg; // @[src/main/scala/PlayerController.scala 130:20 251:31 103:38]
  wire [2:0] _GEN_631 = 3'h5 == stateReg ? 3'h3 : _GEN_624; // @[src/main/scala/PlayerController.scala 130:20 253:18]
  wire [3:0] _GEN_632 = 3'h5 == stateReg ? checkPointCntReg : _GEN_622; // @[src/main/scala/PlayerController.scala 130:20 54:31]
  wire [31:0] _GEN_634 = 3'h5 == stateReg ? $signed(playerXPositionReg) : $signed(_GEN_625); // @[src/main/scala/PlayerController.scala 130:20 67:35]
  wire [31:0] _GEN_635 = 3'h5 == stateReg ? $signed(playerYPositionReg) : $signed(_GEN_626); // @[src/main/scala/PlayerController.scala 130:20 68:35]
  wire [31:0] _GEN_636 = 3'h5 == stateReg ? $signed(sprite0SpeedReg) : $signed(_GEN_627); // @[src/main/scala/PlayerController.scala 130:20 69:32]
  wire [7:0] _GEN_637 = 3'h5 == stateReg ? sprite0AngleReg : _GEN_628; // @[src/main/scala/PlayerController.scala 130:20 70:32]
  wire [39:0] _GEN_639 = 3'h2 == stateReg ? $signed(_playerXPositionReg_T_4) : $signed({{8{_GEN_634[31]}},_GEN_634}); // @[src/main/scala/PlayerController.scala 130:20 244:26]
  wire [39:0] _GEN_640 = 3'h2 == stateReg ? $signed(_playerYPositionReg_T_4) : $signed({{8{_GEN_635[31]}},_GEN_635}); // @[src/main/scala/PlayerController.scala 130:20 245:26]
  wire  _GEN_650 = 3'h1 == stateReg ? _GEN_59 : sprite0Visible; // @[src/main/scala/PlayerController.scala 130:20 95:31]
  wire [39:0] _GEN_661 = 3'h1 == stateReg ? $signed({{8{playerXPositionReg[31]}},playerXPositionReg}) : $signed(_GEN_639
    ); // @[src/main/scala/PlayerController.scala 130:20 67:35]
  wire [39:0] _GEN_662 = 3'h1 == stateReg ? $signed({{8{playerYPositionReg[31]}},playerYPositionReg}) : $signed(_GEN_640
    ); // @[src/main/scala/PlayerController.scala 130:20 68:35]
  wire  _GEN_670 = 3'h0 == stateReg ? sprite0Visible : _GEN_650; // @[src/main/scala/PlayerController.scala 130:20 95:31]
  ...
  wire [39:0] _GEN_629 = reset ? $signed(40'sh2400000) : $signed(_GEN_680); // @[src/main/scala/PlayerController.scala 67:{35,35}]
  wire [39:0] _GEN_638 = reset ? $signed(40'sha00000) : $signed(_GEN_681); // @[src/main/scala/PlayerController.scala 68:{35,35}]
  PositionToAddress posToAddress ( // @[src/main/scala/PlayerController.scala 99:28]
    .io_posX(posToAddress_io_posX),
    .io_posY(posToAddress_io_posY),
    .io_address(posToAddress_io_address)
  );
  AddressToPosition addressToPosition ( // @[src/main/scala/PlayerController.scala 106:33]
    .io_posX(addressToPosition_io_posX),
    .io_posY(addressToPosition_io_posY),
    .io_address(addressToPosition_io_address)
  );
  assign io_tilemapRomTileAddress = tilemapRomTileAddrReg; // @[src/main/scala/PlayerController.scala 104:28]
  assign io_playerXPosition = _posToAddress_io_posX_T_1[10:0]; // @[src/main/scala/PlayerController.scala 114:22]
  assign io_playerYPosition = _posToAddress_io_posY_T_1[9:0]; // @[src/main/scala/PlayerController.scala 115:22]
  assign io_spriteVisible_0 = sprite0Visible; // @[src/main/scala/PlayerController.scala 118:30]
  assign io_spriteVisible_1 = sprite1Visible; // @[src/main/scala/PlayerController.scala 122:30]
  assign io_spriteVisible_2 = sprite2Visible; // @[src/main/scala/PlayerController.scala 126:30]
  assign io_spriteFlipHorizontal_0 = sprite0FlipHorizontalReg; // @[src/main/scala/PlayerController.scala 119:30]
  assign io_spriteFlipHorizontal_1 = sprite1FlipHorizontalReg; // @[src/main/scala/PlayerController.scala 123:30]
  assign io_spriteFlipVertical_1 = sprite1FlipVerticalReg; // @[src/main/scala/PlayerController.scala 124:28]
  assign io_spriteFlipVertical_2 = sprite2FlipVerticalReg; // @[src/main/scala/PlayerController.scala 127:28]
  assign posToAddress_io_posX = _posToAddress_io_posX_T_1[10:0]; // @[src/main/scala/PlayerController.scala 100:24]
  assign posToAddress_io_posY = _posToAddress_io_posY_T_1[9:0]; // @[src/main/scala/PlayerController.scala 101:24]
  assign addressToPosition_io_address = {{5'd0}, _addressToPosition_io_address_T_8}; // @[src/main/scala/PlayerController.scala 108:32]
  always @(posedge clock) begin
    ...
    end else if (!(3'h0 == stateReg)) begin // @[src/main/scala/PlayerController.scala 130:20]
      if (!(3'h1 == stateReg)) begin // @[src/main/scala/PlayerController.scala 130:20]
        if (!(3'h2 == stateReg)) begin // @[src/main/scala/PlayerController.scala 130:20]
          checkPointCntReg <= _GEN_632;
        end
      end
    end
    if (reset) begin // @[src/main/scala/PlayerController.scala 64:25]
      stateReg <= 3'h0; // @[src/main/scala/PlayerController.scala 64:25]
    end else if (3'h0 == stateReg) begin // @[src/main/scala/PlayerController.scala 130:20]
      if (io_enable) begin // @[src/main/scala/PlayerController.scala 132:22]
        if (io_newFrame) begin // @[src/main/scala/PlayerController.scala 133:26]
          stateReg <= 3'h1; // @[src/main/scala/PlayerController.scala 134:20]
        end
      end
    end else if (3'h1 == stateReg) begin // @[src/main/scala/PlayerController.scala 130:20]
      stateReg <= 3'h2; // @[src/main/scala/PlayerController.scala 239:16]
    end else if (3'h2 == stateReg) begin // @[src/main/scala/PlayerController.scala 130:20]
      stateReg <= 3'h5; // @[src/main/scala/PlayerController.scala 247:16]
    end else begin
      stateReg <= _GEN_631;
    end
    playerXPositionReg <= _GEN_629[31:0]; // @[src/main/scala/PlayerController.scala 67:{35,35}]
    playerYPositionReg <= _GEN_638[31:0]; // @[src/main/scala/PlayerController.scala 68:{35,35}]
    if (reset) begin // @[src/main/scala/PlayerController.scala 69:32]
      sprite0SpeedReg <= 32'sh0; // @[src/main/scala/PlayerController.scala 69:32]
    end else if (!(3'h0 == stateReg)) begin // @[src/main/scala/PlayerController.scala 130:20]
      if (3'h1 == stateReg) begin // @[src/main/scala/PlayerController.scala 130:20]
        if (io_btnD) begin // @[src/main/scala/PlayerController.scala 140:20]
    ...
    if (reset) begin // @[src/main/scala/PlayerController.scala 70:32]
      sprite0AngleReg <= 8'h80; // @[src/main/scala/PlayerController.scala 70:32]
    end else if (!(3'h0 == stateReg)) begin // @[src/main/scala/PlayerController.scala 130:20]
      if (3'h1 == stateReg) begin // @[src/main/scala/PlayerController.scala 130:20]
        if (io_btnR) begin // @[src/main/scala/PlayerController.scala 158:21]
          sprite0AngleReg <= _sprite0AngleReg_T_1; // @[src/main/scala/PlayerController.scala 159:25]
        end else begin
    ...
    if (reset) begin // @[src/main/scala/PlayerController.scala 72:23]
      cosReg <= 16'sh0; // @[src/main/scala/PlayerController.scala 72:23]
    end else if (!(3'h0 == stateReg)) begin // @[src/main/scala/PlayerController.scala 130:20]
      if (3'h1 == stateReg) begin // @[src/main/scala/PlayerController.scala 130:20]
        if (8'hff == sprite0AngleReg) begin // @[src/main/scala/PlayerController.scala 236:14]
          cosReg <= 16'shff; // @[src/main/scala/PlayerController.scala 236:14]
        end else begin
          cosReg <= _GEN_321;
        end
      end
    ...
    if (reset) begin // @[src/main/scala/PlayerController.scala 73:23]
      sinReg <= 16'sh0; // @[src/main/scala/PlayerController.scala 73:23]
    end else if (!(3'h0 == stateReg)) begin // @[src/main/scala/PlayerController.scala 130:20]
      if (3'h1 == stateReg) begin // @[src/main/scala/PlayerController.scala 130:20]
        if (8'hff == sprite0AngleReg) begin // @[src/main/scala/PlayerController.scala 237:14]
          sinReg <= -16'sh6; // @[src/main/scala/PlayerController.scala 237:14]
        end else begin
          sinReg <= _GEN_577;
        end
      end
    ...
    if (reset) begin // @[src/main/scala/PlayerController.scala 87:41]
      sprite0FlipHorizontalReg <= 1'h0; // @[src/main/scala/PlayerController.scala 87:41]
    end else if (!(3'h0 == stateReg)) begin // @[src/main/scala/PlayerController.scala 130:20]
      if (3'h1 == stateReg) begin // @[src/main/scala/PlayerController.scala 130:20]
        if (sprite0AngleReg >= 8'h71 & sprite0AngleReg <= 8'h90) begin // @[src/main/scala/PlayerController.scala 166:66]
          sprite0FlipHorizontalReg <= 1'h0; // @[src/main/scala/PlayerController.scala 171:36]
        end else begin
          sprite0FlipHorizontalReg <= _GEN_57;
        end
      end
    end
    if (reset) begin // @[src/main/scala/PlayerController.scala 90:41]
      sprite1FlipHorizontalReg <= 1'h0; // @[src/main/scala/PlayerController.scala 90:41]
    end else if (!(3'h0 == stateReg)) begin // @[src/main/scala/PlayerController.scala 130:20]
      if (3'h1 == stateReg) begin // @[src/main/scala/PlayerController.scala 130:20]
        if (!(sprite0AngleReg >= 8'h71 & sprite0AngleReg <= 8'h90)) begin // @[src/main/scala/PlayerController.scala 166:66]
    ...
    if (reset) begin // @[src/main/scala/PlayerController.scala 91:39]
      sprite1FlipVerticalReg <= 1'h0; // @[src/main/scala/PlayerController.scala 91:39]
    end else if (!(3'h0 == stateReg)) begin // @[src/main/scala/PlayerController.scala 130:20]
      if (3'h1 == stateReg) begin // @[src/main/scala/PlayerController.scala 130:20]
        if (!(sprite0AngleReg >= 8'h71 & sprite0AngleReg <= 8'h90)) begin // @[src/main/scala/PlayerController.scala 166:66]
    ...
    if (reset) begin // @[src/main/scala/PlayerController.scala 93:39]
      sprite2FlipVerticalReg <= 1'h0; // @[src/main/scala/PlayerController.scala 93:39]
    end else if (!(3'h0 == stateReg)) begin // @[src/main/scala/PlayerController.scala 130:20]
      if (3'h1 == stateReg) begin // @[src/main/scala/PlayerController.scala 130:20]
        if (!(sprite0AngleReg >= 8'h71 & sprite0AngleReg <= 8'h90)) begin // @[src/main/scala/PlayerController.scala 166:66]
    ...
    sprite0Visible <= reset | _GEN_670; // @[src/main/scala/PlayerController.scala 95:{31,31}]
    if (reset) begin // @[src/main/scala/PlayerController.scala 96:31]
      sprite1Visible <= 1'h0; // @[src/main/scala/PlayerController.scala 96:31]
    end else if (!(3'h0 == stateReg)) begin // @[src/main/scala/PlayerController.scala 130:20]
      if (3'h1 == stateReg) begin // @[src/main/scala/PlayerController.scala 130:20]
        if (sprite0AngleReg >= 8'h71 & sprite0AngleReg <= 8'h90) begin // @[src/main/scala/PlayerController.scala 166:66]
          sprite1Visible <= 1'h0; // @[src/main/scala/PlayerController.scala 168:26]
        end else begin
    ...
    if (reset) begin // @[src/main/scala/PlayerController.scala 97:31]
      sprite2Visible <= 1'h0; // @[src/main/scala/PlayerController.scala 97:31]
    end else if (!(3'h0 == stateReg)) begin // @[src/main/scala/PlayerController.scala 130:20]
      if (3'h1 == stateReg) begin // @[src/main/scala/PlayerController.scala 130:20]
        if (sprite0AngleReg >= 8'h71 & sprite0AngleReg <= 8'h90) begin // @[src/main/scala/PlayerController.scala 166:66]
          sprite2Visible <= 1'h0; // @[src/main/scala/PlayerController.scala 169:26]
        end else begin
          sprite2Visible <= _GEN_53;
        end
      end
    end
    if (reset) begin // @[src/main/scala/PlayerController.scala 103:38]
      tilemapRomTileAddrReg <= 11'h0; // @[src/main/scala/PlayerController.scala 103:38]
    end else if (!(3'h0 == stateReg)) begin // @[src/main/scala/PlayerController.scala 130:20]
      if (!(3'h1 == stateReg)) begin // @[src/main/scala/PlayerController.scala 130:20]
        if (!(3'h2 == stateReg)) begin // @[src/main/scala/PlayerController.scala 130:20]
...
`ifdef RANDOMIZE_REG_INIT
  ...
  _RAND_2 = {1{`RANDOM}};
  playerXPositionReg = _RAND_2[31:0];
  _RAND_3 = {1{`RANDOM}};
  playerYPositionReg = _RAND_3[31:0];
  _RAND_4 = {1{`RANDOM}};
  sprite0SpeedReg = _RAND_4[31:0];
  _RAND_5 = {1{`RANDOM}};
  sprite0AngleReg = _RAND_5[7:0];
  _RAND_6 = {1{`RANDOM}};
  cosReg = _RAND_6[15:0];
  _RAND_7 = {1{`RANDOM}};
  sinReg = _RAND_7[15:0];
  _RAND_8 = {1{`RANDOM}};
  sprite0FlipHorizontalReg = _RAND_8[0:0];
  _RAND_9 = {1{`RANDOM}};
  sprite1FlipHorizontalReg = _RAND_9[0:0];
  _RAND_10 = {1{`RANDOM}};
  sprite1FlipVerticalReg = _RAND_10[0:0];
  _RAND_11 = {1{`RANDOM}};
  sprite2FlipVerticalReg = _RAND_11[0:0];
  _RAND_12 = {1{`RANDOM}};
  sprite0Visible = _RAND_12[0:0];
  _RAND_13 = {1{`RANDOM}};
  sprite1Visible = _RAND_13[0:0];
  _RAND_14 = {1{`RANDOM}};
  sprite2Visible = _RAND_14[0:0];
  _RAND_15 = {1{`RANDOM}};
  tilemapRomTileAddrReg = _RAND_15[10:0];
`endif // RANDOMIZE_REG_INIT
  `endif // RANDOMIZE
end // initial
`ifdef FIRRTL_AFTER_INITIAL
...
`ifdef RANDOMIZE_REG_INIT
  ...
  reg [31:0] _RAND_3;
`endif // RANDOMIZE_REG_INIT
  wire [7:0] raceText_14 = io_time_3 + 8'h1a; // @[src/main/scala/RaceScoreboardPrinter.scala 117:32]
  wire [7:0] raceText_15 = io_time_2 + 8'h1a; // @[src/main/scala/RaceScoreboardPrinter.scala 118:32]
  wire [7:0] raceText_16 = io_time_1 + 8'h1a; // @[src/main/scala/RaceScoreboardPrinter.scala 119:32]
  wire [7:0] raceText_17 = io_time_0 + 8'h1a; // @[src/main/scala/RaceScoreboardPrinter.scala 120:32]
  reg [5:0] xIdx; // @[src/main/scala/RaceScoreboardPrinter.scala 127:23]
  reg [4:0] yIdx; // @[src/main/scala/RaceScoreboardPrinter.scala 128:23]
  wire [10:0] _GEN_109 = {{5'd0}, xIdx}; // @[src/main/scala/RaceScoreboardPrinter.scala 129:39]
  wire [11:0] _backBufferAddress_T = {{1'd0}, _GEN_109}; // @[src/main/scala/RaceScoreboardPrinter.scala 129:39]
  wire [10:0] _backBufferAddress_T_2 = 6'h28 * yIdx; // @[src/main/scala/RaceScoreboardPrinter.scala 129:54]
  wire [5:0] _textAddress_T_1 = xIdx - 6'hf; // @[src/main/scala/RaceScoreboardPrinter.scala 130:29]
  wire [4:0] _textAddress_T_3 = yIdx - 5'h1; // @[src/main/scala/RaceScoreboardPrinter.scala 130:57]
  wire [8:0] _textAddress_T_4 = 4'h9 * _textAddress_T_3; // @[src/main/scala/RaceScoreboardPrinter.scala 130:49]
  wire [8:0] _GEN_110 = {{3'd0}, _textAddress_T_1}; // @[src/main/scala/RaceScoreboardPrinter.scala 130:42]
  wire [8:0] textAddress = _GEN_110 + _textAddress_T_4; // @[src/main/scala/RaceScoreboardPrinter.scala 130:42]
  reg  running; // @[src/main/scala/RaceScoreboardPrinter.scala 132:26]
  reg  done; // @[src/main/scala/RaceScoreboardPrinter.scala 133:23]
  wire [7:0] _GEN_1 = 5'h1 == textAddress[4:0] ? 8'h13 : 8'h3; // @[src/main/scala/RaceScoreboardPrinter.scala 137:{32,32}]
  wire [7:0] _GEN_2 = 5'h2 == textAddress[4:0] ? 8'h14 : _GEN_1; // @[src/main/scala/RaceScoreboardPrinter.scala 137:{32,32}]
  wire [7:0] _GEN_3 = 5'h3 == textAddress[4:0] ? 8'h24 : _GEN_2; // @[src/main/scala/RaceScoreboardPrinter.scala 137:{32,32}]
  wire [7:0] _GEN_4 = 5'h4 == textAddress[4:0] ? 8'h12 : _GEN_3; // @[src/main/scala/RaceScoreboardPrinter.scala 137:{32,32}]
  wire [7:0] _GEN_5 = 5'h5 == textAddress[4:0] ? 8'h14 : _GEN_4; // @[src/main/scala/RaceScoreboardPrinter.scala 137:{32,32}]
  wire [7:0] _GEN_6 = 5'h6 == textAddress[4:0] ? 8'hf : _GEN_5; // @[src/main/scala/RaceScoreboardPrinter.scala 137:{32,32}]
  wire [7:0] _GEN_7 = 5'h7 == textAddress[4:0] ? 8'h4 : _GEN_6; // @[src/main/scala/RaceScoreboardPrinter.scala 137:{32,32}]
  wire [7:0] _GEN_8 = 5'h8 == textAddress[4:0] ? 8'h11 : _GEN_7; // @[src/main/scala/RaceScoreboardPrinter.scala 137:{32,32}]
  wire [7:0] _GEN_9 = 5'h9 == textAddress[4:0] ? 8'h2 : _GEN_8; // @[src/main/scala/RaceScoreboardPrinter.scala 137:{32,32}]
  wire [7:0] _GEN_10 = 5'ha == textAddress[4:0] ? 8'h14 : _GEN_9; // @[src/main/scala/RaceScoreboardPrinter.scala 137:{32,32}]
  wire [7:0] _GEN_11 = 5'hb == textAddress[4:0] ? 8'hf : _GEN_10; // @[src/main/scala/RaceScoreboardPrinter.scala 137:{32,32}]
  wire [7:0] _GEN_12 = 5'hc == textAddress[4:0] ? 8'h24 : _GEN_11; // @[src/main/scala/RaceScoreboardPrinter.scala 137:{32,32}]
  wire [7:0] _GEN_13 = 5'hd == textAddress[4:0] ? 8'h24 : _GEN_12; // @[src/main/scala/RaceScoreboardPrinter.scala 137:{32,32}]
  wire [7:0] _GEN_14 = 5'he == textAddress[4:0] ? 8'h1c : _GEN_13; // @[src/main/scala/RaceScoreboardPrinter.scala 137:{32,32}]
  wire [7:0] _GEN_15 = 5'hf == textAddress[4:0] ? 8'h1a : _GEN_14; // @[src/main/scala/RaceScoreboardPrinter.scala 137:{32,32}]
  wire [7:0] _GEN_16 = 5'h10 == textAddress[4:0] ? 8'h1c : _GEN_15; // @[src/main/scala/RaceScoreboardPrinter.scala 137:{32,32}]
  wire [7:0] _GEN_17 = 5'h11 == textAddress[4:0] ? 8'h20 : _GEN_16; // @[src/main/scala/RaceScoreboardPrinter.scala 137:{32,32}]
  wire [7:0] _GEN_20 = 5'h2 == textAddress[4:0] ? 8'h11 : 8'h24; // @[src/main/scala/RaceScoreboardPrinter.scala 139:{32,32}]
  wire [7:0] _GEN_21 = 5'h3 == textAddress[4:0] ? 8'h4 : _GEN_20; // @[src/main/scala/RaceScoreboardPrinter.scala 139:{32,32}]
  wire [7:0] _GEN_22 = 5'h4 == textAddress[4:0] ? 8'h0 : _GEN_21; // @[src/main/scala/RaceScoreboardPrinter.scala 139:{32,32}]
  wire [7:0] _GEN_23 = 5'h5 == textAddress[4:0] ? 8'h3 : _GEN_22; // @[src/main/scala/RaceScoreboardPrinter.scala 139:{32,32}]
  wire [7:0] _GEN_24 = 5'h6 == textAddress[4:0] ? 8'h18 : _GEN_23; // @[src/main/scala/RaceScoreboardPrinter.scala 139:{32,32}]
  wire [7:0] _GEN_25 = 5'h7 == textAddress[4:0] ? 8'h24 : _GEN_24; // @[src/main/scala/RaceScoreboardPrinter.scala 139:{32,32}]
  wire [7:0] _GEN_26 = 5'h8 == textAddress[4:0] ? 8'h24 : _GEN_25; // @[src/main/scala/RaceScoreboardPrinter.scala 139:{32,32}]
  wire [7:0] _GEN_27 = 5'h9 == textAddress[4:0] ? 8'h24 : _GEN_26; // @[src/main/scala/RaceScoreboardPrinter.scala 139:{32,32}]
  wire [7:0] _GEN_28 = 5'ha == textAddress[4:0] ? 8'h24 : _GEN_27; // @[src/main/scala/RaceScoreboardPrinter.scala 139:{32,32}]
  wire [7:0] _GEN_29 = 5'hb == textAddress[4:0] ? 8'h24 : _GEN_28; // @[src/main/scala/RaceScoreboardPrinter.scala 139:{32,32}]
  wire [7:0] _GEN_30 = 5'hc == textAddress[4:0] ? 8'h24 : _GEN_29; // @[src/main/scala/RaceScoreboardPrinter.scala 139:{32,32}]
  wire [7:0] _GEN_31 = 5'hd == textAddress[4:0] ? 8'h24 : _GEN_30; // @[src/main/scala/RaceScoreboardPrinter.scala 139:{32,32}]
  wire [7:0] _GEN_32 = 5'he == textAddress[4:0] ? 8'h24 : _GEN_31; // @[src/main/scala/RaceScoreboardPrinter.scala 139:{32,32}]
  wire [7:0] _GEN_33 = 5'hf == textAddress[4:0] ? 8'h24 : _GEN_32; // @[src/main/scala/RaceScoreboardPrinter.scala 139:{32,32}]
  wire [7:0] _GEN_34 = 5'h10 == textAddress[4:0] ? 8'h24 : _GEN_33; // @[src/main/scala/RaceScoreboardPrinter.scala 139:{32,32}]
  wire [7:0] _GEN_35 = 5'h11 == textAddress[4:0] ? 8'h24 : _GEN_34; // @[src/main/scala/RaceScoreboardPrinter.scala 139:{32,32}]
  wire [7:0] _GEN_48 = 5'hc == textAddress[4:0] ? 8'h12 : _GEN_29; // @[src/main/scala/RaceScoreboardPrinter.scala 141:{32,32}]
  wire [7:0] _GEN_49 = 5'hd == textAddress[4:0] ? 8'h4 : _GEN_48; // @[src/main/scala/RaceScoreboardPrinter.scala 141:{32,32}]
  wire [7:0] _GEN_50 = 5'he == textAddress[4:0] ? 8'h13 : _GEN_49; // @[src/main/scala/RaceScoreboardPrinter.scala 141:{32,32}]
  wire [7:0] _GEN_51 = 5'hf == textAddress[4:0] ? 8'h24 : _GEN_50; // @[src/main/scala/RaceScoreboardPrinter.scala 141:{32,32}]
  wire [7:0] _GEN_52 = 5'h10 == textAddress[4:0] ? 8'h24 : _GEN_51; // @[src/main/scala/RaceScoreboardPrinter.scala 141:{32,32}]
  wire [7:0] _GEN_53 = 5'h11 == textAddress[4:0] ? 8'h24 : _GEN_52; // @[src/main/scala/RaceScoreboardPrinter.scala 141:{32,32}]
  wire [7:0] _GEN_55 = 5'h1 == textAddress[4:0] ? 8'h6 : 8'h24; // @[src/main/scala/RaceScoreboardPrinter.scala 143:{32,32}]
  wire [7:0] _GEN_56 = 5'h2 == textAddress[4:0] ? 8'he : _GEN_55; // @[src/main/scala/RaceScoreboardPrinter.scala 143:{32,32}]
  wire [7:0] _GEN_57 = 5'h3 == textAddress[4:0] ? 8'he : _GEN_56; // @[src/main/scala/RaceScoreboardPrinter.scala 143:{32,32}]
  wire [7:0] _GEN_58 = 5'h4 == textAddress[4:0] ? 8'he : _GEN_57; // @[src/main/scala/RaceScoreboardPrinter.scala 143:{32,32}]
  wire [7:0] _GEN_59 = 5'h5 == textAddress[4:0] ? 8'he : _GEN_58; // @[src/main/scala/RaceScoreboardPrinter.scala 143:{32,32}]
  wire [7:0] _GEN_60 = 5'h6 == textAddress[4:0] ? 8'he : _GEN_59; // @[src/main/scala/RaceScoreboardPrinter.scala 143:{32,32}]
  wire [7:0] _GEN_61 = 5'h7 == textAddress[4:0] ? 8'he : _GEN_60; // @[src/main/scala/RaceScoreboardPrinter.scala 143:{32,32}]
  wire [7:0] _GEN_62 = 5'h8 == textAddress[4:0] ? 8'h24 : _GEN_61; // @[src/main/scala/RaceScoreboardPrinter.scala 143:{32,32}]
  wire [7:0] _GEN_63 = 5'h9 == textAddress[4:0] ? 8'h24 : _GEN_62; // @[src/main/scala/RaceScoreboardPrinter.scala 143:{32,32}]
  wire [7:0] _GEN_64 = 5'ha == textAddress[4:0] ? 8'h6 : _GEN_63; // @[src/main/scala/RaceScoreboardPrinter.scala 143:{32,32}]
  wire [7:0] _GEN_65 = 5'hb == textAddress[4:0] ? 8'he : _GEN_64; // @[src/main/scala/RaceScoreboardPrinter.scala 143:{32,32}]
  wire [7:0] _GEN_66 = 5'hc == textAddress[4:0] ? 8'he : _GEN_65; // @[src/main/scala/RaceScoreboardPrinter.scala 143:{32,32}]
  wire [7:0] _GEN_67 = 5'hd == textAddress[4:0] ? 8'he : _GEN_66; // @[src/main/scala/RaceScoreboardPrinter.scala 143:{32,32}]
  wire [7:0] _GEN_68 = 5'he == textAddress[4:0] ? 8'he : _GEN_67; // @[src/main/scala/RaceScoreboardPrinter.scala 143:{32,32}]
  wire [7:0] _GEN_69 = 5'hf == textAddress[4:0] ? 8'he : _GEN_68; // @[src/main/scala/RaceScoreboardPrinter.scala 143:{32,32}]
  wire [7:0] _GEN_70 = 5'h10 == textAddress[4:0] ? 8'he : _GEN_69; // @[src/main/scala/RaceScoreboardPrinter.scala 143:{32,32}]
  wire [7:0] _GEN_71 = 5'h11 == textAddress[4:0] ? 8'h24 : _GEN_70; // @[src/main/scala/RaceScoreboardPrinter.scala 143:{32,32}]
  wire [7:0] _GEN_73 = 5'h1 == textAddress[4:0] ? 8'h0 : 8'hb; // @[src/main/scala/RaceScoreboardPrinter.scala 145:{32,32}]
  wire [7:0] _GEN_74 = 5'h2 == textAddress[4:0] ? 8'hf : _GEN_73; // @[src/main/scala/RaceScoreboardPrinter.scala 145:{32,32}]
  wire [7:0] _GEN_75 = 5'h3 == textAddress[4:0] ? 8'h24 : _GEN_74; // @[src/main/scala/RaceScoreboardPrinter.scala 145:{32,32}]
  wire [7:0] _GEN_76 = 5'h4 == textAddress[4:0] ? 8'h1b : _GEN_75; // @[src/main/scala/RaceScoreboardPrinter.scala 145:{32,32}]
  wire [7:0] _GEN_77 = 5'h5 == textAddress[4:0] ? 8'h24 : _GEN_76; // @[src/main/scala/RaceScoreboardPrinter.scala 145:{32,32}]
  wire [7:0] _GEN_78 = 5'h6 == textAddress[4:0] ? 8'h24 : _GEN_77; // @[src/main/scala/RaceScoreboardPrinter.scala 145:{32,32}]
  wire [7:0] _GEN_79 = 5'h7 == textAddress[4:0] ? 8'h24 : _GEN_78; // @[src/main/scala/RaceScoreboardPrinter.scala 145:{32,32}]
  wire [7:0] _GEN_80 = 5'h8 == textAddress[4:0] ? 8'h24 : _GEN_79; // @[src/main/scala/RaceScoreboardPrinter.scala 145:{32,32}]
  wire [7:0] _GEN_81 = 5'h9 == textAddress[4:0] ? 8'h13 : _GEN_80; // @[src/main/scala/RaceScoreboardPrinter.scala 145:{32,32}]
  wire [7:0] _GEN_82 = 5'ha == textAddress[4:0] ? 8'h8 : _GEN_81; // @[src/main/scala/RaceScoreboardPrinter.scala 145:{32,32}]
  wire [7:0] _GEN_83 = 5'hb == textAddress[4:0] ? 8'hc : _GEN_82; // @[src/main/scala/RaceScoreboardPrinter.scala 145:{32,32}]
  wire [7:0] _GEN_84 = 5'hc == textAddress[4:0] ? 8'h4 : _GEN_83; // @[src/main/scala/RaceScoreboardPrinter.scala 145:{32,32}]
  wire [7:0] _GEN_85 = 5'hd == textAddress[4:0] ? 8'h24 : _GEN_84; // @[src/main/scala/RaceScoreboardPrinter.scala 145:{32,32}]
  wire [7:0] _GEN_86 = 5'he == textAddress[4:0] ? raceText_14 : _GEN_85; // @[src/main/scala/RaceScoreboardPrinter.scala 145:{32,32}]
  wire [7:0] _GEN_87 = 5'hf == textAddress[4:0] ? raceText_15 : _GEN_86; // @[src/main/scala/RaceScoreboardPrinter.scala 145:{32,32}]
  wire [7:0] _GEN_88 = 5'h10 == textAddress[4:0] ? raceText_16 : _GEN_87; // @[src/main/scala/RaceScoreboardPrinter.scala 145:{32,32}]
  wire [7:0] _GEN_89 = 5'h11 == textAddress[4:0] ? raceText_17 : _GEN_88; // @[src/main/scala/RaceScoreboardPrinter.scala 145:{32,32}]
  wire [7:0] _GEN_90 = io_screen == 4'h3 ? _GEN_71 : _GEN_89; // @[src/main/scala/RaceScoreboardPrinter.scala 142:35 143:32 145:32]
  wire [7:0] _GEN_91 = io_screen == 4'h2 ? _GEN_53 : _GEN_90; // @[src/main/scala/RaceScoreboardPrinter.scala 140:35 141:32]
  wire [7:0] _GEN_92 = io_screen == 4'h1 ? _GEN_35 : _GEN_91; // @[src/main/scala/RaceScoreboardPrinter.scala 138:35 139:32]
  wire [7:0] _GEN_93 = io_screen == 4'h0 ? _GEN_17 : _GEN_92; // @[src/main/scala/RaceScoreboardPrinter.scala 136:29 137:32]
  wire  _T_4 = ~running; // @[src/main/scala/RaceScoreboardPrinter.scala 151:21]
  wire  _GEN_94 = io_load & ~running | running; // @[src/main/scala/RaceScoreboardPrinter.scala 151:31 152:17 132:26]
  wire [5:0] _GEN_95 = io_load & ~running ? 6'hf : xIdx; // @[src/main/scala/RaceScoreboardPrinter.scala 151:31 153:14 127:23]
  wire [4:0] _GEN_96 = io_load & ~running ? 5'h1 : yIdx; // @[src/main/scala/RaceScoreboardPrinter.scala 151:31 154:14 128:23]
  wire  _GEN_97 = _T_4 ? 1'h0 : done; // @[src/main/scala/RaceScoreboardPrinter.scala 157:20 158:14 133:23]
  wire [5:0] _xIdx_T_1 = xIdx + 6'h1; // @[src/main/scala/RaceScoreboardPrinter.scala 166:26]
  wire [4:0] _yIdx_T_1 = yIdx + 5'h1; // @[src/main/scala/RaceScoreboardPrinter.scala 169:30]
  wire  _GEN_103 = xIdx == 6'h17 & yIdx == 5'h2 | _GEN_97; // @[src/main/scala/RaceScoreboardPrinter.scala 174:56 176:18]
  assign io_done = done; // @[src/main/scala/RaceScoreboardPrinter.scala 134:13]
  assign io_backBufferWriteData = _GEN_93[5:0];
  assign io_backBufferWriteAddress = _backBufferAddress_T[10:0] + _backBufferAddress_T_2; // @[src/main/scala/RaceScoreboardPrinter.scala 129:46]
  assign io_backBufferWriteEnable = running; // @[src/main/scala/RaceScoreboardPrinter.scala 161:19 149:30 162:34]
  always @(posedge clock) begin
    if (reset) begin // @[src/main/scala/RaceScoreboardPrinter.scala 127:23]
      xIdx <= 6'hf; // @[src/main/scala/RaceScoreboardPrinter.scala 127:23]
    end else if (running) begin // @[src/main/scala/RaceScoreboardPrinter.scala 161:19]
      if (xIdx < 6'h17) begin // @[src/main/scala/RaceScoreboardPrinter.scala 165:32]
        xIdx <= _xIdx_T_1; // @[src/main/scala/RaceScoreboardPrinter.scala 166:18]
      end else if (yIdx < 5'h2) begin // @[src/main/scala/RaceScoreboardPrinter.scala 168:36]
        xIdx <= 6'hf; // @[src/main/scala/RaceScoreboardPrinter.scala 170:22]
      end else begin
        xIdx <= _GEN_95;
      end
    end else begin
    ...
    if (reset) begin // @[src/main/scala/RaceScoreboardPrinter.scala 128:23]
      yIdx <= 5'h1; // @[src/main/scala/RaceScoreboardPrinter.scala 128:23]
    end else if (running) begin // @[src/main/scala/RaceScoreboardPrinter.scala 161:19]
      if (xIdx < 6'h17) begin // @[src/main/scala/RaceScoreboardPrinter.scala 165:32]
        yIdx <= _GEN_96;
      end else if (yIdx < 5'h2) begin // @[src/main/scala/RaceScoreboardPrinter.scala 168:36]
        yIdx <= _yIdx_T_1; // @[src/main/scala/RaceScoreboardPrinter.scala 169:22]
      end else begin
        yIdx <= _GEN_96;
      end
    end else begin
    ...
    if (reset) begin // @[src/main/scala/RaceScoreboardPrinter.scala 132:26]
      running <= 1'h0; // @[src/main/scala/RaceScoreboardPrinter.scala 132:26]
    end else if (running) begin // @[src/main/scala/RaceScoreboardPrinter.scala 161:19]
      if (xIdx == 6'h17 & yIdx == 5'h2) begin // @[src/main/scala/RaceScoreboardPrinter.scala 174:56]
        running <= 1'h0; // @[src/main/scala/RaceScoreboardPrinter.scala 175:21]
      end else begin
        running <= _GEN_94;
      end
    end else begin
    ...
    if (reset) begin // @[src/main/scala/RaceScoreboardPrinter.scala 133:23]
      done <= 1'h0; // @[src/main/scala/RaceScoreboardPrinter.scala 133:23]
    end else if (running) begin // @[src/main/scala/RaceScoreboardPrinter.scala 161:19]
      done <= _GEN_103;
    end else if (_T_4) begin // @[src/main/scala/RaceScoreboardPrinter.scala 157:20]
      done <= 1'h0; // @[src/main/scala/RaceScoreboardPrinter.scala 158:14]
    end
  end
// Register and memory initialization
`ifdef RANDOMIZE_GARBAGE_ASSIGN
...
`ifdef RANDOMIZE_REG_INIT
  ...
  reg [31:0] _RAND_10;
`endif // RANDOMIZE_REG_INIT
  wire  playerController_clock; // @[src/main/scala/RaceManager.scala 80:32]
  wire  playerController_reset; // @[src/main/scala/RaceManager.scala 80:32]
  wire [10:0] playerController_io_tilemapRomTileAddress; // @[src/main/scala/RaceManager.scala 80:32]
  wire  playerController_io_tilemapRomCollisionData; // @[src/main/scala/RaceManager.scala 80:32]
  wire  playerController_io_btnU; // @[src/main/scala/RaceManager.scala 80:32]
  wire  playerController_io_btnL; // @[src/main/scala/RaceManager.scala 80:32]
  wire  playerController_io_btnR; // @[src/main/scala/RaceManager.scala 80:32]
  wire  playerController_io_btnD; // @[src/main/scala/RaceManager.scala 80:32]
  wire [10:0] playerController_io_playerXPosition; // @[src/main/scala/RaceManager.scala 80:32]
  wire [9:0] playerController_io_playerYPosition; // @[src/main/scala/RaceManager.scala 80:32]
  wire  playerController_io_spriteVisible_0; // @[src/main/scala/RaceManager.scala 80:32]
  wire  playerController_io_spriteVisible_1; // @[src/main/scala/RaceManager.scala 80:32]
  wire  playerController_io_spriteVisible_2; // @[src/main/scala/RaceManager.scala 80:32]
  wire  playerController_io_spriteFlipHorizontal_0; // @[src/main/scala/RaceManager.scala 80:32]
  wire  playerController_io_spriteFlipHorizontal_1; // @[src/main/scala/RaceManager.scala 80:32]
  wire  playerController_io_spriteFlipVertical_1; // @[src/main/scala/RaceManager.scala 80:32]
  wire  playerController_io_spriteFlipVertical_2; // @[src/main/scala/RaceManager.scala 80:32]
  wire  playerController_io_newFrame; // @[src/main/scala/RaceManager.scala 80:32]
  wire  playerController_io_enable; // @[src/main/scala/RaceManager.scala 80:32]
  wire  frameCounter_clock; // @[src/main/scala/RaceManager.scala 106:28]
  wire  frameCounter_reset; // @[src/main/scala/RaceManager.scala 106:28]
  wire  frameCounter_io_inc; // @[src/main/scala/RaceManager.scala 106:28]
  wire [7:0] frameCounter_io_data_0; // @[src/main/scala/RaceManager.scala 106:28]
  wire [7:0] frameCounter_io_data_1; // @[src/main/scala/RaceManager.scala 106:28]
  wire [7:0] frameCounter_io_data_2; // @[src/main/scala/RaceManager.scala 106:28]
  wire [7:0] frameCounter_io_data_3; // @[src/main/scala/RaceManager.scala 106:28]
  wire  raceScoreboardPrinter_clock; // @[src/main/scala/RaceManager.scala 110:37]
  wire  raceScoreboardPrinter_reset; // @[src/main/scala/RaceManager.scala 110:37]
  wire  raceScoreboardPrinter_io_load; // @[src/main/scala/RaceManager.scala 110:37]
  wire  raceScoreboardPrinter_io_done; // @[src/main/scala/RaceManager.scala 110:37]
  wire [7:0] raceScoreboardPrinter_io_time_0; // @[src/main/scala/RaceManager.scala 110:37]
  wire [7:0] raceScoreboardPrinter_io_time_1; // @[src/main/scala/RaceManager.scala 110:37]
  wire [7:0] raceScoreboardPrinter_io_time_2; // @[src/main/scala/RaceManager.scala 110:37]
  wire [7:0] raceScoreboardPrinter_io_time_3; // @[src/main/scala/RaceManager.scala 110:37]
  wire [3:0] raceScoreboardPrinter_io_screen; // @[src/main/scala/RaceManager.scala 110:37]
  wire [5:0] raceScoreboardPrinter_io_backBufferWriteData; // @[src/main/scala/RaceManager.scala 110:37]
  wire [10:0] raceScoreboardPrinter_io_backBufferWriteAddress; // @[src/main/scala/RaceManager.scala 110:37]
  wire  raceScoreboardPrinter_io_backBufferWriteEnable; // @[src/main/scala/RaceManager.scala 110:37]
  reg [9:0] viewBoxXReg; // @[src/main/scala/RaceManager.scala 60:28]
  reg [8:0] viewBoxYReg; // @[src/main/scala/RaceManager.scala 61:28]
  reg [5:0] backBufferWriteDataReg; // @[src/main/scala/RaceManager.scala 66:39]
  reg [10:0] backBufferWriteAddressReg; // @[src/main/scala/RaceManager.scala 67:42]
  reg  backBufferWriteEnableReg; // @[src/main/scala/RaceManager.scala 68:41]
  reg  raceStarted; // @[src/main/scala/RaceManager.scala 77:28]
  reg [10:0] playerScreenXPosition; // @[src/main/scala/RaceManager.scala 92:34]
  reg [9:0] playerScreenYPosition; // @[src/main/scala/RaceManager.scala 93:34]
  wire [10:0] _GEN_16 = {{1'd0}, viewBoxXReg}; // @[src/main/scala/RaceManager.scala 94:65]
  wire [9:0] _GEN_25 = {{1'd0}, viewBoxYReg}; // @[src/main/scala/RaceManager.scala 95:65]
  reg [15:0] screenAnimationCounter; // @[src/main/scala/RaceManager.scala 107:39]
  reg [2:0] scoreboardScreen; // @[src/main/scala/RaceManager.scala 108:33]
  reg [1:0] raceManagerStateReg; // @[src/main/scala/RaceManager.scala 116:36]
  wire [10:0] tempViewBoxX = playerController_io_playerXPosition + 11'h10; // @[src/main/scala/RaceManager.scala 131:63]
  wire [9:0] tempViewBoxY = playerController_io_playerYPosition + 10'h10; // @[src/main/scala/RaceManager.scala 132:63]
  wire [10:0] _viewBoxXReg_T_1 = tempViewBoxX - 11'h140; // @[src/main/scala/RaceManager.scala 134:35]
  wire [9:0] _viewBoxYReg_T_1 = tempViewBoxY - 10'hf0; // @[src/main/scala/RaceManager.scala 135:35]
  wire [10:0] _GEN_2 = tempViewBoxX < 11'h140 ? 11'h0 : _viewBoxXReg_T_1; // @[src/main/scala/RaceManager.scala 134:19 137:34 138:21]
  wire [9:0] _GEN_3 = tempViewBoxY < 10'hf0 ? 10'h0 : _viewBoxYReg_T_1; // @[src/main/scala/RaceManager.scala 135:19 141:34 142:21]
  wire [10:0] _GEN_4 = tempViewBoxX > 11'h3c0 ? 11'h280 : _GEN_2; // @[src/main/scala/RaceManager.scala 145:42 146:21]
  wire [9:0] _GEN_5 = tempViewBoxY > 10'h2d0 ? 10'h1e0 : _GEN_3; // @[src/main/scala/RaceManager.scala 149:42 150:21]
  wire  _T_6 = screenAnimationCounter < 16'h190; // @[src/main/scala/RaceManager.scala 153:35]
  wire [15:0] _screenAnimationCounter_T_1 = screenAnimationCounter + 16'h1; // @[src/main/scala/RaceManager.scala 154:58]
  wire [2:0] _GEN_7 = _T_6 ? 3'h3 : 3'h4; // @[src/main/scala/RaceManager.scala 167:50 168:26 170:26]
  wire  _GEN_8 = _T_6 ? raceStarted : 1'h1; // @[src/main/scala/RaceManager.scala 167:50 171:21 77:28]
  wire [2:0] _GEN_9 = screenAnimationCounter < 16'h12c ? 3'h2 : _GEN_7; // @[src/main/scala/RaceManager.scala 165:50 166:26]
  wire  _GEN_10 = screenAnimationCounter < 16'h12c ? raceStarted : _GEN_8; // @[src/main/scala/RaceManager.scala 165:50 77:28]
  wire [2:0] _GEN_11 = screenAnimationCounter < 16'hc8 ? 3'h1 : _GEN_9; // @[src/main/scala/RaceManager.scala 163:50 164:26]
  wire  _GEN_12 = screenAnimationCounter < 16'hc8 ? raceStarted : _GEN_10; // @[src/main/scala/RaceManager.scala 163:50 77:28]
  wire [2:0] _GEN_13 = screenAnimationCounter < 16'h64 ? 3'h0 : _GEN_11; // @[src/main/scala/RaceManager.scala 161:44 162:26]
  ...
  wire [10:0] _GEN_40 = 2'h0 == raceManagerStateReg ? {{1'd0}, viewBoxXReg} : _GEN_27; // @[src/main/scala/RaceManager.scala 119:31 60:28]
  wire [9:0] _GEN_41 = 2'h0 == raceManagerStateReg ? {{1'd0}, viewBoxYReg} : _GEN_28; // @[src/main/scala/RaceManager.scala 119:31 61:28]
  wire [10:0] _GEN_37 = reset ? 11'h0 : _GEN_40; // @[src/main/scala/RaceManager.scala 60:{28,28}]
  wire [9:0] _GEN_49 = reset ? 10'h0 : _GEN_41; // @[src/main/scala/RaceManager.scala 61:{28,28}]
  PlayerController playerController ( // @[src/main/scala/RaceManager.scala 80:32]
  ...
  BCDCounter frameCounter ( // @[src/main/scala/RaceManager.scala 106:28]
  ...
  RaceScoreboardPrinter raceScoreboardPrinter ( // @[src/main/scala/RaceManager.scala 110:37]
  ...
  assign io_spriteXPosition_0 = playerScreenXPosition; // @[src/main/scala/RaceManager.scala 99:32]
  assign io_spriteXPosition_1 = playerScreenXPosition; // @[src/main/scala/RaceManager.scala 99:32]
  assign io_spriteXPosition_2 = playerScreenXPosition; // @[src/main/scala/RaceManager.scala 99:32]
  assign io_spriteYPosition_0 = playerScreenYPosition; // @[src/main/scala/RaceManager.scala 100:32]
  assign io_spriteYPosition_1 = playerScreenYPosition; // @[src/main/scala/RaceManager.scala 100:32]
  assign io_spriteYPosition_2 = playerScreenYPosition; // @[src/main/scala/RaceManager.scala 100:32]
  assign io_spriteVisible_0 = playerController_io_spriteVisible_0; // @[src/main/scala/RaceManager.scala 98:32]
  assign io_spriteVisible_1 = playerController_io_spriteVisible_1; // @[src/main/scala/RaceManager.scala 98:32]
  assign io_spriteVisible_2 = playerController_io_spriteVisible_2; // @[src/main/scala/RaceManager.scala 98:32]
  assign io_spriteFlipHorizontal_0 = playerController_io_spriteFlipHorizontal_0; // @[src/main/scala/RaceManager.scala 101:32]
  assign io_spriteFlipHorizontal_1 = playerController_io_spriteFlipHorizontal_1; // @[src/main/scala/RaceManager.scala 101:32]
  assign io_spriteFlipVertical_1 = playerController_io_spriteFlipVertical_1; // @[src/main/scala/RaceManager.scala 102:32]
  assign io_spriteFlipVertical_2 = playerController_io_spriteFlipVertical_2; // @[src/main/scala/RaceManager.scala 102:32]
  assign io_viewBoxX = viewBoxXReg; // @[src/main/scala/RaceManager.scala 62:15]
  assign io_viewBoxY = viewBoxYReg; // @[src/main/scala/RaceManager.scala 63:15]
  assign io_backBufferWriteData = backBufferWriteDataReg; // @[src/main/scala/RaceManager.scala 69:26]
  assign io_backBufferWriteAddress = backBufferWriteAddressReg; // @[src/main/scala/RaceManager.scala 70:29]
  assign io_backBufferWriteEnable = backBufferWriteEnableReg; // @[src/main/scala/RaceManager.scala 71:28]
  assign io_tilemapRomTileAddress = playerController_io_tilemapRomTileAddress; // @[src/main/scala/RaceManager.scala 81:28]
  assign playerController_clock = clock;
  assign playerController_reset = reset;
  assign playerController_io_tilemapRomCollisionData = io_tilemapRomCollisionData; // @[src/main/scala/RaceManager.scala 83:47]
  assign playerController_io_btnU = io_btnU; // @[src/main/scala/RaceManager.scala 84:28]
  assign playerController_io_btnL = io_btnL; // @[src/main/scala/RaceManager.scala 85:28]
  assign playerController_io_btnR = io_btnR; // @[src/main/scala/RaceManager.scala 88:28]
  assign playerController_io_btnD = io_btnD; // @[src/main/scala/RaceManager.scala 86:28]
  assign playerController_io_newFrame = io_newFrame; // @[src/main/scala/RaceManager.scala 89:32]
  ...
  assign raceScoreboardPrinter_io_time_0 = frameCounter_io_data_0; // @[src/main/scala/RaceManager.scala 112:33]
  assign raceScoreboardPrinter_io_time_1 = frameCounter_io_data_1; // @[src/main/scala/RaceManager.scala 112:33]
  assign raceScoreboardPrinter_io_time_2 = frameCounter_io_data_2; // @[src/main/scala/RaceManager.scala 112:33]
  assign raceScoreboardPrinter_io_time_3 = frameCounter_io_data_3; // @[src/main/scala/RaceManager.scala 112:33]
  assign raceScoreboardPrinter_io_screen = {{1'd0}, scoreboardScreen}; // @[src/main/scala/RaceManager.scala 113:35]
  always @(posedge clock) begin
    viewBoxXReg <= _GEN_37[9:0]; // @[src/main/scala/RaceManager.scala 60:{28,28}]
    viewBoxYReg <= _GEN_49[8:0]; // @[src/main/scala/RaceManager.scala 61:{28,28}]
    if (reset) begin // @[src/main/scala/RaceManager.scala 66:39]
      backBufferWriteDataReg <= 6'h0; // @[src/main/scala/RaceManager.scala 66:39]
    end else if (!(2'h0 == raceManagerStateReg)) begin // @[src/main/scala/RaceManager.scala 119:31]
      if (!(2'h1 == raceManagerStateReg)) begin // @[src/main/scala/RaceManager.scala 119:31]
        if (2'h2 == raceManagerStateReg) begin // @[src/main/scala/RaceManager.scala 119:31]
          backBufferWriteDataReg <= raceScoreboardPrinter_io_backBufferWriteData; // @[src/main/scala/RaceManager.scala 175:30]
        end
      end
    end
    if (reset) begin // @[src/main/scala/RaceManager.scala 67:42]
      backBufferWriteAddressReg <= 11'h0; // @[src/main/scala/RaceManager.scala 67:42]
    end else if (!(2'h0 == raceManagerStateReg)) begin // @[src/main/scala/RaceManager.scala 119:31]
      if (!(2'h1 == raceManagerStateReg)) begin // @[src/main/scala/RaceManager.scala 119:31]
        if (2'h2 == raceManagerStateReg) begin // @[src/main/scala/RaceManager.scala 119:31]
          backBufferWriteAddressReg <= raceScoreboardPrinter_io_backBufferWriteAddress; // @[src/main/scala/RaceManager.scala 176:33]
        end
      end
    end
    if (reset) begin // @[src/main/scala/RaceManager.scala 68:41]
      backBufferWriteEnableReg <= 1'h0; // @[src/main/scala/RaceManager.scala 68:41]
    end else if (!(2'h0 == raceManagerStateReg)) begin // @[src/main/scala/RaceManager.scala 119:31]
      if (!(2'h1 == raceManagerStateReg)) begin // @[src/main/scala/RaceManager.scala 119:31]
        if (2'h2 == raceManagerStateReg) begin // @[src/main/scala/RaceManager.scala 119:31]
          backBufferWriteEnableReg <= raceScoreboardPrinter_io_backBufferWriteEnable; // @[src/main/scala/RaceManager.scala 177:32]
        end
      end
    end
    if (reset) begin // @[src/main/scala/RaceManager.scala 77:28]
      raceStarted <= 1'h0; // @[src/main/scala/RaceManager.scala 77:28]
    end else if (!(2'h0 == raceManagerStateReg)) begin // @[src/main/scala/RaceManager.scala 119:31]
      if (!(2'h1 == raceManagerStateReg)) begin // @[src/main/scala/RaceManager.scala 119:31]
        if (2'h2 == raceManagerStateReg) begin // @[src/main/scala/RaceManager.scala 119:31]
          raceStarted <= _GEN_14;
    ...
    playerScreenXPosition <= playerController_io_playerXPosition - _GEN_16; // @[src/main/scala/RaceManager.scala 94:80]
    playerScreenYPosition <= playerController_io_playerYPosition - _GEN_25; // @[src/main/scala/RaceManager.scala 95:80]
    if (reset) begin // @[src/main/scala/RaceManager.scala 107:39]
      screenAnimationCounter <= 16'h0; // @[src/main/scala/RaceManager.scala 107:39]
    end else if (!(2'h0 == raceManagerStateReg)) begin // @[src/main/scala/RaceManager.scala 119:31]
      if (2'h1 == raceManagerStateReg) begin // @[src/main/scala/RaceManager.scala 119:31]
        if (screenAnimationCounter < 16'h190) begin // @[src/main/scala/RaceManager.scala 153:44]
          screenAnimationCounter <= _screenAnimationCounter_T_1; // @[src/main/scala/RaceManager.scala 154:32]
        end
      end
    end
    if (reset) begin // @[src/main/scala/RaceManager.scala 108:33]
      scoreboardScreen <= 3'h0; // @[src/main/scala/RaceManager.scala 108:33]
    end else if (!(2'h0 == raceManagerStateReg)) begin // @[src/main/scala/RaceManager.scala 119:31]
      if (!(2'h1 == raceManagerStateReg)) begin // @[src/main/scala/RaceManager.scala 119:31]
        if (2'h2 == raceManagerStateReg) begin // @[src/main/scala/RaceManager.scala 119:31]
          scoreboardScreen <= _GEN_13;
        end
      end
    end
    if (reset) begin // @[src/main/scala/RaceManager.scala 116:36]
      raceManagerStateReg <= 2'h0; // @[src/main/scala/RaceManager.scala 116:36]
    end else if (2'h0 == raceManagerStateReg) begin // @[src/main/scala/RaceManager.scala 119:31]
      if (io_enable) begin // @[src/main/scala/RaceManager.scala 121:24]
        if (io_newFrame) begin // @[src/main/scala/RaceManager.scala 122:31]
          raceManagerStateReg <= 2'h1; // @[src/main/scala/RaceManager.scala 123:37]
        end
      end
    end else if (2'h1 == raceManagerStateReg) begin // @[src/main/scala/RaceManager.scala 119:31]
      raceManagerStateReg <= 2'h2; // @[src/main/scala/RaceManager.scala 157:27]
    end else if (2'h2 == raceManagerStateReg) begin // @[src/main/scala/RaceManager.scala 119:31]
      raceManagerStateReg <= _GEN_15;
    end else begin
...
`ifdef RANDOMIZE_REG_INIT
  ...
  _RAND_6 = {1{`RANDOM}};
  playerScreenXPosition = _RAND_6[10:0];
  _RAND_7 = {1{`RANDOM}};
  playerScreenYPosition = _RAND_7[9:0];
  _RAND_8 = {1{`RANDOM}};
  screenAnimationCounter = _RAND_8[15:0];
  _RAND_9 = {1{`RANDOM}};
  scoreboardScreen = _RAND_9[2:0];
  _RAND_10 = {1{`RANDOM}};
  raceManagerStateReg = _RAND_10[1:0];
`endif // RANDOMIZE_REG_INIT
  `endif // RANDOMIZE
end // initial
`ifdef FIRRTL_AFTER_INITIAL
...
`endif // RANDOMIZE_REG_INIT
  ...
  wire [2:0] tilemapRom_io_tilemapIdx; // @[src/main/scala/ScreenManager.scala 107:26]
  ...
  wire  raceManager_clock; // @[src/main/scala/ScreenManager.scala 116:27]
  wire  raceManager_reset; // @[src/main/scala/ScreenManager.scala 116:27]
  wire  raceManager_io_btnU; // @[src/main/scala/ScreenManager.scala 116:27]
  wire  raceManager_io_btnL; // @[src/main/scala/ScreenManager.scala 116:27]
  wire  raceManager_io_btnR; // @[src/main/scala/ScreenManager.scala 116:27]
  wire  raceManager_io_btnD; // @[src/main/scala/ScreenManager.scala 116:27]
  wire [10:0] raceManager_io_spriteXPosition_0; // @[src/main/scala/ScreenManager.scala 116:27]
  wire [10:0] raceManager_io_spriteXPosition_1; // @[src/main/scala/ScreenManager.scala 116:27]
  wire [10:0] raceManager_io_spriteXPosition_2; // @[src/main/scala/ScreenManager.scala 116:27]
  wire [9:0] raceManager_io_spriteYPosition_0; // @[src/main/scala/ScreenManager.scala 116:27]
  wire [9:0] raceManager_io_spriteYPosition_1; // @[src/main/scala/ScreenManager.scala 116:27]
  wire [9:0] raceManager_io_spriteYPosition_2; // @[src/main/scala/ScreenManager.scala 116:27]
  wire  raceManager_io_spriteVisible_0; // @[src/main/scala/ScreenManager.scala 116:27]
  wire  raceManager_io_spriteVisible_1; // @[src/main/scala/ScreenManager.scala 116:27]
  wire  raceManager_io_spriteVisible_2; // @[src/main/scala/ScreenManager.scala 116:27]
  wire  raceManager_io_spriteFlipHorizontal_0; // @[src/main/scala/ScreenManager.scala 116:27]
  wire  raceManager_io_spriteFlipHorizontal_1; // @[src/main/scala/ScreenManager.scala 116:27]
  wire  raceManager_io_spriteFlipVertical_1; // @[src/main/scala/ScreenManager.scala 116:27]
  wire  raceManager_io_spriteFlipVertical_2; // @[src/main/scala/ScreenManager.scala 116:27]
  wire [9:0] raceManager_io_viewBoxX; // @[src/main/scala/ScreenManager.scala 116:27]
  wire [8:0] raceManager_io_viewBoxY; // @[src/main/scala/ScreenManager.scala 116:27]
  wire [5:0] raceManager_io_backBufferWriteData; // @[src/main/scala/ScreenManager.scala 116:27]
  wire [10:0] raceManager_io_backBufferWriteAddress; // @[src/main/scala/ScreenManager.scala 116:27]
  wire  raceManager_io_backBufferWriteEnable; // @[src/main/scala/ScreenManager.scala 116:27]
  wire  raceManager_io_newFrame; // @[src/main/scala/ScreenManager.scala 116:27]
  wire  raceManager_io_enable; // @[src/main/scala/ScreenManager.scala 116:27]
  wire [10:0] raceManager_io_tilemapRomTileAddress; // @[src/main/scala/ScreenManager.scala 116:27]
  wire  raceManager_io_tilemapRomCollisionData; // @[src/main/scala/ScreenManager.scala 116:27]
  wire  menuPrinter_clock; // @[src/main/scala/ScreenManager.scala 136:27]
  wire  menuPrinter_reset; // @[src/main/scala/ScreenManager.scala 136:27]
  wire  menuPrinter_io_load; // @[src/main/scala/ScreenManager.scala 136:27]
  wire  menuPrinter_io_done; // @[src/main/scala/ScreenManager.scala 136:27]
  wire [3:0] menuPrinter_io_track; // @[src/main/scala/ScreenManager.scala 136:27]
  wire [5:0] menuPrinter_io_backBufferWriteData; // @[src/main/scala/ScreenManager.scala 136:27]
  wire [10:0] menuPrinter_io_backBufferWriteAddress; // @[src/main/scala/ScreenManager.scala 136:27]
  wire  menuPrinter_io_backBufferWriteEnable; // @[src/main/scala/ScreenManager.scala 136:27]
  reg [9:0] viewBoxXReg; // @[src/main/scala/ScreenManager.scala 97:28]
  reg [3:0] screenManagerStateReg; // @[src/main/scala/ScreenManager.scala 103:38]
  reg  currentScreenReg; // @[src/main/scala/ScreenManager.scala 104:33]
  reg [3:0] selectedTrackReg; // @[src/main/scala/ScreenManager.scala 135:33]
  reg  btnLPressed; // @[src/main/scala/ScreenManager.scala 140:28]
  reg  btnRPressed; // @[src/main/scala/ScreenManager.scala 141:28]
  wire [9:0] _viewBoxXReg_T_1 = viewBoxXReg + 10'h10; // @[src/main/scala/ScreenManager.scala 169:36]
  wire [9:0] _GEN_4 = io_newFrame ? _viewBoxXReg_T_1 : viewBoxXReg; // @[src/main/scala/ScreenManager.scala 168:25 169:21 97:28]
  wire [3:0] _GEN_5 = io_newFrame ? 4'h3 : screenManagerStateReg; // @[src/main/scala/ScreenManager.scala 168:25 170:31 103:38]
  wire [3:0] _GEN_6 = viewBoxXReg >= 10'h280 ? 4'h7 : 4'h2; // @[src/main/scala/ScreenManager.scala 177:34 178:31 181:31]
  wire  _GEN_7 = viewBoxXReg >= 10'h280 | currentScreenReg; // @[src/main/scala/ScreenManager.scala 177:34 179:26 104:33]
  wire [3:0] _GEN_8 = menuPrinter_io_done ? 4'h8 : screenManagerStateReg; // @[src/main/scala/ScreenManager.scala 191:33 192:31 103:38]
  wire [3:0] _GEN_9 = screenLoader_io_done ? 4'h6 : screenManagerStateReg; // @[src/main/scala/ScreenManager.scala 202:34 204:31 103:38]
  wire [3:0] _GEN_10 = ~currentScreenReg ? 4'h2 : 4'h8; // @[src/main/scala/ScreenManager.scala 237:31 240:50 241:35]
  wire [3:0] _GEN_11 = currentScreenReg ? 4'h5 : _GEN_10; // @[src/main/scala/ScreenManager.scala 243:56 244:35]
  wire [9:0] _GEN_12 = currentScreenReg ? 10'h0 : viewBoxXReg; // @[src/main/scala/ScreenManager.scala 243:56 245:25 97:28]
  wire [3:0] _GEN_14 = io_btnC ? _GEN_11 : 4'h8; // @[src/main/scala/ScreenManager.scala 239:23 237:31]
  wire [9:0] _GEN_15 = io_btnC ? _GEN_12 : viewBoxXReg; // @[src/main/scala/ScreenManager.scala 239:23 97:28]
  wire [3:0] _selectedTrackReg_T_1 = selectedTrackReg + 4'h1; // @[src/main/scala/ScreenManager.scala 253:50]
  wire [3:0] _GEN_17 = selectedTrackReg == 4'h7 ? 4'h1 : _selectedTrackReg_T_1; // @[src/main/scala/ScreenManager.scala 253:30 254:62 255:32]
  wire [3:0] _GEN_18 = currentScreenReg ? _GEN_17 : selectedTrackReg; // @[src/main/scala/ScreenManager.scala 135:33 252:56]
  wire [3:0] _GEN_19 = currentScreenReg ? 4'h4 : _GEN_14; // @[src/main/scala/ScreenManager.scala 252:56 257:35]
  wire  _GEN_20 = io_btnR & ~btnRPressed | btnRPressed; // @[src/main/scala/ScreenManager.scala 250:50 251:23 141:28]
  wire [3:0] _GEN_21 = io_btnR & ~btnRPressed ? _GEN_18 : selectedTrackReg; // @[src/main/scala/ScreenManager.scala 135:33 250:50]
  wire [3:0] _GEN_22 = io_btnR & ~btnRPressed ? _GEN_19 : _GEN_14; // @[src/main/scala/ScreenManager.scala 250:50]
  wire [3:0] _selectedTrackReg_T_3 = selectedTrackReg - 4'h1; // @[src/main/scala/ScreenManager.scala 264:50]
  wire [3:0] _GEN_23 = selectedTrackReg == 4'h1 ? 4'h7 : _selectedTrackReg_T_3; // @[src/main/scala/ScreenManager.scala 264:30 265:44 266:32]
  wire [3:0] _GEN_24 = currentScreenReg ? _GEN_23 : _GEN_21; // @[src/main/scala/ScreenManager.scala 263:56]
  wire [3:0] _GEN_25 = currentScreenReg ? 4'h4 : _GEN_22; // @[src/main/scala/ScreenManager.scala 263:56 268:35]
  wire  _GEN_26 = io_btnL & ~btnLPressed | btnLPressed; // @[src/main/scala/ScreenManager.scala 261:50 262:23 140:28]
  wire [3:0] _GEN_27 = io_btnL & ~btnLPressed ? _GEN_24 : _GEN_21; // @[src/main/scala/ScreenManager.scala 261:50]
  wire [3:0] _GEN_28 = io_btnL & ~btnLPressed ? _GEN_25 : _GEN_22; // @[src/main/scala/ScreenManager.scala 261:50]
  wire  _GEN_29 = ~io_btnR ? 1'h0 : _GEN_20; // @[src/main/scala/ScreenManager.scala 272:24 273:23]
  wire  _GEN_30 = ~io_btnL ? 1'h0 : _GEN_26; // @[src/main/scala/ScreenManager.scala 276:24 277:23]
  wire [3:0] _GEN_31 = io_newFrame ? _GEN_28 : screenManagerStateReg; // @[src/main/scala/ScreenManager.scala 236:25 103:38]
  wire [9:0] _GEN_32 = io_newFrame ? _GEN_15 : viewBoxXReg; // @[src/main/scala/ScreenManager.scala 236:25 97:28]
  wire  _GEN_34 = io_newFrame ? _GEN_29 : btnRPressed; // @[src/main/scala/ScreenManager.scala 236:25 141:28]
  wire [3:0] _GEN_35 = io_newFrame ? _GEN_27 : selectedTrackReg; // @[src/main/scala/ScreenManager.scala 236:25 135:33]
  wire  _GEN_36 = io_newFrame ? _GEN_30 : btnLPressed; // @[src/main/scala/ScreenManager.scala 236:25 140:28]
  wire [3:0] _GEN_38 = 4'h8 == screenManagerStateReg ? 4'h7 : screenManagerStateReg; // @[src/main/scala/ScreenManager.scala 145:33 285:29 103:38]
  wire [3:0] _GEN_39 = 4'h7 == screenManagerStateReg ? _GEN_31 : _GEN_38; // @[src/main/scala/ScreenManager.scala 145:33]
  wire [9:0] _GEN_40 = 4'h7 == screenManagerStateReg ? _GEN_32 : viewBoxXReg; // @[src/main/scala/ScreenManager.scala 145:33 97:28]
  wire  _GEN_42 = 4'h7 == screenManagerStateReg ? _GEN_34 : btnRPressed; // @[src/main/scala/ScreenManager.scala 141:28 145:33]
  wire [3:0] _GEN_43 = 4'h7 == screenManagerStateReg ? _GEN_35 : selectedTrackReg; // @[src/main/scala/ScreenManager.scala 135:33 145:33]
  wire  _GEN_44 = 4'h7 == screenManagerStateReg ? _GEN_36 : btnLPressed; // @[src/main/scala/ScreenManager.scala 140:28 145:33]
  wire [10:0] _GEN_54 = 4'h6 == screenManagerStateReg ? $signed(raceManager_io_spriteXPosition_0) : $signed(11'sh0); // @[src/main/scala/ScreenManager.scala 145:33 212:26 69:22]
  wire [10:0] _GEN_55 = 4'h6 == screenManagerStateReg ? $signed(raceManager_io_spriteXPosition_1) : $signed(11'sh0); // @[src/main/scala/ScreenManager.scala 145:33 212:26 69:22]
  wire [10:0] _GEN_56 = 4'h6 == screenManagerStateReg ? $signed(raceManager_io_spriteXPosition_2) : $signed(11'sh0); // @[src/main/scala/ScreenManager.scala 145:33 212:26 69:22]
  wire [9:0] _GEN_70 = 4'h6 == screenManagerStateReg ? $signed(raceManager_io_spriteYPosition_0) : $signed(10'sh0); // @[src/main/scala/ScreenManager.scala 145:33 213:26 70:22]
  wire [9:0] _GEN_71 = 4'h6 == screenManagerStateReg ? $signed(raceManager_io_spriteYPosition_1) : $signed(10'sh0); // @[src/main/scala/ScreenManager.scala 145:33 213:26 70:22]
  wire [9:0] _GEN_72 = 4'h6 == screenManagerStateReg ? $signed(raceManager_io_spriteYPosition_2) : $signed(10'sh0); // @[src/main/scala/ScreenManager.scala 145:33 213:26 70:22]
  wire  _GEN_86 = 4'h6 == screenManagerStateReg & raceManager_io_spriteVisible_0; // @[src/main/scala/ScreenManager.scala 145:33 214:24 71:20]
  wire  _GEN_87 = 4'h6 == screenManagerStateReg & raceManager_io_spriteVisible_1; // @[src/main/scala/ScreenManager.scala 145:33 214:24 71:20]
  wire  _GEN_88 = 4'h6 == screenManagerStateReg & raceManager_io_spriteVisible_2; // @[src/main/scala/ScreenManager.scala 145:33 214:24 71:20]
  wire  _GEN_102 = 4'h6 == screenManagerStateReg & raceManager_io_spriteFlipHorizontal_0; // @[src/main/scala/ScreenManager.scala 145:33 215:31 72:27]
  wire  _GEN_103 = 4'h6 == screenManagerStateReg & raceManager_io_spriteFlipHorizontal_1; // @[src/main/scala/ScreenManager.scala 145:33 215:31 72:27]
  wire  _GEN_119 = 4'h6 == screenManagerStateReg & raceManager_io_spriteFlipVertical_1; // @[src/main/scala/ScreenManager.scala 145:33 216:29 73:25]
  wire  _GEN_120 = 4'h6 == screenManagerStateReg & raceManager_io_spriteFlipVertical_2; // @[src/main/scala/ScreenManager.scala 145:33 216:29 73:25]
  wire [9:0] _GEN_134 = 4'h6 == screenManagerStateReg ? raceManager_io_viewBoxX : viewBoxXReg; // @[src/main/scala/ScreenManager.scala 145:33 217:19 99:15]
  wire [8:0] _GEN_135 = 4'h6 == screenManagerStateReg ? raceManager_io_viewBoxY : 9'h0; // @[src/main/scala/ScreenManager.scala 100:15 145:33 218:19]
  wire [5:0] _GEN_136 = 4'h6 == screenManagerStateReg ? raceManager_io_backBufferWriteData :
    screenLoader_io_backBufferWriteData; // @[src/main/scala/ScreenManager.scala 130:26 145:33 219:30]
  wire [10:0] _GEN_137 = 4'h6 == screenManagerStateReg ? raceManager_io_backBufferWriteAddress :
    screenLoader_io_backBufferWriteAddress; // @[src/main/scala/ScreenManager.scala 131:29 145:33 220:33]
  wire  _GEN_138 = 4'h6 == screenManagerStateReg ? raceManager_io_backBufferWriteEnable :
    screenLoader_io_backBufferWriteEnable; // @[src/main/scala/ScreenManager.scala 132:28 145:33 221:32]
  wire [3:0] _GEN_140 = 4'h6 == screenManagerStateReg ? selectedTrackReg : 4'h0; // @[src/main/scala/ScreenManager.scala 110:28 145:33 225:32]
  wire [10:0] _GEN_141 = 4'h6 == screenManagerStateReg ? raceManager_io_tilemapRomTileAddress :
    screenLoader_io_tileAddress; // @[src/main/scala/ScreenManager.scala 111:29 145:33 226:33]
  wire  _GEN_143 = 4'h6 == screenManagerStateReg & tilemapRom_io_collisionData; // @[src/main/scala/ScreenManager.scala 145:33 127:42 228:46]
  wire [3:0] _GEN_145 = 4'h6 == screenManagerStateReg ? screenManagerStateReg : _GEN_39; // @[src/main/scala/ScreenManager.scala 145:33 103:38]
  wire [9:0] _GEN_146 = 4'h6 == screenManagerStateReg ? viewBoxXReg : _GEN_40; // @[src/main/scala/ScreenManager.scala 145:33 97:28]
  wire  _GEN_148 = 4'h6 == screenManagerStateReg ? btnRPressed : _GEN_42; // @[src/main/scala/ScreenManager.scala 141:28 145:33]
  wire [3:0] _GEN_149 = 4'h6 == screenManagerStateReg ? selectedTrackReg : _GEN_43; // @[src/main/scala/ScreenManager.scala 135:33 145:33]
  wire  _GEN_150 = 4'h6 == screenManagerStateReg ? btnLPressed : _GEN_44; // @[src/main/scala/ScreenManager.scala 140:28 145:33]
  wire [3:0] _GEN_152 = 4'h5 == screenManagerStateReg ? selectedTrackReg : _GEN_140; // @[src/main/scala/ScreenManager.scala 145:33 199:32]
  wire [3:0] _GEN_154 = 4'h5 == screenManagerStateReg ? _GEN_9 : _GEN_145; // @[src/main/scala/ScreenManager.scala 145:33]
  wire [10:0] _GEN_163 = 4'h5 == screenManagerStateReg ? $signed(11'sh0) : $signed(_GEN_54); // @[src/main/scala/ScreenManager.scala 145:33 69:22]
  wire [10:0] _GEN_164 = 4'h5 == screenManagerStateReg ? $signed(11'sh0) : $signed(_GEN_55); // @[src/main/scala/ScreenManager.scala 145:33 69:22]
  wire [10:0] _GEN_165 = 4'h5 == screenManagerStateReg ? $signed(11'sh0) : $signed(_GEN_56); // @[src/main/scala/ScreenManager.scala 145:33 69:22]
  wire [9:0] _GEN_179 = 4'h5 == screenManagerStateReg ? $signed(10'sh0) : $signed(_GEN_70); // @[src/main/scala/ScreenManager.scala 145:33 70:22]
  wire [9:0] _GEN_180 = 4'h5 == screenManagerStateReg ? $signed(10'sh0) : $signed(_GEN_71); // @[src/main/scala/ScreenManager.scala 145:33 70:22]
  wire [9:0] _GEN_181 = 4'h5 == screenManagerStateReg ? $signed(10'sh0) : $signed(_GEN_72); // @[src/main/scala/ScreenManager.scala 145:33 70:22]
  wire  _GEN_195 = 4'h5 == screenManagerStateReg ? 1'h0 : _GEN_86; // @[src/main/scala/ScreenManager.scala 145:33 71:20]
  wire  _GEN_196 = 4'h5 == screenManagerStateReg ? 1'h0 : _GEN_87; // @[src/main/scala/ScreenManager.scala 145:33 71:20]
  wire  _GEN_197 = 4'h5 == screenManagerStateReg ? 1'h0 : _GEN_88; // @[src/main/scala/ScreenManager.scala 145:33 71:20]
  wire  _GEN_211 = 4'h5 == screenManagerStateReg ? 1'h0 : _GEN_102; // @[src/main/scala/ScreenManager.scala 145:33 72:27]
  wire  _GEN_212 = 4'h5 == screenManagerStateReg ? 1'h0 : _GEN_103; // @[src/main/scala/ScreenManager.scala 145:33 72:27]
  wire  _GEN_228 = 4'h5 == screenManagerStateReg ? 1'h0 : _GEN_119; // @[src/main/scala/ScreenManager.scala 145:33 73:25]
  wire  _GEN_229 = 4'h5 == screenManagerStateReg ? 1'h0 : _GEN_120; // @[src/main/scala/ScreenManager.scala 145:33 73:25]
  wire [9:0] _GEN_243 = 4'h5 == screenManagerStateReg ? viewBoxXReg : _GEN_134; // @[src/main/scala/ScreenManager.scala 145:33 99:15]
  wire [8:0] _GEN_244 = 4'h5 == screenManagerStateReg ? 9'h0 : _GEN_135; // @[src/main/scala/ScreenManager.scala 100:15 145:33]
  wire [5:0] _GEN_245 = 4'h5 == screenManagerStateReg ? screenLoader_io_backBufferWriteData : _GEN_136; // @[src/main/scala/ScreenManager.scala 130:26 145:33]
  wire [10:0] _GEN_246 = 4'h5 == screenManagerStateReg ? screenLoader_io_backBufferWriteAddress : _GEN_137; // @[src/main/scala/ScreenManager.scala 131:29 145:33]
  wire  _GEN_247 = 4'h5 == screenManagerStateReg ? screenLoader_io_backBufferWriteEnable : _GEN_138; // @[src/main/scala/ScreenManager.scala 132:28 145:33]
  wire [10:0] _GEN_248 = 4'h5 == screenManagerStateReg ? screenLoader_io_tileAddress : _GEN_141; // @[src/main/scala/ScreenManager.scala 111:29 145:33]
  wire  _GEN_250 = 4'h5 == screenManagerStateReg ? 1'h0 : _GEN_143; // @[src/main/scala/ScreenManager.scala 145:33 127:42]
  wire  _GEN_251 = 4'h5 == screenManagerStateReg ? 1'h0 : 4'h6 == screenManagerStateReg; // @[src/main/scala/ScreenManager.scala 118:25 145:33]
  wire [9:0] _GEN_252 = 4'h5 == screenManagerStateReg ? viewBoxXReg : _GEN_146; // @[src/main/scala/ScreenManager.scala 145:33 97:28]
  wire  _GEN_254 = 4'h5 == screenManagerStateReg ? btnRPressed : _GEN_148; // @[src/main/scala/ScreenManager.scala 141:28 145:33]
  wire [3:0] _GEN_255 = 4'h5 == screenManagerStateReg ? selectedTrackReg : _GEN_149; // @[src/main/scala/ScreenManager.scala 135:33 145:33]
  wire  _GEN_256 = 4'h5 == screenManagerStateReg ? btnLPressed : _GEN_150; // @[src/main/scala/ScreenManager.scala 140:28 145:33]
  wire [5:0] _GEN_258 = 4'h4 == screenManagerStateReg ? menuPrinter_io_backBufferWriteData : _GEN_245; // @[src/main/scala/ScreenManager.scala 145:33 187:30]
  wire [10:0] _GEN_259 = 4'h4 == screenManagerStateReg ? menuPrinter_io_backBufferWriteAddress : _GEN_246; // @[src/main/scala/ScreenManager.scala 145:33 188:33]
  wire  _GEN_260 = 4'h4 == screenManagerStateReg ? menuPrinter_io_backBufferWriteEnable : _GEN_247; // @[src/main/scala/ScreenManager.scala 145:33 189:32]
  wire [3:0] _GEN_261 = 4'h4 == screenManagerStateReg ? _GEN_8 : _GEN_154; // @[src/main/scala/ScreenManager.scala 145:33]
  wire  _GEN_262 = 4'h4 == screenManagerStateReg ? 1'h0 : 4'h5 == screenManagerStateReg; // @[src/main/scala/ScreenManager.scala 112:24 145:33]
  wire [3:0] _GEN_263 = 4'h4 == screenManagerStateReg ? 4'h0 : _GEN_152; // @[src/main/scala/ScreenManager.scala 110:28 145:33]
  wire [10:0] _GEN_273 = 4'h4 == screenManagerStateReg ? $signed(11'sh0) : $signed(_GEN_163); // @[src/main/scala/ScreenManager.scala 145:33 69:22]
  wire [10:0] _GEN_274 = 4'h4 == screenManagerStateReg ? $signed(11'sh0) : $signed(_GEN_164); // @[src/main/scala/ScreenManager.scala 145:33 69:22]
  wire [10:0] _GEN_275 = 4'h4 == screenManagerStateReg ? $signed(11'sh0) : $signed(_GEN_165); // @[src/main/scala/ScreenManager.scala 145:33 69:22]
  wire [9:0] _GEN_289 = 4'h4 == screenManagerStateReg ? $signed(10'sh0) : $signed(_GEN_179); // @[src/main/scala/ScreenManager.scala 145:33 70:22]
  wire [9:0] _GEN_290 = 4'h4 == screenManagerStateReg ? $signed(10'sh0) : $signed(_GEN_180); // @[src/main/scala/ScreenManager.scala 145:33 70:22]
  wire [9:0] _GEN_291 = 4'h4 == screenManagerStateReg ? $signed(10'sh0) : $signed(_GEN_181); // @[src/main/scala/ScreenManager.scala 145:33 70:22]
  wire  _GEN_305 = 4'h4 == screenManagerStateReg ? 1'h0 : _GEN_195; // @[src/main/scala/ScreenManager.scala 145:33 71:20]
  wire  _GEN_306 = 4'h4 == screenManagerStateReg ? 1'h0 : _GEN_196; // @[src/main/scala/ScreenManager.scala 145:33 71:20]
  wire  _GEN_307 = 4'h4 == screenManagerStateReg ? 1'h0 : _GEN_197; // @[src/main/scala/ScreenManager.scala 145:33 71:20]
  wire  _GEN_321 = 4'h4 == screenManagerStateReg ? 1'h0 : _GEN_211; // @[src/main/scala/ScreenManager.scala 145:33 72:27]
  wire  _GEN_322 = 4'h4 == screenManagerStateReg ? 1'h0 : _GEN_212; // @[src/main/scala/ScreenManager.scala 145:33 72:27]
  wire  _GEN_338 = 4'h4 == screenManagerStateReg ? 1'h0 : _GEN_228; // @[src/main/scala/ScreenManager.scala 145:33 73:25]
  wire  _GEN_339 = 4'h4 == screenManagerStateReg ? 1'h0 : _GEN_229; // @[src/main/scala/ScreenManager.scala 145:33 73:25]
  wire [9:0] _GEN_353 = 4'h4 == screenManagerStateReg ? viewBoxXReg : _GEN_243; // @[src/main/scala/ScreenManager.scala 145:33 99:15]
  wire [8:0] _GEN_354 = 4'h4 == screenManagerStateReg ? 9'h0 : _GEN_244; // @[src/main/scala/ScreenManager.scala 100:15 145:33]
  wire [10:0] _GEN_355 = 4'h4 == screenManagerStateReg ? screenLoader_io_tileAddress : _GEN_248; // @[src/main/scala/ScreenManager.scala 111:29 145:33]
  wire  _GEN_357 = 4'h4 == screenManagerStateReg ? 1'h0 : _GEN_250; // @[src/main/scala/ScreenManager.scala 145:33 127:42]
  wire  _GEN_358 = 4'h4 == screenManagerStateReg ? 1'h0 : _GEN_251; // @[src/main/scala/ScreenManager.scala 118:25 145:33]
  wire [9:0] _GEN_359 = 4'h4 == screenManagerStateReg ? viewBoxXReg : _GEN_252; // @[src/main/scala/ScreenManager.scala 145:33 97:28]
  wire  _GEN_361 = 4'h4 == screenManagerStateReg ? btnRPressed : _GEN_254; // @[src/main/scala/ScreenManager.scala 141:28 145:33]
  wire [3:0] _GEN_362 = 4'h4 == screenManagerStateReg ? selectedTrackReg : _GEN_255; // @[src/main/scala/ScreenManager.scala 135:33 145:33]
  wire  _GEN_363 = 4'h4 == screenManagerStateReg ? btnLPressed : _GEN_256; // @[src/main/scala/ScreenManager.scala 140:28 145:33]
  wire [3:0] _GEN_365 = 4'h3 == screenManagerStateReg ? _GEN_6 : _GEN_261; // @[src/main/scala/ScreenManager.scala 145:33]
  wire  _GEN_366 = 4'h3 == screenManagerStateReg ? _GEN_7 : currentScreenReg; // @[src/main/scala/ScreenManager.scala 104:33 145:33]
  wire  _GEN_367 = 4'h3 == screenManagerStateReg ? 1'h0 : 4'h4 == screenManagerStateReg; // @[src/main/scala/ScreenManager.scala 137:23 145:33]
  wire [5:0] _GEN_368 = 4'h3 == screenManagerStateReg ? screenLoader_io_backBufferWriteData : _GEN_258; // @[src/main/scala/ScreenManager.scala 130:26 145:33]
  wire [10:0] _GEN_369 = 4'h3 == screenManagerStateReg ? screenLoader_io_backBufferWriteAddress : _GEN_259; // @[src/main/scala/ScreenManager.scala 131:29 145:33]
  wire  _GEN_370 = 4'h3 == screenManagerStateReg ? screenLoader_io_backBufferWriteEnable : _GEN_260; // @[src/main/scala/ScreenManager.scala 132:28 145:33]
  wire  _GEN_371 = 4'h3 == screenManagerStateReg ? 1'h0 : _GEN_262; // @[src/main/scala/ScreenManager.scala 112:24 145:33]
  wire [3:0] _GEN_372 = 4'h3 == screenManagerStateReg ? 4'h0 : _GEN_263; // @[src/main/scala/ScreenManager.scala 110:28 145:33]
  wire [10:0] _GEN_381 = 4'h3 == screenManagerStateReg ? $signed(11'sh0) : $signed(_GEN_273); // @[src/main/scala/ScreenManager.scala 145:33 69:22]
  wire [10:0] _GEN_382 = 4'h3 == screenManagerStateReg ? $signed(11'sh0) : $signed(_GEN_274); // @[src/main/scala/ScreenManager.scala 145:33 69:22]
  wire [10:0] _GEN_383 = 4'h3 == screenManagerStateReg ? $signed(11'sh0) : $signed(_GEN_275); // @[src/main/scala/ScreenManager.scala 145:33 69:22]
  wire [9:0] _GEN_397 = 4'h3 == screenManagerStateReg ? $signed(10'sh0) : $signed(_GEN_289); // @[src/main/scala/ScreenManager.scala 145:33 70:22]
  wire [9:0] _GEN_398 = 4'h3 == screenManagerStateReg ? $signed(10'sh0) : $signed(_GEN_290); // @[src/main/scala/ScreenManager.scala 145:33 70:22]
  wire [9:0] _GEN_399 = 4'h3 == screenManagerStateReg ? $signed(10'sh0) : $signed(_GEN_291); // @[src/main/scala/ScreenManager.scala 145:33 70:22]
  wire  _GEN_413 = 4'h3 == screenManagerStateReg ? 1'h0 : _GEN_305; // @[src/main/scala/ScreenManager.scala 145:33 71:20]
  wire  _GEN_414 = 4'h3 == screenManagerStateReg ? 1'h0 : _GEN_306; // @[src/main/scala/ScreenManager.scala 145:33 71:20]
  wire  _GEN_415 = 4'h3 == screenManagerStateReg ? 1'h0 : _GEN_307; // @[src/main/scala/ScreenManager.scala 145:33 71:20]
  wire  _GEN_429 = 4'h3 == screenManagerStateReg ? 1'h0 : _GEN_321; // @[src/main/scala/ScreenManager.scala 145:33 72:27]
  wire  _GEN_430 = 4'h3 == screenManagerStateReg ? 1'h0 : _GEN_322; // @[src/main/scala/ScreenManager.scala 145:33 72:27]
  wire  _GEN_446 = 4'h3 == screenManagerStateReg ? 1'h0 : _GEN_338; // @[src/main/scala/ScreenManager.scala 145:33 73:25]
  wire  _GEN_447 = 4'h3 == screenManagerStateReg ? 1'h0 : _GEN_339; // @[src/main/scala/ScreenManager.scala 145:33 73:25]
  wire [9:0] _GEN_461 = 4'h3 == screenManagerStateReg ? viewBoxXReg : _GEN_353; // @[src/main/scala/ScreenManager.scala 145:33 99:15]
  wire [8:0] _GEN_462 = 4'h3 == screenManagerStateReg ? 9'h0 : _GEN_354; // @[src/main/scala/ScreenManager.scala 100:15 145:33]
  wire [10:0] _GEN_463 = 4'h3 == screenManagerStateReg ? screenLoader_io_tileAddress : _GEN_355; // @[src/main/scala/ScreenManager.scala 111:29 145:33]
  wire  _GEN_465 = 4'h3 == screenManagerStateReg ? 1'h0 : _GEN_357; // @[src/main/scala/ScreenManager.scala 145:33 127:42]
  wire  _GEN_466 = 4'h3 == screenManagerStateReg ? 1'h0 : _GEN_358; // @[src/main/scala/ScreenManager.scala 118:25 145:33]
  wire [9:0] _GEN_467 = 4'h3 == screenManagerStateReg ? viewBoxXReg : _GEN_359; // @[src/main/scala/ScreenManager.scala 145:33 97:28]
  wire  _GEN_469 = 4'h3 == screenManagerStateReg ? btnRPressed : _GEN_361; // @[src/main/scala/ScreenManager.scala 141:28 145:33]
  wire [3:0] _GEN_470 = 4'h3 == screenManagerStateReg ? selectedTrackReg : _GEN_362; // @[src/main/scala/ScreenManager.scala 135:33 145:33]
  wire  _GEN_471 = 4'h3 == screenManagerStateReg ? btnLPressed : _GEN_363; // @[src/main/scala/ScreenManager.scala 140:28 145:33]
  wire  _GEN_476 = 4'h2 == screenManagerStateReg ? 1'h0 : _GEN_367; // @[src/main/scala/ScreenManager.scala 137:23 145:33]
  wire [5:0] _GEN_477 = 4'h2 == screenManagerStateReg ? screenLoader_io_backBufferWriteData : _GEN_368; // @[src/main/scala/ScreenManager.scala 130:26 145:33]
  wire [10:0] _GEN_478 = 4'h2 == screenManagerStateReg ? screenLoader_io_backBufferWriteAddress : _GEN_369; // @[src/main/scala/ScreenManager.scala 131:29 145:33]
  wire  _GEN_479 = 4'h2 == screenManagerStateReg ? screenLoader_io_backBufferWriteEnable : _GEN_370; // @[src/main/scala/ScreenManager.scala 132:28 145:33]
  wire  _GEN_480 = 4'h2 == screenManagerStateReg ? 1'h0 : _GEN_371; // @[src/main/scala/ScreenManager.scala 112:24 145:33]
  wire [3:0] _GEN_481 = 4'h2 == screenManagerStateReg ? 4'h0 : _GEN_372; // @[src/main/scala/ScreenManager.scala 110:28 145:33]
  wire [10:0] _GEN_490 = 4'h2 == screenManagerStateReg ? $signed(11'sh0) : $signed(_GEN_381); // @[src/main/scala/ScreenManager.scala 145:33 69:22]
  wire [10:0] _GEN_491 = 4'h2 == screenManagerStateReg ? $signed(11'sh0) : $signed(_GEN_382); // @[src/main/scala/ScreenManager.scala 145:33 69:22]
  wire [10:0] _GEN_492 = 4'h2 == screenManagerStateReg ? $signed(11'sh0) : $signed(_GEN_383); // @[src/main/scala/ScreenManager.scala 145:33 69:22]
  wire [9:0] _GEN_506 = 4'h2 == screenManagerStateReg ? $signed(10'sh0) : $signed(_GEN_397); // @[src/main/scala/ScreenManager.scala 145:33 70:22]
  wire [9:0] _GEN_507 = 4'h2 == screenManagerStateReg ? $signed(10'sh0) : $signed(_GEN_398); // @[src/main/scala/ScreenManager.scala 145:33 70:22]
  wire [9:0] _GEN_508 = 4'h2 == screenManagerStateReg ? $signed(10'sh0) : $signed(_GEN_399); // @[src/main/scala/ScreenManager.scala 145:33 70:22]
  wire  _GEN_522 = 4'h2 == screenManagerStateReg ? 1'h0 : _GEN_413; // @[src/main/scala/ScreenManager.scala 145:33 71:20]
  wire  _GEN_523 = 4'h2 == screenManagerStateReg ? 1'h0 : _GEN_414; // @[src/main/scala/ScreenManager.scala 145:33 71:20]
  wire  _GEN_524 = 4'h2 == screenManagerStateReg ? 1'h0 : _GEN_415; // @[src/main/scala/ScreenManager.scala 145:33 71:20]
  wire  _GEN_538 = 4'h2 == screenManagerStateReg ? 1'h0 : _GEN_429; // @[src/main/scala/ScreenManager.scala 145:33 72:27]
  wire  _GEN_539 = 4'h2 == screenManagerStateReg ? 1'h0 : _GEN_430; // @[src/main/scala/ScreenManager.scala 145:33 72:27]
  wire  _GEN_555 = 4'h2 == screenManagerStateReg ? 1'h0 : _GEN_446; // @[src/main/scala/ScreenManager.scala 145:33 73:25]
  wire  _GEN_556 = 4'h2 == screenManagerStateReg ? 1'h0 : _GEN_447; // @[src/main/scala/ScreenManager.scala 145:33 73:25]
  wire [9:0] _GEN_570 = 4'h2 == screenManagerStateReg ? viewBoxXReg : _GEN_461; // @[src/main/scala/ScreenManager.scala 145:33 99:15]
  wire [8:0] _GEN_571 = 4'h2 == screenManagerStateReg ? 9'h0 : _GEN_462; // @[src/main/scala/ScreenManager.scala 100:15 145:33]
  wire [10:0] _GEN_572 = 4'h2 == screenManagerStateReg ? screenLoader_io_tileAddress : _GEN_463; // @[src/main/scala/ScreenManager.scala 111:29 145:33]
  wire  _GEN_574 = 4'h2 == screenManagerStateReg ? 1'h0 : _GEN_465; // @[src/main/scala/ScreenManager.scala 145:33 127:42]
  wire  _GEN_575 = 4'h2 == screenManagerStateReg ? 1'h0 : _GEN_466; // @[src/main/scala/ScreenManager.scala 118:25 145:33]
  wire  _GEN_580 = 4'h1 == screenManagerStateReg | _GEN_480; // @[src/main/scala/ScreenManager.scala 145:33 155:28]
  wire [3:0] _GEN_581 = 4'h1 == screenManagerStateReg ? 4'h0 : _GEN_481; // @[src/main/scala/ScreenManager.scala 145:33 156:32]
  wire  _GEN_586 = 4'h1 == screenManagerStateReg ? 1'h0 : _GEN_476; // @[src/main/scala/ScreenManager.scala 137:23 145:33]
  wire [5:0] _GEN_587 = 4'h1 == screenManagerStateReg ? screenLoader_io_backBufferWriteData : _GEN_477; // @[src/main/scala/ScreenManager.scala 130:26 145:33]
  wire [10:0] _GEN_588 = 4'h1 == screenManagerStateReg ? screenLoader_io_backBufferWriteAddress : _GEN_478; // @[src/main/scala/ScreenManager.scala 131:29 145:33]
  wire  _GEN_589 = 4'h1 == screenManagerStateReg ? screenLoader_io_backBufferWriteEnable : _GEN_479; // @[src/main/scala/ScreenManager.scala 132:28 145:33]
  wire [10:0] _GEN_598 = 4'h1 == screenManagerStateReg ? $signed(11'sh0) : $signed(_GEN_490); // @[src/main/scala/ScreenManager.scala 145:33 69:22]
  wire [10:0] _GEN_599 = 4'h1 == screenManagerStateReg ? $signed(11'sh0) : $signed(_GEN_491); // @[src/main/scala/ScreenManager.scala 145:33 69:22]
  wire [10:0] _GEN_600 = 4'h1 == screenManagerStateReg ? $signed(11'sh0) : $signed(_GEN_492); // @[src/main/scala/ScreenManager.scala 145:33 69:22]
  wire [9:0] _GEN_614 = 4'h1 == screenManagerStateReg ? $signed(10'sh0) : $signed(_GEN_506); // @[src/main/scala/ScreenManager.scala 145:33 70:22]
  wire [9:0] _GEN_615 = 4'h1 == screenManagerStateReg ? $signed(10'sh0) : $signed(_GEN_507); // @[src/main/scala/ScreenManager.scala 145:33 70:22]
  wire [9:0] _GEN_616 = 4'h1 == screenManagerStateReg ? $signed(10'sh0) : $signed(_GEN_508); // @[src/main/scala/ScreenManager.scala 145:33 70:22]
  wire  _GEN_630 = 4'h1 == screenManagerStateReg ? 1'h0 : _GEN_522; // @[src/main/scala/ScreenManager.scala 145:33 71:20]
  wire  _GEN_631 = 4'h1 == screenManagerStateReg ? 1'h0 : _GEN_523; // @[src/main/scala/ScreenManager.scala 145:33 71:20]
  wire  _GEN_632 = 4'h1 == screenManagerStateReg ? 1'h0 : _GEN_524; // @[src/main/scala/ScreenManager.scala 145:33 71:20]
  wire  _GEN_646 = 4'h1 == screenManagerStateReg ? 1'h0 : _GEN_538; // @[src/main/scala/ScreenManager.scala 145:33 72:27]
  wire  _GEN_647 = 4'h1 == screenManagerStateReg ? 1'h0 : _GEN_539; // @[src/main/scala/ScreenManager.scala 145:33 72:27]
  wire  _GEN_663 = 4'h1 == screenManagerStateReg ? 1'h0 : _GEN_555; // @[src/main/scala/ScreenManager.scala 145:33 73:25]
  wire  _GEN_664 = 4'h1 == screenManagerStateReg ? 1'h0 : _GEN_556; // @[src/main/scala/ScreenManager.scala 145:33 73:25]
  wire [9:0] _GEN_678 = 4'h1 == screenManagerStateReg ? viewBoxXReg : _GEN_570; // @[src/main/scala/ScreenManager.scala 145:33 99:15]
  wire [8:0] _GEN_679 = 4'h1 == screenManagerStateReg ? 9'h0 : _GEN_571; // @[src/main/scala/ScreenManager.scala 100:15 145:33]
  wire [10:0] _GEN_680 = 4'h1 == screenManagerStateReg ? screenLoader_io_tileAddress : _GEN_572; // @[src/main/scala/ScreenManager.scala 111:29 145:33]
  wire  _GEN_682 = 4'h1 == screenManagerStateReg ? 1'h0 : _GEN_574; // @[src/main/scala/ScreenManager.scala 145:33 127:42]
  wire  _GEN_683 = 4'h1 == screenManagerStateReg ? 1'h0 : _GEN_575; // @[src/main/scala/ScreenManager.scala 118:25 145:33]
  wire [3:0] _GEN_690 = 4'h0 == screenManagerStateReg ? 4'h0 : _GEN_581; // @[src/main/scala/ScreenManager.scala 110:28 145:33]
  reg  io_frameUpdateDone_REG; // @[src/main/scala/ScreenManager.scala 291:40]
  reg  io_frameUpdateDone_REG_1; // @[src/main/scala/ScreenManager.scala 291:32]
  ...
  RaceManager raceManager ( // @[src/main/scala/ScreenManager.scala 116:27]
  ...
  MenuPrinter menuPrinter ( // @[src/main/scala/ScreenManager.scala 136:27]
  ...
  assign io_spriteXPosition_0 = 4'h0 == screenManagerStateReg ? $signed(11'sh0) : $signed(_GEN_598); // @[src/main/scala/ScreenManager.scala 145:33 69:22]
  assign io_spriteXPosition_1 = 4'h0 == screenManagerStateReg ? $signed(11'sh0) : $signed(_GEN_599); // @[src/main/scala/ScreenManager.scala 145:33 69:22]
  assign io_spriteXPosition_2 = 4'h0 == screenManagerStateReg ? $signed(11'sh0) : $signed(_GEN_600); // @[src/main/scala/ScreenManager.scala 145:33 69:22]
  assign io_spriteYPosition_0 = 4'h0 == screenManagerStateReg ? $signed(10'sh0) : $signed(_GEN_614); // @[src/main/scala/ScreenManager.scala 145:33 70:22]
  assign io_spriteYPosition_1 = 4'h0 == screenManagerStateReg ? $signed(10'sh0) : $signed(_GEN_615); // @[src/main/scala/ScreenManager.scala 145:33 70:22]
  assign io_spriteYPosition_2 = 4'h0 == screenManagerStateReg ? $signed(10'sh0) : $signed(_GEN_616); // @[src/main/scala/ScreenManager.scala 145:33 70:22]
  assign io_spriteVisible_0 = 4'h0 == screenManagerStateReg ? 1'h0 : _GEN_630; // @[src/main/scala/ScreenManager.scala 145:33 71:20]
  assign io_spriteVisible_1 = 4'h0 == screenManagerStateReg ? 1'h0 : _GEN_631; // @[src/main/scala/ScreenManager.scala 145:33 71:20]
  assign io_spriteVisible_2 = 4'h0 == screenManagerStateReg ? 1'h0 : _GEN_632; // @[src/main/scala/ScreenManager.scala 145:33 71:20]
  assign io_spriteFlipHorizontal_0 = 4'h0 == screenManagerStateReg ? 1'h0 : _GEN_646; // @[src/main/scala/ScreenManager.scala 145:33 72:27]
  assign io_spriteFlipHorizontal_1 = 4'h0 == screenManagerStateReg ? 1'h0 : _GEN_647; // @[src/main/scala/ScreenManager.scala 145:33 72:27]
  assign io_spriteFlipVertical_1 = 4'h0 == screenManagerStateReg ? 1'h0 : _GEN_663; // @[src/main/scala/ScreenManager.scala 145:33 73:25]
  assign io_spriteFlipVertical_2 = 4'h0 == screenManagerStateReg ? 1'h0 : _GEN_664; // @[src/main/scala/ScreenManager.scala 145:33 73:25]
  assign io_viewBoxX = 4'h0 == screenManagerStateReg ? viewBoxXReg : _GEN_678; // @[src/main/scala/ScreenManager.scala 145:33 99:15]
  assign io_viewBoxY = 4'h0 == screenManagerStateReg ? 9'h0 : _GEN_679; // @[src/main/scala/ScreenManager.scala 100:15 145:33]
  assign io_backBufferWriteData = 4'h0 == screenManagerStateReg ? screenLoader_io_backBufferWriteData : _GEN_587; // @[src/main/scala/ScreenManager.scala 130:26 145:33]
  assign io_backBufferWriteAddress = 4'h0 == screenManagerStateReg ? screenLoader_io_backBufferWriteAddress : _GEN_588; // @[src/main/scala/ScreenManager.scala 131:29 145:33]
  assign io_backBufferWriteEnable = 4'h0 == screenManagerStateReg ? screenLoader_io_backBufferWriteEnable : _GEN_589; // @[src/main/scala/ScreenManager.scala 132:28 145:33]
  assign io_frameUpdateDone = io_frameUpdateDone_REG_1; // @[src/main/scala/ScreenManager.scala 291:22]
  assign tilemapRom_clock = clock;
  assign tilemapRom_io_tileAddress = 4'h0 == screenManagerStateReg ? screenLoader_io_tileAddress : _GEN_680; // @[src/main/scala/ScreenManager.scala 111:29 145:33]
  assign tilemapRom_io_tilemapIdx = _GEN_690[2:0];
  assign screenLoader_clock = clock;
  assign screenLoader_reset = reset;
  assign screenLoader_io_load = 4'h0 == screenManagerStateReg ? 1'h0 : _GEN_580; // @[src/main/scala/ScreenManager.scala 112:24 145:33]
  ...
  assign raceManager_io_btnU = io_btnU; // @[src/main/scala/ScreenManager.scala 120:23]
  assign raceManager_io_btnL = io_btnL; // @[src/main/scala/ScreenManager.scala 121:23]
  assign raceManager_io_btnR = io_btnR; // @[src/main/scala/ScreenManager.scala 122:23]
  assign raceManager_io_btnD = io_btnD; // @[src/main/scala/ScreenManager.scala 123:23]
  assign raceManager_io_newFrame = io_newFrame; // @[src/main/scala/ScreenManager.scala 125:27]
  assign raceManager_io_enable = 4'h0 == screenManagerStateReg ? 1'h0 : _GEN_683; // @[src/main/scala/ScreenManager.scala 118:25 145:33]
  assign raceManager_io_tilemapRomCollisionData = 4'h0 == screenManagerStateReg ? 1'h0 : _GEN_682; // @[src/main/scala/ScreenManager.scala 145:33 127:42]
  assign menuPrinter_clock = clock;
  assign menuPrinter_reset = reset;
  assign menuPrinter_io_load = 4'h0 == screenManagerStateReg ? 1'h0 : _GEN_586; // @[src/main/scala/ScreenManager.scala 137:23 145:33]
  assign menuPrinter_io_track = selectedTrackReg; // @[src/main/scala/ScreenManager.scala 138:24]
  always @(posedge clock) begin
    if (reset) begin // @[src/main/scala/ScreenManager.scala 97:28]
      viewBoxXReg <= 10'h0; // @[src/main/scala/ScreenManager.scala 97:28]
    end else if (!(4'h0 == screenManagerStateReg)) begin // @[src/main/scala/ScreenManager.scala 145:33]
      if (!(4'h1 == screenManagerStateReg)) begin // @[src/main/scala/ScreenManager.scala 145:33]
        if (4'h2 == screenManagerStateReg) begin // @[src/main/scala/ScreenManager.scala 145:33]
          viewBoxXReg <= _GEN_4;
        end else begin
          viewBoxXReg <= _GEN_467;
        end
      end
    end
    if (reset) begin // @[src/main/scala/ScreenManager.scala 103:38]
      screenManagerStateReg <= 4'h0; // @[src/main/scala/ScreenManager.scala 103:38]
    end else if (4'h0 == screenManagerStateReg) begin // @[src/main/scala/ScreenManager.scala 145:33]
      if (io_newFrame) begin // @[src/main/scala/ScreenManager.scala 148:25]
        screenManagerStateReg <= 4'h1; // @[src/main/scala/ScreenManager.scala 149:31]
      end
    end else if (4'h1 == screenManagerStateReg) begin // @[src/main/scala/ScreenManager.scala 145:33]
      if (screenLoader_io_done) begin // @[src/main/scala/ScreenManager.scala 159:34]
        screenManagerStateReg <= 4'h7; // @[src/main/scala/ScreenManager.scala 161:31]
      end
    end else if (4'h2 == screenManagerStateReg) begin // @[src/main/scala/ScreenManager.scala 145:33]
      screenManagerStateReg <= _GEN_5;
    end else begin
      screenManagerStateReg <= _GEN_365;
    end
    if (reset) begin // @[src/main/scala/ScreenManager.scala 104:33]
      ...
      if (4'h1 == screenManagerStateReg) begin // @[src/main/scala/ScreenManager.scala 145:33]
        if (screenLoader_io_done) begin // @[src/main/scala/ScreenManager.scala 159:34]
          currentScreenReg <= 1'h0; // @[src/main/scala/ScreenManager.scala 162:26]
        end
      end else if (!(4'h2 == screenManagerStateReg)) begin // @[src/main/scala/ScreenManager.scala 145:33]
        currentScreenReg <= _GEN_366;
      end
    end
    if (reset) begin // @[src/main/scala/ScreenManager.scala 135:33]
      selectedTrackReg <= 4'h1; // @[src/main/scala/ScreenManager.scala 135:33]
    end else if (!(4'h0 == screenManagerStateReg)) begin // @[src/main/scala/ScreenManager.scala 145:33]
      if (!(4'h1 == screenManagerStateReg)) begin // @[src/main/scala/ScreenManager.scala 145:33]
        if (!(4'h2 == screenManagerStateReg)) begin // @[src/main/scala/ScreenManager.scala 145:33]
          selectedTrackReg <= _GEN_470;
        end
      end
    end
    if (reset) begin // @[src/main/scala/ScreenManager.scala 140:28]
      btnLPressed <= 1'h0; // @[src/main/scala/ScreenManager.scala 140:28]
    end else if (!(4'h0 == screenManagerStateReg)) begin // @[src/main/scala/ScreenManager.scala 145:33]
      if (!(4'h1 == screenManagerStateReg)) begin // @[src/main/scala/ScreenManager.scala 145:33]
        if (!(4'h2 == screenManagerStateReg)) begin // @[src/main/scala/ScreenManager.scala 145:33]
          btnLPressed <= _GEN_471;
        end
      end
    end
    if (reset) begin // @[src/main/scala/ScreenManager.scala 141:28]
      btnRPressed <= 1'h0; // @[src/main/scala/ScreenManager.scala 141:28]
    end else if (!(4'h0 == screenManagerStateReg)) begin // @[src/main/scala/ScreenManager.scala 145:33]
      if (!(4'h1 == screenManagerStateReg)) begin // @[src/main/scala/ScreenManager.scala 145:33]
        if (!(4'h2 == screenManagerStateReg)) begin // @[src/main/scala/ScreenManager.scala 145:33]
          btnRPressed <= _GEN_469;
        end
      end
    end
    io_frameUpdateDone_REG <= io_newFrame; // @[src/main/scala/ScreenManager.scala 291:40]
    io_frameUpdateDone_REG_1 <= io_frameUpdateDone_REG; // @[src/main/scala/ScreenManager.scala 291:32]
  end
// Register and memory initialization
`ifdef RANDOMIZE_GARBAGE_ASSIGN
`define RANDOMIZE
...
`ifdef RANDOMIZE_REG_INIT
  ...
  viewBoxXReg = _RAND_0[9:0];
  _RAND_1 = {1{`RANDOM}};
  screenManagerStateReg = _RAND_1[3:0];
  _RAND_2 = {1{`RANDOM}};
  currentScreenReg = _RAND_2[0:0];
  _RAND_3 = {1{`RANDOM}};
  selectedTrackReg = _RAND_3[3:0];
  _RAND_4 = {1{`RANDOM}};
  btnLPressed = _RAND_4[0:0];
  _RAND_5 = {1{`RANDOM}};
  btnRPressed = _RAND_5[0:0];
  _RAND_6 = {1{`RANDOM}};
  io_frameUpdateDone_REG = _RAND_6[0:0];
  _RAND_7 = {1{`RANDOM}};
  io_frameUpdateDone_REG_1 = _RAND_7[0:0];
`endif // RANDOMIZE_REG_INIT
  `endif // RANDOMIZE
end // initial
`ifdef FIRRTL_AFTER_INITIAL

...
`endif // RANDOMIZE_REG_INIT
  ...
  reg  btnCPressed; // @[src/main/scala/ScreenManager.scala 150:28]
  reg  btnLPressed; // @[src/main/scala/ScreenManager.scala 151:28]
  reg  btnRPressed; // @[src/main/scala/ScreenManager.scala 152:28]
  wire [1:0] _GEN_0 = io_newFrame ? 2'h0 : currentScreenReg; // @[src/main/scala/ScreenManager.scala 159:25 160:26 107:33]
  wire  _T_2 = currentScreenReg == 2'h0; // @[src/main/scala/ScreenManager.scala 176:29]
  wire  _T_3 = currentScreenReg == 2'h2; // @[src/main/scala/ScreenManager.scala 179:35]
  wire [9:0] _GEN_4 = currentScreenReg == 2'h2 ? 10'h0 : viewBoxXReg; // @[src/main/scala/ScreenManager.scala 179:51 180:21 100:28]
  wire [8:0] _GEN_5 = currentScreenReg == 2'h2 ? 9'h1e0 : viewBoxYReg; // @[src/main/scala/ScreenManager.scala 179:51 181:21 101:28]
  wire [9:0] _viewBoxXReg_T_1 = viewBoxXReg + 10'h10; // @[src/main/scala/ScreenManager.scala 188:36]
  wire [9:0] _GEN_8 = io_newFrame ? _viewBoxXReg_T_1 : viewBoxXReg; // @[src/main/scala/ScreenManager.scala 187:25 188:21 100:28]
  wire [3:0] _GEN_9 = io_newFrame ? 4'h3 : screenManagerStateReg; // @[src/main/scala/ScreenManager.scala 187:25 189:31 106:38]
  wire [3:0] _GEN_10 = viewBoxXReg >= 10'h280 ? 4'h8 : 4'h2; // @[src/main/scala/ScreenManager.scala 196:34 197:31 200:31]
  wire [1:0] _GEN_11 = viewBoxXReg >= 10'h280 ? 2'h1 : currentScreenReg; // @[src/main/scala/ScreenManager.scala 196:34 198:26 107:33]
  wire [3:0] _GEN_12 = menuPrinter_io_done ? 4'h9 : screenManagerStateReg; // @[src/main/scala/ScreenManager.scala 210:33 211:31 106:38]
  wire [3:0] _GEN_13 = screenLoader_io_done ? 4'h6 : screenManagerStateReg; // @[src/main/scala/ScreenManager.scala 221:34 223:31 106:38]
  wire [3:0] _GEN_14 = scoreboardPrinter_io_done ? 4'h9 : screenManagerStateReg; // @[src/main/scala/ScreenManager.scala 233:39 234:31 106:38]
  wire [3:0] _GEN_15 = raceManager_io_finished ? 4'h1 : screenManagerStateReg; // @[src/main/scala/ScreenManager.scala 263:37 264:31 106:38]
  wire [1:0] _GEN_16 = raceManager_io_finished ? 2'h2 : currentScreenReg; // @[src/main/scala/ScreenManager.scala 263:37 265:26 107:33]
  wire [3:0] _GEN_17 = _T_3 ? 4'h7 : {{2'd0}, currentScreenReg}; // @[src/main/scala/ScreenManager.scala 274:47 275:28 107:33]
  wire [3:0] _GEN_18 = _T_2 ? 4'h2 : 4'h9; // @[src/main/scala/ScreenManager.scala 272:31 280:50 281:35]
  wire  _T_16 = currentScreenReg == 2'h1; // @[src/main/scala/ScreenManager.scala 283:33]
  wire [3:0] _GEN_19 = currentScreenReg == 2'h1 ? 4'h5 : _GEN_18; // @[src/main/scala/ScreenManager.scala 283:56 284:35]
  wire [8:0] _GEN_21 = _T_3 ? 9'h0 : viewBoxYReg; // @[src/main/scala/ScreenManager.scala 286:49 288:25 101:28]
  wire [3:0] _GEN_22 = _T_3 ? 4'h0 : _GEN_17; // @[src/main/scala/ScreenManager.scala 286:49 289:30]
  wire  _GEN_23 = io_btnC & ~btnCPressed | btnCPressed; // @[src/main/scala/ScreenManager.scala 278:50 279:23 150:28]
  wire [3:0] _GEN_24 = io_btnC & ~btnCPressed ? _GEN_19 : 4'h9; // @[src/main/scala/ScreenManager.scala 272:31 278:50]
  wire [9:0] _GEN_25 = io_btnC & ~btnCPressed ? _GEN_4 : viewBoxXReg; // @[src/main/scala/ScreenManager.scala 100:28 278:50]
  wire [8:0] _GEN_26 = io_btnC & ~btnCPressed ? _GEN_21 : viewBoxYReg; // @[src/main/scala/ScreenManager.scala 101:28 278:50]
  wire [3:0] _GEN_27 = io_btnC & ~btnCPressed ? _GEN_22 : _GEN_17; // @[src/main/scala/ScreenManager.scala 278:50]
  wire [3:0] _selectedTrackReg_T_1 = selectedTrackReg + 4'h1; // @[src/main/scala/ScreenManager.scala 296:50]
  wire [3:0] _GEN_28 = selectedTrackReg == 4'h7 ? 4'h1 : _selectedTrackReg_T_1; // @[src/main/scala/ScreenManager.scala 296:30 297:62 298:32]
  wire [3:0] _GEN_29 = _T_16 ? _GEN_28 : selectedTrackReg; // @[src/main/scala/ScreenManager.scala 138:33 295:56]
  wire [3:0] _GEN_30 = _T_16 ? 4'h4 : _GEN_24; // @[src/main/scala/ScreenManager.scala 295:56 300:35]
  wire  _GEN_31 = io_btnR & ~btnRPressed | btnRPressed; // @[src/main/scala/ScreenManager.scala 293:50 294:23 152:28]
  wire [3:0] _GEN_32 = io_btnR & ~btnRPressed ? _GEN_29 : selectedTrackReg; // @[src/main/scala/ScreenManager.scala 138:33 293:50]
  wire [3:0] _GEN_33 = io_btnR & ~btnRPressed ? _GEN_30 : _GEN_24; // @[src/main/scala/ScreenManager.scala 293:50]
  wire [3:0] _selectedTrackReg_T_3 = selectedTrackReg - 4'h1; // @[src/main/scala/ScreenManager.scala 307:50]
  wire [3:0] _GEN_34 = selectedTrackReg == 4'h1 ? 4'h7 : _selectedTrackReg_T_3; // @[src/main/scala/ScreenManager.scala 307:30 308:44 309:32]
  wire [3:0] _GEN_35 = _T_16 ? _GEN_34 : _GEN_32; // @[src/main/scala/ScreenManager.scala 306:56]
  wire [3:0] _GEN_36 = _T_16 ? 4'h4 : _GEN_33; // @[src/main/scala/ScreenManager.scala 306:56 311:35]
  wire  _GEN_37 = io_btnL & ~btnLPressed | btnLPressed; // @[src/main/scala/ScreenManager.scala 304:50 305:23 151:28]
  wire [3:0] _GEN_38 = io_btnL & ~btnLPressed ? _GEN_35 : _GEN_32; // @[src/main/scala/ScreenManager.scala 304:50]
  wire [3:0] _GEN_39 = io_btnL & ~btnLPressed ? _GEN_36 : _GEN_33; // @[src/main/scala/ScreenManager.scala 304:50]
  wire  _GEN_40 = ~io_btnC ? 1'h0 : _GEN_23; // @[src/main/scala/ScreenManager.scala 315:24 316:23]
  wire  _GEN_41 = ~io_btnR ? 1'h0 : _GEN_31; // @[src/main/scala/ScreenManager.scala 319:24 320:23]
  wire  _GEN_42 = ~io_btnL ? 1'h0 : _GEN_37; // @[src/main/scala/ScreenManager.scala 323:24 324:23]
  wire [3:0] _GEN_43 = io_newFrame ? _GEN_39 : screenManagerStateReg; // @[src/main/scala/ScreenManager.scala 271:25 106:38]
  wire [3:0] _GEN_44 = io_newFrame ? _GEN_27 : {{2'd0}, currentScreenReg}; // @[src/main/scala/ScreenManager.scala 271:25 107:33]
  wire  _GEN_45 = io_newFrame ? _GEN_40 : btnCPressed; // @[src/main/scala/ScreenManager.scala 271:25 150:28]
  wire [9:0] _GEN_46 = io_newFrame ? _GEN_25 : viewBoxXReg; // @[src/main/scala/ScreenManager.scala 271:25 100:28]
  wire [8:0] _GEN_47 = io_newFrame ? _GEN_26 : viewBoxYReg; // @[src/main/scala/ScreenManager.scala 271:25 101:28]
  wire  _GEN_48 = io_newFrame ? _GEN_41 : btnRPressed; // @[src/main/scala/ScreenManager.scala 271:25 152:28]
  wire [3:0] _GEN_49 = io_newFrame ? _GEN_38 : selectedTrackReg; // @[src/main/scala/ScreenManager.scala 271:25 138:33]
  wire  _GEN_50 = io_newFrame ? _GEN_42 : btnLPressed; // @[src/main/scala/ScreenManager.scala 271:25 151:28]
  wire [3:0] _GEN_52 = 4'h9 == screenManagerStateReg ? 4'h8 : screenManagerStateReg; // @[src/main/scala/ScreenManager.scala 156:33 332:29 106:38]
  wire [3:0] _GEN_53 = 4'h8 == screenManagerStateReg ? _GEN_43 : _GEN_52; // @[src/main/scala/ScreenManager.scala 156:33]
  wire [3:0] _GEN_54 = 4'h8 == screenManagerStateReg ? _GEN_44 : {{2'd0}, currentScreenReg}; // @[src/main/scala/ScreenManager.scala 107:33 156:33]
  wire  _GEN_55 = 4'h8 == screenManagerStateReg ? _GEN_45 : btnCPressed; // @[src/main/scala/ScreenManager.scala 150:28 156:33]
  wire [9:0] _GEN_56 = 4'h8 == screenManagerStateReg ? _GEN_46 : viewBoxXReg; // @[src/main/scala/ScreenManager.scala 100:28 156:33]
  wire [8:0] _GEN_57 = 4'h8 == screenManagerStateReg ? _GEN_47 : viewBoxYReg; // @[src/main/scala/ScreenManager.scala 101:28 156:33]
  wire  _GEN_58 = 4'h8 == screenManagerStateReg ? _GEN_48 : btnRPressed; // @[src/main/scala/ScreenManager.scala 152:28 156:33]
  wire [3:0] _GEN_59 = 4'h8 == screenManagerStateReg ? _GEN_49 : selectedTrackReg; // @[src/main/scala/ScreenManager.scala 138:33 156:33]
  wire  _GEN_60 = 4'h8 == screenManagerStateReg ? _GEN_50 : btnLPressed; // @[src/main/scala/ScreenManager.scala 151:28 156:33]
  wire [10:0] _GEN_70 = 4'h6 == screenManagerStateReg ? $signed(raceManager_io_spriteXPosition_0) : $signed(11'sh0); // @[src/main/scala/ScreenManager.scala 156:33 242:26 72:22]
  wire [10:0] _GEN_71 = 4'h6 == screenManagerStateReg ? $signed(raceManager_io_spriteXPosition_1) : $signed(11'sh0); // @[src/main/scala/ScreenManager.scala 156:33 242:26 72:22]
  wire [10:0] _GEN_72 = 4'h6 == screenManagerStateReg ? $signed(raceManager_io_spriteXPosition_2) : $signed(11'sh0); // @[src/main/scala/ScreenManager.scala 156:33 242:26 72:22]
  wire [9:0] _GEN_86 = 4'h6 == screenManagerStateReg ? $signed(raceManager_io_spriteYPosition_0) : $signed(10'sh0); // @[src/main/scala/ScreenManager.scala 156:33 243:26 73:22]
  wire [9:0] _GEN_87 = 4'h6 == screenManagerStateReg ? $signed(raceManager_io_spriteYPosition_1) : $signed(10'sh0); // @[src/main/scala/ScreenManager.scala 156:33 243:26 73:22]
  wire [9:0] _GEN_88 = 4'h6 == screenManagerStateReg ? $signed(raceManager_io_spriteYPosition_2) : $signed(10'sh0); // @[src/main/scala/ScreenManager.scala 156:33 243:26 73:22]
  wire  _GEN_102 = 4'h6 == screenManagerStateReg & raceManager_io_spriteVisible_0; // @[src/main/scala/ScreenManager.scala 156:33 244:24 74:20]
  wire  _GEN_103 = 4'h6 == screenManagerStateReg & raceManager_io_spriteVisible_1; // @[src/main/scala/ScreenManager.scala 156:33 244:24 74:20]
  wire  _GEN_104 = 4'h6 == screenManagerStateReg & raceManager_io_spriteVisible_2; // @[src/main/scala/ScreenManager.scala 156:33 244:24 74:20]
  wire  _GEN_118 = 4'h6 == screenManagerStateReg & raceManager_io_spriteFlipHorizontal_0; // @[src/main/scala/ScreenManager.scala 156:33 245:31 75:27]
  wire  _GEN_119 = 4'h6 == screenManagerStateReg & raceManager_io_spriteFlipHorizontal_1; // @[src/main/scala/ScreenManager.scala 156:33 245:31 75:27]
  wire  _GEN_135 = 4'h6 == screenManagerStateReg & raceManager_io_spriteFlipVertical_1; // @[src/main/scala/ScreenManager.scala 156:33 246:29 76:25]
  wire  _GEN_136 = 4'h6 == screenManagerStateReg & raceManager_io_spriteFlipVertical_2; // @[src/main/scala/ScreenManager.scala 156:33 246:29 76:25]
  wire [9:0] _GEN_150 = 4'h6 == screenManagerStateReg ? raceManager_io_viewBoxX : viewBoxXReg; // @[src/main/scala/ScreenManager.scala 102:15 156:33 247:19]
  wire [8:0] _GEN_151 = 4'h6 == screenManagerStateReg ? raceManager_io_viewBoxY : viewBoxYReg; // @[src/main/scala/ScreenManager.scala 103:15 156:33 248:19]
  wire [5:0] _GEN_152 = 4'h6 == screenManagerStateReg ? raceManager_io_backBufferWriteData :
    screenLoader_io_backBufferWriteData; // @[src/main/scala/ScreenManager.scala 133:26 156:33 249:30]
  wire [10:0] _GEN_153 = 4'h6 == screenManagerStateReg ? raceManager_io_backBufferWriteAddress :
    screenLoader_io_backBufferWriteAddress; // @[src/main/scala/ScreenManager.scala 134:29 156:33 250:33]
  wire  _GEN_154 = 4'h6 == screenManagerStateReg ? raceManager_io_backBufferWriteEnable :
    screenLoader_io_backBufferWriteEnable; // @[src/main/scala/ScreenManager.scala 135:28 156:33 251:32]
  wire [3:0] _GEN_156 = 4'h6 == screenManagerStateReg ? selectedTrackReg : 4'h0; // @[src/main/scala/ScreenManager.scala 113:28 156:33 255:32]
  wire [10:0] _GEN_157 = 4'h6 == screenManagerStateReg ? raceManager_io_tilemapRomTileAddress :
    screenLoader_io_tileAddress; // @[src/main/scala/ScreenManager.scala 114:29 156:33 256:33]
  wire  _GEN_159 = 4'h6 == screenManagerStateReg & tilemapRom_io_collisionData; // @[src/main/scala/ScreenManager.scala 156:33 130:42 258:46]
  wire [3:0] _GEN_161 = 4'h6 == screenManagerStateReg ? _GEN_15 : _GEN_53; // @[src/main/scala/ScreenManager.scala 156:33]
  wire [3:0] _GEN_162 = 4'h6 == screenManagerStateReg ? {{2'd0}, _GEN_16} : _GEN_54; // @[src/main/scala/ScreenManager.scala 156:33]
  wire  _GEN_163 = 4'h6 == screenManagerStateReg ? btnCPressed : _GEN_55; // @[src/main/scala/ScreenManager.scala 150:28 156:33]
  wire [9:0] _GEN_164 = 4'h6 == screenManagerStateReg ? viewBoxXReg : _GEN_56; // @[src/main/scala/ScreenManager.scala 100:28 156:33]
  wire [8:0] _GEN_165 = 4'h6 == screenManagerStateReg ? viewBoxYReg : _GEN_57; // @[src/main/scala/ScreenManager.scala 101:28 156:33]
  wire  _GEN_166 = 4'h6 == screenManagerStateReg ? btnRPressed : _GEN_58; // @[src/main/scala/ScreenManager.scala 152:28 156:33]
  wire [3:0] _GEN_167 = 4'h6 == screenManagerStateReg ? selectedTrackReg : _GEN_59; // @[src/main/scala/ScreenManager.scala 138:33 156:33]
  wire  _GEN_168 = 4'h6 == screenManagerStateReg ? btnLPressed : _GEN_60; // @[src/main/scala/ScreenManager.scala 151:28 156:33]
  wire [5:0] _GEN_170 = 4'h7 == screenManagerStateReg ? scoreboardPrinter_io_backBufferWriteData : _GEN_152; // @[src/main/scala/ScreenManager.scala 156:33 229:30]
  wire [10:0] _GEN_171 = 4'h7 == screenManagerStateReg ? scoreboardPrinter_io_backBufferWriteAddress : _GEN_153; // @[src/main/scala/ScreenManager.scala 156:33 230:33]
  wire  _GEN_172 = 4'h7 == screenManagerStateReg ? scoreboardPrinter_io_backBufferWriteEnable : _GEN_154; // @[src/main/scala/ScreenManager.scala 156:33 231:32]
  wire [3:0] _GEN_173 = 4'h7 == screenManagerStateReg ? _GEN_14 : _GEN_161; // @[src/main/scala/ScreenManager.scala 156:33]
  wire [10:0] _GEN_182 = 4'h7 == screenManagerStateReg ? $signed(11'sh0) : $signed(_GEN_70); // @[src/main/scala/ScreenManager.scala 156:33 72:22]
  wire [10:0] _GEN_183 = 4'h7 == screenManagerStateReg ? $signed(11'sh0) : $signed(_GEN_71); // @[src/main/scala/ScreenManager.scala 156:33 72:22]
  wire [10:0] _GEN_184 = 4'h7 == screenManagerStateReg ? $signed(11'sh0) : $signed(_GEN_72); // @[src/main/scala/ScreenManager.scala 156:33 72:22]
  wire [9:0] _GEN_198 = 4'h7 == screenManagerStateReg ? $signed(10'sh0) : $signed(_GEN_86); // @[src/main/scala/ScreenManager.scala 156:33 73:22]
  wire [9:0] _GEN_199 = 4'h7 == screenManagerStateReg ? $signed(10'sh0) : $signed(_GEN_87); // @[src/main/scala/ScreenManager.scala 156:33 73:22]
  wire [9:0] _GEN_200 = 4'h7 == screenManagerStateReg ? $signed(10'sh0) : $signed(_GEN_88); // @[src/main/scala/ScreenManager.scala 156:33 73:22]
  wire  _GEN_214 = 4'h7 == screenManagerStateReg ? 1'h0 : _GEN_102; // @[src/main/scala/ScreenManager.scala 156:33 74:20]
  wire  _GEN_215 = 4'h7 == screenManagerStateReg ? 1'h0 : _GEN_103; // @[src/main/scala/ScreenManager.scala 156:33 74:20]
  wire  _GEN_216 = 4'h7 == screenManagerStateReg ? 1'h0 : _GEN_104; // @[src/main/scala/ScreenManager.scala 156:33 74:20]
  wire  _GEN_230 = 4'h7 == screenManagerStateReg ? 1'h0 : _GEN_118; // @[src/main/scala/ScreenManager.scala 156:33 75:27]
  wire  _GEN_231 = 4'h7 == screenManagerStateReg ? 1'h0 : _GEN_119; // @[src/main/scala/ScreenManager.scala 156:33 75:27]
  wire  _GEN_247 = 4'h7 == screenManagerStateReg ? 1'h0 : _GEN_135; // @[src/main/scala/ScreenManager.scala 156:33 76:25]
  wire  _GEN_248 = 4'h7 == screenManagerStateReg ? 1'h0 : _GEN_136; // @[src/main/scala/ScreenManager.scala 156:33 76:25]
  wire [9:0] _GEN_262 = 4'h7 == screenManagerStateReg ? viewBoxXReg : _GEN_150; // @[src/main/scala/ScreenManager.scala 102:15 156:33]
  wire [8:0] _GEN_263 = 4'h7 == screenManagerStateReg ? viewBoxYReg : _GEN_151; // @[src/main/scala/ScreenManager.scala 103:15 156:33]
  wire [3:0] _GEN_265 = 4'h7 == screenManagerStateReg ? 4'h0 : _GEN_156; // @[src/main/scala/ScreenManager.scala 113:28 156:33]
  wire [10:0] _GEN_266 = 4'h7 == screenManagerStateReg ? screenLoader_io_tileAddress : _GEN_157; // @[src/main/scala/ScreenManager.scala 114:29 156:33]
  wire  _GEN_268 = 4'h7 == screenManagerStateReg ? 1'h0 : _GEN_159; // @[src/main/scala/ScreenManager.scala 156:33 130:42]
  wire  _GEN_269 = 4'h7 == screenManagerStateReg ? 1'h0 : 4'h6 == screenManagerStateReg; // @[src/main/scala/ScreenManager.scala 121:25 156:33]
  wire [3:0] _GEN_270 = 4'h7 == screenManagerStateReg ? {{2'd0}, currentScreenReg} : _GEN_162; // @[src/main/scala/ScreenManager.scala 107:33 156:33]
  wire  _GEN_271 = 4'h7 == screenManagerStateReg ? btnCPressed : _GEN_163; // @[src/main/scala/ScreenManager.scala 150:28 156:33]
  wire [9:0] _GEN_272 = 4'h7 == screenManagerStateReg ? viewBoxXReg : _GEN_164; // @[src/main/scala/ScreenManager.scala 100:28 156:33]
  wire [8:0] _GEN_273 = 4'h7 == screenManagerStateReg ? viewBoxYReg : _GEN_165; // @[src/main/scala/ScreenManager.scala 101:28 156:33]
  wire  _GEN_274 = 4'h7 == screenManagerStateReg ? btnRPressed : _GEN_166; // @[src/main/scala/ScreenManager.scala 152:28 156:33]
  wire [3:0] _GEN_275 = 4'h7 == screenManagerStateReg ? selectedTrackReg : _GEN_167; // @[src/main/scala/ScreenManager.scala 138:33 156:33]
  wire  _GEN_276 = 4'h7 == screenManagerStateReg ? btnLPressed : _GEN_168; // @[src/main/scala/ScreenManager.scala 151:28 156:33]
  wire [3:0] _GEN_278 = 4'h5 == screenManagerStateReg ? selectedTrackReg : _GEN_265; // @[src/main/scala/ScreenManager.scala 156:33 218:32]
  wire [3:0] _GEN_280 = 4'h5 == screenManagerStateReg ? _GEN_13 : _GEN_173; // @[src/main/scala/ScreenManager.scala 156:33]
  wire  _GEN_281 = 4'h5 == screenManagerStateReg ? 1'h0 : 4'h7 == screenManagerStateReg; // @[src/main/scala/ScreenManager.scala 146:29 156:33]
  wire [5:0] _GEN_282 = 4'h5 == screenManagerStateReg ? screenLoader_io_backBufferWriteData : _GEN_170; // @[src/main/scala/ScreenManager.scala 133:26 156:33]
  wire [10:0] _GEN_283 = 4'h5 == screenManagerStateReg ? screenLoader_io_backBufferWriteAddress : _GEN_171; // @[src/main/scala/ScreenManager.scala 134:29 156:33]
  wire  _GEN_284 = 4'h5 == screenManagerStateReg ? screenLoader_io_backBufferWriteEnable : _GEN_172; // @[src/main/scala/ScreenManager.scala 135:28 156:33]
  wire [10:0] _GEN_293 = 4'h5 == screenManagerStateReg ? $signed(11'sh0) : $signed(_GEN_182); // @[src/main/scala/ScreenManager.scala 156:33 72:22]
  wire [10:0] _GEN_294 = 4'h5 == screenManagerStateReg ? $signed(11'sh0) : $signed(_GEN_183); // @[src/main/scala/ScreenManager.scala 156:33 72:22]
  wire [10:0] _GEN_295 = 4'h5 == screenManagerStateReg ? $signed(11'sh0) : $signed(_GEN_184); // @[src/main/scala/ScreenManager.scala 156:33 72:22]
  wire [9:0] _GEN_309 = 4'h5 == screenManagerStateReg ? $signed(10'sh0) : $signed(_GEN_198); // @[src/main/scala/ScreenManager.scala 156:33 73:22]
  wire [9:0] _GEN_310 = 4'h5 == screenManagerStateReg ? $signed(10'sh0) : $signed(_GEN_199); // @[src/main/scala/ScreenManager.scala 156:33 73:22]
  wire [9:0] _GEN_311 = 4'h5 == screenManagerStateReg ? $signed(10'sh0) : $signed(_GEN_200); // @[src/main/scala/ScreenManager.scala 156:33 73:22]
  wire  _GEN_325 = 4'h5 == screenManagerStateReg ? 1'h0 : _GEN_214; // @[src/main/scala/ScreenManager.scala 156:33 74:20]
  wire  _GEN_326 = 4'h5 == screenManagerStateReg ? 1'h0 : _GEN_215; // @[src/main/scala/ScreenManager.scala 156:33 74:20]
  wire  _GEN_327 = 4'h5 == screenManagerStateReg ? 1'h0 : _GEN_216; // @[src/main/scala/ScreenManager.scala 156:33 74:20]
  wire  _GEN_341 = 4'h5 == screenManagerStateReg ? 1'h0 : _GEN_230; // @[src/main/scala/ScreenManager.scala 156:33 75:27]
  wire  _GEN_342 = 4'h5 == screenManagerStateReg ? 1'h0 : _GEN_231; // @[src/main/scala/ScreenManager.scala 156:33 75:27]
  wire  _GEN_358 = 4'h5 == screenManagerStateReg ? 1'h0 : _GEN_247; // @[src/main/scala/ScreenManager.scala 156:33 76:25]
  wire  _GEN_359 = 4'h5 == screenManagerStateReg ? 1'h0 : _GEN_248; // @[src/main/scala/ScreenManager.scala 156:33 76:25]
  wire [9:0] _GEN_373 = 4'h5 == screenManagerStateReg ? viewBoxXReg : _GEN_262; // @[src/main/scala/ScreenManager.scala 102:15 156:33]
  wire [8:0] _GEN_374 = 4'h5 == screenManagerStateReg ? viewBoxYReg : _GEN_263; // @[src/main/scala/ScreenManager.scala 103:15 156:33]
  wire [10:0] _GEN_375 = 4'h5 == screenManagerStateReg ? screenLoader_io_tileAddress : _GEN_266; // @[src/main/scala/ScreenManager.scala 114:29 156:33]
  wire  _GEN_377 = 4'h5 == screenManagerStateReg ? 1'h0 : _GEN_268; // @[src/main/scala/ScreenManager.scala 156:33 130:42]
  wire  _GEN_378 = 4'h5 == screenManagerStateReg ? 1'h0 : _GEN_269; // @[src/main/scala/ScreenManager.scala 121:25 156:33]
  wire [3:0] _GEN_379 = 4'h5 == screenManagerStateReg ? {{2'd0}, currentScreenReg} : _GEN_270; // @[src/main/scala/ScreenManager.scala 107:33 156:33]
  wire  _GEN_380 = 4'h5 == screenManagerStateReg ? btnCPressed : _GEN_271; // @[src/main/scala/ScreenManager.scala 150:28 156:33]
  wire [9:0] _GEN_381 = 4'h5 == screenManagerStateReg ? viewBoxXReg : _GEN_272; // @[src/main/scala/ScreenManager.scala 100:28 156:33]
  wire [8:0] _GEN_382 = 4'h5 == screenManagerStateReg ? viewBoxYReg : _GEN_273; // @[src/main/scala/ScreenManager.scala 101:28 156:33]
  wire  _GEN_383 = 4'h5 == screenManagerStateReg ? btnRPressed : _GEN_274; // @[src/main/scala/ScreenManager.scala 152:28 156:33]
  wire [3:0] _GEN_384 = 4'h5 == screenManagerStateReg ? selectedTrackReg : _GEN_275; // @[src/main/scala/ScreenManager.scala 138:33 156:33]
  wire  _GEN_385 = 4'h5 == screenManagerStateReg ? btnLPressed : _GEN_276; // @[src/main/scala/ScreenManager.scala 151:28 156:33]
  wire [5:0] _GEN_387 = 4'h4 == screenManagerStateReg ? menuPrinter_io_backBufferWriteData : _GEN_282; // @[src/main/scala/ScreenManager.scala 156:33 206:30]
  wire [10:0] _GEN_388 = 4'h4 == screenManagerStateReg ? menuPrinter_io_backBufferWriteAddress : _GEN_283; // @[src/main/scala/ScreenManager.scala 156:33 207:33]
  wire  _GEN_389 = 4'h4 == screenManagerStateReg ? menuPrinter_io_backBufferWriteEnable : _GEN_284; // @[src/main/scala/ScreenManager.scala 156:33 208:32]
  wire [3:0] _GEN_390 = 4'h4 == screenManagerStateReg ? _GEN_12 : _GEN_280; // @[src/main/scala/ScreenManager.scala 156:33]
  wire  _GEN_391 = 4'h4 == screenManagerStateReg ? 1'h0 : 4'h5 == screenManagerStateReg; // @[src/main/scala/ScreenManager.scala 115:24 156:33]
  wire [3:0] _GEN_392 = 4'h4 == screenManagerStateReg ? 4'h0 : _GEN_278; // @[src/main/scala/ScreenManager.scala 113:28 156:33]
  wire  _GEN_394 = 4'h4 == screenManagerStateReg ? 1'h0 : _GEN_281; // @[src/main/scala/ScreenManager.scala 146:29 156:33]
  wire [10:0] _GEN_403 = 4'h4 == screenManagerStateReg ? $signed(11'sh0) : $signed(_GEN_293); // @[src/main/scala/ScreenManager.scala 156:33 72:22]
  wire [10:0] _GEN_404 = 4'h4 == screenManagerStateReg ? $signed(11'sh0) : $signed(_GEN_294); // @[src/main/scala/ScreenManager.scala 156:33 72:22]
  wire [10:0] _GEN_405 = 4'h4 == screenManagerStateReg ? $signed(11'sh0) : $signed(_GEN_295); // @[src/main/scala/ScreenManager.scala 156:33 72:22]
  wire [9:0] _GEN_419 = 4'h4 == screenManagerStateReg ? $signed(10'sh0) : $signed(_GEN_309); // @[src/main/scala/ScreenManager.scala 156:33 73:22]
  wire [9:0] _GEN_420 = 4'h4 == screenManagerStateReg ? $signed(10'sh0) : $signed(_GEN_310); // @[src/main/scala/ScreenManager.scala 156:33 73:22]
  wire [9:0] _GEN_421 = 4'h4 == screenManagerStateReg ? $signed(10'sh0) : $signed(_GEN_311); // @[src/main/scala/ScreenManager.scala 156:33 73:22]
  wire  _GEN_435 = 4'h4 == screenManagerStateReg ? 1'h0 : _GEN_325; // @[src/main/scala/ScreenManager.scala 156:33 74:20]
  wire  _GEN_436 = 4'h4 == screenManagerStateReg ? 1'h0 : _GEN_326; // @[src/main/scala/ScreenManager.scala 156:33 74:20]
  wire  _GEN_437 = 4'h4 == screenManagerStateReg ? 1'h0 : _GEN_327; // @[src/main/scala/ScreenManager.scala 156:33 74:20]
  wire  _GEN_451 = 4'h4 == screenManagerStateReg ? 1'h0 : _GEN_341; // @[src/main/scala/ScreenManager.scala 156:33 75:27]
  wire  _GEN_452 = 4'h4 == screenManagerStateReg ? 1'h0 : _GEN_342; // @[src/main/scala/ScreenManager.scala 156:33 75:27]
  wire  _GEN_468 = 4'h4 == screenManagerStateReg ? 1'h0 : _GEN_358; // @[src/main/scala/ScreenManager.scala 156:33 76:25]
  wire  _GEN_469 = 4'h4 == screenManagerStateReg ? 1'h0 : _GEN_359; // @[src/main/scala/ScreenManager.scala 156:33 76:25]
  wire [9:0] _GEN_483 = 4'h4 == screenManagerStateReg ? viewBoxXReg : _GEN_373; // @[src/main/scala/ScreenManager.scala 102:15 156:33]
  wire [8:0] _GEN_484 = 4'h4 == screenManagerStateReg ? viewBoxYReg : _GEN_374; // @[src/main/scala/ScreenManager.scala 103:15 156:33]
  wire [10:0] _GEN_485 = 4'h4 == screenManagerStateReg ? screenLoader_io_tileAddress : _GEN_375; // @[src/main/scala/ScreenManager.scala 114:29 156:33]
  wire  _GEN_487 = 4'h4 == screenManagerStateReg ? 1'h0 : _GEN_377; // @[src/main/scala/ScreenManager.scala 156:33 130:42]
  wire  _GEN_488 = 4'h4 == screenManagerStateReg ? 1'h0 : _GEN_378; // @[src/main/scala/ScreenManager.scala 121:25 156:33]
  wire [3:0] _GEN_489 = 4'h4 == screenManagerStateReg ? {{2'd0}, currentScreenReg} : _GEN_379; // @[src/main/scala/ScreenManager.scala 107:33 156:33]
  wire  _GEN_490 = 4'h4 == screenManagerStateReg ? btnCPressed : _GEN_380; // @[src/main/scala/ScreenManager.scala 150:28 156:33]
  wire [9:0] _GEN_491 = 4'h4 == screenManagerStateReg ? viewBoxXReg : _GEN_381; // @[src/main/scala/ScreenManager.scala 100:28 156:33]
  wire [8:0] _GEN_492 = 4'h4 == screenManagerStateReg ? viewBoxYReg : _GEN_382; // @[src/main/scala/ScreenManager.scala 101:28 156:33]
  wire  _GEN_493 = 4'h4 == screenManagerStateReg ? btnRPressed : _GEN_383; // @[src/main/scala/ScreenManager.scala 152:28 156:33]
  wire [3:0] _GEN_494 = 4'h4 == screenManagerStateReg ? selectedTrackReg : _GEN_384; // @[src/main/scala/ScreenManager.scala 138:33 156:33]
  wire  _GEN_495 = 4'h4 == screenManagerStateReg ? btnLPressed : _GEN_385; // @[src/main/scala/ScreenManager.scala 151:28 156:33]
  wire [3:0] _GEN_497 = 4'h3 == screenManagerStateReg ? _GEN_10 : _GEN_390; // @[src/main/scala/ScreenManager.scala 156:33]
  wire [3:0] _GEN_498 = 4'h3 == screenManagerStateReg ? {{2'd0}, _GEN_11} : _GEN_489; // @[src/main/scala/ScreenManager.scala 156:33]
  wire  _GEN_499 = 4'h3 == screenManagerStateReg ? 1'h0 : 4'h4 == screenManagerStateReg; // @[src/main/scala/ScreenManager.scala 141:23 156:33]
  wire [5:0] _GEN_500 = 4'h3 == screenManagerStateReg ? screenLoader_io_backBufferWriteData : _GEN_387; // @[src/main/scala/ScreenManager.scala 133:26 156:33]
  wire [10:0] _GEN_501 = 4'h3 == screenManagerStateReg ? screenLoader_io_backBufferWriteAddress : _GEN_388; // @[src/main/scala/ScreenManager.scala 134:29 156:33]
  wire  _GEN_502 = 4'h3 == screenManagerStateReg ? screenLoader_io_backBufferWriteEnable : _GEN_389; // @[src/main/scala/ScreenManager.scala 135:28 156:33]
  wire  _GEN_503 = 4'h3 == screenManagerStateReg ? 1'h0 : _GEN_391; // @[src/main/scala/ScreenManager.scala 115:24 156:33]
  wire [3:0] _GEN_504 = 4'h3 == screenManagerStateReg ? 4'h0 : _GEN_392; // @[src/main/scala/ScreenManager.scala 113:28 156:33]
  wire  _GEN_505 = 4'h3 == screenManagerStateReg ? 1'h0 : _GEN_394; // @[src/main/scala/ScreenManager.scala 146:29 156:33]
  wire [10:0] _GEN_514 = 4'h3 == screenManagerStateReg ? $signed(11'sh0) : $signed(_GEN_403); // @[src/main/scala/ScreenManager.scala 156:33 72:22]
  wire [10:0] _GEN_515 = 4'h3 == screenManagerStateReg ? $signed(11'sh0) : $signed(_GEN_404); // @[src/main/scala/ScreenManager.scala 156:33 72:22]
  wire [10:0] _GEN_516 = 4'h3 == screenManagerStateReg ? $signed(11'sh0) : $signed(_GEN_405); // @[src/main/scala/ScreenManager.scala 156:33 72:22]
  wire [9:0] _GEN_530 = 4'h3 == screenManagerStateReg ? $signed(10'sh0) : $signed(_GEN_419); // @[src/main/scala/ScreenManager.scala 156:33 73:22]
  wire [9:0] _GEN_531 = 4'h3 == screenManagerStateReg ? $signed(10'sh0) : $signed(_GEN_420); // @[src/main/scala/ScreenManager.scala 156:33 73:22]
  wire [9:0] _GEN_532 = 4'h3 == screenManagerStateReg ? $signed(10'sh0) : $signed(_GEN_421); // @[src/main/scala/ScreenManager.scala 156:33 73:22]
  wire  _GEN_546 = 4'h3 == screenManagerStateReg ? 1'h0 : _GEN_435; // @[src/main/scala/ScreenManager.scala 156:33 74:20]
  wire  _GEN_547 = 4'h3 == screenManagerStateReg ? 1'h0 : _GEN_436; // @[src/main/scala/ScreenManager.scala 156:33 74:20]
  wire  _GEN_548 = 4'h3 == screenManagerStateReg ? 1'h0 : _GEN_437; // @[src/main/scala/ScreenManager.scala 156:33 74:20]
  wire  _GEN_562 = 4'h3 == screenManagerStateReg ? 1'h0 : _GEN_451; // @[src/main/scala/ScreenManager.scala 156:33 75:27]
  wire  _GEN_563 = 4'h3 == screenManagerStateReg ? 1'h0 : _GEN_452; // @[src/main/scala/ScreenManager.scala 156:33 75:27]
  wire  _GEN_579 = 4'h3 == screenManagerStateReg ? 1'h0 : _GEN_468; // @[src/main/scala/ScreenManager.scala 156:33 76:25]
  wire  _GEN_580 = 4'h3 == screenManagerStateReg ? 1'h0 : _GEN_469; // @[src/main/scala/ScreenManager.scala 156:33 76:25]
  wire [9:0] _GEN_594 = 4'h3 == screenManagerStateReg ? viewBoxXReg : _GEN_483; // @[src/main/scala/ScreenManager.scala 102:15 156:33]
  wire [8:0] _GEN_595 = 4'h3 == screenManagerStateReg ? viewBoxYReg : _GEN_484; // @[src/main/scala/ScreenManager.scala 103:15 156:33]
  wire [10:0] _GEN_596 = 4'h3 == screenManagerStateReg ? screenLoader_io_tileAddress : _GEN_485; // @[src/main/scala/ScreenManager.scala 114:29 156:33]
  wire  _GEN_598 = 4'h3 == screenManagerStateReg ? 1'h0 : _GEN_487; // @[src/main/scala/ScreenManager.scala 156:33 130:42]
  wire  _GEN_599 = 4'h3 == screenManagerStateReg ? 1'h0 : _GEN_488; // @[src/main/scala/ScreenManager.scala 121:25 156:33]
  wire  _GEN_600 = 4'h3 == screenManagerStateReg ? btnCPressed : _GEN_490; // @[src/main/scala/ScreenManager.scala 150:28 156:33]
  wire [9:0] _GEN_601 = 4'h3 == screenManagerStateReg ? viewBoxXReg : _GEN_491; // @[src/main/scala/ScreenManager.scala 100:28 156:33]
  wire [8:0] _GEN_602 = 4'h3 == screenManagerStateReg ? viewBoxYReg : _GEN_492; // @[src/main/scala/ScreenManager.scala 101:28 156:33]
  wire  _GEN_603 = 4'h3 == screenManagerStateReg ? btnRPressed : _GEN_493; // @[src/main/scala/ScreenManager.scala 152:28 156:33]
  wire [3:0] _GEN_604 = 4'h3 == screenManagerStateReg ? selectedTrackReg : _GEN_494; // @[src/main/scala/ScreenManager.scala 138:33 156:33]
  wire  _GEN_605 = 4'h3 == screenManagerStateReg ? btnLPressed : _GEN_495; // @[src/main/scala/ScreenManager.scala 151:28 156:33]
  wire [3:0] _GEN_609 = 4'h2 == screenManagerStateReg ? {{2'd0}, currentScreenReg} : _GEN_498; // @[src/main/scala/ScreenManager.scala 107:33 156:33]
  wire  _GEN_610 = 4'h2 == screenManagerStateReg ? 1'h0 : _GEN_499; // @[src/main/scala/ScreenManager.scala 141:23 156:33]
  wire [5:0] _GEN_611 = 4'h2 == screenManagerStateReg ? screenLoader_io_backBufferWriteData : _GEN_500; // @[src/main/scala/ScreenManager.scala 133:26 156:33]
  wire [10:0] _GEN_612 = 4'h2 == screenManagerStateReg ? screenLoader_io_backBufferWriteAddress : _GEN_501; // @[src/main/scala/ScreenManager.scala 134:29 156:33]
  wire  _GEN_613 = 4'h2 == screenManagerStateReg ? screenLoader_io_backBufferWriteEnable : _GEN_502; // @[src/main/scala/ScreenManager.scala 135:28 156:33]
  wire  _GEN_614 = 4'h2 == screenManagerStateReg ? 1'h0 : _GEN_503; // @[src/main/scala/ScreenManager.scala 115:24 156:33]
  wire [3:0] _GEN_615 = 4'h2 == screenManagerStateReg ? 4'h0 : _GEN_504; // @[src/main/scala/ScreenManager.scala 113:28 156:33]
  wire  _GEN_616 = 4'h2 == screenManagerStateReg ? 1'h0 : _GEN_505; // @[src/main/scala/ScreenManager.scala 146:29 156:33]
  wire [10:0] _GEN_625 = 4'h2 == screenManagerStateReg ? $signed(11'sh0) : $signed(_GEN_514); // @[src/main/scala/ScreenManager.scala 156:33 72:22]
  wire [10:0] _GEN_626 = 4'h2 == screenManagerStateReg ? $signed(11'sh0) : $signed(_GEN_515); // @[src/main/scala/ScreenManager.scala 156:33 72:22]
  wire [10:0] _GEN_627 = 4'h2 == screenManagerStateReg ? $signed(11'sh0) : $signed(_GEN_516); // @[src/main/scala/ScreenManager.scala 156:33 72:22]
  wire [9:0] _GEN_641 = 4'h2 == screenManagerStateReg ? $signed(10'sh0) : $signed(_GEN_530); // @[src/main/scala/ScreenManager.scala 156:33 73:22]
  wire [9:0] _GEN_642 = 4'h2 == screenManagerStateReg ? $signed(10'sh0) : $signed(_GEN_531); // @[src/main/scala/ScreenManager.scala 156:33 73:22]
  wire [9:0] _GEN_643 = 4'h2 == screenManagerStateReg ? $signed(10'sh0) : $signed(_GEN_532); // @[src/main/scala/ScreenManager.scala 156:33 73:22]
  wire  _GEN_657 = 4'h2 == screenManagerStateReg ? 1'h0 : _GEN_546; // @[src/main/scala/ScreenManager.scala 156:33 74:20]
  wire  _GEN_658 = 4'h2 == screenManagerStateReg ? 1'h0 : _GEN_547; // @[src/main/scala/ScreenManager.scala 156:33 74:20]
  wire  _GEN_659 = 4'h2 == screenManagerStateReg ? 1'h0 : _GEN_548; // @[src/main/scala/ScreenManager.scala 156:33 74:20]
  wire  _GEN_673 = 4'h2 == screenManagerStateReg ? 1'h0 : _GEN_562; // @[src/main/scala/ScreenManager.scala 156:33 75:27]
  wire  _GEN_674 = 4'h2 == screenManagerStateReg ? 1'h0 : _GEN_563; // @[src/main/scala/ScreenManager.scala 156:33 75:27]
  wire  _GEN_690 = 4'h2 == screenManagerStateReg ? 1'h0 : _GEN_579; // @[src/main/scala/ScreenManager.scala 156:33 76:25]
  wire  _GEN_691 = 4'h2 == screenManagerStateReg ? 1'h0 : _GEN_580; // @[src/main/scala/ScreenManager.scala 156:33 76:25]
  wire [9:0] _GEN_705 = 4'h2 == screenManagerStateReg ? viewBoxXReg : _GEN_594; // @[src/main/scala/ScreenManager.scala 102:15 156:33]
  wire [8:0] _GEN_706 = 4'h2 == screenManagerStateReg ? viewBoxYReg : _GEN_595; // @[src/main/scala/ScreenManager.scala 103:15 156:33]
  wire [10:0] _GEN_707 = 4'h2 == screenManagerStateReg ? screenLoader_io_tileAddress : _GEN_596; // @[src/main/scala/ScreenManager.scala 114:29 156:33]
  wire  _GEN_709 = 4'h2 == screenManagerStateReg ? 1'h0 : _GEN_598; // @[src/main/scala/ScreenManager.scala 156:33 130:42]
  wire  _GEN_710 = 4'h2 == screenManagerStateReg ? 1'h0 : _GEN_599; // @[src/main/scala/ScreenManager.scala 121:25 156:33]
  wire  _GEN_716 = 4'h1 == screenManagerStateReg | _GEN_614; // @[src/main/scala/ScreenManager.scala 156:33 167:28]
  wire [3:0] _GEN_717 = 4'h1 == screenManagerStateReg ? 4'h0 : _GEN_615; // @[src/main/scala/ScreenManager.scala 156:33 168:32]
  wire [3:0] _GEN_722 = 4'h1 == screenManagerStateReg ? {{2'd0}, currentScreenReg} : _GEN_609; // @[src/main/scala/ScreenManager.scala 107:33 156:33]
  wire  _GEN_723 = 4'h1 == screenManagerStateReg ? 1'h0 : _GEN_610; // @[src/main/scala/ScreenManager.scala 141:23 156:33]
  wire [5:0] _GEN_724 = 4'h1 == screenManagerStateReg ? screenLoader_io_backBufferWriteData : _GEN_611; // @[src/main/scala/ScreenManager.scala 133:26 156:33]
  wire [10:0] _GEN_725 = 4'h1 == screenManagerStateReg ? screenLoader_io_backBufferWriteAddress : _GEN_612; // @[src/main/scala/ScreenManager.scala 134:29 156:33]
  wire  _GEN_726 = 4'h1 == screenManagerStateReg ? screenLoader_io_backBufferWriteEnable : _GEN_613; // @[src/main/scala/ScreenManager.scala 135:28 156:33]
  wire  _GEN_727 = 4'h1 == screenManagerStateReg ? 1'h0 : _GEN_616; // @[src/main/scala/ScreenManager.scala 146:29 156:33]
  wire [10:0] _GEN_736 = 4'h1 == screenManagerStateReg ? $signed(11'sh0) : $signed(_GEN_625); // @[src/main/scala/ScreenManager.scala 156:33 72:22]
  wire [10:0] _GEN_737 = 4'h1 == screenManagerStateReg ? $signed(11'sh0) : $signed(_GEN_626); // @[src/main/scala/ScreenManager.scala 156:33 72:22]
  wire [10:0] _GEN_738 = 4'h1 == screenManagerStateReg ? $signed(11'sh0) : $signed(_GEN_627); // @[src/main/scala/ScreenManager.scala 156:33 72:22]
  wire [9:0] _GEN_752 = 4'h1 == screenManagerStateReg ? $signed(10'sh0) : $signed(_GEN_641); // @[src/main/scala/ScreenManager.scala 156:33 73:22]
  wire [9:0] _GEN_753 = 4'h1 == screenManagerStateReg ? $signed(10'sh0) : $signed(_GEN_642); // @[src/main/scala/ScreenManager.scala 156:33 73:22]
  wire [9:0] _GEN_754 = 4'h1 == screenManagerStateReg ? $signed(10'sh0) : $signed(_GEN_643); // @[src/main/scala/ScreenManager.scala 156:33 73:22]
  wire  _GEN_768 = 4'h1 == screenManagerStateReg ? 1'h0 : _GEN_657; // @[src/main/scala/ScreenManager.scala 156:33 74:20]
  wire  _GEN_769 = 4'h1 == screenManagerStateReg ? 1'h0 : _GEN_658; // @[src/main/scala/ScreenManager.scala 156:33 74:20]
  wire  _GEN_770 = 4'h1 == screenManagerStateReg ? 1'h0 : _GEN_659; // @[src/main/scala/ScreenManager.scala 156:33 74:20]
  wire  _GEN_784 = 4'h1 == screenManagerStateReg ? 1'h0 : _GEN_673; // @[src/main/scala/ScreenManager.scala 156:33 75:27]
  wire  _GEN_785 = 4'h1 == screenManagerStateReg ? 1'h0 : _GEN_674; // @[src/main/scala/ScreenManager.scala 156:33 75:27]
  wire  _GEN_801 = 4'h1 == screenManagerStateReg ? 1'h0 : _GEN_690; // @[src/main/scala/ScreenManager.scala 156:33 76:25]
  wire  _GEN_802 = 4'h1 == screenManagerStateReg ? 1'h0 : _GEN_691; // @[src/main/scala/ScreenManager.scala 156:33 76:25]
  wire [9:0] _GEN_816 = 4'h1 == screenManagerStateReg ? viewBoxXReg : _GEN_705; // @[src/main/scala/ScreenManager.scala 102:15 156:33]
  wire [8:0] _GEN_817 = 4'h1 == screenManagerStateReg ? viewBoxYReg : _GEN_706; // @[src/main/scala/ScreenManager.scala 103:15 156:33]
  wire [10:0] _GEN_818 = 4'h1 == screenManagerStateReg ? screenLoader_io_tileAddress : _GEN_707; // @[src/main/scala/ScreenManager.scala 114:29 156:33]
  wire  _GEN_820 = 4'h1 == screenManagerStateReg ? 1'h0 : _GEN_709; // @[src/main/scala/ScreenManager.scala 156:33 130:42]
  wire  _GEN_821 = 4'h1 == screenManagerStateReg ? 1'h0 : _GEN_710; // @[src/main/scala/ScreenManager.scala 121:25 156:33]
  wire [3:0] _GEN_826 = 4'h0 == screenManagerStateReg ? {{2'd0}, _GEN_0} : _GEN_722; // @[src/main/scala/ScreenManager.scala 156:33]
  wire [3:0] _GEN_829 = 4'h0 == screenManagerStateReg ? 4'h0 : _GEN_717; // @[src/main/scala/ScreenManager.scala 113:28 156:33]
  reg  io_frameUpdateDone_REG; // @[src/main/scala/ScreenManager.scala 338:40]
  reg  io_frameUpdateDone_REG_1; // @[src/main/scala/ScreenManager.scala 338:32]
  ...
  assign io_spriteXPosition_0 = 4'h0 == screenManagerStateReg ? $signed(11'sh0) : $signed(_GEN_736); // @[src/main/scala/ScreenManager.scala 156:33 72:22]
  assign io_spriteXPosition_1 = 4'h0 == screenManagerStateReg ? $signed(11'sh0) : $signed(_GEN_737); // @[src/main/scala/ScreenManager.scala 156:33 72:22]
  assign io_spriteXPosition_2 = 4'h0 == screenManagerStateReg ? $signed(11'sh0) : $signed(_GEN_738); // @[src/main/scala/ScreenManager.scala 156:33 72:22]
  assign io_spriteYPosition_0 = 4'h0 == screenManagerStateReg ? $signed(10'sh0) : $signed(_GEN_752); // @[src/main/scala/ScreenManager.scala 156:33 73:22]
  assign io_spriteYPosition_1 = 4'h0 == screenManagerStateReg ? $signed(10'sh0) : $signed(_GEN_753); // @[src/main/scala/ScreenManager.scala 156:33 73:22]
  assign io_spriteYPosition_2 = 4'h0 == screenManagerStateReg ? $signed(10'sh0) : $signed(_GEN_754); // @[src/main/scala/ScreenManager.scala 156:33 73:22]
  assign io_spriteVisible_0 = 4'h0 == screenManagerStateReg ? 1'h0 : _GEN_768; // @[src/main/scala/ScreenManager.scala 156:33 74:20]
  assign io_spriteVisible_1 = 4'h0 == screenManagerStateReg ? 1'h0 : _GEN_769; // @[src/main/scala/ScreenManager.scala 156:33 74:20]
  assign io_spriteVisible_2 = 4'h0 == screenManagerStateReg ? 1'h0 : _GEN_770; // @[src/main/scala/ScreenManager.scala 156:33 74:20]
  assign io_spriteFlipHorizontal_0 = 4'h0 == screenManagerStateReg ? 1'h0 : _GEN_784; // @[src/main/scala/ScreenManager.scala 156:33 75:27]
  assign io_spriteFlipHorizontal_1 = 4'h0 == screenManagerStateReg ? 1'h0 : _GEN_785; // @[src/main/scala/ScreenManager.scala 156:33 75:27]
  assign io_spriteFlipVertical_1 = 4'h0 == screenManagerStateReg ? 1'h0 : _GEN_801; // @[src/main/scala/ScreenManager.scala 156:33 76:25]
  assign io_spriteFlipVertical_2 = 4'h0 == screenManagerStateReg ? 1'h0 : _GEN_802; // @[src/main/scala/ScreenManager.scala 156:33 76:25]
  assign io_viewBoxX = 4'h0 == screenManagerStateReg ? viewBoxXReg : _GEN_816; // @[src/main/scala/ScreenManager.scala 102:15 156:33]
  assign io_viewBoxY = 4'h0 == screenManagerStateReg ? viewBoxYReg : _GEN_817; // @[src/main/scala/ScreenManager.scala 103:15 156:33]
  assign io_backBufferWriteData = 4'h0 == screenManagerStateReg ? screenLoader_io_backBufferWriteData : _GEN_724; // @[src/main/scala/ScreenManager.scala 133:26 156:33]
  assign io_backBufferWriteAddress = 4'h0 == screenManagerStateReg ? screenLoader_io_backBufferWriteAddress : _GEN_725; // @[src/main/scala/ScreenManager.scala 134:29 156:33]
  assign io_backBufferWriteEnable = 4'h0 == screenManagerStateReg ? screenLoader_io_backBufferWriteEnable : _GEN_726; // @[src/main/scala/ScreenManager.scala 135:28 156:33]
  assign io_frameUpdateDone = io_frameUpdateDone_REG_1; // @[src/main/scala/ScreenManager.scala 338:22]
  assign tilemapRom_clock = clock;
  assign tilemapRom_io_tileAddress = 4'h0 == screenManagerStateReg ? screenLoader_io_tileAddress : _GEN_818; // @[src/main/scala/ScreenManager.scala 114:29 156:33]
  assign tilemapRom_io_tilemapIdx = _GEN_829[2:0];
  assign screenLoader_clock = clock;
  assign screenLoader_reset = reset;
  assign screenLoader_io_load = 4'h0 == screenManagerStateReg ? 1'h0 : _GEN_716; // @[src/main/scala/ScreenManager.scala 115:24 156:33]
  ...
  assign raceManager_io_enable = 4'h0 == screenManagerStateReg ? 1'h0 : _GEN_821; // @[src/main/scala/ScreenManager.scala 121:25 156:33]
  assign raceManager_io_tilemapRomCollisionData = 4'h0 == screenManagerStateReg ? 1'h0 : _GEN_820; // @[src/main/scala/ScreenManager.scala 156:33 130:42]
  ...
  assign menuPrinter_io_load = 4'h0 == screenManagerStateReg ? 1'h0 : _GEN_723; // @[src/main/scala/ScreenManager.scala 141:23 156:33]
  ...
  assign scoreboardPrinter_io_load = 4'h0 == screenManagerStateReg ? 1'h0 : _GEN_727; // @[src/main/scala/ScreenManager.scala 146:29 156:33]
  ...
  always @(posedge clock) begin
    ...
    end else if (!(4'h0 == screenManagerStateReg)) begin // @[src/main/scala/ScreenManager.scala 156:33]
      if (4'h1 == screenManagerStateReg) begin // @[src/main/scala/ScreenManager.scala 156:33]
        if (currentScreenReg == 2'h0) begin // @[src/main/scala/ScreenManager.scala 176:46]
          viewBoxXReg <= 10'h0; // @[src/main/scala/ScreenManager.scala 177:21]
        end else begin
          viewBoxXReg <= _GEN_4;
        end
      end else if (4'h2 == screenManagerStateReg) begin // @[src/main/scala/ScreenManager.scala 156:33]
        viewBoxXReg <= _GEN_8;
      end else begin
    ...
    if (reset) begin // @[src/main/scala/ScreenManager.scala 101:28]
      ...
      if (4'h1 == screenManagerStateReg) begin // @[src/main/scala/ScreenManager.scala 156:33]
        if (currentScreenReg == 2'h0) begin // @[src/main/scala/ScreenManager.scala 176:46]
          viewBoxYReg <= 9'h0; // @[src/main/scala/ScreenManager.scala 178:21]
        end else begin
          viewBoxYReg <= _GEN_5;
        end
      end else if (!(4'h2 == screenManagerStateReg)) begin // @[src/main/scala/ScreenManager.scala 156:33]
    ...
    if (reset) begin // @[src/main/scala/ScreenManager.scala 106:38]
      ...
      if (io_newFrame) begin // @[src/main/scala/ScreenManager.scala 159:25]
        screenManagerStateReg <= 4'h1; // @[src/main/scala/ScreenManager.scala 161:31]
      end
    end else if (4'h1 == screenManagerStateReg) begin // @[src/main/scala/ScreenManager.scala 156:33]
      if (screenLoader_io_done) begin // @[src/main/scala/ScreenManager.scala 171:34]
        screenManagerStateReg <= 4'h8; // @[src/main/scala/ScreenManager.scala 173:31]
      end
    end else if (4'h2 == screenManagerStateReg) begin // @[src/main/scala/ScreenManager.scala 156:33]
    ...
    if (reset) begin // @[src/main/scala/ScreenManager.scala 138:33]
      ...
      if (!(4'h1 == screenManagerStateReg)) begin // @[src/main/scala/ScreenManager.scala 156:33]
        if (!(4'h2 == screenManagerStateReg)) begin // @[src/main/scala/ScreenManager.scala 156:33]
          selectedTrackReg <= _GEN_604;
        end
      end
    end
    if (reset) begin // @[src/main/scala/ScreenManager.scala 150:28]
      btnCPressed <= 1'h0; // @[src/main/scala/ScreenManager.scala 150:28]
    end else if (!(4'h0 == screenManagerStateReg)) begin // @[src/main/scala/ScreenManager.scala 156:33]
      if (!(4'h1 == screenManagerStateReg)) begin // @[src/main/scala/ScreenManager.scala 156:33]
        if (!(4'h2 == screenManagerStateReg)) begin // @[src/main/scala/ScreenManager.scala 156:33]
    ...
    if (reset) begin // @[src/main/scala/ScreenManager.scala 151:28]
      btnLPressed <= 1'h0; // @[src/main/scala/ScreenManager.scala 151:28]
    end else if (!(4'h0 == screenManagerStateReg)) begin // @[src/main/scala/ScreenManager.scala 156:33]
      if (!(4'h1 == screenManagerStateReg)) begin // @[src/main/scala/ScreenManager.scala 156:33]
        if (!(4'h2 == screenManagerStateReg)) begin // @[src/main/scala/ScreenManager.scala 156:33]
    ...
    if (reset) begin // @[src/main/scala/ScreenManager.scala 152:28]
      btnRPressed <= 1'h0; // @[src/main/scala/ScreenManager.scala 152:28]
    end else if (!(4'h0 == screenManagerStateReg)) begin // @[src/main/scala/ScreenManager.scala 156:33]
      if (!(4'h1 == screenManagerStateReg)) begin // @[src/main/scala/ScreenManager.scala 156:33]
        if (!(4'h2 == screenManagerStateReg)) begin // @[src/main/scala/ScreenManager.scala 156:33]
    ...
    io_frameUpdateDone_REG <= io_newFrame; // @[src/main/scala/ScreenManager.scala 338:40]
    io_frameUpdateDone_REG_1 <= io_frameUpdateDone_REG; // @[src/main/scala/ScreenManager.scala 338:32]
  end
// Register and memory initialization
`ifdef RANDOMIZE_GARBAGE_ASSIGN
`define RANDOMIZE
